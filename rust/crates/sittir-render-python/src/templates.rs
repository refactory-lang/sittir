...
fn render_as_pattern(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "alias")?;
    let field_1 = resolve_field(node, "expression")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_await(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "primary_expression")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_case_clause(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "consequence")?;
    let field_1 = resolve_field(node, "guard")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_class_definition(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_1 = resolve_field(node, "name")?;
    let field_2 = resolve_field(node, "superclasses")?;
...
fn render_class_pattern(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "arguments")?;
    let field_1 = resolve_field(node, "dotted_name")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_comparison_operator(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "left")?;
    let field_1 = resolve_field(node, "operators")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_complex_pattern(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "imaginary")?;
    let field_1 = resolve_field(node, "real")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_conditional_expression(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_2 = resolve_field(node, "condition")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_constrained_type(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "base_type")?;
...
fn render_decorated_definition(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "definition")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_exec_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "code")?;
    let field_1 = resolve_field(node, "in_clause")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_for_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "alternative")?;
    let field_1 = resolve_field(node, "async_marker")?;
    let field_2 = resolve_field(node, "body")?;
    let field_3 = resolve_field(node, "left")?;
    let field_4 = resolve_field(node, "right")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_generic_type(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_1 = resolve_field(node, "type_parameter")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_import_from_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "module_name")?;
    let field_1 = resolve_field(node, "name")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_interpolation(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "expression")?;
    let field_1 = resolve_field(node, "format_specifier")?;
    let field_2 = resolve_field(node, "type_conversion")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_keyword_pattern(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "identifier")?;
    let field_1 = resolve_field(node, "simple_pattern")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_match_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "body")?;
    let field_1 = resolve_field(node, "subject")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_raise_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "cause")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_relative_import(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "dotted_name")?;
    let field_1 = resolve_field(node, "import_prefix")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_slice(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "start")?;
    let field_1 = resolve_field(node, "step")?;
    let field_2 = resolve_field(node, "stop")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_subscript(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "subscript")?;
    let field_1 = resolve_field(node, "value")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_try_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "body")?;
    let field_1 = resolve_field(node, "else_clause")?;
    let field_2 = resolve_field(node, "except_clauses")?;
    let field_3 = resolve_field(node, "finally_clause")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
...
fn render_with_statement(node: &NodeData) -> Result<String, ::askama::Error> {
    ...
    let field_0 = resolve_field(node, "async_marker")?;
    let field_1 = resolve_field(node, "body")?;
    let field_2 = resolve_field(node, "with_clause")?;
    let variant = resolve_variant(node);
    let text = resolve_text(node)?;
