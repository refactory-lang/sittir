...
export interface BracketedTypeTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _type: Box<BracketedTypeTypeTransportSlot>
}
...
export interface ClosureExpressionExprTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _body: Box<_ClosureExpressionExprBodyTransportSlot>
}
...
export interface ElseClauseTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _block: Box<ExpressionEndingWithBlockTransport>
}
...
export interface LetChainTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _let_chain: Box<ConditionTransport>
}
...
export interface NonSpecialTokenTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _literal: NonSpecialTokenLiteralTransportSlot
}
...
export interface RangeExpressionTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _range_expression_binary: Box<RangeExpressionBinaryTransport>
...
export interface TypeArgumentsRepeat1Transport {
  '$source'?: Source
  '$named'?: boolean
  '$text'?: string
  '$span'?: Span
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _type: TypeArgumentsRepeat1TypeTransportSlot
...
export interface TypeArgumentsTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _type_arguments_repeat1: Array<TypeArgumentsRepeat1Transport>
}
...
export interface TypeParametersRepeat1Transport {
  ...
  '$triviaData'?: TransportTrivia
  _attribute_item?: Array<AttributeItemTransport>
  _metavariable: TypeParametersRepeat1MetavariableTransportSlot
}
...
export interface TypeParametersTransport {
  ...
  '$childIndex'?: number
  '$triviaData'?: TransportTrivia
  _type_parameters_repeat1: Array<TypeParametersRepeat1Transport>
}
