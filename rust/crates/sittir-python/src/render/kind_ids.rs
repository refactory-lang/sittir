...
pub const _SIMPLE_STATEMENTS_ELEMENTS: KindId = KindId(241);
pub const _SUBJECTS: KindId = KindId(242);
pub const _CASE_PATTERNS: KindId = KindId(243);
pub const _WITH_CLAUSE_WITH_ITEMS: KindId = KindId(244);
pub const _TYPES: KindId = KindId(245);
pub const _ARGUMENT_LIST_ELEMENTS: KindId = KindId(246);
pub const _EXPRESSION_LIST_EXPRESSIONS: KindId = KindId(247);
pub const _LIST_PATTERN_CASE_PATTERNS: KindId = KindId(248);
pub const _DICT_PATTERN_ELEMENTS: KindId = KindId(249);
pub const _PATTERN_LIST_PATTERNS: KindId = KindId(250);
pub const _SUBSCRIPTS: KindId = KindId(251);
pub const _DICTIONARY_ELEMENTS: KindId = KindId(252);
pub const _SLICE_GROUP: KindId = KindId(253);
pub const _AUGMENTED_ASSIGNMENT_OPERATOR: KindId = KindId(254);
pub const _EXCEPT_CLAUSE_EXCEPTION_AS: KindId = KindId(255);
...
pub fn kind_name_from_id(id: KindId) -> &'static str {
    match id.0 {
        ...
        241 => "simple_statements_elements", // "_simple_statements_elements"
        242 => "subjects", // "_subjects"
        243 => "case_patterns", // "_case_patterns"
        244 => "with_clause_with_items", // "_with_clause_with_items"
        245 => "types", // "_types"
        246 => "argument_list_elements", // "_argument_list_elements"
        247 => "expression_list_expressions", // "_expression_list_expressions"
        248 => "list_pattern_case_patterns", // "_list_pattern_case_patterns"
        249 => "dict_pattern_elements", // "_dict_pattern_elements"
        250 => "pattern_list_patterns", // "_pattern_list_patterns"
        251 => "subscripts", // "_subscripts"
        252 => "dictionary_elements", // "_dictionary_elements"
        253 => "slice_group", // "_slice_group"
        254 => "_augmented_assignment_operator", // "_augmented_assignment_operator"
        255 => "except_clause_exception_as", // "_except_clause_exception_as"
