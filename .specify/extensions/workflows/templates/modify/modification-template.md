...
_Auto-generated by scan-impact.sh - review and adjust_
...
_Filled during /speckit.plan - Only scenarios that change, reference original spec for unchanged_
...
_Check if modification violates any project principles_
...
_Modification spec created using `/modify` workflow - See .specify/extensions/workflows/modify/_
