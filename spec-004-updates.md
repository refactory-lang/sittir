...
| **snake_case** | Rule names, clause names, field names | tree-sitter | `function_item`, `return_type_clause`, `visibility_modifier` |
| **UPPER_SNAKE** | Template variables | ast-grep patterns | `$NAME`, `$$$PARAMETERS`, `$VISIBILITY_MODIFIER` |
