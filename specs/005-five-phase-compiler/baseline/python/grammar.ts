...
export type PythonGrammar = {
	...
	readonly as_pattern: {
		...
		fields: {
			alias: {
				multiple: false;
				required: false;
				types: [{ type: "as_pattern_target"; named: true }];
			};
		};
		children: {
			multiple: true;
	...
	readonly block: {
		...
		fields: {
			alternative: {
				multiple: true;
				required: false;
				types: [{ type: "case_clause"; named: true }];
			};
		};
		children: {
			multiple: true;
	...
	readonly class_definition: {
		...
		fields: {
			...
			superclasses: {
				multiple: false;
				required: false;
				types: [{ type: "argument_list"; named: true }];
			};
			type_parameters: {
				multiple: false;
				required: false;
	...
	readonly class_pattern: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: "case_pattern"; named: true }, { type: "dotted_name"; named: true }];
		};
	};
	...
	readonly dict_pattern: {
		...
		children: { multiple: true; required: false; types: [{ type: "splat_pattern"; named: true }] };
	};
	readonly dictionary: {
		type: "dictionary";
		named: true;
	...
	readonly except_clause: {
		...
		fields: {
			...
			value: { multiple: true; required: false; types: [{ type: "expression"; named: true }] };
		};
	...
	readonly exec_statement: {
		...
		children: { multiple: true; required: false; types: [{ type: "expression"; named: true }] };
	};
	...
	readonly format_expression: {
		...
		fields: {
			...
			format_specifier: {
				multiple: false;
				required: false;
				types: [{ type: "format_specifier"; named: true }];
			};
			type_conversion: {
				multiple: false;
				required: false;
				types: [{ type: "type_conversion"; named: true }];
			};
		};
	};
	readonly format_specifier: {
		...
		children: {
			multiple: true;
			required: false;
			types: [{ type: "format_expression"; named: true }];
		};
	};
	...
	readonly generic_type: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: "identifier"; named: true }, { type: "type_parameter"; named: true }];
		};
	};
	...
	readonly import_from_statement: {
		...
		children: {
			multiple: false;
			required: false;
			types: [{ type: "wildcard_import"; named: true }];
		};
	};
	...
	readonly lambda: {
		...
		fields: {
			...
			parameters: {
				multiple: false;
				required: false;
				types: [{ type: "lambda_parameters"; named: true }];
			};
		};
	};
	...
	readonly member_type: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: "identifier"; named: true }, { type: "type"; named: true }];
		};
	};
	readonly module: {
		type: "module";
	...
	readonly print_statement: {
		...
		named: true;
		fields: {
			argument: { multiple: true; required: false; types: [{ type: "expression"; named: true }] };
		};
	...
	readonly raise_statement: {
		...
		named: true;
		fields: {
			cause: { multiple: false; required: false; types: [{ type: "expression"; named: true }] };
		};
		children: {
			multiple: false;
			required: false;
	...
	readonly relative_import: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: "dotted_name"; named: true }, { type: "import_prefix"; named: true }];
		};
	};
	...
	readonly try_statement: {
		...
		children: {
			...
			types: [
				...
				{ type: "except_clause"; named: true },
				{ type: "finally_clause"; named: true },
			];
		};
	};
	readonly tuple: {
	...
	readonly with_statement: {
		...
		named: true;
		fields: { body: { multiple: false; required: true; types: [{ type: "block"; named: true }] } };
		children: { multiple: false; required: true; types: [{ type: "with_clause"; named: true }] };
	};
	readonly yield: {
		type: "yield";
		named: true;
