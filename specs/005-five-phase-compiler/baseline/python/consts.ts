...
> = {
	...
	block: [{ name: "alternative", required: false, multiple: true }],
	boolean_operator: [
		{ name: "left", required: true, multiple: false },
		{ name: "operator", required: true, multiple: false },
		{ name: "right", required: true, multiple: false },
	...
	decorated_definition: [{ name: "definition", required: true, multiple: false }],
	decorator: [
		{ name: "expression", required: true, multiple: false },
	...
	dict_pattern: [],
	dictionary: [],
	dictionary_comprehension: [{ name: "body", required: true, multiple: false }],
	...
	exec_statement: [{ name: "code", required: true, multiple: false }],
	expression_list: [],
	expression_statement: [],
	...
	future_import_statement: [{ name: "name", required: true, multiple: true }],
	generator_expression: [{ name: "body", required: true, multiple: false }],
	generic_type: [
	...
	import_statement: [{ name: "name", required: true, multiple: true }],
	interpolation: [
		{ name: "expression", required: true, multiple: false },
		{ name: "formatSpecifier", required: false, multiple: false },
		{ name: "typeConversion", required: false, multiple: false },
	...
	lambda_parameters: [],
	list: [],
	list_comprehension: [{ name: "body", required: true, multiple: false }],
	list_pattern: [],
	...
	raise_statement: [{ name: "cause", required: false, multiple: false }],
	relative_import: [
	...
	typed_parameter: [{ name: "type", required: true, multiple: false }],
	unary_operator: [
