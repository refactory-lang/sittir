...
export function wrapAsPattern(data: AnyNodeData, tree: TreeHandle): unknown {
	...
	return {
		...data,
		get alias() {
			return (data.fields?.['alias'] as AnyNodeData | undefined)?.text;
		},
		get expression() {
...
export function wrapComparisonOperator(
	...
	return {
		...
		get comparators() {
			return drillInAll(data.fields?.['comparators'], tree);
		}
	};
}
...
export function wrapImportFromStatement(
	...
	return {
		...
		get wildcardImport() {
			return drillIn(data.fields?.['wildcard_import'], tree);
		}
	};
}
...
export function wrapPrintStatement(
	...
	return {
		...
		get chevron() {
			return drillIn(data.fields?.['chevron'], tree);
		}
	};
}
