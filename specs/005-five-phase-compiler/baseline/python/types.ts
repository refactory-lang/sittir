...
export interface ImportFromStatementName {
	readonly type: 'import_from_statement';
	readonly fields: {
		readonly module_name: DottedName | RelativeImport;
		readonly name?: readonly (AliasedImport | DottedName)[];
...
export type ImportFromStatement =
...
export type ImportFromStatementNameConfig = ConfigOf<ImportFromStatementName>;
export type ImportFromStatementConfig =
...
export type SplatPatternConfig =
...
export type AliasedImportFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ArgumentListFromInput =
	| DictionarySplat
	| Expression
	| KeywordArgument
	| ListSplat
...
export type AssignmentV0FromInput = FromInputOf<
	AssignmentV0,
	LeafScalarMap,
	LeafStringMap
>;
export type AssignmentV1FromInput = FromInputOf<
	AssignmentV1,
	LeafScalarMap,
	LeafStringMap
>;
export type AssignmentV2FromInput = FromInputOf<
	AssignmentV2,
	LeafScalarMap,
	LeafStringMap
>;
...
export type DefaultParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type DeleteStatementFromInput = Expression | ExpressionList;
export type DictPatternFromInput = SplatPattern;
export type DictionaryFromInput = DictionarySplat | Pair;
...
export type DictionarySplatFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type DictionarySplatPatternFromInput =
	| Attribute
	| Identifier
	| Subscript;
export type DottedNameFromInput = Identifier;
...
export type ExecStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ExpressionListFromInput = Expression;
export type ExpressionStatementFromInput =
	| Assignment
	| AugmentedAssignment
	| Expression
	| Yield;
...
export type IfStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ImportFromStatementV0FromInput = FromInputOf<
	ImportFromStatementV0,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportFromStatementNameFromInput = FromInputOf<
	ImportFromStatementName,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportFromStatementFromInput =
...
export type LambdaParametersFromInput = Parameter;
export type ListFromInput =
	| Expression
	| ListSplat
	| ParenthesizedListSplat
	| Yield;
export type ListComprehensionFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ListPatternFromInput = CasePattern | Pattern;
export type ListSplatFromInput = FromInputOf<
	ListSplat,
	LeafScalarMap,
	LeafStringMap
>;
export type ListSplatPatternFromInput = Attribute | Identifier | Subscript;
...
export type MemberTypeFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ModuleFromInput = CompoundStatement | SimpleStatement;
export type NamedExpressionFromInput = FromInputOf<
	NamedExpression,
	LeafScalarMap,
	LeafStringMap
>;
export type NonlocalStatementFromInput = Identifier;
...
export type ParametersFromInput = Parameter;
export type ParenthesizedExpressionFromInput =
	| Expression
	| ListSplat
	| ParenthesizedExpression
	| Yield;
export type ParenthesizedListSplatFromInput =
	| ListSplat
	| ParenthesizedExpression;
export type PatternListFromInput = Pattern;
export type PrintStatementChevronFromInput = FromInputOf<
	PrintStatementChevron,
	LeafScalarMap,
	LeafStringMap
>;
export type PrintStatementV1FromInput = FromInputOf<
	PrintStatementV1,
	LeafScalarMap,
	LeafStringMap
>;
export type PrintStatementFromInput =
...
export type SplatPatternIdentifierFromInput = FromInputOf<
	SplatPatternIdentifier,
	LeafScalarMap,
	LeafStringMap
>;
export type SplatPattern_FromInput = FromInputOf<
	SplatPattern_,
	LeafScalarMap,
	LeafStringMap
>;
export type SplatPatternFromInput =
	| SplatPatternIdentifierFromInput
	| SplatPattern_FromInput;
export type SplatTypeStarFromInput = FromInputOf<
	SplatTypeStar,
	LeafScalarMap,
	LeafStringMap
>;
export type SplatTypeTok_2a2aFromInput = FromInputOf<
	SplatTypeTok_2a2a,
	LeafScalarMap,
	LeafStringMap
>;
export type SplatTypeFromInput =
...
export type TryStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type TupleFromInput =
	| Expression
	| ListSplat
	| ParenthesizedListSplat
	| Yield;
export type TuplePatternFromInput = CasePattern | Pattern;
...
export type WhileStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type WithClauseFromInput = WithItem;
...
export type WithStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type YieldFromInput = Expression | ExpressionList | Expressions;
...
export type ComprehensionClauses = ForInClause;

export type Suite = Block;
...
export type ExpressionWithinForInClause = Expression | Lambda;
...
export interface VariantMap {
	...
	import_from_statement: {
		v0: ImportFromStatementV0;
		name: ImportFromStatementName;
	};
