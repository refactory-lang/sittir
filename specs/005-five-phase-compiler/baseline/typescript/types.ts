...
export type AsExpressionTypeAnnotationConfig =
	ConfigOf<AsExpressionTypeAnnotation>;
export type AsExpressionConfig =
...
export type CallExpressionTypeArgumentsConfig =
	ConfigOf<CallExpressionTypeArguments>;
...
export type ForInStatementConfig =
...
export type ImportAttributeConfig =
...
export type ImportStatementFromClauseConfig =
	ConfigOf<ImportStatementFromClause>;
...
export type MemberExpressionOptionalChainConfig =
	ConfigOf<MemberExpressionOptionalChain>;
export type MemberExpressionConfig =
...
export type ParenthesizedExpressionTypeConfig =
	ConfigOf<ParenthesizedExpressionType>;
export type ParenthesizedExpressionV1Config =
	ConfigOf<ParenthesizedExpressionV1>;
...
export type PublicFieldDefinitionStaticConfig =
	ConfigOf<PublicFieldDefinitionStatic>;
export type PublicFieldDefinitionAbstractConfig =
	ConfigOf<PublicFieldDefinitionAbstract>;
export type PublicFieldDefinitionAccessorConfig =
	ConfigOf<PublicFieldDefinitionAccessor>;
...
export type AmbientDeclarationV0FromInput = FromInputOf<
	AmbientDeclarationV0,
	LeafScalarMap,
	LeafStringMap
>;
export type AmbientDeclarationModuleFromInput = FromInputOf<
	AmbientDeclarationModule,
	LeafScalarMap,
	LeafStringMap
>;
export type AmbientDeclarationFromInput =
...
export type ArrayTypeFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ArrowFunctionFromInput = FromInputOf<
	ArrowFunction,
	LeafScalarMap,
	LeafStringMap
>;
export type AsExpressionConstFromInput = FromInputOf<
	AsExpressionConst,
	LeafScalarMap,
	LeafStringMap
>;
export type AsExpressionTypeAnnotationFromInput = FromInputOf<
	AsExpressionTypeAnnotation,
	LeafScalarMap,
	LeafStringMap
>;
export type AsExpressionFromInput =
...
export type BreakStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type CallExpressionTypeArgumentsFromInput = FromInputOf<
	CallExpressionTypeArguments,
	LeafScalarMap,
	LeafStringMap
>;
export type CallExpressionV1FromInput = FromInputOf<
	CallExpressionV1,
	LeafScalarMap,
	LeafStringMap
>;
...
export type ClassBodyDecoratorFromInput = FromInputOf<
	ClassBodyDecorator,
	LeafScalarMap,
	LeafStringMap
>;
export type ClassBodyV1FromInput = FromInputOf<
	ClassBodyV1,
	LeafScalarMap,
	LeafStringMap
>;
export type ClassBodyFromInput =
...
export type ContinueStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type DecoratorFromInput =
	| CallExpression
	| Identifier
	| MemberExpression
	| ParenthesizedExpression;
...
export type ExportSpecifierFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ExportStatementStarFromInput = FromInputOf<
	ExportStatementStar,
	LeafScalarMap,
	LeafStringMap
>;
export type ExportStatementV1FromInput = FromInputOf<
	ExportStatementV1,
	LeafScalarMap,
	LeafStringMap
>;
export type ExportStatementV2FromInput = FromInputOf<
	ExportStatementV2,
	LeafScalarMap,
	LeafStringMap
>;
export type ExportStatementV3FromInput = FromInputOf<
	ExportStatementV3,
	LeafScalarMap,
	LeafStringMap
>;
export type ExportStatementDefaultFromInput = FromInputOf<
	ExportStatementDefault,
	LeafScalarMap,
	LeafStringMap
>;
...
export type FlowMaybeTypeFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ForInStatementV0FromInput = FromInputOf<
	ForInStatementV0,
	LeafScalarMap,
	LeafStringMap
>;
export type ForInStatementEqFromInput = FromInputOf<
	ForInStatementEq,
	LeafScalarMap,
	LeafStringMap
>;
export type ForInStatementV2FromInput = FromInputOf<
	ForInStatementV2,
	LeafScalarMap,
	LeafStringMap
>;
export type ForInStatementFromInput =
...
export type ImportAliasFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ImportAttributeWithFromInput = FromInputOf<
	ImportAttributeWith,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportAttributeAssertFromInput = FromInputOf<
	ImportAttributeAssert,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportAttributeFromInput =
...
export type ImportRequireClauseFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ImportSpecifierV0FromInput = FromInputOf<
	ImportSpecifierV0,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportSpecifierAsFromInput = FromInputOf<
	ImportSpecifierAs,
	LeafScalarMap,
	LeafStringMap
>;
...
export type ImportStatementFromClauseFromInput = FromInputOf<
	ImportStatementFromClause,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportStatementV1FromInput = FromInputOf<
	ImportStatementV1,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportStatementV2FromInput = FromInputOf<
	ImportStatementV2,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportStatementFromInput =
	| ImportStatementFromClauseFromInput
	| ImportStatementV1FromInput
	| ImportStatementV2FromInput;
export type IndexSignatureColonFromInput = FromInputOf<
	IndexSignatureColon,
	LeafScalarMap,
	LeafStringMap
>;
export type IndexSignatureMappedTypeClauseFromInput = FromInputOf<
	IndexSignatureMappedTypeClause,
	LeafScalarMap,
	LeafStringMap
>;
...
export type InstantiationExpressionFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type InterfaceBodyFromInput =
	| CallSignature
	| ConstructSignature
	| ExportStatement
	| IndexSignature
...
export type LexicalDeclarationFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type LiteralTypeFromInput =
	| False
	| Null
	| Number
	| String
...
export type MappedTypeClauseFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type MemberExpressionDotFromInput = FromInputOf<
	MemberExpressionDot,
	LeafScalarMap,
	LeafStringMap
>;
export type MemberExpressionOptionalChainFromInput = FromInputOf<
	MemberExpressionOptionalChain,
	LeafScalarMap,
	LeafStringMap
>;
export type MemberExpressionFromInput =
...
export type ObjectAssignmentPatternFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ObjectPatternFromInput =
	| ObjectAssignmentPattern
	| PairPattern
	| RestPattern
	| ShorthandPropertyIdentifierPattern;
...
export type PairPatternFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ParenthesizedExpressionTypeFromInput = FromInputOf<
	ParenthesizedExpressionType,
	LeafScalarMap,
	LeafStringMap
>;
export type ParenthesizedExpressionV1FromInput = FromInputOf<
	ParenthesizedExpressionV1,
	LeafScalarMap,
	LeafStringMap
>;
...
export type PropertySignatureFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type PublicFieldDefinitionStaticFromInput = FromInputOf<
	PublicFieldDefinitionStatic,
	LeafScalarMap,
	LeafStringMap
>;
export type PublicFieldDefinitionAbstractFromInput = FromInputOf<
	PublicFieldDefinitionAbstract,
	LeafScalarMap,
	LeafStringMap
>;
export type PublicFieldDefinitionAccessorFromInput = FromInputOf<
	PublicFieldDefinitionAccessor,
	LeafScalarMap,
	LeafStringMap
>;
export type PublicFieldDefinitionFromInput =
...
export type TemplateStringFromInput =
	| EscapeSequence
	| StringFragment
	| TemplateSubstitution;
...
export type TryStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type TupleTypeFromInput =
	| OptionalParameter
	| OptionalType
	| RequiredParameter
	| RestType
...
export type TypePredicateAnnotationFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type TypeQueryFromInput =
	| CallExpression
	| Identifier
	| InstantiationExpression
	| MemberExpression
...
export type VariableDeclarationFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type VariableDeclaratorEqFromInput = FromInputOf<
	VariableDeclaratorEq,
	LeafScalarMap,
	LeafStringMap
>;
export type VariableDeclaratorBangFromInput = FromInputOf<
	VariableDeclaratorBang,
	LeafScalarMap,
	LeafStringMap
>;
export type VariableDeclaratorFromInput =
...
export type ParameterName = AccessibilityModifier | OverrideModifier;
...
export interface VariantMap {
	ambient_declaration: {
		v0: AmbientDeclarationV0;
		module: AmbientDeclarationModule;
	};
	as_expression: {
		const: AsExpressionConst;
		type_annotation: AsExpressionTypeAnnotation;
	};
	call_expression: {
		type_arguments: CallExpressionTypeArguments;
		v1: CallExpressionV1;
	};
	class_body: { decorator: ClassBodyDecorator; v1: ClassBodyV1 };
	constraint: { extends: ConstraintExtends; colon: ConstraintColon };
	export_statement: {
		star: ExportStatementStar;
		v1: ExportStatementV1;
		v2: ExportStatementV2;
		v3: ExportStatementV3;
	...
	import_attribute: {
		with: ImportAttributeWith;
		assert: ImportAttributeAssert;
	};
	import_specifier: { v0: ImportSpecifierV0; as: ImportSpecifierAs };
	import_statement: {
		from_clause: ImportStatementFromClause;
		v1: ImportStatementV1;
		v2: ImportStatementV2;
	};
	index_signature: {
	...
	member_expression: {
		...
		optional_chain: MemberExpressionOptionalChain;
	};
	parenthesized_expression: {
		type: ParenthesizedExpressionType;
		v1: ParenthesizedExpressionV1;
	};
	public_field_definition: {
		static: PublicFieldDefinitionStatic;
		abstract: PublicFieldDefinitionAbstract;
		accessor: PublicFieldDefinitionAccessor;
	};
	string: { tok_22: StringTok_22; tok_27: StringTok_27 };
	variable_declarator: {
		eq: VariableDeclaratorEq;
		bang: VariableDeclaratorBang;
	};
}
