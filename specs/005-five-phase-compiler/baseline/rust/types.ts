...
export type TokenRepetitionPattern =
...
export type ForeignModItemConfig =
...
export type MacroDefinitionConfig =
...
export type PointerTypeMutableSpecifierConfig =
	ConfigOf<PointerTypeMutableSpecifier>;
export type PointerTypeConfig =
...
export type ReferenceExpressionMutableSpecifierConfig =
	ConfigOf<ReferenceExpressionMutableSpecifier>;
export type ReferenceExpressionConfig =
...
export type TokenRepetitionConfig =
	| TokenRepetitionPlusConfig
	| TokenRepetitionStarConfig
	| TokenRepetitionQuestionConfig;
export type TokenRepetitionPatternPlusConfig =
	ConfigOf<TokenRepetitionPatternPlus>;
export type TokenRepetitionPatternStarConfig =
	ConfigOf<TokenRepetitionPatternStar>;
export type TokenRepetitionPatternQuestionConfig =
	ConfigOf<TokenRepetitionPatternQuestion>;
export type TokenRepetitionPatternConfig =
...
export type TokenTreePatternConfig =
...
export type ArrayExpressionSemiFromInput = FromInputOf<
	ArrayExpressionSemi,
	LeafScalarMap,
	LeafStringMap
>;
export type ArrayExpressionCommaFromInput = FromInputOf<
	ArrayExpressionComma,
	LeafScalarMap,
	LeafStringMap
>;
export type ArrayExpressionFromInput =
...
export type CapturedPatternFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ClosureExpressionFromInput = FromInputOf<
	ClosureExpression,
	LeafScalarMap,
	LeafStringMap
>;
...
export type FieldInitializerFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type FieldInitializerListFromInput =
	| BaseFieldInitializer
	| FieldInitializer
	| ShorthandFieldInitializer;
export type FieldPatternV0FromInput = FromInputOf<
	FieldPatternV0,
	LeafScalarMap,
	LeafStringMap
>;
export type FieldPatternColonFromInput = FromInputOf<
	FieldPatternColon,
	LeafScalarMap,
	LeafStringMap
>;
...
export type ForeignModItemSemiFromInput = FromInputOf<
	ForeignModItemSemi,
	LeafScalarMap,
	LeafStringMap
>;
export type ForeignModItemBodyFromInput = FromInputOf<
	ForeignModItemBody,
	LeafScalarMap,
	LeafStringMap
>;
export type ForeignModItemFromInput =
...
export type FunctionSignatureItemFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type FunctionTypeTraitFromInput = FromInputOf<
	FunctionTypeTrait,
	LeafScalarMap,
	LeafStringMap
>;
export type FunctionTypeFnFromInput = FromInputOf<
	FunctionTypeFn,
	LeafScalarMap,
	LeafStringMap
>;
export type FunctionTypeFromInput =
...
export type IfExpressionFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ImplItemBodyFromInput = FromInputOf<
	ImplItemBody,
	LeafScalarMap,
	LeafStringMap
>;
export type ImplItemSemiFromInput = FromInputOf<
	ImplItemSemi,
	LeafScalarMap,
	LeafStringMap
>;
...
export type LifetimeParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type LineCommentV0FromInput = FromInputOf<
	LineCommentV0,
	LeafScalarMap,
	LeafStringMap
>;
export type LineCommentOuterFromInput = FromInputOf<
	LineCommentOuter,
	LeafScalarMap,
	LeafStringMap
>;
export type LineCommentFromInput =
...
export type LoopExpressionFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type MacroDefinitionParenFromInput = FromInputOf<
	MacroDefinitionParen,
	LeafScalarMap,
	LeafStringMap
>;
export type MacroDefinitionBracketFromInput = FromInputOf<
	MacroDefinitionBracket,
	LeafScalarMap,
	LeafStringMap
>;
export type MacroDefinitionBraceFromInput = FromInputOf<
	MacroDefinitionBrace,
	LeafScalarMap,
	LeafStringMap
>;
export type MacroDefinitionFromInput =
...
export type MatchPatternFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ModItemSemiFromInput = FromInputOf<
	ModItemSemi,
	LeafScalarMap,
	LeafStringMap
>;
export type ModItemBodyFromInput = FromInputOf<
	ModItemBody,
	LeafScalarMap,
	LeafStringMap
>;
...
export type NegativeLiteralFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type OrPatternRightFromInput = FromInputOf<
	OrPatternRight,
	LeafScalarMap,
	LeafStringMap
>;
export type OrPatternV1FromInput = FromInputOf<
	OrPatternV1,
	LeafScalarMap,
	LeafStringMap
>;
...
export type ParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ParametersFromInput =
	| AttributeItem
	| Parameter
	| SelfParameter
	| Type
...
export type PointerTypeConstFromInput = FromInputOf<
	PointerTypeConst,
	LeafScalarMap,
	LeafStringMap
>;
export type PointerTypeMutableSpecifierFromInput = FromInputOf<
	PointerTypeMutableSpecifier,
	LeafScalarMap,
	LeafStringMap
>;
export type PointerTypeFromInput =
...
export type QualifiedTypeFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type RangeExpressionEndFromInput = FromInputOf<
	RangeExpressionEnd,
	LeafScalarMap,
	LeafStringMap
>;
export type RangeExpressionV1FromInput = FromInputOf<
	RangeExpressionV1,
	LeafScalarMap,
	LeafStringMap
>;
export type RangeExpressionV2FromInput = FromInputOf<
	RangeExpressionV2,
	LeafScalarMap,
	LeafStringMap
>;
export type RangeExpressionFromInput =
	| RangeExpressionEndFromInput
	| RangeExpressionV1FromInput
	| RangeExpressionV2FromInput;
export type RangePatternEllipsisFromInput = FromInputOf<
	RangePatternEllipsis,
	LeafScalarMap,
	LeafStringMap
>;
export type RangePatternDotdotFromInput = FromInputOf<
	RangePatternDotdot,
	LeafScalarMap,
	LeafStringMap
>;
export type RangePatternTok_2e2e3dFromInput = FromInputOf<
	RangePatternTok_2e2e3d,
	LeafScalarMap,
	LeafStringMap
>;
...
export type ReferenceExpressionConstFromInput = FromInputOf<
	ReferenceExpressionConst,
	LeafScalarMap,
	LeafStringMap
>;
export type ReferenceExpressionMutableSpecifierFromInput = FromInputOf<
	ReferenceExpressionMutableSpecifier,
	LeafScalarMap,
	LeafStringMap
>;
export type ReferenceExpressionFromInput =
...
export type StructExpressionFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type StructItemWhereClauseFromInput = FromInputOf<
	StructItemWhereClause,
	LeafScalarMap,
	LeafStringMap
>;
export type StructItemSemiFromInput = FromInputOf<
	StructItemSemi,
	LeafScalarMap,
	LeafStringMap
>;
export type StructItemFromInput =
...
export type TokenBindingPatternFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type TokenRepetitionFromInput =
	| Crate
	| Identifier
	| Literal
	| Metavariable
	...
	| TokenRepetition
	| TokenTree;
export type TokenRepetitionPatternFromInput =
	| Crate
	| Identifier
	| Literal
	| Metavariable
	...
	| TokenRepetitionPattern
	| TokenTreePattern;
export type TokenTreeFromInput =
	| Crate
	| Identifier
	| Literal
	| Metavariable
	...
	| TokenRepetition
	| TokenTree;
export type TokenTreePatternFromInput =
	| Crate
	| Identifier
	| Literal
	| Metavariable
...
export type TypeArgumentsFromInput =
	| Block
	| Lifetime
	| Literal
	| TraitBounds
...
export type TypeParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type TypeParametersFromInput =
	| AttributeItem
	| ConstParameter
	| LifetimeParameter
	| Metavariable
...
export type VariadicParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type VisibilityModifierV0FromInput = FromInputOf<
	VisibilityModifierV0,
	LeafScalarMap,
	LeafStringMap
>;
export type VisibilityModifierParenFromInput = FromInputOf<
	VisibilityModifierParen,
	LeafScalarMap,
	LeafStringMap
>;
export type VisibilityModifierFromInput =
...
export type LiteralConfig = RawStringLiteralConfig | StringLiteralConfig;
...
export type ReservedIdentifier = Identifier;
...
export interface VariantMap {
	...
	pointer_type: {
		const: PointerTypeConst;
		mutable_specifier: PointerTypeMutableSpecifier;
	};
	range_expression: {
		end: RangeExpressionEnd;
		v1: RangeExpressionV1;
		v2: RangeExpressionV2;
	};
	range_pattern: {
		ellipsis: RangePatternEllipsis;
		dotdot: RangePatternDotdot;
		tok_2e2e3d: RangePatternTok_2e2e3d;
	};
	reference_expression: {
		const: ReferenceExpressionConst;
		mutable_specifier: ReferenceExpressionMutableSpecifier;
	};
	struct_item: { where_clause: StructItemWhereClause; semi: StructItemSemi };
	token_repetition: {
		plus: TokenRepetitionPlus;
		star: TokenRepetitionStar;
		question: TokenRepetitionQuestion;
	};
	token_repetition_pattern: {
		plus: TokenRepetitionPatternPlus;
		star: TokenRepetitionPatternStar;
		question: TokenRepetitionPatternQuestion;
	};
	token_tree: {
		paren: TokenTreeParen;
		bracket: TokenTreeBracket;
		brace: TokenTreeBrace;
	};
	token_tree_pattern: {
		paren: TokenTreePatternParen;
		bracket: TokenTreePatternBracket;
		brace: TokenTreePatternBrace;
	};
	visibility_modifier: {
		v0: VisibilityModifierV0;
		paren: VisibilityModifierParen;
	};
}
