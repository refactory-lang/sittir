...
export type TypescriptGrammar = {
	...
	readonly abstract_class_declaration: {
		...
		fields: {
			body: {
				multiple: false;
				required: true;
				types: [{ type: 'class_body'; named: true }];
			};
			decorator: {
				multiple: true;
				required: false;
			...
			name: {
				multiple: false;
				required: true;
				types: [{ type: 'type_identifier'; named: true }];
			};
			type_parameters: {
				multiple: false;
				required: false;
	...
	readonly accessibility_modifier: {
	...
	readonly array_pattern: {
		...
		children: {
			...
			required: false;
			types: [
				{ type: 'assignment_pattern'; named: true },
	...
	readonly array_type: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'primary_type'; named: true }];
		};
	};
	...
	readonly catch_clause: {
		...
		fields: {
			...
			type: {
				multiple: false;
				required: false;
				types: [{ type: 'type_annotation'; named: true }];
			};
		};
	};
	readonly class: {
	...
	readonly class_heritage: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: 'extends_clause'; named: true },
				{ type: 'implements_clause'; named: true }
			];
		};
	};
	...
	readonly enum_declaration: {
		...
		fields: {
			body: {
				multiple: false;
				required: true;
				types: [{ type: 'enum_body'; named: true }];
			};
			name: {
				multiple: false;
				required: true;
	...
	readonly interface_declaration: {
		...
		fields: {
			body: {
				multiple: false;
				required: true;
				types: [{ type: 'interface_body'; named: true }];
			};
			name: {
				multiple: false;
				required: true;
	...
	readonly new_expression: {
		...
		fields: {
			arguments: {
				multiple: false;
				required: false;
				types: [{ type: 'arguments'; named: true }];
			};
			constructor: {
				multiple: false;
				required: true;
	...
	readonly program: {
		...
		children: {
			...
			required: false;
			types: [
				{ type: 'hash_bang_line'; named: true },
	...
	readonly regex: {
		...
		fields: {
			flags: {
				multiple: false;
				required: false;
				types: [{ type: 'regex_flags'; named: true }];
			};
			pattern: {
				multiple: false;
				required: true;
				types: [{ type: 'regex_pattern'; named: true }];
			};
		};
	};
	...
	readonly switch_body: {
		...
		children: {
			...
			required: false;
			types: [
				{ type: 'switch_case'; named: true },
				{ type: 'switch_default'; named: true }
			];
		};
	};
	...
	readonly switch_statement: {
		...
		fields: {
			body: {
				multiple: false;
				required: true;
				types: [{ type: 'switch_body'; named: true }];
			};
			value: {
				multiple: false;
				required: true;
	...
	readonly try_statement: {
		...
		fields: {
			...
			handler: {
				multiple: false;
				required: false;
				types: [{ type: 'catch_clause'; named: true }];
			};
		};
	};
	readonly tuple_type: {
	...
	readonly type_assertion: {
		...
		children: {
			...
			types: [
				{ type: 'expression'; named: true },
				{ type: 'type_arguments'; named: true }
			];
		};
	};
	readonly type_parameter: {
		...
		fields: {
			...
			value: {
				multiple: false;
				required: false;
				types: [{ type: 'default_type'; named: true }];
			};
		};
	};
	readonly type_parameters: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'type_parameter'; named: true }];
		};
	};
	...
	readonly type_predicate_annotation: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'type_predicate'; named: true }];
		};
	};
	readonly type_query: {
		type: 'type_query';
	...
	readonly private_property_identifier: {
	...
	readonly shorthand_property_identifier: {
