...
export type NodeData<K extends NodeKind<PythonGrammar>> = BaseNodeData<
	PythonGrammar,
	K
>;
export type NodeConfig<K extends NodeKind<PythonGrammar>> = BaseNodeConfig<
	PythonGrammar,
	K
>;
export type TreeNode<K extends NodeKind<PythonGrammar>> = BaseTreeNode<
	PythonGrammar,
	K
>;
...
export interface ImportFromStatement {
	...
	readonly fields: {
		...
		readonly wildcard_import: WildcardImport | HiddenImportList;
	};
}
...
export type HiddenComprehensionClausesConfig =
	ConfigOf<HiddenComprehensionClauses>;
...
export interface HiddenUFutureUTree extends AnyTreeNode {
	readonly type: '__future__';
}
...
export type HiddenSimpleStatementsFromInput = FromInputOf<
	HiddenSimpleStatements,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportStatementFromInput = FromInputOf<
	ImportStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type RelativeImportFromInput = FromInputOf<
	RelativeImport,
	LeafScalarMap,
	LeafStringMap
>;
export type FutureImportStatementFromInput = FromInputOf<
	FutureImportStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ImportFromStatementFromInput = FromInputOf<
	ImportFromStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenImportListFromInput = FromInputOf<
	HiddenImportList,
	LeafScalarMap,
	LeafStringMap
>;
export type AliasedImportFromInput = FromInputOf<
	AliasedImport,
	LeafScalarMap,
	LeafStringMap
>;
export type PrintStatementFromInput = FromInputOf<
	PrintStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ChevronFromInput = FromInputOf<
	Chevron,
	LeafScalarMap,
	LeafStringMap
>;
export type AssertStatementFromInput = FromInputOf<
	AssertStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ExpressionStatementFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type NamedExpressionFromInput = FromInputOf<
	NamedExpression,
	LeafScalarMap,
	LeafStringMap
>;
export type ReturnStatementFromInput = FromInputOf<
	ReturnStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type DeleteStatementFromInput = FromInputOf<
	DeleteStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type RaiseStatementFromInput = FromInputOf<
	RaiseStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type IfStatementFromInput = FromInputOf<
	IfStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ElifClauseFromInput = FromInputOf<
	ElifClause,
	LeafScalarMap,
	LeafStringMap
>;
export type ElseClauseFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type MatchStatementFromInput = FromInputOf<
	MatchStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenMatchBlockFromInput = FromInputOf<
	HiddenMatchBlock,
	LeafScalarMap,
	LeafStringMap
>;
export type CaseClauseFromInput = FromInputOf<
	CaseClause,
	LeafScalarMap,
	LeafStringMap
>;
export type ForStatementFromInput = FromInputOf<
	ForStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type WhileStatementFromInput = FromInputOf<
	WhileStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type TryStatementFromInput = FromInputOf<
	TryStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ExceptClauseFromInput = FromInputOf<
	ExceptClause,
	LeafScalarMap,
	LeafStringMap
>;
export type FinallyClauseFromInput = FromInputOf<
	FinallyClause,
	LeafScalarMap,
	LeafStringMap
>;
export type WithStatementFromInput = FromInputOf<
	WithStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type WithClauseFromInput = FromInputOf<
	WithClause,
	LeafScalarMap,
	LeafStringMap
>;
export type WithItemFromInput = FromInputOf<
	WithItem,
	LeafScalarMap,
	LeafStringMap
>;
export type FunctionDefinitionFromInput = FromInputOf<
	FunctionDefinition,
	LeafScalarMap,
	LeafStringMap
>;
export type ParametersFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type LambdaParametersFromInput = FromInputOf<
	LambdaParameters,
	LeafScalarMap,
	LeafStringMap
>;
export type ListSplatFromInput = FromInputOf<
	ListSplat,
	LeafScalarMap,
	LeafStringMap
>;
export type DictionarySplatFromInput = FromInputOf<
	DictionarySplat,
	LeafScalarMap,
	LeafStringMap
>;
export type GlobalStatementFromInput = FromInputOf<
	GlobalStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type NonlocalStatementFromInput = FromInputOf<
	NonlocalStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ExecStatementFromInput = FromInputOf<
	ExecStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type TypeAliasStatementFromInput = FromInputOf<
	TypeAliasStatement,
	LeafScalarMap,
	LeafStringMap
>;
export type ClassDefinitionFromInput = FromInputOf<
	ClassDefinition,
	LeafScalarMap,
	LeafStringMap
>;
export type TypeParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ParenthesizedListSplatFromInput = FromInputOf<
	ParenthesizedListSplat,
	LeafScalarMap,
	LeafStringMap
>;
export type ArgumentListFromInput = FromInputOf<
	ArgumentList,
	LeafScalarMap,
	LeafStringMap
>;
export type DecoratedDefinitionFromInput = FromInputOf<
	DecoratedDefinition,
	LeafScalarMap,
	LeafStringMap
>;
export type DecoratorFromInput = FromInputOf<
	Decorator,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenSuiteFromInput = FromInputOf<
	HiddenSuite,
	LeafScalarMap,
	LeafStringMap
>;
export type BlockFromInput = FromInputOf<Block, LeafScalarMap, LeafStringMap>;
export type ExpressionListFromInput = FromInputOf<
	ExpressionList,
	LeafScalarMap,
	LeafStringMap
>;
export type DottedNameFromInput = FromInputOf<
	DottedName,
	LeafScalarMap,
	LeafStringMap
>;
export type CasePatternFromInput = FromInputOf<
	CasePattern,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenSimplePatternFromInput = FromInputOf<
	HiddenSimplePattern,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenAsPatternFromInput = FromInputOf<
	HiddenAsPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type UnionPatternFromInput = FromInputOf<
	UnionPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenListPatternFromInput = FromInputOf<
	HiddenListPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenTuplePatternFromInput = FromInputOf<
	HiddenTuplePattern,
	LeafScalarMap,
	LeafStringMap
>;
export type DictPatternFromInput = FromInputOf<
	DictPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type KeywordPatternFromInput = FromInputOf<
	KeywordPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type SplatPatternFromInput = FromInputOf<
	SplatPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type ClassPatternFromInput = FromInputOf<
	ClassPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type ComplexPatternFromInput = FromInputOf<
	ComplexPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenParametersFromInput = FromInputOf<
	HiddenParameters,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenPatternsFromInput = FromInputOf<
	HiddenPatterns,
	LeafScalarMap,
	LeafStringMap
>;
export type ParameterFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type PatternFromInput = FromInputOf<
	Pattern,
	LeafScalarMap,
	LeafStringMap
>;
export type TuplePatternFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type ListPatternFromInput = FromInputOf<
	ListPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type DefaultParameterFromInput = FromInputOf<
	DefaultParameter,
	LeafScalarMap,
	LeafStringMap
>;
export type TypedDefaultParameterFromInput = FromInputOf<
	TypedDefaultParameter,
	LeafScalarMap,
	LeafStringMap
>;
export type ListSplatPatternFromInput = FromInputOf<
	ListSplatPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type DictionarySplatPatternFromInput = FromInputOf<
	DictionarySplatPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type AsPatternFromInput = FromInputOf<
	AsPattern,
	LeafScalarMap,
	LeafStringMap
>;
export type ExpressionFromInput = FromInputOf<
	Expression,
	LeafScalarMap,
	LeafStringMap
>;
export type PrimaryExpressionFromInput = FromInputOf<
	PrimaryExpression,
	LeafScalarMap,
	LeafStringMap
>;
export type NotOperatorFromInput = FromInputOf<
	NotOperator,
	LeafScalarMap,
	LeafStringMap
>;
export type BooleanOperatorFromInput = FromInputOf<
	BooleanOperator,
	LeafScalarMap,
	LeafStringMap
>;
export type BinaryOperatorFromInput = FromInputOf<
	BinaryOperator,
	LeafScalarMap,
	LeafStringMap
>;
export type UnaryOperatorFromInput = FromInputOf<
	UnaryOperator,
	LeafScalarMap,
	LeafStringMap
>;
export type ComparisonOperatorFromInput = FromInputOf<
	ComparisonOperator,
	LeafScalarMap,
	LeafStringMap
>;
export type LambdaFromInput = FromInputOf<Lambda, LeafScalarMap, LeafStringMap>;
export type LambdaWithinForInClauseFromInput = FromInputOf<
	LambdaWithinForInClause,
	LeafScalarMap,
	LeafStringMap
>;
export type AssignmentFromInput =
	| FromInputOf<AssignmentEq, LeafScalarMap, LeafStringMap>
	| FromInputOf<AssignmentColon, LeafScalarMap, LeafStringMap>
	| FromInputOf<AssignmentColon2, LeafScalarMap, LeafStringMap>;
export type AugmentedAssignmentFromInput = FromInputOf<
	AugmentedAssignment,
	LeafScalarMap,
	LeafStringMap
>;
export type PatternListFromInput = FromInputOf<
	PatternList,
	LeafScalarMap,
	LeafStringMap
>;
...
export type AttributeFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type SubscriptFromInput = FromInputOf<
	Subscript,
	LeafScalarMap,
	LeafStringMap
>;
...
export type TypedParameterFromInput = FromInputOf<
	TypedParameter,
	LeafScalarMap,
	LeafStringMap
>;
export type TypeFromInput = FromInputOf<Type, LeafScalarMap, LeafStringMap>;
export type SplatTypeFromInput = FromInputOf<
	SplatType,
	LeafScalarMap,
	LeafStringMap
>;
export type GenericTypeFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type UnionTypeFromInput = FromInputOf<
	UnionType,
	LeafScalarMap,
	LeafStringMap
>;
export type ConstrainedTypeFromInput = FromInputOf<
	ConstrainedType,
	LeafScalarMap,
	LeafStringMap
>;
export type MemberTypeFromInput = FromInputOf<
	MemberType,
	LeafScalarMap,
	LeafStringMap
>;
export type KeywordArgumentFromInput = FromInputOf<
	KeywordArgument,
	LeafScalarMap,
	LeafStringMap
>;
...
export type DictionaryFromInput = FromInputOf<
	Dictionary,
	LeafScalarMap,
	LeafStringMap
>;
export type PairFromInput = FromInputOf<Pair, LeafScalarMap, LeafStringMap>;
export type ListComprehensionFromInput = FromInputOf<
	ListComprehension,
	LeafScalarMap,
	LeafStringMap
>;
export type DictionaryComprehensionFromInput = FromInputOf<
	DictionaryComprehension,
	LeafScalarMap,
	LeafStringMap
>;
export type SetComprehensionFromInput = FromInputOf<
	SetComprehension,
	LeafScalarMap,
	LeafStringMap
>;
export type GeneratorExpressionFromInput = FromInputOf<
	GeneratorExpression,
	LeafScalarMap,
	LeafStringMap
>;
export type HiddenComprehensionClausesFromInput = FromInputOf<
...
export type ParenthesizedExpressionFromInput = FromInputOf<
	...
	LeafStringMap
>;
export type HiddenCollectionElementsFromInput = FromInputOf<
	HiddenCollectionElements,
	LeafScalarMap,
	LeafStringMap
>;
export type ForInClauseFromInput = FromInputOf<
	ForInClause,
	LeafScalarMap,
	LeafStringMap
>;
export type IfClauseFromInput = FromInputOf<
	IfClause,
	LeafScalarMap,
	LeafStringMap
>;
export type ConditionalExpressionFromInput = FromInputOf<
	ConditionalExpression,
	LeafScalarMap,
	LeafStringMap
>;
export type ConcatenatedStringFromInput = FromInputOf<
	ConcatenatedString,
	LeafScalarMap,
	LeafStringMap
>;
export type StringFromInput = FromInputOf<String, LeafScalarMap, LeafStringMap>;
export type StringContentFromInput = FromInputOf<
	StringContent,
	LeafScalarMap,
	LeafStringMap
>;
export type InterpolationFromInput = FromInputOf<
	Interpolation,
	LeafScalarMap,
	LeafStringMap
>;
export type FormatSpecifierFromInput = FromInputOf<
	FormatSpecifier,
	LeafScalarMap,
	LeafStringMap
>;
export type AwaitFromInput = FromInputOf<Await, LeafScalarMap, LeafStringMap>;
export type AsPatternTargetFromInput = FromInputOf<
	AsPatternTarget,
	LeafScalarMap,
	LeafStringMap
>;
export type FormatExpressionFromInput = FromInputOf<
	FormatExpression,
	LeafScalarMap,
	LeafStringMap
>;
...
// Supertype unions
export type HiddenStatement = HiddenSimpleStatements;
...
export type HiddenStatementTree =
	| HiddenSimpleStatementsTree
	| HiddenCompoundStatementTree;
...
export type HiddenSimpleStatementFromInput =
...
export type HiddenSimpleStatementTree =
...
export type HiddenNamedExpressionLhs = Identifier | KeywordIdentifier;

export type HiddenNamedExpressionLhsTree =
	| IdentifierTree
	| KeywordIdentifierTree;

export type HiddenExpressions = Expression | ExpressionList;

export type HiddenExpressionsConfig = ExpressionConfig | ExpressionListConfig;
export type HiddenExpressionsFromInput =
	| ExpressionFromInput
...
export type HiddenCompoundStatementConfig =
	| IfStatementConfig
	| ForStatementConfig
...
export type HiddenCompoundStatementFromInput =
...
export type HiddenCompoundStatementTree =
	| IfStatementTree
	| ForStatementTree
	| WhileStatementTree
	| TryStatementTree
...
export type HiddenExpressionWithinForInClauseConfig =
	| ExpressionConfig
	| LambdaWithinForInClauseConfig;
export type HiddenExpressionWithinForInClauseFromInput =
	| ExpressionFromInput
	| LambdaWithinForInClauseFromInput;
export type HiddenExpressionWithinForInClauseTree =
	| ExpressionTree
	| LambdaWithinForInClauseTree;

export type HiddenLeftHandSide = Pattern | PatternList;

export type HiddenLeftHandSideConfig = PatternConfig | PatternListConfig;
export type HiddenLeftHandSideFromInput =
	| PatternFromInput
...
export type HiddenRightHandSideConfig =
	| ExpressionConfig
	...
	| PatternListConfig
	| YieldConfig;
export type HiddenRightHandSideFromInput =
	| ExpressionFromInput
	| ExpressionListFromInput
	| AssignmentFromInput
	...
	| PatternListFromInput
	| YieldFromInput;
export type HiddenRightHandSideTree =
	| ExpressionTree
	| ExpressionListTree
	| AssignmentTree
...
export type HiddenFExpressionConfig =
	| ExpressionConfig
	| ExpressionListConfig
	| PatternListConfig
	| YieldConfig;
export type HiddenFExpressionFromInput =
	| ExpressionFromInput
	| ExpressionListFromInput
	| PatternListFromInput
	| YieldFromInput;
export type HiddenFExpressionTree =
	| ExpressionTree
	| ExpressionListTree
	| PatternListTree
	| YieldTree;
...
export interface HiddenNotEscapeSequence {
	readonly type: '_not_escape_sequence';
	readonly text: string;
}
export interface HiddenNotEscapeSequenceTree extends AnyTreeNode {
	readonly type: '_not_escape_sequence';
}
...
export interface Coloneq {
	readonly type: ':=';
	readonly text: string;
}
export interface ColoneqTree extends AnyTreeNode {
	readonly type: ':=';
}
...
export interface TildeTree extends AnyTreeNode {
	readonly type: '~';
}
export interface Lt {
	readonly type: '<';
...
export interface Ltgt {
	readonly type: '<>';
	readonly text: string;
}
export interface LtgtTree extends AnyTreeNode {
	readonly type: '<>';
}
...
export interface Ateq {
	readonly type: '@=';
	readonly text: string;
}
export interface AteqTree extends AnyTreeNode {
	readonly type: '@=';
}
export interface Slashslasheq {
	readonly type: '//=';
	readonly text: string;
}
export interface SlashslasheqTree extends AnyTreeNode {
	readonly type: '//=';
}
...
export interface Starstareq {
	readonly type: '**=';
	readonly text: string;
}
export interface StarstareqTree extends AnyTreeNode {
	readonly type: '**=';
}
...
export interface TokBs {
	readonly type: '\\';
	readonly text: string;
}
export interface TokBsTree extends AnyTreeNode {
	readonly type: '\\';
}
...
export interface VariantMap {
	assignment: {
		eq: AssignmentEq;
		colon: AssignmentColon;
		colon2: AssignmentColon2;
	};
}
