...
export type HiddenExpressionWithinForInClause = Expression | LambdaWithinForInClause;
...
export type HiddenFExpression = Expression | ExpressionList | PatternList | Yield;
