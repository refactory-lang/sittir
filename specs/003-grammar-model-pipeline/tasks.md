...
- [ ] T027 [P] [US3] Implement computeSignatures(models) in `packages/codegen/src/optimization.ts` — intern FactorySignature, FromSignature, HydrationSignature
- [ ] T028 [P] [US3] Implement identifyFieldLists, identifyChildLists, identifyEnumPatterns in `packages/codegen/src/optimization.ts`
