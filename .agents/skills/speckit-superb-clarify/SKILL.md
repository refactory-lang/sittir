...
description: Orchestrates the obra/superpowers brainstorming skill within the spec-kit
  specify workflow. Loads the authoritative SKILL.md at runtime, binds spec-kit context,
  and produces an intent summary for speckit.specify.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: superb:commands/clarify.md
---
