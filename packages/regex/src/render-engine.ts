...
/**
 * Render-only engine for @sittir/regex.
 *
 ...
 * back to a JS engine.
 */
export function createRenderEngine(options?: EngineOptions<Options>): SittirEngine<PatternRoot, Options> {
	const result = createNativeEngine<PatternRoot, Options>(
		{
