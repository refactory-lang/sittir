...
export default defineConfig({
	resolve: {
		alias: [
			...
			{ find: '@sittir/codegen/validate/from', replacement: pkg('codegen/src/validate/from.ts') },
			{ find: '@sittir/codegen/validate/factory-render-parse', replacement: pkg('codegen/src/validate/factory-render-parse.ts') },
			{ find: '@sittir/codegen/validate/read-render-parse', replacement: pkg('codegen/src/validate/read-render-parse.ts') },
