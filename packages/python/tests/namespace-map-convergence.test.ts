...
describe('python NamespaceMap access-path convergence', () => {
	it('FunctionDefinition three-path convergence', () => {
		expectTrue<
			Equals<FunctionDefinition.Config, ConfigFor<'function_definition'>>
		>();
		expectTrue<
			Equals<
				ConfigFor<'function_definition'>,
				NamespaceMap['function_definition']['Config']
			>
		>();
		expectTrue<
			Equals<
				FunctionDefinition.Config,
				NamespaceMap['function_definition']['Config']
			>
		>();
	});
	...
	it('Fluent / Loose / Tree / Kind each converge', () => {
		expectTrue<
			Equals<FunctionDefinition.Fluent, FluentFor<'function_definition'>>
		>();
		expectTrue<
			Equals<FunctionDefinition.Loose, LooseFor<'function_definition'>>
		>();
		expectTrue<
			Equals<FunctionDefinition.Tree, TreeFor<'function_definition'>>
		>();
