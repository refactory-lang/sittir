...
describe('if_statement', () => {
  it('factory produces correct type', () => {
    const node = ir.ifStatement({ condition: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, consequence: { $type: TSKindId.Newline, $text: '
...
describe('elif_clause', () => {
  it('factory produces correct type', () => {
    const node = ir.elifClause({ condition: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, consequence: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any });
...
describe('match_statement', () => {
  it('factory produces correct type', () => {
    const node = ir.matchStatement({ subject: [{ $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any], body: { $type: TSKindId.MatchBlock, $text: 'test', $source: 2, $named: true , _content: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any } as any });
...
describe('case_clause', () => {
  it('factory produces correct type', () => {
    const node = ir.caseClause({ casePattern: [{ $type: TSKindId.CasePattern, $text: 'test', $source: 2, $named: true , _content: { $type: TSKindId.True, $text: 'True', $source: 2, $named: true } as any } as any], consequence: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any });
...
describe('for_statement', () => {
  it('factory produces correct type', () => {
    const node = ir.forStatement({ left: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, right: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, body: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any });
...
describe('while_statement', () => {
  it('factory produces correct type', () => {
    const node = ir.whileStatement({ condition: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, body: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any });
...
describe('function_definition', () => {
  it('factory produces correct type', () => {
    const node = ir.functionDefinition({ name: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, parameters: { $type: TSKindId.Parameters, $text: 'test', $source: 2, $named: true } as any, body: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any });
...
describe('class_definition', () => {
  it('factory produces correct type', () => {
    const node = ir.classDefinition({ name: { $type: TSKindId.Identifier, $text: 'test', $source: 2, $named: true } as any, body: { $type: TSKindId.Newline, $text: '
', $source: 2, $named: true } as any });
...
describe('argument_list', () => {
  ...
  it('render produces non-empty string', () => {
    const node = ir.argumentList({ $type: TSKindId.ArgumentListGroup1, $text: 'test', $source: 2, $named: true } as any);
    expect(node.$render!().length).toBeGreaterThan(0);
  });
});
...
describe('dictionary', () => {
  ...
  it('render produces non-empty string', () => {
    const node = ir.dictionary({ $type: TSKindId.DictionaryGroup1, $text: 'test', $source: 2, $named: true } as any);
    expect(node.$render!().length).toBeGreaterThan(0);
  });
});
