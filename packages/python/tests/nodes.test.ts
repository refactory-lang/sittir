...
describe("aliased_import", () => {
	it("factory produces correct type", () => {
		const node = ir.aliasedImport({
			name: { $type: "dotted_name", $text: "test", $source: "factory", $named: true } as any,
			alias: { $type: "identifier", $text: "test", $source: "factory", $named: true } as any,
		});
...
describe("match_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.match({
			subject: [{ $type: "expression", $text: "test", $source: "factory", $named: true } as any],
			body: { $type: "_match_block", $text: "test", $source: "factory", $named: true } as any,
		});
...
describe("with_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.withStatement({
			withClause: { $type: "with_clause", $text: "test", $source: "factory", $named: true } as any,
			body: { $type: "_suite", $text: "test", $source: "factory", $named: true } as any,
		});
...
describe("function_definition", () => {
	it("factory produces correct type", () => {
		const node = ir.functionDefinition({
			...
			parameters: { $type: "parameters", $text: "test", $source: "factory", $named: true } as any,
			body: { $type: "_suite", $text: "test", $source: "factory", $named: true } as any,
		});
...
describe("assignment", () => {
	it("eq form produces correct type", () => {
		const node = ir.assignment.eq({
			left: { $type: "_left_hand_side", $text: "test", $source: "factory", $named: true } as any,
			right: { $type: "_right_hand_side", $text: "test", $source: "factory", $named: true } as any,
		});
...
describe("constrained_type", () => {
	it("factory produces correct type", () => {
		const node = ir.constrainedType({
			baseType: { $type: "type", $text: "test", $source: "factory", $named: true } as any,
			constraint: { $type: "type", $text: "test", $source: "factory", $named: true } as any,
		});
...
describe("pair", () => {
	it("factory produces correct type", () => {
		const node = ir.pair({
			key: { $type: "expression", $text: "test", $source: "factory", $named: true } as any,
			value: { $type: "expression", $text: "test", $source: "factory", $named: true } as any,
		});
