...
describe("relative_import", () => {
	it("factory produces correct type", () => {
		const node = ir.relativeImport({
			importPrefix: { $type: "import_prefix", $text: "test" } as any,
		});
...
describe("import_from_statement", () => {
	...
	it("render produces non-empty string", () => {
		const node = ir.importFrom({
			moduleName: { $type: "relative_import", $text: "test" } as any,
			children: [{ $type: "wildcard_import", $text: "test" } as any] as any,
		});
		expect(node.render().length).toBeGreaterThan(0);
	});
});
...
describe("aliased_import", () => {
	it("factory produces correct type", () => {
		const node = ir.aliasedImport({
			name: { $type: "dotted_name", $text: "test" } as any,
			alias: { $type: "identifier", $text: "test" } as any,
		});
...
describe("print_statement", () => {
	...
	it("render produces non-empty string", () => {
		const node = ir.print({
			...
			children: [{ $type: "chevron", $text: "test" } as any] as any,
		});
		expect(node.render().length).toBeGreaterThan(0);
	});
});
...
describe("named_expression", () => {
	it("factory produces correct type", () => {
		const node = ir.named({
			name: { $type: "_named_expression_lhs", $text: "test" } as any,
...
describe("if_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.ifStatement({
			...
			consequence: { $type: "_suite", $text: "test" } as any,
		});
...
describe("match_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.match({
			subject: [{ $type: "expression", $text: "test" } as any],
			body: { $type: "_match_block", $text: "test" } as any,
		});
...
describe("case_clause", () => {
	it("factory produces correct type", () => {
		const node = ir.caseClause({
			consequence: { $type: "_suite", $text: "test" } as any,
			children: [{ $type: "case_pattern", $text: "test" } as any] as any,
		});
...
describe("for_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.forStatement({
			left: { $type: "_left_hand_side", $text: "test" } as any,
			right: { $type: "_expressions", $text: "test" } as any,
			body: { $type: "_suite", $text: "test" } as any,
		});
...
describe("try_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.tryStatement({
			body: { $type: "_suite", $text: "test" } as any,
			exceptClauses: [{ $type: "except_clause", $text: "test" } as any],
		});
...
describe("with_statement", () => {
	it("factory produces correct type", () => {
		const node = ir.withStatement({
			withClause: { $type: "with_clause", $text: "test" } as any,
			body: { $type: "_suite", $text: "test" } as any,
		});
...
describe("function_definition", () => {
	it("factory produces correct type", () => {
		const node = ir.functionDefinition({
			...
			parameters: { $type: "parameters", $text: "test" } as any,
			body: { $type: "_suite", $text: "test" } as any,
		});
...
describe("decorated_definition", () => {
	it("factory produces correct type", () => {
		const node = ir.decorated({
			definition: { $type: "class_definition", $text: "test" } as any,
			children: [{ $type: "decorator", $text: "test" } as any] as any,
		});
...
describe("keyword_pattern", () => {
	it("factory produces correct type", () => {
		const node = ir.keywordPattern({
			...
			simplePattern: { $type: "_simple_pattern", $text: "test" } as any,
		});
...
describe("splat_pattern", () => {
	it("factory produces correct type", () => {
		const node = ir.splatPattern({
			...
			children: [{ $type: "identifier", $text: "test" } as any] as any,
		});
...
describe("class_pattern", () => {
	it("factory produces correct type", () => {
		const node = ir.classPattern({
			dottedName: { $type: "dotted_name", $text: "test" } as any,
			arguments: [{ $type: "case_pattern", $text: "test" } as any],
		});
...
describe("complex_pattern", () => {
	it("factory produces correct type", () => {
		const node = ir.complexPattern({
			imaginary: { $type: "integer", $text: "test" } as any,
			children: [{ $type: "integer", $text: "test" } as any] as any,
		});
...
describe("as_pattern", () => {
	it("factory produces correct type", () => {
		const node = ir.asPattern({
			...
			alias: { $type: "_as_pattern_target", $text: "test" } as any,
		});
...
describe("binary_operator", () => {
	it("factory produces correct type", () => {
		const node = ir.binaryOperator({
			left: { $type: "primary_expression", $text: "test" } as any,
			operator: "test" as any,
			right: { $type: "primary_expression", $text: "test" } as any,
		});
...
describe("unary_operator", () => {
	it("factory produces correct type", () => {
		const node = ir.unaryOperator({
			operator: "test" as any,
			argument: { $type: "primary_expression", $text: "test" } as any,
		});
...
describe("lambda_within_for_in_clause", () => {
	it("factory produces correct type", () => {
		const node = ir.lambdaWithinForInClause({
			body: { $type: "_expression_within_for_in_clause", $text: "test" } as any,
		});
...
describe("assignment", () => {
	it("eq form produces correct type", () => {
		const node = ir.assignment.eq({
			left: { $type: "_left_hand_side", $text: "test" } as any,
			right: { $type: "_right_hand_side", $text: "test" } as any,
		});
...
describe("attribute", () => {
	it("factory produces correct type", () => {
		const node = ir.attribute({
			object: { $type: "primary_expression", $text: "test" } as any,
			attribute: { $type: "identifier", $text: "test" } as any,
		});
...
describe("subscript", () => {
	it("factory produces correct type", () => {
		const node = ir.subscript({
			value: { $type: "primary_expression", $text: "test" } as any,
			subscript: [{ $type: "expression", $text: "test" } as any],
		});
...
describe("call", () => {
	it("factory produces correct type", () => {
		const node = ir.call({
			...
			arguments: { $type: "generator_expression", $text: "test" } as any,
		});
...
describe("generic_type", () => {
	it("factory produces correct type", () => {
		const node = ir.genericType({
			identifier: { $type: "identifier", $text: "test" } as any,
			typeParameter: { $type: "type_parameter", $text: "test" } as any,
		});
...
describe("constrained_type", () => {
	it("factory produces correct type", () => {
		const node = ir.constrainedType({
			baseType: { $type: "type", $text: "test" } as any,
			constraint: { $type: "type", $text: "test" } as any,
		});
...
describe("pair", () => {
	it("factory produces correct type", () => {
		const node = ir.pair({
			key: { $type: "expression", $text: "test" } as any,
			value: { $type: "expression", $text: "test" } as any,
		});
...
describe("list_comprehension", () => {
	it("factory produces correct type", () => {
		const node = ir.listComprehension({
			...
			children: [{ $type: "_comprehension_clauses", $text: "test" } as any] as any,
		});
...
describe("dictionary_comprehension", () => {
	it("factory produces correct type", () => {
		const node = ir.dictionaryComprehension({
			body: { $type: "pair", $text: "test" } as any,
			children: [{ $type: "_comprehension_clauses", $text: "test" } as any] as any,
		});
...
describe("for_in_clause", () => {
	it("factory produces correct type", () => {
		const node = ir.forInClause({
			left: { $type: "_left_hand_side", $text: "test" } as any,
			right: [{ $type: "_expression_within_for_in_clause", $text: "test" } as any],
		});
...
describe("await", () => {
	it("factory produces correct type", () => {
		const node = ir.await_({
			primaryExpression: { $type: "primary_expression", $text: "test" } as any,
		});
