...
describe('assignment', () => {
  ...
  it('type form produces correct type', () => {
    const node = ir.assignment.type({ left: { $type: '_left_hand_side', $text: 'test' } as any, type: { $type: 'type', $text: 'test' } as any });
    expect(node.$type).toBe('assignment');
    expect(node.$source).toBe('factory');
  });
  it('typed form produces correct type', () => {
    const node = ir.assignment.typed({ left: { $type: '_left_hand_side', $text: 'test' } as any, type: { $type: 'type', $text: 'test' } as any, right: { $type: '_right_hand_side', $text: 'test' } as any });
    expect(node.$type).toBe('assignment');
    expect(node.$source).toBe('factory');
  });
});
