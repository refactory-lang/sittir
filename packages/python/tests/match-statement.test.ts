...
describe('match_statement', () => {
  it('should build with correct kind', () => {
    const builder = ir.matchStatement(ir.asPattern(ir.asPattern(ir.asPattern(ir.asPattern(ir.identifier('test') as any)))), ir.asPattern(ir.asPattern(ir.asPattern(ir.asPattern(ir.identifier('test') as any)))));
