...
export const suggestedRules = {
  ...
  // [applied] promoted supertype
  _simple_pattern: $ => choice($.class_pattern, $.splat_pattern, $.union_pattern, $._list_pattern, $._tuple_pattern, $.dict_pattern, $.string, $.concatenated_string, $.true, $.false, $.none, $._simple_pattern_negative, $.complex_pattern, $.dotted_name),
