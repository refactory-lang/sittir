...
// Round-trip fails: 28  (26 parse errors, 2 AST mismatches; 7 render, 21 factory)
...
export const roundTripFailures: Array<{
  ...
  {
    entry: "Print used as a parameter",
  ...
  // --- dictionary (1) ---
  {
    entry: "Exec used as an identifier",
    kind: "dictionary",
    source: "factory",
    category: "parse-error",
    input:    "{\"__builtins__\" : None}",
    message: "No render rule for 'undefined'",
  },
  // --- tuple (1) ---
  {
    entry: "Calls with splats",
    kind: "tuple",
    source: "factory",
    category: "parse-error",
    input:    "()",
  ...
  // --- type_parameter (1) ---
  {
    entry: "Assignments with type annotations",
    kind: "type_parameter",
    source: "factory",
    category: "parse-error",
    input:    "[Leaf]",
  ...
  // --- format_specifier (1) ---
  {
    entry: "Format strings with format specifiers",
  ...
  // --- list_pattern (1) ---
  {
    entry: "Matching specific values",
    kind: "list_pattern",
    source: "factory",
    category: "parse-error",
    input:    "[\"quit\"]",
