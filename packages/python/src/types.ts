...
export const enum TSKindId {
	...
	Module = 111,
	Statement = 112,
	SimpleStatements = 113,
	ImportStatement = 114,
	ImportPrefix = 115,
	RelativeImport = 116,
	FutureImportStatement = 117,
	ImportFromStatement = 118,
	ImportList = 119,
	AliasedImport = 120,
	WildcardImport = 121,
	PrintStatement = 122,
	Chevron = 123,
	AssertStatement = 124,
	ExpressionStatement = 125,
	NamedExpression = 126,
	NamedExpressionLhs = 127,
	ReturnStatement = 128,
	DeleteStatement = 129,
	RaiseStatement = 130,
	PassStatement = 131,
	...
	Parameters = 149,
	LambdaParameters = 150,
	ListSplat = 151,
	DictionarySplat = 152,
	GlobalStatement = 153,
	NonlocalStatement = 154,
	ExecStatement = 155,
	TypeAliasStatement = 156,
	ClassDefinition = 157,
	TypeParameter = 158,
	ParenthesizedListSplat = 159,
	ArgumentList = 160,
	DecoratedDefinition = 161,
	Decorator = 162,
	Block = 163,
	ExpressionList = 164,
	DottedName = 165,
	...
	Interpolation = 232,
	FExpression = 233,
	NotEscapeSequence = 234,
	FormatSpecifier = 235,
	Await = 236,
	PositionalSeparator = 237,
	KeywordSeparator = 238,
	KwAsyncMarker = 239,
	SimpleStatementsElements = 240,
	Subjects = 241,
	CasePatterns = 242,
	WithClauseWithItems = 243,
	Types = 244,
	ArgumentListElements = 245,
	ExpressionListExpressions = 246,
	ListPatternCasePatterns = 247,
	DictPatternElements = 248,
	PatternListPatterns = 249,
	Subscripts = 250,
	DictionaryElements = 251,
	SliceGroup = 252,
	AugmentedAssignmentOperator = 253,
	ExceptClauseExceptionAs = 254,
	CaseTuplePattern = 255,
	CaseListPattern = 256,
	CaseAsPattern = 257,
	ComprehensionClauses = 258,
	ParenthesizedImportList = 259,
	PrintArguments = 260,
	PrintChevronArguments = 261,
	PrintStatementChevron = 262,
	PrintStatementPlain = 263,
	WildcardPattern = 264,
	SimplePatternNegative = 265,
	ExceptClauseExceptionList = 266,
	ExceptClauseException = 267,
	AssignmentEq = 268,
	AssignmentType = 269,
	AssignmentTyped = 270,
	ExpressionStatementTuple = 271,
	WithClauseBare = 272,
	WithClauseParen = 273,
	MatchBlockBlock = 274,
	SuiteBlock = 275,
	ComparisonOperatorComparator = 276,
	YieldFromClause = 277,
	ModuleRepeat1 = 278,
	ImportPrefixRepeat1 = 279,
	_ImportListRepeat1 = 280,
	AssertStatementRepeat1 = 281,
	IfStatementRepeat1 = 282,
	TryStatementRepeat1 = 283,
	GlobalStatementRepeat1 = 284,
	DecoratedDefinitionRepeat1 = 285,
	DottedNameRepeat1 = 286,
	UnionPatternRepeat1 = 287,
	_ParametersRepeat1 = 288,
	_PatternsRepeat1 = 289,
	ComparisonOperatorRepeat1 = 290,
	_CollectionElementsRepeat1 = 291,
	ForInClauseRepeat1 = 292,
	ConcatenatedStringRepeat1 = 293,
	StringRepeat1 = 294,
	StringContentRepeat1 = 295,
	FormatSpecifierRepeat1 = 296,
	_SimpleStatementsElementsRepeat1 = 297,
	_SubjectsRepeat1 = 298,
	_CasePatternsRepeat1 = 299,
	_WithClauseWithItemsRepeat1 = 300,
	_ExecStatementOptional1Repeat1 = 301,
	_TypesRepeat1 = 302,
	_ArgumentListElementsRepeat1 = 303,
	_ExpressionListExpressionsRepeat1 = 304,
	_DictPatternElementsRepeat1 = 305,
	_PatternListPatternsRepeat1 = 306,
	_SubscriptsRepeat1 = 307,
	_DictionaryElementsRepeat1 = 308,
	ComprehensionClausesRepeat1 = 309,
	_PrintArgumentsRepeat1 = 310,
	_ExceptClauseExceptionListRepeat1 = 311,
	_MatchBlockBlockRepeat1 = 312,
	_AsPatternTarget = 313,
	_FormatExpression = 314,
	_Names = 315,
	_SuiteEmpty = 316,
	_SuiteInline = 317
}
...
export const KIND_DISPLAY_NAMES: ReadonlyMap<number, string> = new Map([
	...
	[168, 'union_pattern'],
	[169, 'dict_pattern'],
	[170, 'key_value_pattern'],
	[171, 'keyword_pattern'],
	[172, 'splat_pattern'],
	[173, 'class_pattern'],
	[174, 'complex_pattern'],
	[175, 'parameters_elements'],
	[176, 'patterns'],
	[177, 'parameter'],
	[178, 'pattern'],
	[179, 'tuple_pattern'],
	...
	[232, 'interpolation'],
	[233, '_f_expression'],
	[234, 'not_escape_sequence'],
	[235, 'format_specifier'],
	[236, 'await'],
	[237, 'positional_separator'],
	[238, 'keyword_separator'],
	[239, '_kw_async_marker'],
	[240, 'simple_statements_elements'],
	[241, 'subjects'],
	[242, 'case_patterns'],
	[243, 'with_clause_with_items'],
	[244, 'types'],
	[245, 'argument_list_elements'],
	[246, 'expression_list_expressions'],
	[247, 'list_pattern_case_patterns'],
	[248, 'dict_pattern_elements'],
	[249, 'pattern_list_patterns'],
	[250, 'subscripts'],
	[251, 'dictionary_elements'],
	[252, 'slice_group'],
	[253, '_augmented_assignment_operator'],
	[254, 'except_clause_exception_as'],
	[255, 'case_tuple_pattern'],
	[256, 'case_list_pattern'],
	[257, 'case_as_pattern'],
	[258, 'comprehension_clauses'],
	[259, 'parenthesized_import_list'],
	[260, 'print_arguments'],
	[261, 'print_chevron_arguments'],
	[262, 'print_statement_chevron'],
	[263, 'print_statement_plain'],
	[264, 'wildcard_pattern'],
	[265, 'simple_pattern_negative'],
	[266, 'except_clause_exception_list'],
	[267, 'except_clause_exception'],
	[268, 'assignment_eq'],
	[269, 'assignment_type'],
	[270, 'assignment_typed'],
	[271, 'expression_statement_tuple'],
	[272, 'with_clause_bare'],
	[273, 'with_clause_paren'],
	[274, 'match_block_block'],
	[275, 'suite_block'],
	[276, 'comparison_operator_comparator'],
	[277, 'yield_from_clause'],
	[278, 'module_repeat1'],
	[279, 'import_prefix_repeat1'],
	[280, '_import_list_repeat1'],
	[281, 'assert_statement_repeat1'],
	...
	[311, '_except_clause_exception_list_repeat1'],
	[312, '_match_block_block_repeat1'],
	[313, 'as_pattern_target'],
	[314, 'format_expression'],
	[315, 'names'],
	[316, 'suite_empty'],
	[317, 'suite_inline']
]);
