...
export interface ListSplatPattern {
	...
	readonly $children: readonly [
		Identifier | KeywordIdentifier | Subscript | Attribute
	];
}
...
export interface ComparisonOperator {
	...
	readonly $fields: {
		readonly left: PrimaryExpression;
		readonly operators: NonEmptyArray<
			Bitflag<
				Operators,
				| '<'
				| '<='
...
export interface TypedParameter {
	...
	readonly $children: readonly [
		Identifier | ListSplatPattern | DictionarySplatPattern
	];
}
...
export interface Set {
	...
	readonly $children: NonEmptyArray<
		Expression | Yield | ListSplat | ParenthesizedListSplat
	>;
}
...
export interface StringContent {
	...
	readonly $children: NonEmptyArray<
		EscapeInterpolation | EscapeSequence | '\\' | _StringContent
	>;
}
...
export interface FormatExpressionTree extends AnyTreeNode {
	readonly type: '_format_expression';
}
...
export interface DecoratorNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface SuiteNs extends NodeNs<
	Suite,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface AssignmentTypedNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _WithClauseParenNs extends NodeNs<
	_WithClauseParen,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
