...
export const enum TSKindId {
	...
	CommaNewline = 109,
	SemicolonSpace = 110,
	SemicolonNewline = 111,
	Space = 112,
	Module = 113,
	Statement = 114,
	SimpleStatements = 115,
	ImportStatement = 116,
	ImportPrefix = 117,
	RelativeImport = 118,
	FutureImportStatement = 119,
	ImportFromStatement = 120,
	ImportList = 121,
	AliasedImport = 122,
	WildcardImport = 123,
	PrintStatement = 124,
	...
	WithClause = 148,
	WithItem = 149,
	FunctionDefinition = 150,
	Parameters = 151,
	LambdaParameters = 152,
	ListSplat = 153,
	DictionarySplat = 154,
	GlobalStatement = 155,
	NonlocalStatement = 156,
	ExecStatement = 157,
	TypeAliasStatement = 158,
	ClassDefinition = 159,
	TypeParameter = 160,
	ParenthesizedListSplat = 161,
	ArgumentList = 162,
	DecoratedDefinition = 163,
	Decorator = 164,
	Block = 165,
	ExpressionList = 166,
	DottedName = 167,
	...
	TuplePattern = 181,
	ListPattern = 182,
	DefaultParameter = 183,
	TypedDefaultParameter = 184,
	ListSplatPattern = 185,
	DictionarySplatPattern = 186,
	AsPattern = 187,
	ExpressionWithinForInClause = 188,
	Expression = 189,
	...
	_NotIn = 195,
	_IsNot = 196,
	ComparisonOperator = 197,
	Lambda = 198,
	LambdaWithinForInClause = 199,
	Assignment = 200,
	AugmentedAssignment = 201,
	PatternList = 202,
	RightHandSide = 203,
	Yield = 204,
	Attribute = 205,
	...
	Dictionary = 220,
	Pair = 221,
	ListComprehension = 222,
	DictionaryComprehension = 223,
	SetComprehension = 224,
	GeneratorExpression = 225,
	...
	KwAsyncMarker = 241,
	SimpleStatementsElements = 242,
	Subjects = 243,
	CasePatterns = 244,
	WithClauseWithItems = 245,
	Types = 246,
	ArgumentListElements = 247,
	ExpressionListExpressions = 248,
	ListPatternCasePatterns = 249,
	DictPatternElements = 250,
	PatternListPatterns = 251,
	Subscripts = 252,
	DictionaryElements = 253,
	SliceGroup = 254,
	AugmentedAssignmentOperator = 255,
	ExceptClauseAs = 256,
	CaseTuplePattern = 257,
	CaseListPattern = 258,
	CaseAsPattern = 259,
	ComprehensionClauses = 260,
	ParenthesizedImportList = 261,
	PrintArguments = 262,
	PrintChevronArguments = 263,
	PrintStatementChevron = 264,
	PrintStatementPlain = 265,
	WildcardPattern = 266,
	SimplePatternNegative = 267,
	ExceptClauseList = 268,
	ExceptClauseException = 269,
	AssignmentEq = 270,
	AssignmentType = 271,
	AssignmentTyped = 272,
	ExpressionStatementTuple = 273,
	WithClauseBare = 274,
	WithClauseParen = 275,
	MatchBlockBlock = 276,
	SuiteBlock = 277,
	ComparisonOperatorComparator = 278,
	YieldFromClause = 279,
	ModuleRepeat1 = 280,
	ImportPrefixRepeat1 = 281,
	_ImportListRepeat1 = 282,
	AssertStatementRepeat1 = 283,
	IfStatementRepeat1 = 284,
	TryStatementRepeat1 = 285,
	GlobalStatementRepeat1 = 286,
	DecoratedDefinitionRepeat1 = 287,
	DottedNameRepeat1 = 288,
	UnionPatternRepeat1 = 289,
	_ParametersRepeat1 = 290,
	_PatternsRepeat1 = 291,
	ComparisonOperatorRepeat1 = 292,
	_CollectionElementsRepeat1 = 293,
	ForInClauseRepeat1 = 294,
	ConcatenatedStringRepeat1 = 295,
	StringRepeat1 = 296,
	StringContentRepeat1 = 297,
	FormatSpecifierRepeat1 = 298,
	_SimpleStatementsElementsRepeat1 = 299,
	_SubjectsRepeat1 = 300,
	_CasePatternsRepeat1 = 301,
	_WithClauseWithItemsRepeat1 = 302,
	_ExecStatementOptional1Repeat1 = 303,
	_TypesRepeat1 = 304,
	_ArgumentListElementsRepeat1 = 305,
	_ExpressionListExpressionsRepeat1 = 306,
	_DictPatternElementsRepeat1 = 307,
	_PatternListPatternsRepeat1 = 308,
	_SubscriptsRepeat1 = 309,
	_DictionaryElementsRepeat1 = 310,
	ComprehensionClausesRepeat1 = 311,
	_PrintArgumentsRepeat1 = 312,
	_ExceptClauseListRepeat1 = 313,
	_MatchBlockBlockRepeat1 = 314,
	_AsPatternTarget = 315,
	_FormatExpression = 316,
	_Names = 317,
	_SuiteEmpty = 318,
	_SuiteInline = 319
}
...
export const KIND_DISPLAY_NAMES: ReadonlyMap<number, string> = new Map([
	...
	[170, 'union_pattern'],
	[171, 'dict_pattern'],
	[172, 'key_value_pattern'],
	[173, 'keyword_pattern'],
	[174, 'splat_pattern'],
	[175, 'class_pattern'],
	[176, 'complex_pattern'],
	[177, 'parameters_elements'],
	[178, 'patterns'],
	[179, 'parameter'],
	[180, 'pattern'],
	[181, 'tuple_pattern'],
	...
	[234, 'interpolation'],
	[235, '_f_expression'],
	[236, 'not_escape_sequence'],
	[237, 'format_specifier'],
	[238, 'await'],
	[239, 'positional_separator'],
	[240, 'keyword_separator'],
	[241, '_kw_async_marker'],
	[242, 'simple_statements_elements'],
	[243, 'subjects'],
	[244, 'case_patterns'],
	[245, 'with_clause_with_items'],
	[246, 'types'],
	[247, 'argument_list_elements'],
	[248, 'expression_list_expressions'],
	[249, 'list_pattern_case_patterns'],
	[250, 'dict_pattern_elements'],
	[251, 'pattern_list_patterns'],
	[252, 'subscripts'],
	[253, 'dictionary_elements'],
	[254, 'slice_group'],
	[255, '_augmented_assignment_operator'],
	[256, 'except_clause_as'],
	[257, 'case_tuple_pattern'],
	[258, 'case_list_pattern'],
	[259, 'case_as_pattern'],
	[260, 'comprehension_clauses'],
	[261, 'parenthesized_import_list'],
	[262, 'print_arguments'],
	[263, 'print_chevron_arguments'],
	[264, 'print_statement_chevron'],
	[265, 'print_statement_plain'],
	[266, 'wildcard_pattern'],
	[267, 'simple_pattern_negative'],
	[268, 'except_clause_list'],
	[269, 'except_clause_exception'],
	[270, 'assignment_eq'],
	[271, 'assignment_type'],
	[272, 'assignment_typed'],
	[273, 'expression_statement_tuple'],
	[274, 'with_clause_bare'],
	[275, 'with_clause_paren'],
	[276, 'match_block_block'],
	[277, 'suite_block'],
	[278, 'comparison_operator_comparator'],
	[279, 'yield_from_clause'],
	[280, 'module_repeat1'],
	[281, 'import_prefix_repeat1'],
	[282, '_import_list_repeat1'],
	[283, 'assert_statement_repeat1'],
	...
	[313, '_except_clause_list_repeat1'],
	[314, '_match_block_block_repeat1'],
	[315, 'as_pattern_target'],
	[316, 'format_expression'],
	[317, 'names'],
	[318, 'suite_empty'],
	[319, 'suite_inline']
]);
