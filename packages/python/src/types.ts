...
export function kindIdFromName(kindName: string): TSKindId {
  switch (kindName) {
    ...
    case "_argument_list_optional1_repeat1":
      return TSKindId._ArgumentListOptional1Repeat1;
    case "_dict_pattern_optional1_repeat1":
      return TSKindId._DictPatternOptional1Repeat1;
    case "_dictionary_optional1_repeat1":
      return TSKindId._DictionaryOptional1Repeat1;
...
export type UnaryOperatorOperator = Terminal<
  TSKindId.Plus | TSKindId.Dash | TSKindId.Tilde,
  "+" | "-" | "~"
>;
...
export interface KeyValuePatternNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface _ListPatternNs extends NodeNs<
  _ListPattern,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface SimpleStatementsNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface _SliceGroup1Ns extends NodeNs<
  _SliceGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface _TuplePatternNs extends NodeNs<
  _TuplePattern,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface KeywordArgumentNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface KeywordIdentifierNs extends NodeNs<
  KeywordIdentifier,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface SliceGroup1Ns extends NodeNs<
  SliceGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
