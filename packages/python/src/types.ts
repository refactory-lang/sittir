...
import type { NodeData as BaseNodeData, NodeConfig as BaseNodeConfig, TreeNode as BaseTreeNode, NodeKind, NodeNs, AnyTreeNodeOf as AnyTreeNode, Terminal, NonEmptyArray, AutoStamp, BooleanKeyword, Bitflag, KindEnum } from '@sittir/types';
...
export interface ComparisonOperator {
  ...
  readonly _primary_expression?: readonly (PrimaryExpression)[];
  readonly __inputHints__?: {
    readonly operators?: Bitflag<Operators, number>;
  };
  left(): PrimaryExpression;
  operators(): number | undefined;
  primaryExpressions(): readonly (PrimaryExpression)[];
}
