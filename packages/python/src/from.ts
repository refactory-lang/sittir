...
export function printStatementFrom(input?: PrintStatementFromInput) {
  return printStatement(input as any);
}
export function printStatementPrintFrom(input?: any) {
  if (isNodeData(input)) return input;
  return printStatementPrint({
    chevron: ((input as any)?.chevron ?? (input as any)?.fields?.chevron),
    argument: (((input as any)?.argument ?? (input as any)?.fields?.argument) ?? []),
  });
}
export function printStatementPrint2From(input?: any) {
  if (isNodeData(input)) return input;
  return printStatementPrint2({
    chevron: ((input as any)?.chevron ?? (input as any)?.fields?.chevron),
  });
}
