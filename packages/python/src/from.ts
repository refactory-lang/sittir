...
function _wrapWithChildren(kind: string, children: readonly unknown[]): unknown {
  switch (kind) {
    case "_collection_elements": return F.collectionElements(children as Parameters<typeof F.collectionElements>[0]);
    ...
    case "_parameters": return F._parameters(children as Parameters<typeof F._parameters>[0]);
