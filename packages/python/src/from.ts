...
export function importFromStatementNameFrom(input: RuntimeNodeOf<ImportFromStatementName> | ImportFromStatementNameFromInput) {
  if (isNodeData<'import_from_statement'>(input)) {
  ...
  const obj = input as ImportFromStatementNameFromInput;
  return import_from_statement__name_({
    moduleName: _r2jsk94(obj.module_name),
