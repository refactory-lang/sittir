...
export function augmentedAssignmentFrom(input: RuntimeNodeOf<AugmentedAssignment> | AugmentedAssignmentFromInput) {
  ...
  const mapped: Record<string, unknown> = Object.fromEntries(Object.entries(input).map(([k, v]) => [k.replace(/_([a-z])/g, (_, c: string) => c.toUpperCase()), v]));
  return augmented_assignment_(mapped as AugmentedAssignmentConfig);
}

export function augmentedAssignmentTok_2b3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_2b3d> | AugmentedAssignmentTok_2b3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_2b3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_2b3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_2b3dFromInput;
  return augmented_assignment__tok_2b3d_({
    left: _resolveLeftHandSide2(obj.left),
...
export function augmentedAssignmentTok_2d3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_2d3d> | AugmentedAssignmentTok_2d3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_2d3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_2d3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_2d3dFromInput;
  return augmented_assignment__tok_2d3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_2a3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_2a3d> | AugmentedAssignmentTok_2a3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_2a3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_2a3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_2a3dFromInput;
  return augmented_assignment__tok_2a3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_2f3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_2f3d> | AugmentedAssignmentTok_2f3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_2f3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_2f3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_2f3dFromInput;
  return augmented_assignment__tok_2f3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_403dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_403d> | AugmentedAssignmentTok_403dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_403d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_403dConfig);
  }
  const obj = input as AugmentedAssignmentTok_403dFromInput;
  return augmented_assignment__tok_403d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_2f2f3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_2f2f3d> | AugmentedAssignmentTok_2f2f3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_2f2f3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_2f2f3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_2f2f3dFromInput;
  return augmented_assignment__tok_2f2f3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_253dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_253d> | AugmentedAssignmentTok_253dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_253d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_253dConfig);
  }
  const obj = input as AugmentedAssignmentTok_253dFromInput;
  return augmented_assignment__tok_253d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_2a2a3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_2a2a3d> | AugmentedAssignmentTok_2a2a3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_2a2a3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_2a2a3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_2a2a3dFromInput;
  return augmented_assignment__tok_2a2a3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_3e3e3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_3e3e3d> | AugmentedAssignmentTok_3e3e3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_3e3e3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_3e3e3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_3e3e3dFromInput;
  return augmented_assignment__tok_3e3e3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_3c3c3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_3c3c3d> | AugmentedAssignmentTok_3c3c3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_3c3c3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_3c3c3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_3c3c3dFromInput;
  return augmented_assignment__tok_3c3c3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_263dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_263d> | AugmentedAssignmentTok_263dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_263d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_263dConfig);
  }
  const obj = input as AugmentedAssignmentTok_263dFromInput;
  return augmented_assignment__tok_263d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_5e3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_5e3d> | AugmentedAssignmentTok_5e3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_5e3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_5e3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_5e3dFromInput;
  return augmented_assignment__tok_5e3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function augmentedAssignmentTok_7c3dFrom(input: RuntimeNodeOf<AugmentedAssignmentTok_7c3d> | AugmentedAssignmentTok_7c3dFromInput) {
  if (isNodeData<'augmented_assignment'>(input)) {
    return augmented_assignment__tok_7c3d_({
      left: input.fields?.left,
      operator: input.fields?.operator,
      right: input.fields?.right,
    } as AugmentedAssignmentTok_7c3dConfig);
  }
  const obj = input as AugmentedAssignmentTok_7c3dFromInput;
  return augmented_assignment__tok_7c3d_({
    left: _resolveLeftHandSide2(obj.left),
    operator: _resolveComprehensionClauses5(obj.operator),
    right: _resolveRightHandSide2(obj.right),
...
export function comparisonOperatorFrom(input: RuntimeNodeOf<ComparisonOperator> | ComparisonOperatorFromInput) {
  ...
  const mapped: Record<string, unknown> = Object.fromEntries(Object.entries(input).map(([k, v]) => [k.replace(/_([a-z])/g, (_, c: string) => c.toUpperCase()), v]));
  return comparison_operator_(mapped as ComparisonOperatorConfig);
}

export function comparisonOperatorAngleFrom(input: RuntimeNodeOf<ComparisonOperatorAngle> | ComparisonOperatorAngleFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__angle_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorAngleConfig);
  }
  const obj = input as ComparisonOperatorAngleFromInput;
  return comparison_operator__angle_({
...
export function comparisonOperatorTok_3c3dFrom(input: RuntimeNodeOf<ComparisonOperatorTok_3c3d> | ComparisonOperatorTok_3c3dFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__tok_3c3d_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorTok_3c3dConfig);
  }
  const obj = input as ComparisonOperatorTok_3c3dFromInput;
  return comparison_operator__tok_3c3d_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorTok_3d3dFrom(input: RuntimeNodeOf<ComparisonOperatorTok_3d3d> | ComparisonOperatorTok_3d3dFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__tok_3d3d_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorTok_3d3dConfig);
  }
  const obj = input as ComparisonOperatorTok_3d3dFromInput;
  return comparison_operator__tok_3d3d_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorTok_213dFrom(input: RuntimeNodeOf<ComparisonOperatorTok_213d> | ComparisonOperatorTok_213dFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__tok_213d_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorTok_213dConfig);
  }
  const obj = input as ComparisonOperatorTok_213dFromInput;
  return comparison_operator__tok_213d_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorTok_3e3dFrom(input: RuntimeNodeOf<ComparisonOperatorTok_3e3d> | ComparisonOperatorTok_3e3dFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__tok_3e3d_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorTok_3e3dConfig);
  }
  const obj = input as ComparisonOperatorTok_3e3dFromInput;
  return comparison_operator__tok_3e3d_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorCloseAngleFrom(input: RuntimeNodeOf<ComparisonOperatorCloseAngle> | ComparisonOperatorCloseAngleFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__close_angle_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorCloseAngleConfig);
  }
  const obj = input as ComparisonOperatorCloseAngleFromInput;
  return comparison_operator__close_angle_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorTok_3c3eFrom(input: RuntimeNodeOf<ComparisonOperatorTok_3c3e> | ComparisonOperatorTok_3c3eFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__tok_3c3e_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorTok_3c3eConfig);
  }
  const obj = input as ComparisonOperatorTok_3c3eFromInput;
  return comparison_operator__tok_3c3e_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorInFrom(input: RuntimeNodeOf<ComparisonOperatorIn> | ComparisonOperatorInFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__in_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorInConfig);
  }
  const obj = input as ComparisonOperatorInFromInput;
  return comparison_operator__in_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorV8From(input: RuntimeNodeOf<ComparisonOperatorV8> | ComparisonOperatorV8FromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__v8_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorV8Config);
  }
  const obj = input as ComparisonOperatorV8FromInput;
  return comparison_operator__v8_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function comparisonOperatorIsFrom(input: RuntimeNodeOf<ComparisonOperatorIs> | ComparisonOperatorIsFromInput) {
  if (isNodeData<'comparison_operator'>(input)) {
    return comparison_operator__is_({
      operators: input.fields?.operators,
      left: input.fields?.left,
      comparators: input.fields?.comparators,
    } as ComparisonOperatorIsConfig);
  }
  const obj = input as ComparisonOperatorIsFromInput;
  return comparison_operator__is_({
    operators: obj.operators !== undefined ? ((Array.isArray(obj.operators) ? obj.operators : [obj.operators])).map(_resolveComprehensionClauses9) : [],
    left: _resolveComprehensionClauses4(obj.left),
    comparators: obj.comparators !== undefined ? ((Array.isArray(obj.comparators) ? obj.comparators : [obj.comparators])).map(_resolveComprehensionClauses4) : [],
...
export function complexPatternFrom(input: RuntimeNodeOf<ComplexPattern> | ComplexPatternFromInput) {
  ...
  const mapped: Record<string, unknown> = Object.fromEntries(Object.entries(input).map(([k, v]) => [k.replace(/_([a-z])/g, (_, c: string) => c.toUpperCase()), v]));
  return complex_pattern_(mapped as ComplexPatternConfig);
}

export function complexPatternPlusFrom(input: RuntimeNodeOf<ComplexPatternPlus> | ComplexPatternPlusFromInput) {
  if (isNodeData<'complex_pattern'>(input)) {
    return complex_pattern__plus_({
      real: input.fields?.real,
      imaginary: input.fields?.imaginary,
    } as ComplexPatternPlusConfig);
  }
  const obj = input as ComplexPatternPlusFromInput;
  return complex_pattern__plus_({
...
export function complexPatternV1From(input: RuntimeNodeOf<ComplexPatternV1> | ComplexPatternV1FromInput) {
  if (isNodeData<'complex_pattern'>(input)) {
    return complex_pattern__v1_({
      real: input.fields?.real,
      imaginary: input.fields?.imaginary,
    } as ComplexPatternV1Config);
  }
  const obj = input as ComplexPatternV1FromInput;
  return complex_pattern__v1_({
    real: _resolveSimplePattern3(obj.real),
    imaginary: _resolveSimplePattern3(obj.imaginary),
  } as ComplexPatternV1Config);
...
export function splatPatternFrom(input: RuntimeNodeOf<SplatPattern> | SplatPatternFromInput) {
  ...
  const mapped: Record<string, unknown> = Object.fromEntries(Object.entries(input).map(([k, v]) => [k.replace(/_([a-z])/g, (_, c: string) => c.toUpperCase()), v]));
  return splat_pattern_(mapped as SplatPatternConfig);
}

export function splatPatternV0From(input: RuntimeNodeOf<SplatPatternV0> | SplatPatternV0FromInput) {
  if (isNodeData<'splat_pattern'>(input)) {
    return splat_pattern__v0_({
      identifier: input.fields?.identifier,
    } as SplatPatternV0Config);
  }
  const obj = input as SplatPatternV0FromInput;
  return splat_pattern__v0_({
    identifier: _resolveNamedExpressionLhs(obj.identifier),
  } as SplatPatternV0Config);
}

export function splatPatternV1From(input: RuntimeNodeOf<SplatPatternV1> | SplatPatternV1FromInput) {
  if (isNodeData<'splat_pattern'>(input)) {
    return splat_pattern__v1_({
    } as SplatPatternV1Config);
  }
  const obj = input as SplatPatternV1FromInput;
  return splat_pattern__v1_({
  } as SplatPatternV1Config);
}

export function splatPatternV2From(input: RuntimeNodeOf<SplatPatternV2> | SplatPatternV2FromInput) {
  if (isNodeData<'splat_pattern'>(input)) {
    return splat_pattern__v2_({
      identifier: input.fields?.identifier,
    } as SplatPatternV2Config);
  }
  const obj = input as SplatPatternV2FromInput;
  return splat_pattern__v2_({
    identifier: _resolveNamedExpressionLhs(obj.identifier),
  } as SplatPatternV2Config);
}

export function splatPatternV3From(input: RuntimeNodeOf<SplatPatternV3> | SplatPatternV3FromInput) {
  if (isNodeData<'splat_pattern'>(input)) {
    return splat_pattern__v3_({
    } as SplatPatternV3Config);
  }
  const obj = input as SplatPatternV3FromInput;
  return splat_pattern__v3_({
  } as SplatPatternV3Config);
}
...
export function splatTypeFrom(input: RuntimeNodeOf<SplatType> | SplatTypeFromInput) {
  ...
  const mapped: Record<string, unknown> = Object.fromEntries(Object.entries(input).map(([k, v]) => [k.replace(/_([a-z])/g, (_, c: string) => c.toUpperCase()), v]));
  return splat_type_(mapped as SplatTypeConfig);
}

export function splatTypeStarFrom(input: RuntimeNodeOf<SplatTypeStar> | SplatTypeStarFromInput) {
  if (isNodeData<'splat_type'>(input)) {
    return splat_type__star_({
      identifier: input.fields?.identifier,
    } as SplatTypeStarConfig);
  }
  const obj = input as SplatTypeStarFromInput;
  return splat_type__star_({
    identifier: _resolveNamedExpressionLhs(obj.identifier),
  } as SplatTypeStarConfig);
}

export function splatTypeTok_2a2aFrom(input: RuntimeNodeOf<SplatTypeTok_2a2a> | SplatTypeTok_2a2aFromInput) {
  if (isNodeData<'splat_type'>(input)) {
    return splat_type__tok_2a2a_({
      identifier: input.fields?.identifier,
    } as SplatTypeTok_2a2aConfig);
  }
  const obj = input as SplatTypeTok_2a2aFromInput;
  return splat_type__tok_2a2a_({
    identifier: _resolveNamedExpressionLhs(obj.identifier),
  } as SplatTypeTok_2a2aConfig);
}
...
export function unaryOperatorFrom(input: RuntimeNodeOf<UnaryOperator> | UnaryOperatorFromInput) {
  ...
  const mapped: Record<string, unknown> = Object.fromEntries(Object.entries(input).map(([k, v]) => [k.replace(/_([a-z])/g, (_, c: string) => c.toUpperCase()), v]));
  return unary_operator_(mapped as UnaryOperatorConfig);
}

export function unaryOperatorPlusFrom(input: RuntimeNodeOf<UnaryOperatorPlus> | UnaryOperatorPlusFromInput) {
  if (isNodeData<'unary_operator'>(input)) {
    return unary_operator__plus_({
      argument: input.fields?.argument,
      operator: input.fields?.operator,
    } as UnaryOperatorPlusConfig);
  }
  const obj = input as UnaryOperatorPlusFromInput;
  return unary_operator__plus_({
...
export function unaryOperatorMinusFrom(input: RuntimeNodeOf<UnaryOperatorMinus> | UnaryOperatorMinusFromInput) {
  if (isNodeData<'unary_operator'>(input)) {
    return unary_operator__minus_({
      argument: input.fields?.argument,
      operator: input.fields?.operator,
    } as UnaryOperatorMinusConfig);
  }
  const obj = input as UnaryOperatorMinusFromInput;
  return unary_operator__minus_({
    argument: _resolveComprehensionClauses4(obj.argument),
    operator: _resolveComprehensionClauses13(obj.operator),
  } as UnaryOperatorMinusConfig);
...
export function unaryOperatorTildeFrom(input: RuntimeNodeOf<UnaryOperatorTilde> | UnaryOperatorTildeFromInput) {
  if (isNodeData<'unary_operator'>(input)) {
    return unary_operator__tilde_({
      argument: input.fields?.argument,
      operator: input.fields?.operator,
    } as UnaryOperatorTildeConfig);
  }
  const obj = input as UnaryOperatorTildeFromInput;
  return unary_operator__tilde_({
    argument: _resolveComprehensionClauses4(obj.argument),
    operator: _resolveComprehensionClauses13(obj.operator),
  } as UnaryOperatorTildeConfig);
