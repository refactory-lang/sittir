...
export interface IsGuards {
	...
	SimpleStatements<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_simple_statements' };
	importStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'import_statement' };
	relativeImport<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'relative_import' };
	futureImportStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'future_import_statement' };
	importFromStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'import_from_statement' };
	aliasedImport<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'aliased_import' };
	printStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'print_statement' };
	chevron<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'chevron' };
	assertStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'assert_statement' };
	expressionStatementTuple<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'expression_statement_tuple' };
	expressionStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'expression_statement' };
	namedExpression<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'named_expression' };
	returnStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'return_statement' };
	deleteStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'delete_statement' };
	raiseStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'raise_statement' };
	ifStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'if_statement' };
	elifClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'elif_clause' };
	elseClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'else_clause' };
	matchStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'match_statement' };
	MatchBlock<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_match_block' };
	caseClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'case_clause' };
	...
	exceptClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'except_clause' };
	...
	withClauseBare<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'with_clause_bare' };
	withClauseParen<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'with_clause_paren' };
	withClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'with_clause' };
	withItem<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'with_item' };
	functionDefinition<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'function_definition' };
	parameters<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'parameters' };
	lambdaParameters<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'lambda_parameters' };
	listSplat<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'list_splat' };
	dictionarySplat<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'dictionary_splat' };
	globalStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'global_statement' };
	nonlocalStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'nonlocal_statement' };
	execStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'exec_statement' };
	typeAliasStatement<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'type_alias_statement' };
	classDefinition<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'class_definition' };
	typeParameter<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'type_parameter' };
	parenthesizedListSplat<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'parenthesized_list_splat' };
	argumentList<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'argument_list' };
	decoratedDefinition<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'decorated_definition' };
	decorator<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'decorator' };
	Suite<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_suite' };
	block<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'block' };
	expressionList<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'expression_list' };
	dottedName<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'dotted_name' };
	casePattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'case_pattern' };
	AsPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_as_pattern' };
	unionPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'union_pattern' };
	ListPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_list_pattern' };
	TuplePattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_tuple_pattern' };
	dictPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'dict_pattern' };
	keywordPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'keyword_pattern' };
	splatPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'splat_pattern' };
	classPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'class_pattern' };
	complexPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'complex_pattern' };
	tuplePattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'tuple_pattern' };
	listPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'list_pattern' };
	defaultParameter<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'default_parameter' };
	typedDefaultParameter<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'typed_default_parameter' };
	listSplatPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'list_splat_pattern' };
	dictionarySplatPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'dictionary_splat_pattern' };
	asPattern<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'as_pattern' };
	notOperator<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'not_operator' };
	booleanOperator<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'boolean_operator' };
	binaryOperator<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'binary_operator' };
	unaryOperator<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'unary_operator' };
	comparisonOperator<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'comparison_operator' };
	lambda<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'lambda' };
	lambdaWithinForInClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'lambda_within_for_in_clause' };
	assignment<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'assignment' };
	augmentedAssignment<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'augmented_assignment' };
	patternList<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'pattern_list' };
	yield_<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'yield' };
	attribute<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'attribute' };
	subscript<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'subscript' };
	slice<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'slice' };
	call<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'call' };
	typedParameter<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'typed_parameter' };
	type<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'type' };
	splatType<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'splat_type' };
	...
	constrainedType<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'constrained_type' };
	memberType<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'member_type' };
	keywordArgument<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'keyword_argument' };
	list<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'list' };
	set<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'set' };
	tuple<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'tuple' };
	dictionary<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'dictionary' };
	pair<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'pair' };
	listComprehension<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'list_comprehension' };
	dictionaryComprehension<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'dictionary_comprehension' };
	setComprehension<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'set_comprehension' };
	generatorExpression<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'generator_expression' };
	ComprehensionClauses<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_comprehension_clauses' };
	parenthesizedExpression<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'parenthesized_expression' };
	forInClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'for_in_clause' };
	ifClause<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'if_clause' };
	conditionalExpression<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'conditional_expression' };
	concatenatedString<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'concatenated_string' };
	string<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'string' };
	stringContent<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'string_content' };
	interpolation<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'interpolation' };
	formatSpecifier<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'format_specifier' };
	await<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: 'await' };
	AsPatternTarget<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_as_pattern_target' };
	FormatExpression<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_format_expression' };
	WithClauseParen<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_with_clause_paren' };
	SimplePatternNegative<T extends { readonly $type: string }>(
		v: T
	): v is T & { readonly $type: '_simple_pattern_negative' };
...
export interface AssertGuards {
	...
	SimpleStatements(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_simple_statements' };
	importStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'import_statement' };
	relativeImport(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'relative_import' };
	futureImportStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'future_import_statement' };
	importFromStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'import_from_statement' };
	aliasedImport(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'aliased_import' };
	printStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'print_statement' };
	chevron(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'chevron' };
	assertStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'assert_statement' };
	expressionStatementTuple(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'expression_statement_tuple' };
	expressionStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'expression_statement' };
	namedExpression(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'named_expression' };
	returnStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'return_statement' };
	deleteStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'delete_statement' };
	raiseStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'raise_statement' };
	ifStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'if_statement' };
	elifClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'elif_clause' };
	elseClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'else_clause' };
	matchStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'match_statement' };
	MatchBlock(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_match_block' };
	caseClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'case_clause' };
	forStatement(v: {
		readonly $type: string;
	...
	exceptClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'except_clause' };
	finallyClause(v: {
		readonly $type: string;
	...
	withClauseBare(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'with_clause_bare' };
	withClauseParen(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'with_clause_paren' };
	withClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'with_clause' };
	withItem(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'with_item' };
	functionDefinition(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'function_definition' };
	parameters(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'parameters' };
	lambdaParameters(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'lambda_parameters' };
	listSplat(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'list_splat' };
	dictionarySplat(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'dictionary_splat' };
	globalStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'global_statement' };
	nonlocalStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'nonlocal_statement' };
	execStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'exec_statement' };
	typeAliasStatement(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'type_alias_statement' };
	classDefinition(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'class_definition' };
	typeParameter(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'type_parameter' };
	parenthesizedListSplat(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'parenthesized_list_splat' };
	argumentList(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'argument_list' };
	decoratedDefinition(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'decorated_definition' };
	decorator(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'decorator' };
	Suite(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_suite' };
	block(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'block' };
	expressionList(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'expression_list' };
	dottedName(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'dotted_name' };
	casePattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'case_pattern' };
	AsPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_as_pattern' };
	unionPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'union_pattern' };
	ListPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_list_pattern' };
	TuplePattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_tuple_pattern' };
	dictPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'dict_pattern' };
	keywordPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'keyword_pattern' };
	splatPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'splat_pattern' };
	classPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'class_pattern' };
	complexPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'complex_pattern' };
	tuplePattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'tuple_pattern' };
	listPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'list_pattern' };
	defaultParameter(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'default_parameter' };
	typedDefaultParameter(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'typed_default_parameter' };
	listSplatPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'list_splat_pattern' };
	dictionarySplatPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'dictionary_splat_pattern' };
	asPattern(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'as_pattern' };
	notOperator(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'not_operator' };
	booleanOperator(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'boolean_operator' };
	binaryOperator(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'binary_operator' };
	unaryOperator(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'unary_operator' };
	comparisonOperator(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'comparison_operator' };
	lambda(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'lambda' };
	lambdaWithinForInClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'lambda_within_for_in_clause' };
	assignment(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'assignment' };
	augmentedAssignment(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'augmented_assignment' };
	patternList(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'pattern_list' };
	yield_(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'yield' };
	attribute(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'attribute' };
	subscript(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'subscript' };
	slice(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'slice' };
	call(v: { readonly $type: string }): asserts v is { readonly $type: 'call' };
	typedParameter(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'typed_parameter' };
	type(v: { readonly $type: string }): asserts v is { readonly $type: 'type' };
	splatType(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'splat_type' };
	genericType(v: {
		readonly $type: string;
	...
	constrainedType(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'constrained_type' };
	memberType(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'member_type' };
	keywordArgument(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'keyword_argument' };
	list(v: { readonly $type: string }): asserts v is { readonly $type: 'list' };
	set(v: { readonly $type: string }): asserts v is { readonly $type: 'set' };
	tuple(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'tuple' };
	dictionary(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'dictionary' };
	pair(v: { readonly $type: string }): asserts v is { readonly $type: 'pair' };
	listComprehension(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'list_comprehension' };
	dictionaryComprehension(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'dictionary_comprehension' };
	setComprehension(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'set_comprehension' };
	generatorExpression(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'generator_expression' };
	ComprehensionClauses(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_comprehension_clauses' };
	parenthesizedExpression(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'parenthesized_expression' };
	forInClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'for_in_clause' };
	ifClause(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'if_clause' };
	conditionalExpression(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'conditional_expression' };
	concatenatedString(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'concatenated_string' };
	string(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'string' };
	stringContent(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'string_content' };
	interpolation(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'interpolation' };
	formatSpecifier(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'format_specifier' };
	await(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: 'await' };
	AsPatternTarget(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_as_pattern_target' };
	FormatExpression(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_format_expression' };
	WithClauseParen(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_with_clause_paren' };
	SimplePatternNegative(v: {
		readonly $type: string;
	}): asserts v is { readonly $type: '_simple_pattern_negative' };
	kind<K extends keyof NamespaceMap>(
		v: { readonly $type: string },
		kind: K
	...
	keywordIdentifier(v: {
		readonly $type: string;
	}): asserts v is KeywordIdentifier;
...
const _supertype_simpleStatement = new Set<string>([
...
const _supertype_namedExpressionLhs = new Set<string>([
	'identifier',
	'keyword_identifier'
]);
...
const _supertype_compoundStatement = new Set<string>([
	'if_statement',
	'for_statement',
	'while_statement',
	'try_statement',
...
const _supertype_simplePattern = new Set<string>([
	'class_pattern',
	'splat_pattern',
	'union_pattern',
	'_list_pattern',
...
const _supertype_parameter = new Set<string>([
	'identifier',
	'typed_parameter',
	'default_parameter',
...
const _supertype_expressionWithinForInClause = new Set<string>([
	'expression',
...
const _supertype_primaryExpression = new Set<string>([
	'await',
	'binary_operator',
	'identifier',
	'keyword_identifier',
...
const _supertype_rightHandSide = new Set<string>([
	'expression',
	'expression_list',
	'assignment',
...
const _supertype_fExpression = new Set<string>([
	'expression',
	'expression_list',
	'pattern_list',
	'yield'
...
const _supertype_dictPatternKv = new Set<string>([
	'_key_value_pattern',
	'splat_pattern'
]);
...
export const assert = {
	...
	SimpleStatements: _makeAssert(
		'SimpleStatements',
		is.SimpleStatements as _AnyGuard
	),
	...
	futureImportStatement: _makeAssert(
		'futureImportStatement',
		is.futureImportStatement as _AnyGuard
	),
	importFromStatement: _makeAssert(
		'importFromStatement',
		is.importFromStatement as _AnyGuard
	),
	...
	assertStatement: _makeAssert(
		'assertStatement',
		is.assertStatement as _AnyGuard
	),
	expressionStatementTuple: _makeAssert(
		'expressionStatementTuple',
		is.expressionStatementTuple as _AnyGuard
	),
	expressionStatement: _makeAssert(
		'expressionStatement',
		is.expressionStatement as _AnyGuard
	),
	namedExpression: _makeAssert(
		'namedExpression',
		is.namedExpression as _AnyGuard
	),
	returnStatement: _makeAssert(
		'returnStatement',
		is.returnStatement as _AnyGuard
	),
	deleteStatement: _makeAssert(
		'deleteStatement',
		is.deleteStatement as _AnyGuard
	),
	...
	withClauseParen: _makeAssert(
		'withClauseParen',
		is.withClauseParen as _AnyGuard
	),
	withClause: _makeAssert('withClause', is.withClause as _AnyGuard),
	withItem: _makeAssert('withItem', is.withItem as _AnyGuard),
	functionDefinition: _makeAssert(
		'functionDefinition',
		is.functionDefinition as _AnyGuard
	),
	parameters: _makeAssert('parameters', is.parameters as _AnyGuard),
	lambdaParameters: _makeAssert(
		'lambdaParameters',
		is.lambdaParameters as _AnyGuard
	),
	listSplat: _makeAssert('listSplat', is.listSplat as _AnyGuard),
	dictionarySplat: _makeAssert(
		'dictionarySplat',
		is.dictionarySplat as _AnyGuard
	),
	globalStatement: _makeAssert(
		'globalStatement',
		is.globalStatement as _AnyGuard
	),
	nonlocalStatement: _makeAssert(
		'nonlocalStatement',
		is.nonlocalStatement as _AnyGuard
	),
	execStatement: _makeAssert('execStatement', is.execStatement as _AnyGuard),
	typeAliasStatement: _makeAssert(
		'typeAliasStatement',
		is.typeAliasStatement as _AnyGuard
	),
	classDefinition: _makeAssert(
		'classDefinition',
		is.classDefinition as _AnyGuard
	),
	typeParameter: _makeAssert('typeParameter', is.typeParameter as _AnyGuard),
	parenthesizedListSplat: _makeAssert(
		'parenthesizedListSplat',
		is.parenthesizedListSplat as _AnyGuard
	),
	argumentList: _makeAssert('argumentList', is.argumentList as _AnyGuard),
	decoratedDefinition: _makeAssert(
		'decoratedDefinition',
		is.decoratedDefinition as _AnyGuard
	),
	...
	tuplePattern: _makeAssert('tuplePattern', is.tuplePattern as _AnyGuard),
	listPattern: _makeAssert('listPattern', is.listPattern as _AnyGuard),
	defaultParameter: _makeAssert(
		'defaultParameter',
		is.defaultParameter as _AnyGuard
	),
	typedDefaultParameter: _makeAssert(
		'typedDefaultParameter',
		is.typedDefaultParameter as _AnyGuard
	),
	listSplatPattern: _makeAssert(
		'listSplatPattern',
		is.listSplatPattern as _AnyGuard
	),
	dictionarySplatPattern: _makeAssert(
		'dictionarySplatPattern',
		is.dictionarySplatPattern as _AnyGuard
	),
	asPattern: _makeAssert('asPattern', is.asPattern as _AnyGuard),
	notOperator: _makeAssert('notOperator', is.notOperator as _AnyGuard),
	booleanOperator: _makeAssert(
		'booleanOperator',
		is.booleanOperator as _AnyGuard
	),
	...
	comparisonOperator: _makeAssert(
		'comparisonOperator',
		is.comparisonOperator as _AnyGuard
	),
	lambda: _makeAssert('lambda', is.lambda as _AnyGuard),
	lambdaWithinForInClause: _makeAssert(
		'lambdaWithinForInClause',
		is.lambdaWithinForInClause as _AnyGuard
	),
	assignment: _makeAssert('assignment', is.assignment as _AnyGuard),
	augmentedAssignment: _makeAssert(
		'augmentedAssignment',
		is.augmentedAssignment as _AnyGuard
	),
	...
	constrainedType: _makeAssert(
		'constrainedType',
		is.constrainedType as _AnyGuard
	),
	memberType: _makeAssert('memberType', is.memberType as _AnyGuard),
	keywordArgument: _makeAssert(
		'keywordArgument',
		is.keywordArgument as _AnyGuard
	),
	...
	listComprehension: _makeAssert(
		'listComprehension',
		is.listComprehension as _AnyGuard
	),
	dictionaryComprehension: _makeAssert(
		'dictionaryComprehension',
		is.dictionaryComprehension as _AnyGuard
	),
	setComprehension: _makeAssert(
		'setComprehension',
		is.setComprehension as _AnyGuard
	),
	generatorExpression: _makeAssert(
		'generatorExpression',
		is.generatorExpression as _AnyGuard
	),
	ComprehensionClauses: _makeAssert(
		'ComprehensionClauses',
		is.ComprehensionClauses as _AnyGuard
	),
	...
	conditionalExpression: _makeAssert(
		'conditionalExpression',
		is.conditionalExpression as _AnyGuard
	),
	concatenatedString: _makeAssert(
		'concatenatedString',
		is.concatenatedString as _AnyGuard
	),
	...
	formatSpecifier: _makeAssert(
		'formatSpecifier',
		is.formatSpecifier as _AnyGuard
	),
	await: _makeAssert('await', is.await as _AnyGuard),
	AsPatternTarget: _makeAssert(
		'AsPatternTarget',
		is.AsPatternTarget as _AnyGuard
	),
	FormatExpression: _makeAssert(
		'FormatExpression',
		is.FormatExpression as _AnyGuard
	),
	WithClauseParen: _makeAssert(
		'WithClauseParen',
		is.WithClauseParen as _AnyGuard
	),
	SimplePatternNegative: _makeAssert(
		'SimplePatternNegative',
		is.SimplePatternNegative as _AnyGuard
	),
	kind: _makeAssertKind(is.kind as _AnyGuard),
	statement: _makeAssert('statement', is.statement as _AnyGuard),
	simpleStatement: _makeAssert(
		'simpleStatement',
		is.simpleStatement as _AnyGuard
	),
	namedExpressionLhs: _makeAssert(
		'namedExpressionLhs',
		is.namedExpressionLhs as _AnyGuard
	),
	expressions: _makeAssert('expressions', is.expressions as _AnyGuard),
	compoundStatement: _makeAssert(
		'compoundStatement',
		is.compoundStatement as _AnyGuard
	),
	...
	expressionWithinForInClause: _makeAssert(
		'expressionWithinForInClause',
		is.expressionWithinForInClause as _AnyGuard
	),
	...
	keywordIdentifier: _makeAssert(
		'keywordIdentifier',
		is.keywordIdentifier as _AnyGuard
	),
