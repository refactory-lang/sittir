...
export interface IsGuards {
  AsPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId._AsPattern };
  ComprehensionClauses<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ComprehensionClauses };
  ExceptClauseList<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ExceptClauseList };
  ExpressionStatementTuple<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ExpressionStatementTuple };
  ListPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId._ListPattern };
  MatchBlock<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.MatchBlock };
  SimplePatternNegative<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.SimplePatternNegative };
  SimpleStatements<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.SimpleStatements };
  SliceGroup1<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId._SliceGroup1 };
  TuplePattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId._TuplePattern };
  WithClauseBare<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.WithClauseBare };
  WithClauseParen<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.WithClauseParen };
  aliasedImport<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.AliasedImport };
  argumentList<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ArgumentList };
  asPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.AsPattern };
  assertStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.AssertStatement };
  assignment<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Assignment };
  attribute<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Attribute };
  ...
  binaryOperator<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.BinaryOperator };
  block<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.Block };
  booleanOperator<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.BooleanOperator };
  call<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.Call };
  caseClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.CaseClause };
  casePattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.CasePattern };
  chevron<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Chevron };
  classDefinition<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ClassDefinition };
  classPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ClassPattern };
  comparisonOperator<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ComparisonOperator };
  complexPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ComplexPattern };
  ...
  constrainedType<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ConstrainedType };
  ...
  defaultParameter<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DefaultParameter };
  deleteStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DeleteStatement };
  dictPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DictPattern };
  dictionary<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Dictionary };
  dictionaryComprehension<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DictionaryComprehension };
  dictionarySplat<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DictionarySplat };
  dictionarySplatPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DictionarySplatPattern };
  dottedName<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.DottedName };
  elifClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ElifClause };
  elseClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ElseClause };
  exceptClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ExceptClause };
  execStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ExecStatement };
  expressionList<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ExpressionList };
  ...
  forInClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ForInClause };
  forStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ForStatement };
  formatSpecifier<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.FormatSpecifier };
  ...
  globalStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.GlobalStatement };
  ifClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.IfClause };
  ...
  interpolation<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Interpolation };
  keywordArgument<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.KeywordArgument };
  keywordPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.KeywordPattern };
  lambda<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.Lambda };
  lambdaParameters<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.LambdaParameters };
  ...
  listPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ListPattern };
  listSplat<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ListSplat };
  listSplatPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.ListSplatPattern };
  matchStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.MatchStatement };
  memberType<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.MemberType };
  module<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.Module };
  namedExpression<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.NamedExpression };
  nonlocalStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.NonlocalStatement };
  notOperator<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.NotOperator };
  pair<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.Pair };
  parameters<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Parameters };
  ...
  patternList<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.PatternList };
  printStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.PrintStatement };
  raiseStatement<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.RaiseStatement };
  relativeImport<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.RelativeImport };
  ...
  setComprehension<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.SetComprehension };
  slice<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.Slice };
  splatPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.SplatPattern };
  splatType<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.SplatType };
  string<T extends { readonly $type: number }>(v: T): v is T & { readonly $type: TSKindId.String };
  stringContent<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.StringContent };
  subscript<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.Subscript };
  ...
  tuplePattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.TuplePattern };
  ...
  typedParameter<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.TypedParameter };
  unaryOperator<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.UnaryOperator };
  unionPattern<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.UnionPattern };
  ...
  withClause<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.WithClause };
  withItem<T extends { readonly $type: number }>(
    v: T,
  ): v is T & { readonly $type: TSKindId.WithItem };
...
export interface AssertGuards {
  ...
  ExceptClauseList(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ExceptClauseList };
  ExpressionStatementTuple(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ExpressionStatementTuple };
  ListPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId._ListPattern };
  MatchBlock(v: { readonly $type: number }): asserts v is { readonly $type: TSKindId.MatchBlock };
  SimplePatternNegative(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.SimplePatternNegative };
  SimpleStatements(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.SimpleStatements };
  SliceGroup1(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId._SliceGroup1 };
  TuplePattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId._TuplePattern };
  WithClauseBare(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.WithClauseBare };
  WithClauseParen(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.WithClauseParen };
  aliasedImport(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.AliasedImport };
  argumentList(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ArgumentList };
  asPattern(v: { readonly $type: number }): asserts v is { readonly $type: TSKindId.AsPattern };
  assertStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.AssertStatement };
  ...
  binaryOperator(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.BinaryOperator };
  block(v: { readonly $type: number }): asserts v is { readonly $type: TSKindId.Block };
  booleanOperator(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.BooleanOperator };
  ...
  classDefinition(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ClassDefinition };
  classPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ClassPattern };
  comparisonOperator(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ComparisonOperator };
  complexPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ComplexPattern };
  ...
  constrainedType(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ConstrainedType };
  ...
  defaultParameter(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.DefaultParameter };
  deleteStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.DeleteStatement };
  ...
  dictionarySplat(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.DictionarySplat };
  ...
  exceptClause(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ExceptClause };
  execStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ExecStatement };
  expressionList(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ExpressionList };
  ...
  formatSpecifier(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.FormatSpecifier };
  ...
  globalStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.GlobalStatement };
  ...
  interpolation(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.Interpolation };
  keywordArgument(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.KeywordArgument };
  keywordPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.KeywordPattern };
  lambda(v: { readonly $type: number }): asserts v is { readonly $type: TSKindId.Lambda };
  lambdaParameters(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.LambdaParameters };
  ...
  listSplatPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.ListSplatPattern };
  matchStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.MatchStatement };
  ...
  namedExpression(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.NamedExpression };
  nonlocalStatement(v: {
    readonly $type: number;
  ...
  printStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.PrintStatement };
  raiseStatement(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.RaiseStatement };
  relativeImport(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.RelativeImport };
  returnStatement(v: {
    readonly $type: number;
  ...
  setComprehension(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.SetComprehension };
  slice(v: { readonly $type: number }): asserts v is { readonly $type: TSKindId.Slice };
  splatPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.SplatPattern };
  ...
  stringContent(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.StringContent };
  ...
  tuplePattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.TuplePattern };
  ...
  typedParameter(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.TypedParameter };
  unaryOperator(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.UnaryOperator };
  unionPattern(v: {
    readonly $type: number;
  }): asserts v is { readonly $type: TSKindId.UnionPattern };
...
const _supertype_compoundStatement_ids = new Set<number>([
  131, 137, 138, 139, 142, 145, 154, 158, 134,
]);
...
const _supertype_simplePattern_ids = new Set<number>([
  173, 172, 166, 167, 168, 169, 231, 230, 88, 89, 90, 250, 174, 162,
]);
...
const _supertype_statement_ids = new Set<number>([
  110, 131, 137, 138, 139, 142, 145, 154, 158, 134,
]);
...
const _supertype_primaryExpression_ids = new Set<number>([
  237, 191, 1, 231, 230, 85, 86, 88, 89, 90, 192, 203, 204, 206, 215, 220, 218, 221, 216, 222, 217,
  225, 223, 183,
]);
