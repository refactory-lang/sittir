...
export declare function _asPattern(child: (T.CasePattern | T.Identifier)): {
    $type: TSKindId._AsPattern;
    $source: 2;
    $named: true;
    $children: (T.CasePattern | T.Identifier)[];
    children(): (T.CasePattern | T.Identifier)[];
    $with: {
        $child: (v: (T.CasePattern | T.Identifier)) => /*elided*/ any & {
            $render(): string;
...
export declare function comprehensionClauses(...children: (T.ForInClause | T.IfClause)[]): {
    ...
    $source: 2;
    $named: true;
    $children: (T.ForInClause | T.IfClause)[];
    children(): (T.ForInClause | T.IfClause)[];
    $with: {
...
export declare function _importList(config: T.ImportList.Config): {
    ...
    name(): readonly [T.AliasedImport | T.DottedName, ...(T.AliasedImport | T.DottedName)[]];
    $with: {
        name: (values_0: T.AliasedImport | T.DottedName, ...values: (T.AliasedImport | T.DottedName)[]) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function _matchBlockBlock(config: T.MatchBlockBlock.Config): {
    $type: TSKindId.MatchBlockBlock;
    $source: 2;
    $named: true;
    _alternative: readonly T.CaseClause[];
    alternative(): readonly T.CaseClause[];
    $with: {
        alternative: (...values: T.CaseClause[]) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function simpleStatements(...children: T.SimpleStatement[]): {
    ...
    $source: 2;
    $named: true;
    $children: T.SimpleStatement[] & readonly [T.SimpleStatement, ...T.SimpleStatement[]];
    children(): T.SimpleStatement[] & readonly [T.SimpleStatement, ...T.SimpleStatement[]];
    $with: {
...
export declare function await_(primaryExpression: T.PrimaryExpression): {
    $type: TSKindId.Await;
    $source: 2;
    $named: true;
...
export declare function chevron(expression: T.Expression): {
...
export declare function classPattern(config: T.ClassPattern.Config): {
    ...
    arguments(): readonly T.CasePattern[];
    $with: {
...
export declare function comparisonOperator(config: T.ComparisonOperator.Config): {
    ...
    $with: {
        ...
        operators: (value: Parameters<typeof comparisonOperator>[0]['operators']) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function complexPattern(config: T.ComplexPattern.Config): {
    ...
    children(): [] | readonly [T.Float | T.Integer];
    $with: {
        real: (value?: BooleanKeyword<"-">) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function dictionarySplat(expression: T.Expression): {
...
export declare function elseClause(config: T.ElseClause.Config): {
...
export declare function expressionStatement(config: Omit<ConfigOf<T.ExpressionStatementUFormTuple>, '$variant'>): {
...
export declare function expressionStatementUFormTuple(_config?: Omit<ConfigOf<T.ExpressionStatementUFormTuple>, '$variant'>): {
    $type: TSKindId.ExpressionStatement;
    $source: 2;
    $named: true;
    $variant: 'tuple';
...
export declare function finallyClause(config: T.FinallyClause.Config): {
    ...
    block(): T.Suite;
    $with: {
        block: (value: T.Suite) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function ifClause(expression: T.Expression): {
...
export declare function listSplat(expression: T.Expression): {
...
export declare function matchStatement(config: T.MatchStatement.Config): {
    ...
    _body: T.MatchBlock;
    subject(): readonly [T.Expression, ...T.Expression[]];
    body(): T.MatchBlock;
    $with: {
        subject: (values_0: T.Expression, ...values: T.Expression[]) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function notOperator(argument: T.Expression): {
...
export declare function printStatement(config: T.PrintStatement.Config): {
...
export declare function raiseStatement(config?: T.RaiseStatement.Config): {
...
export declare function slice(config?: T.Slice.Config): {
    $type: TSKindId.Slice;
    $source: 2;
    $named: true;
...
export declare function splatPattern(identifier: T._Identifier | T.Identifier | "_"): {
    ...
    $with: {
        identifier: (value: T._Identifier | T.Identifier | "_") => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function splatType(identifier: T._Identifier | T.Identifier): {
...
export declare function subscript(config: T.Subscript.Config): {
    ...
    subscript(): readonly [T.Slice | T.Expression, ...(T.Slice | T.Expression)[]];
    $with: {
        ...
        subscript: (values_0: T.Slice | T.Expression, ...values: (T.Slice | T.Expression)[]) => /*elided*/ any & {
            $render(): string;
            $toEdit(startOrRange: number | import("@sittir/types").ByteRange, endPos?: number): import("@sittir/types").Edit;
            $replace(target: {
                range(): import("@sittir/types").ByteRange;
...
export declare function tryStatement(config: T.TryStatement.Config): {
    ...
    body(): T.Suite;
    exceptClauses(): readonly T.ExceptClause[];
...
export declare function withClauseUFormBare(_config?: Omit<ConfigOf<T.WithClauseUFormBare>, '$variant'>): {
...
export declare function withItem(value: T.Expression): {
