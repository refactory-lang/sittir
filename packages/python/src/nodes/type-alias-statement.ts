...
export function type_alias_statement(left: Builder): TypeAliasStatementBuilder {
...
export namespace type_alias_statement {
  export function from(options: TypeAliasStatementOptions): TypeAliasStatementBuilder {
    const b = new TypeAliasStatementBuilder(options.left);
