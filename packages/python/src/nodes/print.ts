...
class PrintBuilder extends Builder<PrintStatement> {
...
export type { PrintBuilder };

export function print(): PrintBuilder {
...
export namespace print {
  export function from(options: PrintStatementOptions): PrintBuilder {
    const b = new PrintBuilder();
