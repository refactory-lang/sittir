...
class ImportFromBuilder extends Builder<ImportFromStatement> {
...
export type { ImportFromBuilder };

export function import_from(moduleName: Builder<DottedName | RelativeImport>): ImportFromBuilder {
  return new ImportFromBuilder(moduleName);
}
...
export namespace import_from {
  export function from(options: ImportFromStatementOptions): ImportFromBuilder {
    const b = new ImportFromBuilder(options.moduleName);
