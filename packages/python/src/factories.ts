  ...
  return withMethods(
    {
      ...
      $with: {
        operators: (
          value: NonNullable<Parameters<typeof _comparisonOperatorComparator>[0]>["operators"],
  ...
  return withMethods(
    {
      ...
      $with: {
        values: (...values: NonEmptyArray<T.Expression>) =>
          exceptClauseList({ ...config, value: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        names: (...values: NonEmptyArray<T.DottedName | T.AliasedImport>) =>
          _importList({ ...config, name: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        alternatives: (...values: T.CaseClause[]) =>
          _matchBlockBlock({ ...config, alternative: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        ) => argumentList({ ...config, arguments: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeParameters: (value?: T.TypeParameter) =>
          classDefinition({ ...config, typeParameters: value }),
        superclasses: (value?: T.ArgumentList) =>
          classDefinition({ ...config, superclasses: value }),
        body: (value: T.SimpleStatements | T.Block | T.Newline) =>
          classDefinition({ ...config, body: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        alternative: (value: T.Expression) =>
          conditionalExpression({ ...config, alternative: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: NonEmptyArray<T.Decorator>) =>
          decoratedDefinition({ ...config, decorator: values }),
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.Identifier | T.TuplePattern) =>
          defaultParameter({ ...config, name: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        dictPatternKv: (value?: T.DictPatternKv) =>
          dictPattern({ ...config, dictPatternKv: value }),
        keys: (...values: T.SimplePattern[]) => dictPattern({ ...config, key: values }),
        values: (...values: T.CasePattern[]) => dictPattern({ ...config, value: values }),
        splatPatterns: (...values: T.SplatPattern[]) =>
          dictPattern({ ...config, splatPattern: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        entries: (...values: (T.Pair | T.DictionarySplat)[]) =>
          dictionary({ ...config, entries: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        consequence: (value: T.SimpleStatements | T.Block | T.Newline) =>
          elifClause({ ...config, consequence: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        content: (value?: T.ExceptClauseAs | T.ExceptClauseList) =>
          exceptClause({ ...config, content: value }),
        simpleStatements: (value?: T.SimpleStatements) =>
          exceptClause({ ...config, simpleStatements: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        rights: (...values: NonEmptyArray<T.ExpressionWithinForInClause>) =>
          forInClause({ ...config, right: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        body: (value: T.SimpleStatements | T.Block | T.Newline) =>
          forStatement({ ...config, body: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        asyncMarker: (
          value?: NonNullable<Parameters<typeof functionDefinition>[0]>["asyncMarker"],
        ) => functionDefinition({ ...config, asyncMarker: value }),
        name: (value: T.Identifier) => functionDefinition({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameter) =>
          functionDefinition({ ...config, typeParameters: value }),
        ...
        body: (value: T.SimpleStatements | T.Block | T.Newline) =>
          functionDefinition({ ...config, body: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        alternatives: (...values: (T.ElifClause | T.ElseClause)[]) =>
          ifStatement({ ...config, alternative: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        moduleName: (value: T.RelativeImport | T.DottedName) =>
          importFromStatement({ ...config, moduleName: value }),
        wildcardImports: (
          ...values: NonEmptyArray<T.WildcardImport | T.DottedName | T.AliasedImport>
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeConversion: (value?: T.TypeConversion) =>
          interpolation({ ...config, typeConversion: value }),
        formatSpecifier: (value?: T.FormatSpecifier) =>
          interpolation({ ...config, formatSpecifier: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        simplePattern: (value: T.SimplePattern) =>
          keywordPattern({ ...config, simplePattern: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        parameters: (value?: T.LambdaParameters) =>
          lambdaWithinForInClause({ ...config, parameters: value }),
        body: (value: T.ExpressionWithinForInClause) =>
          lambdaWithinForInClause({ ...config, body: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        subjects: (...values: NonEmptyArray<T.Expression>) =>
          matchStatement({ ...config, subject: values }),
...
export function parenthesizedExpression(
  child: T.Expression | T.Yield | T.ParenthesizedListSplat | T.ListSplat,
) {
  const _content = child;
  return withMethods(
    {
  ...
  return withMethods(
    {
      ...
      $with: {
        $children: (
          ...vs: (T.EscapeInterpolation | T.EscapeSequence | "\\" | T._StringContent)[]
        ) => stringContent(...vs),
      },
    },
    methodsEngine,
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        subscripts: (...values: NonEmptyArray<T.Expression | T.Slice>) =>
          subscript({ ...config, subscript: values }),
      },
    },
    methodsEngine,
  );
...
export function typeConversion(text: string) {
  ...
  if (
    ...
    !_leafRe_typeConversion.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        body: (value: T.SimpleStatements | T.Block | T.Newline) =>
          whileStatement({ ...config, body: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        body: (value: T.SimpleStatements | T.Block | T.Newline) =>
          withStatement({ ...config, body: value }),
      },
    },
    methodsEngine,
  );
...
export type FluentKindMap = {
  ...
  _expression_statement_tuple: FluentNode<
