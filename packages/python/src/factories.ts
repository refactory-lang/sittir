...
export function simpleStatements(...children: T.SimpleStatement[]) {
  ...
  return {
    ...
    replace(target: T.SimpleStatementsTree) { const r = target.range(); return toEdit(this, r); },
  };
}
...
export function forStatement(config: T.ForStatement.Config) {
  ...
  return {
    ...
    $named: true as const,
    $fields: fields,
    async(value?: "async" | undefined) { return _fs(config, forStatement, 'async', value, fields.async); },
...
export function withStatement(config: T.WithStatement.Config) {
  ...
  return {
    ...
    $named: true as const,
    $fields: fields,
    async(value?: "async" | undefined) { return _fs(config, withStatement, 'async', value, fields.async); },
...
export function functionDefinition(config: T.FunctionDefinition.Config) {
  ...
  return {
    ...
    $named: true as const,
    $fields: fields,
    async(value?: "async" | undefined) { return _fs(config, functionDefinition, 'async', value, fields.async); },
...
export function execStatement(config: T.ExecStatement.Config) {
  ...
  return {
    ...
    inClause(...values: NonEmptyArray<"in" | T.Expression>) { return _fsm(config, execStatement, 'inClause', values, fields.in_clause); },
    render() { return render(this); },
    toEdit(startOrRange: number | ByteRange, endPos?: number) {
      if (typeof startOrRange === 'number') return toEdit(this, startOrRange, endPos!);
      return toEdit(this, startOrRange);
...
export function suite(child: T.SimpleStatements) {
  ...
  return {
    ...
    replace(target: T.SuiteTree) { const r = target.range(); return toEdit(this, r); },
  };
}
...
export function simplePattern(child?: (T.ClassPattern | T.SplatPattern | T.UnionPattern | T._ListPattern | T._TuplePattern | T.DictPattern | T.String | T.ConcatenatedString | T.True | T.False | T.None | T.Integer | T.Float | T.ComplexPattern | T.DottedName)) {
  ...
  return {
    ...
    replace(target: T.SimplePatternTree) { const r = target.range(); return toEdit(this, r); },
  };
}
...
export function _listPattern(...children: T.CasePattern[]) {
  ...
  return {
    ...
    replace(target: T._ListPatternTree) { const r = target.range(); return toEdit(this, r); },
  };
}
...
export function _tuplePattern(...children: T.CasePattern[]) {
  ...
  return {
    ...
    replace(target: T._TuplePatternTree) { const r = target.range(); return toEdit(this, r); },
  };
}
...
export function forInClause(config: T.ForInClause.Config) {
  ...
  return {
    ...
    $named: true as const,
    $fields: fields,
    async(value?: "async" | undefined) { return _fs(config, forInClause, 'async', value, fields.async); },
