...
export const compoundStatement = {
  if: _attach(F.ifStatement, { from: FR.ifStatementFrom }),
  for: _attach(F.forStatement, { from: FR.forStatementFrom }),
  while: _attach(F.whileStatement, { from: FR.whileStatementFrom }),
  try: _attach(F.tryStatement, { from: FR.tryStatementFrom }),
  with: _attach(F.withStatement, { from: FR.withStatementFrom }),
  function: _attach(F.functionDefinition, { from: FR.functionDefinitionFrom }),
  class: _attach(F.classDefinition, { from: FR.classDefinitionFrom }),
...
export const fExpression = {
  ...
  yield: _attach(F.yield_, { from: FR.yield_From }),
} as const;
...
export const simplePattern = {
  class: _attach(F.classPattern, { from: FR.classPatternFrom }),
  splat: _attach(F.splatPattern, { from: FR.splatPatternFrom }),
...
export const simpleStatement = {
  ...
  import: _attach(F.importStatement, { from: FR.importStatementFrom }),
  ...
  return: _attach(F.returnStatement, { from: FR.returnStatementFrom }),
  delete: _attach(F.deleteStatement, { from: FR.deleteStatementFrom }),
...
export const parameter = {
  ...
  default: _attach(F.defaultParameter, { from: FR.defaultParameterFrom }),
...
export const ir = {
  ...
  with: _attach(F.withItem, { from: FR.withItemFrom }),
