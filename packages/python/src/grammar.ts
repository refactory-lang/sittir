...
export type PythonGrammar = {
	...
	readonly case_clause: {
		...
		fields: {
			...
			guard: {
				multiple: false;
				required: false;
				types: [{ type: 'if_clause'; named: true }];
			};
		};
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'case_pattern'; named: true }];
		};
	};
	...
	readonly dict_pattern_kv: {
		...
		children: {
			multiple: false;
			required: false;
			types: [{ type: 'splat_pattern'; named: true }];
		};
	};
	readonly dictionary: {
		type: 'dictionary';
	...
	readonly dictionary_comprehension: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: 'for_in_clause'; named: true },
				{ type: 'if_clause'; named: true }
			];
		};
	};
	...
	readonly import_from_statement: {
		...
		fields: {
			module_name: {
				...
				types: [
					{ type: 'dotted_name'; named: true },
					{ type: 'relative_import'; named: true }
				];
			};
			name: {
				multiple: true;
	...
	readonly lambda_parameters: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'parameter'; named: true }];
		};
	};
	readonly list: {
		type: 'list';
	...
	readonly string: {
		...
		fields: {
			...
			string_end: {
				multiple: false;
				required: true;
				types: [{ type: 'string_end'; named: true }];
			};
			string_start: {
				multiple: false;
				required: true;
	...
	readonly with_clause_bare: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'with_item'; named: true }];
		};
	};
