...
export type PythonGrammar = {
	...
	readonly class_pattern: {
		...
		fields: {
			...
			dotted_name: {
				multiple: false;
				required: true;
				types: [{ type: "dotted_name"; named: true }];
			};
		};
	};
	...
	readonly relative_import: {
		...
		fields: {
			...
			import_prefix: {
				multiple: false;
				required: true;
				types: [{ type: "import_prefix"; named: true }];
			};
		};
	};
	...
	readonly string: {
		...
		fields: {
			...
			string_start: {
				multiple: false;
				required: true;
				types: [{ type: "string_start"; named: true }];
			};
		};
	};
	...
	readonly try_statement: {
		...
		fields: {
			...
			except_clauses: {
				multiple: true;
				required: false;
				types: [{ type: "except_clause"; named: true }];
			};
			finally_clause: {
				multiple: false;
				required: false;
	...
	readonly with_clause: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: "with_clause_bare"; named: true },
				{ type: "with_clause_paren"; named: true },
			];
		};
	};
	...
	readonly with_statement: {
		...
		fields: {
			...
			with_clause: {
				multiple: false;
				required: true;
				types: [{ type: "with_clause"; named: true }];
			};
		};
	};
	readonly yield: {
