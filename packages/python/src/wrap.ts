...
export function wrapDictPatternKv(data: T.DictPatternKv, tree: TreeHandle) {
  return drillIn<T.DictPatternKv>(normalizeSingularWrapSlot(_filterWrapChildrenByKind(data.$children, ["_key_value_pattern","key_value_pattern","splat_pattern"]), "children", true, data.$type, { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span }), tree);
}
...
export function wrapExpressionWithinForInClause(data: T.ExpressionWithinForInClause, tree: TreeHandle) {
  return drillIn<T.ExpressionWithinForInClause>(normalizeSingularWrapSlot(_filterWrapChildrenByKind(data.$children, ["expression","lambda_within_for_in_clause"]), "children", true, data.$type, { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span }), tree);
}

export function wrapFExpression(data: T.FExpression, tree: TreeHandle) {
  return drillIn<T.FExpression>(normalizeSingularWrapSlot(_filterWrapChildrenByKind(data.$children, ["expression","expression_list","pattern_list","yield"]), "children", true, data.$type, { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span }), tree);
}
...
export function wrapMatchBlock(data: T.MatchBlock, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _match_block_block: normalizeSingularWrapSlot((data as any)._match_block_block, "match_block_block", true, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "match_block_block", span: ((data as any) as _NodeData).$span }),
...
export function wrapNamedExpressionLhs(data: T.NamedExpressionLhs, tree: TreeHandle) {
  return drillIn<T.NamedExpressionLhs>(normalizeSingularWrapSlot(_filterWrapChildrenByKind(data.$children, ["identifier","keyword_identifier"]), "children", true, data.$type, { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span }), tree);
}

export function wrapRightHandSide(data: T.RightHandSide, tree: TreeHandle) {
  return drillIn<T.RightHandSide>(normalizeSingularWrapSlot(_filterWrapChildrenByKind(data.$children, ["expression","expression_list","assignment","augmented_assignment","pattern_list","yield"]), "children", true, data.$type, { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span }), tree);
}
...
export function wrapAssignment(data: T.Assignment, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _left: normalizeSingularWrapSlot((data as any)._left, "left", true, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "left", span: ((data as any) as _NodeData).$span }),
    _assignment_eq: normalizeSingularWrapSlot((data as any)._assignment_eq, "assignment_eq", false, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "assignment_eq", span: ((data as any) as _NodeData).$span }),
    _assignment_type: normalizeSingularWrapSlot((data as any)._assignment_type, "assignment_type", false, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "assignment_type", span: ((data as any) as _NodeData).$span }),
    _assignment_typed: normalizeSingularWrapSlot((data as any)._assignment_typed, "assignment_typed", false, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "assignment_typed", span: ((data as any) as _NodeData).$span }),
...
export function wrapDictPattern(data: T.DictPattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _dict_pattern_kv: normalizeRepeatedWrapSlot(_filterWrapChildrenByKind(data._dict_pattern_kv, ["_dict_pattern_kv","_key_value_pattern","splat_pattern","dict_pattern_kv"]), false, "dict_pattern_kv", { tree, nodeType: data.$type, slotName: "dict_pattern_kv", span: (data as _NodeData).$span }),
...
export function wrapExecStatement(data: T.ExecStatement, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _expression: normalizeRepeatedWrapSlot(_filterWrapChildrenByKind(_concatInSourceOrder([data._comparison_operator, data._not_operator, data._boolean_operator, data._lambda, data._await, data._binary_operator, data._identifier, data._keyword_identifier, data._string, data._concatenated_string, data._integer, data._float, data._true, data._false, data._none, data._unary_operator, data._attribute, data._subscript, data._call, data._list, data._list_comprehension, data._dictionary, data._dictionary_comprehension, data._set, data._set_comprehension, data._tuple, data._parenthesized_expression, data._generator_expression, data._ellipsis, data._list_splat_pattern, data._conditional_expression, data._named_expression, data._as_pattern, data._expression]), ["expression","comparison_operator","not_operator","boolean_operator","lambda","primary_expression","await","binary_operator","identifier","keyword_identifier","string","concatenated_string","integer","float","true","false","none","unary_operator","attribute","subscript","call","list","list_comprehension","dictionary","dictionary_comprehension","set","set_comprehension","tuple","parenthesized_expression","generator_expression","ellipsis","list_splat_pattern","conditional_expression","named_expression","as_pattern"]), false, "expression", { tree, nodeType: data.$type, slotName: "expression", span: (data as _NodeData).$span }),
...
export function wrapPattern(data: T.Pattern, tree: TreeHandle) {
  return drillIn<T.Pattern>(normalizeSingularWrapSlot(_filterWrapChildrenByKind(data.$children, ["identifier","keyword_identifier","subscript","attribute","list_splat_pattern","tuple_pattern","list_pattern"]), "children", true, data.$type, { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span }), tree);
}
...
export function wrapWithClause(data: T.WithClause, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _with_clause_bare: normalizeSingularWrapSlot((data as any)._with_clause_bare, "with_clause_bare", false, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "with_clause_bare", span: ((data as any) as _NodeData).$span }),
    _with_clause_paren: normalizeSingularWrapSlot((data as any)._with_clause_paren, "with_clause_paren", false, (data as any).$type, { tree, nodeType: (data as any).$type, slotName: "with_clause_paren", span: ((data as any) as _NodeData).$span }),
