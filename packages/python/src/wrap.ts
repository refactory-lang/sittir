...
const _overrides = {
  ...
  "relative_import": {"fields":{"import_prefix":{"types":[],"multiple":false,"required":true,"position":0},"dotted_name":{"types":[{"type":"dotted_name","named":true}],"multiple":false,"required":false,"position":1}}},
  "future_import_statement": {"fields":{"from":{"types":[{"type":"from","named":false}],"multiple":false,"required":true,"position":0}}},
  "import_from_statement": {"fields":{"from":{"types":[{"type":"from","named":false}],"multiple":false,"required":true,"position":0},"wildcard_import":{"types":[{"type":"wildcard_import","named":true},{"type":"_import_list","named":true}],"multiple":false,"required":true,"position":2}}},
  "chevron": {"fields":{"expression":{"types":[],"multiple":false,"required":true,"position":0}}},
  ...
  "try_statement": {"fields":{"try":{"types":[{"type":"try","named":false}],"multiple":false,"required":true,"position":0},"except_clauses":{"types":[{"type":"except_clause","named":true}],"multiple":true,"required":true,"position":2},"else_clause":{"types":[{"type":"else_clause","named":true}],"multiple":false,"required":false,"position":3},"finally_clause":{"types":[{"type":"finally_clause","named":true}],"multiple":false,"required":false,"position":4}}},
  "except_clause": {"fields":{"except":{"types":[{"type":"except","named":false}],"multiple":false,"required":true,"position":0}}},
  "finally_clause": {"fields":{"finally":{"types":[{"type":"finally","named":false}],"multiple":false,"required":true,"position":0},"block":{"types":[{"type":"_suite","named":true}],"multiple":false,"required":true,"position":1}}},
  "with_statement": {"fields":{"async":{"types":[{"type":"async","named":false}],"multiple":false,"required":false,"position":0},"with_clause":{"types":[{"type":"with_clause","named":true}],"multiple":false,"required":true,"position":1}}},
  "function_definition": {"fields":{"async":{"types":[{"type":"async","named":false}],"multiple":false,"required":false,"position":0}}},
  "list_splat": {"fields":{"expression":{"types":[],"multiple":false,"required":true,"position":0}}},
  "dictionary_splat": {"fields":{"expression":{"types":[],"multiple":false,"required":true,"position":0}}},
  ...
  "decorator": {"fields":{"expression":{"types":[],"multiple":false,"required":true,"position":0},"newline":{"types":[],"multiple":false,"required":true,"position":1}}},
  "expression_list": {"fields":{"expression":{"types":[{"type":"expression","named":true}],"multiple":false,"required":true,"position":0}}},
  "_as_pattern": {"fields":{"case_pattern":{"types":[{"type":"case_pattern","named":true}],"multiple":false,"required":true,"position":0},"identifier":{"types":[{"type":"identifier","named":true}],"multiple":false,"required":true,"position":1}}},
  "keyword_pattern": {"fields":{"identifier":{"types":[],"multiple":false,"required":true,"position":0},"simple_pattern":{"types":[{"type":"_simple_pattern","named":true}],"multiple":false,"required":true,"position":1}}},
  "splat_pattern": {"fields":{"identifier":{"types":[{"type":"*","named":false},{"type":"**","named":false}],"multiple":false,"required":true,"position":0}}},
  "class_pattern": {"fields":{"dotted_name":{"types":[],"multiple":false,"required":true,"position":0},"arguments":{"types":[{"type":"case_pattern","named":true}],"multiple":true,"required":false,"position":1}}},
  ...
  "as_pattern": {"fields":{"expression":{"types":[],"multiple":false,"required":true,"position":0}}},
  ...
  "comparison_operator": {"fields":{"left":{"types":[],"multiple":false,"required":true,"position":0},"comparators":{"types":[{"type":"primary_expression","named":true}],"multiple":true,"required":true,"position":1}}},
  ...
  "splat_type": {"fields":{"identifier":{"types":[{"type":"*","named":false},{"type":"**","named":false},{"type":"identifier","named":true}],"multiple":false,"required":true,"position":-1}}},
  "generic_type": {"fields":{"identifier":{"types":[{"type":"identifier","named":true}],"multiple":false,"required":true,"position":0},"type_parameter":{"types":[],"multiple":false,"required":true,"position":1}}},
  ...
  "member_type": {"fields":{"base_type":{"types":[],"multiple":false,"required":true,"position":0},"identifier":{"types":[],"multiple":false,"required":true,"position":1}}},
  "_comprehension_clauses": {"fields":{"for_in_clause":{"types":[{"type":"for_in_clause","named":true}],"multiple":false,"required":true,"position":0}}},
  "for_in_clause": {"fields":{"async":{"types":[{"type":"async","named":false}],"multiple":false,"required":false,"position":0}}},
  "if_clause": {"fields":{"if":{"types":[{"type":"if","named":false}],"multiple":false,"required":true,"position":0},"expression":{"types":[],"multiple":false,"required":true,"position":1}}},
  ...
  "concatenated_string": {"fields":{"string":{"types":[{"type":"string","named":true}],"multiple":false,"required":true,"position":0}}},
  "string": {"fields":{"string_start":{"types":[],"multiple":false,"required":true,"position":0},"content":{"types":[{"type":"interpolation","named":true},{"type":"string_content","named":true}],"multiple":true,"required":true,"position":1},"string_end":{"types":[],"multiple":false,"required":true,"position":2}}},
  "await": {"fields":{"await":{"types":[{"type":"await","named":false}],"multiple":false,"required":true,"position":0},"primary_expression":{"types":[],"multiple":false,"required":true,"position":1}}},
} as const;
export { _overrides };
