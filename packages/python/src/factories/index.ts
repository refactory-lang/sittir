...
export const _asPattern: Hoisted<typeof O._asPattern> = hoist(O._asPattern);
...
export const compoundStatement: Hoisted<typeof O.compoundStatement> = hoistRoutes(O.compoundStatement);
export const matchBlock: Hoisted<typeof O.matchBlock> = hoistRoutes(O.matchBlock);
