...
const _KIND_ID_STORED: ReadonlySet<number> = new Set([
	...
	101, 121, 131, 132, 133, 234, 237, 238, 239, 253, 264
]);
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	_simple_statements: new Set([
		1, 64, 69, 70, 74, 75, 76, 114, 117, 118, 119, 120, 122, 124, 125, 126, 128, 129, 130, 131, 132, 133, 151, 152, 153,
		154, 155, 156, 159, 164, 165, 183, 185, 189, 190, 191, 192, 195, 196, 198, 199, 202, 203, 204, 206, 215, 216, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 240, 251, 259, 260, 262, 263, 271, 277
	]),
	import_statement: new Set([119, 120, 165]),
	future_import_statement: new Set([119, 120, 165, 259]),
	_import_list: new Set([120, 165]),
	print_statement: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 260, 262, 263, 277
	]),
	chevron: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	expression_statement: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 198, 199, 202, 203, 204,
		206, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 271, 277
	]),
	...
	else_clause: new Set([
		1, 64, 69, 70, 74, 75, 76, 101, 113, 114, 117, 118, 119, 120, 122, 124, 125, 126, 128, 129, 130, 131, 132, 133, 151,
		152, 153, 154, 155, 156, 159, 163, 164, 165, 183, 185, 189, 190, 191, 192, 195, 196, 198, 199, 202, 203, 204, 206,
		215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 240, 251, 259, 260, 262, 263, 271, 275,
		277
	]),
	_match_block: new Set([101, 274]),
	...
	with_clause: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 147, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206,
		215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 243, 251, 272, 273, 277
	]),
	with_item: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	parameters: new Set([1, 175, 176, 179, 180, 181, 182, 183, 184, 203, 204, 207, 237, 238]),
	lambda_parameters: new Set([1, 175, 176, 179, 180, 181, 182, 183, 184, 203, 204, 207, 237, 238]),
	list_splat: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	...
	type_parameter: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 208,
		209, 210, 211, 212, 213, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 244, 251, 277
	]),
	...
	argument_list: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 214,
		215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 245, 251, 277
	]),
	decorator: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	...
	case_pattern: new Set([
		74, 75, 76, 165, 166, 168, 169, 170, 171, 172, 173, 174, 229, 230, 247, 248, 255, 256, 257, 264, 265
	]),
	dict_pattern: new Set([170, 172, 248]),
	_parameters: new Set([1, 176, 179, 180, 181, 182, 183, 184, 203, 204, 207, 237, 238]),
	_patterns: new Set([1, 176, 179, 180, 183, 203, 204]),
	tuple_pattern: new Set([1, 176, 179, 180, 183, 203, 204]),
	list_pattern: new Set([1, 176, 179, 180, 183, 203, 204]),
	list_splat_pattern: new Set([1, 203, 204]),
	dictionary_splat_pattern: new Set([1, 203, 204]),
	...
	type: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 209,
		210, 211, 212, 213, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	list: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	...
	_simple_statements_elements: new Set([
		1, 64, 69, 70, 74, 75, 76, 114, 117, 118, 119, 120, 122, 124, 125, 126, 128, 129, 130, 131, 132, 133, 151, 152, 153,
		154, 155, 156, 159, 164, 165, 183, 185, 189, 190, 191, 192, 195, 196, 198, 199, 202, 203, 204, 206, 215, 216, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 259, 260, 262, 263, 271, 277
	]),
	_subjects: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	...
	_with_clause_with_items: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 147, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206,
		215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	_types: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 208,
		209, 210, 211, 212, 213, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	...
	_dict_pattern_elements: new Set([170, 172]),
	_pattern_list_patterns: new Set([1, 176, 179, 180, 183, 203, 204]),
	_subscripts: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 205, 206,
		215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	...
	_parenthesized_import_list: new Set([119, 120, 165]),
	...
	print_statement_plain: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206, 215,
		216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 260, 277
	]),
	_except_clause_exception: new Set([254, 266]),
	_assignment_eq: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 198, 199, 200, 202, 203,
		204, 206, 215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 251, 277
	]),
	...
	_with_clause_paren: new Set([
		1, 64, 69, 70, 74, 75, 76, 126, 147, 151, 152, 159, 164, 183, 185, 189, 190, 191, 192, 195, 196, 202, 203, 204, 206,
		215, 216, 217, 218, 219, 220, 221, 222, 223, 224, 225, 228, 229, 230, 236, 243, 251, 277
	]),
	_suite_block: new Set([163]),
