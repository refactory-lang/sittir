...
const _KIND_ID_STORED: ReadonlySet<number> = new Set([
	...
	101, 123, 133, 134, 135, 236, 239, 240, 241, 266
]);
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	_simple_statements: new Set([
		1, 64, 69, 70, 74, 75, 76, 116, 119, 120, 121, 122, 124, 126, 127, 128, 130, 131, 132, 133, 134, 135, 153, 154, 155,
		156, 157, 158, 161, 166, 167, 185, 187, 191, 192, 193, 194, 197, 198, 200, 201, 204, 205, 206, 208, 217, 218, 219,
		220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 242, 253, 261, 262, 264, 265, 273, 279
	]),
	import_statement: new Set([121, 122, 167]),
	future_import_statement: new Set([121, 122, 167, 261]),
	_import_list: new Set([122, 167]),
	print_statement: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 262, 264, 265, 279
	]),
	chevron: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	expression_statement: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 200, 201, 204, 205, 206,
		208, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 273, 279
	]),
	...
	else_clause: new Set([
		1, 64, 69, 70, 74, 75, 76, 101, 115, 116, 119, 120, 121, 122, 124, 126, 127, 128, 130, 131, 132, 133, 134, 135, 153,
		154, 155, 156, 157, 158, 161, 165, 166, 167, 185, 187, 191, 192, 193, 194, 197, 198, 200, 201, 204, 205, 206, 208,
		217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 242, 253, 261, 262, 264, 265, 273, 277,
		279
	]),
	...
	with_clause: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 149, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208,
		217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 245, 253, 274, 275, 279
	]),
	with_item: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	parameters: new Set([1, 177, 178, 181, 182, 183, 184, 185, 186, 205, 206, 209, 239, 240]),
	lambda_parameters: new Set([1, 177, 178, 181, 182, 183, 184, 185, 186, 205, 206, 209, 239, 240]),
	list_splat: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	...
	type_parameter: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 210,
		211, 212, 213, 214, 215, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 246, 253, 279
	]),
	...
	argument_list: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 216,
		217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 247, 253, 279
	]),
	decorator: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	...
	case_pattern: new Set([
		74, 75, 76, 167, 168, 170, 171, 172, 173, 174, 175, 176, 231, 232, 249, 250, 257, 258, 259, 266, 267
	]),
	dict_pattern: new Set([172, 174, 250]),
	_parameters: new Set([1, 178, 181, 182, 183, 184, 185, 186, 205, 206, 209, 239, 240]),
	_patterns: new Set([1, 178, 181, 182, 185, 205, 206]),
	tuple_pattern: new Set([1, 178, 181, 182, 185, 205, 206]),
	list_pattern: new Set([1, 178, 181, 182, 185, 205, 206]),
	list_splat_pattern: new Set([1, 205, 206]),
	dictionary_splat_pattern: new Set([1, 205, 206]),
	...
	type: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 211,
		212, 213, 214, 215, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	list: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	...
	_simple_statements_elements: new Set([
		1, 64, 69, 70, 74, 75, 76, 116, 119, 120, 121, 122, 124, 126, 127, 128, 130, 131, 132, 133, 134, 135, 153, 154, 155,
		156, 157, 158, 161, 166, 167, 185, 187, 191, 192, 193, 194, 197, 198, 200, 201, 204, 205, 206, 208, 217, 218, 219,
		220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 261, 262, 264, 265, 273, 279
	]),
	_subjects: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	...
	_with_clause_with_items: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 149, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208,
		217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	_types: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 210,
		211, 212, 213, 214, 215, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	...
	_dict_pattern_elements: new Set([172, 174]),
	_pattern_list_patterns: new Set([1, 178, 181, 182, 185, 205, 206]),
	_subscripts: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 207, 208,
		217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	...
	_parenthesized_import_list: new Set([121, 122, 167]),
	...
	print_statement_plain: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208, 217,
		218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 262, 279
	]),
	_except_clause_exception: new Set([256, 268]),
	_assignment_eq: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 200, 201, 202, 204, 205,
		206, 208, 217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 253, 279
	]),
	...
	_with_clause_paren: new Set([
		1, 64, 69, 70, 74, 75, 76, 128, 149, 153, 154, 161, 166, 185, 187, 191, 192, 193, 194, 197, 198, 204, 205, 206, 208,
		217, 218, 219, 220, 221, 222, 223, 224, 225, 226, 227, 230, 231, 232, 238, 245, 253, 279
	]),
	_suite_block: new Set([165]),
