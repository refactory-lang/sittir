...
export const TREE_SITTER_KIND_ID_JSON = [
  ...
  { name: "is", id: 64, enumName: "AnonIs", cName: "anon_sym_is" },
  { name: "ellipsis", id: 80, enumName: "Ellipsis", cName: "sym_ellipsis" },
  { name: "escape_sequence", id: 82, enumName: "EscapeSequence", cName: "sym_escape_sequence" },
  { name: "type_conversion", id: 85, enumName: "TypeConversion", cName: "sym_type_conversion" },
  { name: "integer", id: 86, enumName: "Integer", cName: "sym_integer" },
  { name: "float", id: 87, enumName: "Float", cName: "sym_float" },
  { name: "true", id: 89, enumName: "True", cName: "sym_true" },
  { name: "false", id: 90, enumName: "False", cName: "sym_false" },
  { name: "none", id: 91, enumName: "None", cName: "sym_none" },
  { name: "comment", id: 92, enumName: "Comment", cName: "sym_comment" },
  { name: "line_continuation", id: 93, enumName: "LineContinuation", cName: "sym_line_continuation" },
