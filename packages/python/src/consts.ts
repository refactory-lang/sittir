...
> = {
	...
	assert_statement: [],
	assignment: [{ name: "left", required: true, multiple: false }],
	attribute: [
	...
	import_from_statement: [{ name: "moduleName", required: true, multiple: false }],
	...
	parenthesized_list_splat: [],
	pattern_list: [],
	print_statement: [{ name: "argument", required: true, multiple: true }],
	...
	splat_pattern: [{ name: "identifier", required: true, multiple: false }],
