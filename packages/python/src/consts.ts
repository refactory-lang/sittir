...
export const TREE_SITTER_KIND_ID_JSON = [
  ...
  { name: "_element_list", id: 290, enumName: "AliasElementList", cName: "alias_sym_element_list" },
  { name: "_parameter_list", id: 292, enumName: "AliasParameterList", cName: "alias_sym_parameter_list" },
  { name: "_pattern_group", id: 293, enumName: "AliasPatternGroup", cName: "alias_sym_pattern_group" },
] as const;
...
export const enum TSFieldId {
  ...
  FieldOperator = 38,
  FieldOperators = 39,
  FieldParameterList = 40,
  FieldParameters = 41,
  FieldPatternGroup = 42,
  FieldPrimaryExpression = 43,
  FieldReal = 44,
  FieldReturnType = 45,
  FieldRight = 46,
  FieldSimplePattern = 47,
  FieldStart = 48,
  FieldStep = 49,
  FieldStop = 50,
  FieldStringEnd = 51,
...
export const TREE_SITTER_FIELD_ID_BY_NAME = {
  ...
  "element_list": TSFieldId.FieldElementList,
  ...
  "parameter_list": TSFieldId.FieldParameterList,
  "parameters": TSFieldId.FieldParameters,
  "pattern_group": TSFieldId.FieldPatternGroup,
...
export const TREE_SITTER_FIELD_NAME_BY_ID = {
  ...
  [TSFieldId.FieldElementList]: "element_list",
  ...
  [TSFieldId.FieldParameterList]: "parameter_list",
  [TSFieldId.FieldParameters]: "parameters",
  [TSFieldId.FieldPatternGroup]: "pattern_group",
...
export const TREE_SITTER_FIELD_ID_JSON = [
  ...
  { name: "element_list", id: 19, enumName: "FieldElementList", cName: "field_element_list" },
  { name: "else_clause", id: 20, enumName: "FieldElseClause", cName: "field_else_clause" },
  { name: "entries", id: 21, enumName: "FieldEntries", cName: "field_entries" },
  ...
  { name: "parameter_list", id: 40, enumName: "FieldParameterList", cName: "field_parameter_list" },
  { name: "parameters", id: 41, enumName: "FieldParameters", cName: "field_parameters" },
  { name: "pattern_group", id: 42, enumName: "FieldPatternGroup", cName: "field_pattern_group" },
  { name: "primary_expression", id: 43, enumName: "FieldPrimaryExpression", cName: "field_primary_expression" },
  { name: "real", id: 44, enumName: "FieldReal", cName: "field_real" },
  { name: "return_type", id: 45, enumName: "FieldReturnType", cName: "field_return_type" },
  { name: "right", id: 46, enumName: "FieldRight", cName: "field_right" },
  { name: "simple_pattern", id: 47, enumName: "FieldSimplePattern", cName: "field_simple_pattern" },
  { name: "start", id: 48, enumName: "FieldStart", cName: "field_start" },
...
export const FIELD_MAP: Record<NodeKind, ReadonlyArray<{
  ...
  '_collection_elements': [
    { name: 'elementList', required: true, multiple: false },
  ],
  '_comprehension_clauses': [
    { name: 'contents', required: false, multiple: true },
  ],
  ...
  '_parameters': [
    { name: 'parameterList', required: true, multiple: false },
  ],
  '_pattern_group': [
    { name: 'patterns', required: true, multiple: true },
  ],
  '_patterns': [
    { name: 'patternGroup', required: true, multiple: false },
  ],
  '_simple_pattern_negative': [
  ...
  'list': [
    { name: 'elementList', required: false, multiple: false },
  ],
  'list_comprehension': [
    { name: 'body', required: true, multiple: false },
    { name: 'comprehensionClauses', required: true, multiple: false },
  ...
  'list_pattern': [
    { name: 'patternGroup', required: false, multiple: false },
  ],
  'list_pattern_group1': [
    { name: 'casePatterns', required: true, multiple: true },
  ],
  ...
  'parameters': [
    { name: 'parameterList', required: false, multiple: false },
  ],
  'parenthesized_expression': [
    { name: 'content', required: true, multiple: false },
  ],
