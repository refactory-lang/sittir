...
const TOOLS: Record<string, string> = {
	...
	'dump-ast-mismatches': './validate/dump-ast-mismatches.js',
...
function printHelp(): void {
	const lines = [
		...
		'  dump-ast-mismatches   read-render-parse AST gap diagnostic + clustering',
		...
		'  grammar-diagnostics pre-codegen grammar diagnostics',
		'',
		'Exercise:',
