	...
	wire<EnrichedGrammar<RustGrammarShape>>(
		{
			...
			transforms: {
				...
				token_tree_pattern: [
					{ '0/1': field('token_pattern'), '1/1': field('token_pattern'), '2/1': field('token_pattern') },
					{ 0: variant('paren'), 1: variant('bracket'), 2: variant('brace') }
				],
				token_tree: [
					{ '0/1': field('tokens'), '1/1': field('tokens'), '2/1': field('tokens') },
					{ 0: variant('paren'), 1: variant('bracket'), 2: variant('brace') }
				],
				delim_token_tree: [
					{ '0/1': field('delim_tokens'), '1/1': field('delim_tokens'), '2/1': field('delim_tokens') },
					{ 0: variant('paren'), 1: variant('bracket'), 2: variant('brace') }
				]
			},
			rules: {
