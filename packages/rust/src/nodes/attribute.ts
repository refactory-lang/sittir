...
import type { ArrayExpression, AssignmentExpression, AsyncBlock, Attribute, AwaitExpression, BinaryExpression, Block, BooleanLiteral, BreakExpression, CallExpression, CharLiteral, ClosureExpression, CompoundAssignmentExpr, ConstBlock, ContinueExpression, Crate, FieldExpression, FloatLiteral, ForExpression, GenBlock, GenericFunction, Identifier, IfExpression, IndexExpression, IntegerLiteral, LoopExpression, MacroInvocation, MatchExpression, Metavariable, ParenthesizedExpression, RangeExpression, RawStringLiteral, ReferenceExpression, ReturnExpression, ScopedIdentifier, Self, StringLiteral, StructExpression, Super, TokenTree, TryBlock, TryExpression, TupleExpression, TypeCastExpression, UnaryExpression, UnitExpression, UnsafeBlock, WhileExpression, YieldExpression } from '../types.js';
...
class AttributeBuilder extends Builder<Attribute> {
  ...
  constructor(children: Builder<Self | Identifier | Metavariable | Super | Crate | ScopedIdentifier>) {
    super();
...
export function attribute(children: Builder<Self | Identifier | Metavariable | Super | Crate | ScopedIdentifier>): AttributeBuilder {
...
export interface AttributeOptions {
  ...
  arguments?: Builder<TokenTree> | Omit<TokenTreeOptions, 'nodeKind'>;
...
export namespace attribute {
  export function from(options: Omit<AttributeOptions, 'nodeKind'>): AttributeBuilder {
    ...
    const b = new AttributeBuilder(_ctor instanceof Builder ? _ctor : scoped_identifier.from(_ctor));
    ...
    if (options.arguments !== undefined) {
      ...
      b.arguments(_v instanceof Builder ? _v : token_tree.from(_v));
    }
    return b;
  }
}
