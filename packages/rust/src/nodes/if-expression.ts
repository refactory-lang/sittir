...
class IfExpressionBuilder extends Builder<IfExpression> {
  ...
  override get nodeKind(): 'if_expression' { return 'if_expression'; }
...
export namespace if_expression {
  export function from(options: Omit<IfExpressionOptions, 'nodeKind'>): IfExpressionBuilder {
    ...
    const b = new IfExpressionBuilder(_ctor);
