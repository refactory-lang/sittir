...
class ArrayExpressionBuilder extends Builder<ArrayExpression> {
  ...
  override get nodeKind(): 'array_expression' { return 'array_expression'; }
...
export namespace array_expression {
  export function from(options: Omit<ArrayExpressionOptions, 'nodeKind'>): ArrayExpressionBuilder {
