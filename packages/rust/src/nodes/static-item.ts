...
class StaticItemBuilder extends Builder<StaticItem> {
...
export type { StaticItemBuilder };

export function static_item(name: Builder<Identifier>): StaticItemBuilder {
  return new StaticItemBuilder(name);
}
...
export namespace static_item {
  export function from(options: StaticItemOptions): StaticItemBuilder {
    const _ctor = options.name;
    const b = new StaticItemBuilder(typeof _ctor === 'string' ? new LeafBuilder('identifier', _ctor) : _ctor);
