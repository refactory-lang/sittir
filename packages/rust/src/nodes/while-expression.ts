...
export function while_expression(condition: Builder<Expression | LetChain | LetCondition>): WhileExpressionBuilder {
...
export namespace while_expression {
  export function from(options: WhileExpressionOptions): WhileExpressionBuilder {
    const b = new WhileExpressionBuilder(options.condition);
