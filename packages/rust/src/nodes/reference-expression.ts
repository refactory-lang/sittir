...
class ReferenceExpressionBuilder extends Builder<ReferenceExpression> {
  ...
  override get nodeKind(): 'reference_expression' { return 'reference_expression'; }
...
export namespace reference_expression {
  export function from(options: Omit<ReferenceExpressionOptions, 'nodeKind'>): ReferenceExpressionBuilder {
    ...
    const b = new ReferenceExpressionBuilder(_ctor);
