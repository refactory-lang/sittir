...
class EnumItemBuilder extends Builder<EnumItem> {
...
export type { EnumItemBuilder };

export function enum_item(name: Builder<TypeIdentifier>): EnumItemBuilder {
  return new EnumItemBuilder(name);
}
...
export namespace enum_item {
  export function from(options: EnumItemOptions): EnumItemBuilder {
    const _ctor = options.name;
    const b = new EnumItemBuilder(typeof _ctor === 'string' ? new LeafBuilder('type_identifier', _ctor) : _ctor);
