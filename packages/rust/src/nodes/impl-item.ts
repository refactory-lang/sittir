...
class ImplItemBuilder extends Builder<ImplItem> {
...
export type { ImplItemBuilder };

export function impl_item(type_: Builder<Type>): ImplItemBuilder {
  return new ImplItemBuilder(type_);
}
...
export namespace impl_item {
  export function from(options: ImplItemOptions): ImplItemBuilder {
    const b = new ImplItemBuilder(options.type);
