...
class ConstBuilder extends Builder<ConstItem> {
  ...
  override get nodeKind(): 'const_item' { return 'const_item'; }
...
export namespace const_ {
  export function from(options: Omit<ConstItemOptions, 'nodeKind'>): ConstBuilder {
