...
class CompoundAssignmentExprBuilder extends Builder<CompoundAssignmentExpr> {
  ...
  override get nodeKind(): 'compound_assignment_expr' { return 'compound_assignment_expr'; }
...
export namespace compound_assignment_expr {
  export function from(options: Omit<CompoundAssignmentExprOptions, 'nodeKind'>): CompoundAssignmentExprBuilder {
    ...
    const b = new CompoundAssignmentExprBuilder(_ctor);
