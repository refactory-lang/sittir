...
class UnionItemBuilder extends Builder<UnionItem> {
...
export type { UnionItemBuilder };

export function union_item(name: Builder<TypeIdentifier>): UnionItemBuilder {
  return new UnionItemBuilder(name);
}
...
export namespace union_item {
  export function from(options: UnionItemOptions): UnionItemBuilder {
    const _ctor = options.name;
    const b = new UnionItemBuilder(typeof _ctor === 'string' ? new LeafBuilder('type_identifier', _ctor) : _ctor);
