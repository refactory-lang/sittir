...
class StaticBuilder extends Builder<StaticItem> {
  ...
  private _children: Builder<VisibilityModifier | MutableSpecifier>[] = [];
  ...
  children(...value: Builder<VisibilityModifier | MutableSpecifier>[]): this {
  ...
  override get nodeKind(): 'static_item' { return 'static_item'; }
...
export interface StaticItemOptions {
  ...
  children?: Builder<VisibilityModifier | MutableSpecifier> | string | Omit<VisibilityModifierOptions, 'nodeKind'> | (Builder<VisibilityModifier | MutableSpecifier> | string | Omit<VisibilityModifierOptions, 'nodeKind'>)[];
}

export namespace static_ {
  export function from(options: Omit<StaticItemOptions, 'nodeKind'>): StaticBuilder {
    ...
    if (options.children !== undefined) {
      ...
      b.children(..._arr.map(_x => typeof _x === 'string' ? new LeafBuilder('mutable_specifier', _x) : _x instanceof Builder ? _x : visibility_modifier.from(_x)));
    }
    return b;
  }
}
