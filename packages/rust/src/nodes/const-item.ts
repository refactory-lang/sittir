...
class ConstItemBuilder extends Builder<ConstItem> {
...
export type { ConstItemBuilder };

export function const_item(name: Builder<Identifier>): ConstItemBuilder {
  return new ConstItemBuilder(name);
}
...
export namespace const_item {
  export function from(options: ConstItemOptions): ConstItemBuilder {
    const _ctor = options.name;
    const b = new ConstItemBuilder(typeof _ctor === 'string' ? new LeafBuilder('identifier', _ctor) : _ctor);
