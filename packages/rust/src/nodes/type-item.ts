...
class TypeItemBuilder extends Builder<TypeItem> {
...
export type { TypeItemBuilder };

export function type_item(name: Builder<TypeIdentifier>): TypeItemBuilder {
  return new TypeItemBuilder(name);
}
...
export namespace type_item {
  export function from(options: TypeItemOptions): TypeItemBuilder {
    const _ctor = options.name;
    const b = new TypeItemBuilder(typeof _ctor === 'string' ? new LeafBuilder('type_identifier', _ctor) : _ctor);
