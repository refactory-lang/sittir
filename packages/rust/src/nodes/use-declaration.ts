...
export function use_declaration(argument: Builder<Crate | Identifier | Metavariable | ScopedIdentifier | ScopedUseList | Self | Super | UseAsClause | UseList | UseWildcard>): UseDeclarationBuilder {
...
export namespace use_declaration {
  export function from(options: UseDeclarationOptions): UseDeclarationBuilder {
    const b = new UseDeclarationBuilder(options.argument);
