    ...
    if (options.right !== undefined) {
      ...
      if (_v instanceof Builder) {
        ...
        switch (_v.nodeKind) {
          ...
          case 'binary_expression': b.right(binary_expression.from(_v)); break;
