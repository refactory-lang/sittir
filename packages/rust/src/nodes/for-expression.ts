...
class ForExpressionBuilder extends Builder<ForExpression> {
  ...
  override get nodeKind(): 'for_expression' { return 'for_expression'; }
...
export function for_expression(pattern: Builder<StringLiteral | RawStringLiteral | CharLiteral | BooleanLiteral | IntegerLiteral | FloatLiteral | NegativeLiteral | Identifier | ScopedIdentifier | GenericPattern | TuplePattern | TupleStructPattern | StructPattern | RefPattern | SlicePattern | CapturedPattern | ReferencePattern | RemainingFieldPattern | MutPattern | RangePattern | OrPattern | ConstBlock | MacroInvocation>): ForExpressionBuilder {
  return new ForExpressionBuilder(pattern);
}

export interface ForExpressionOptions {
  nodeKind: 'for_expression';
...
export namespace for_expression {
  export function from(options: Omit<ForExpressionOptions, 'nodeKind'>): ForExpressionBuilder {
    ...
    const b = new ForExpressionBuilder(_ctor);
