...
class BinaryExpressionBuilder extends Builder<BinaryExpression> {
  ...
  private _right!: Builder<UnaryExpression | ReferenceExpression | TryExpression | BinaryExpression | AssignmentExpression | CompoundAssignmentExpr | TypeCastExpression | CallExpression | ReturnExpression | YieldExpression | StringLiteral | RawStringLiteral | CharLiteral | BooleanLiteral | IntegerLiteral | FloatLiteral | Identifier | Self | ScopedIdentifier | GenericFunction | AwaitExpression | FieldExpression | ArrayExpression | TupleExpression | MacroInvocation | UnitExpression | BreakExpression | ContinueExpression | IndexExpression | Metavariable | ClosureExpression | ParenthesizedExpression | StructExpression | UnsafeBlock | AsyncBlock | GenBlock | TryBlock | Block | IfExpression | MatchExpression | WhileExpression | LoopExpression | ForExpression | ConstBlock | RangeExpression>;
...
export namespace binary_expression {
  export function from(options: Omit<BinaryExpressionOptions, 'nodeKind'>): BinaryExpressionBuilder {
    ...
    const b = new BinaryExpressionBuilder(_ctor);
    ...
    if (options.right !== undefined) {
      ...
      if (_v instanceof Builder) {
        ...
        switch (_v.nodeKind) {
          case 'unary_expression': b.right(unary_expression.from(_v)); break;
          case 'reference_expression': b.right(reference_expression.from(_v)); break;
          case 'try_expression': b.right(try_expression.from(_v)); break;
          case 'assignment_expression': b.right(assignment_expression.from(_v)); break;
          case 'compound_assignment_expr': b.right(compound_assignment_expr.from(_v)); break;
          case 'type_cast_expression': b.right(type_cast_expression.from(_v)); break;
          case 'call_expression': b.right(call_expression.from(_v)); break;
          case 'return_expression': b.right(return_expression.from(_v)); break;
          case 'yield_expression': b.right(yield_expression.from(_v)); break;
          ...
          case 'generic_function': b.right(generic_function.from(_v)); break;
          case 'await_expression': b.right(await_expression.from(_v)); break;
          case 'field_expression': b.right(field_expression.from(_v)); break;
          case 'array_expression': b.right(array_expression.from(_v)); break;
          case 'tuple_expression': b.right(tuple_expression.from(_v)); break;
          case 'macro_invocation': b.right(macro_invocation.from(_v)); break;
          case 'break_expression': b.right(break_expression.from(_v)); break;
          case 'continue_expression': b.right(continue_expression.from(_v)); break;
          case 'index_expression': b.right(index_expression.from(_v)); break;
          case 'closure_expression': b.right(closure_expression.from(_v)); break;
          case 'parenthesized_expression': b.right(parenthesized_expression.from(_v)); break;
          case 'struct_expression': b.right(struct_expression.from(_v)); break;
          case 'unsafe_block': b.right(unsafe_block.from(_v)); break;
          case 'async_block': b.right(async_block.from(_v)); break;
          case 'gen_block': b.right(gen_block.from(_v)); break;
          case 'try_block': b.right(try_block.from(_v)); break;
          case 'block': b.right(block.from(_v)); break;
          case 'if_expression': b.right(if_expression.from(_v)); break;
          case 'match_expression': b.right(match_expression.from(_v)); break;
          case 'while_expression': b.right(while_expression.from(_v)); break;
          case 'loop_expression': b.right(loop_expression.from(_v)); break;
          case 'for_expression': b.right(for_expression.from(_v)); break;
          case 'const_block': b.right(const_block.from(_v)); break;
          case 'range_expression': b.right(range_expression.from(_v)); break;
        }
      }
    }
    return b;
