...
class TraitItemBuilder extends Builder<TraitItem> {
...
export type { TraitItemBuilder };

export function trait_item(name: Builder<TypeIdentifier>): TraitItemBuilder {
  return new TraitItemBuilder(name);
}
...
export namespace trait_item {
  export function from(options: TraitItemOptions): TraitItemBuilder {
    const _ctor = options.name;
    const b = new TraitItemBuilder(typeof _ctor === 'string' ? new LeafBuilder('type_identifier', _ctor) : _ctor);
