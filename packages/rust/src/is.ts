...
const _supertype_nonSpecialToken_ids = new Set<number>([318, 319, 122, 320, 120, 151, 1, 79, 132, 133, 134, 349, 350]);
...
const _supertype_expressionExceptRange_ids = new Set<number>([
	254, 256, 255, 257, 258, 259, 260, 263, 261, 262, 318, 319, 122, 320, 120, 151, 1, 132, 250, 232, 294, 295, 265, 267,
...
const _supertype_pattern_ids = new Set<number>([
	318, 319, 122, 320, 120, 151, 317, 1, 250, 302, 303, 305, 306, 311, 304, 312, 313, 308, 309, 310, 314, 287, 246, 352
]);
const _supertype_literal_ids = new Set<number>([318, 319, 122, 320, 120, 151]);
const _supertype_literalPattern_ids = new Set<number>([318, 319, 122, 320, 120, 151, 317]);
