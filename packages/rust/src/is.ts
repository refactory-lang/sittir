...
const _supertype_tokenPattern_ids = new Set<number>([
	164, 166, 165, 135, 312, 313, 122, 314, 120, 151, 1, 79, 132, 133, 134, 349, 350
]);
const _supertype_tokens_ids = new Set<number>([
	168, 169, 135, 312, 313, 122, 314, 120, 151, 1, 79, 132, 133, 134, 349, 350
]);
const _supertype_nonSpecialToken_ids = new Set<number>([312, 313, 122, 314, 120, 151, 1, 79, 132, 133, 134, 349, 350]);
...
const _supertype_nonDelimToken_ids = new Set<number>([312, 313, 122, 314, 120, 151, 1, 79, 132, 133, 134, 349, 350]);
...
const _supertype_pattern_ids = new Set<number>([
	312, 313, 122, 314, 120, 151, 311, 1, 244, 296, 297, 299, 300, 305, 298, 306, 307, 303, 304, 308, 281, 240, 352
]);
...
const _kindIdByKind = new Map<string, number>([
	...
	['pub', TSKindId.Pub],
	['_string_literal_open', TSKindId.StringLiteralOpen],
	['raw', TSKindId.Raw],
