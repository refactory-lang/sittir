...
const _supertype_type_ids = new Set<number>([236, 233, 135, 234, 227, 246, 224, 221, 223, 1, 240, 237, 229, 199]);
const _supertype_expression_ids = new Set<number>([
	...
	240, 285, 286, 287, 135, 282, 260, 263, 290, 291, 292, 293, 294, 268, 273, 278, 279, 280, 281, 247
]);
