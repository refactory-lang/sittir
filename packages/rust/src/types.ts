...
export interface VisibilityModifierCrateTree extends AnyTreeNode {
	readonly type: "_visibility_modifier_crate";
}
...
export interface ExpressionStatementBlockEndingTree extends AnyTreeNode {
	readonly type: "_expression_statement_block_ending";
}
...
export interface OuterDocCommentMarkerTree extends AnyTreeNode {
	readonly type: "_outer_doc_comment_marker";
}
export interface InnerDocCommentMarkerTree extends AnyTreeNode {
	readonly type: "_inner_doc_comment_marker";
}
