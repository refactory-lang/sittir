...
export type ExpressionStatement =
	| ExpressionStatementUFormWithSemi
	| ExpressionStatementUFormBlockEnding;
...
export type MacroDefinition =
	| MacroDefinitionUFormParen
	| MacroDefinitionUFormBracket
	| MacroDefinitionUFormBrace;
...
export type TokenTreePattern =
	| TokenTreePatternUFormParen
	| TokenTreePatternUFormBracket
	| TokenTreePatternUFormBrace;
...
export type StructItem =
	| StructItemUFormBrace
	| StructItemUFormTuple
	| StructItemUFormUnit;
...
export interface FunctionModifiers {
	...
	readonly $fields: {
		readonly modifier: NonEmptyArray<
			'async' | 'default' | 'const' | 'unsafe' | ExternModifier
		>;
	};
}
...
export interface TypeParameters {
	...
	readonly $children: NonEmptyArray<
		| AttributeItem
		| Metavariable
		| TypeParameter
		| LifetimeParameter
...
export type VisibilityModifier =
	| VisibilityModifierUFormInPath
	| VisibilityModifierUFormCrate
	| VisibilityModifierUFormPub;
...
export interface TypeArguments {
	...
	readonly $children: NonEmptyArray<
		_Type | TypeBinding | Lifetime | Literal | Block | TraitBounds
	>;
}
...
export type DelimTokenTree =
	| DelimTokenTreeUFormParen
	| DelimTokenTreeUFormBracket
	| DelimTokenTreeUFormBrace;
...
export type RangeExpression =
	| RangeExpressionUFormBinary
	| RangeExpressionUFormPostfix
	| RangeExpressionUFormPrefix
	| RangeExpressionUFormBare;
...
export interface ReferenceExpression {
	...
	readonly $children: readonly [
		ReferenceExpressionRawConst | ReferenceExpressionRawMut | MutableSpecifier
	];
}
...
export type ArrayExpression =
	| ArrayExpressionUFormSemi
	| ArrayExpressionUFormList;
...
export type ClosureExpression =
	| ClosureExpressionUFormBlock
	| ClosureExpressionUFormExpr;
...
export type RangePattern =
	| RangePatternUFormLeftWithRight
	| RangePatternUFormLeftBare
	| RangePatternUFormPrefix;
...
export type LineComment =
	| LineCommentUFormRegularDslash
	| LineCommentUFormDoc
	| LineCommentUFormContent;
...
export interface VisibilityModifierPub {
	...
	readonly $children: readonly [
		Self | Super | Crate | VisibilityModifierInPath
	];
}
...
export type ReferenceExpressionRawConst = Terminal<
	'_reference_expression_raw_const',
	string
>;
export type LineCommentRegularDslash = Terminal<
...
export type RawStringLiteralContent = Terminal<
	'raw_string_literal_content',
	string
>;
export type FloatLiteral = Terminal<'float_literal', string>;
export type OuterBlockDocCommentMarker = Terminal<
	'_outer_block_doc_comment_marker',
	string
>;
export type InnerBlockDocCommentMarker = Terminal<
...
export interface ShorthandFieldIdentifierTree extends AnyTreeNode {
	readonly type: '_shorthand_field_identifier';
}
...
export interface DocCommentTree extends AnyTreeNode {
	readonly type: '_doc_comment';
}
...
export interface ExpressionStatementWithSemiNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface ExpressionStatementBlockEndingNs extends NodeNs<
	ExpressionStatementBlockEnding,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ExternModifierNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface VisibilityModifierCrateNs extends NodeNs<
	VisibilityModifierCrate,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ShorthandFieldIdentifierNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _StringContentNs extends NodeNs<
	_StringContent,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ClosureExpressionBlockNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _ClosureExpressionExprNs extends NodeNs<
	_ClosureExpressionExpr,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _FieldPatternShorthandNs extends NodeNs<
	_FieldPatternShorthand,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface FunctionTypeFnFormNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _ImplItemBodyNs extends NodeNs<
	_ImplItemBody,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _MacroDefinitionParenNs extends NodeNs<
	_MacroDefinitionParen,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _MacroDefinitionBracketNs extends NodeNs<
	_MacroDefinitionBracket,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _MacroDefinitionBraceNs extends NodeNs<
	_MacroDefinitionBrace,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ModItemInlineNs extends NodeNs<
	_ModItemInline,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface RangeExpressionPrefixNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _RangeExpressionBareNs extends NodeNs<
	_RangeExpressionBare,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface StructItemTupleNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _VisibilityModifierCrateNs extends NodeNs<
	_VisibilityModifierCrate,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface VisibilityModifierInPathNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _PointerTypeMutNs extends NodeNs<
	_PointerTypeMut,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ReferenceExpressionRawMutNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _ExpressionStatementWithSemiNs extends NodeNs<
	_ExpressionStatementWithSemi,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ExpressionStatementBlockEndingNs extends NodeNs<
	_ExpressionStatementBlockEnding,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ForeignModItemBodyNs extends NodeNs<
	_ForeignModItemBody,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface MatchArmWithCommaNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _MatchArmBlockEndingNs extends NodeNs<
	_MatchArmBlockEnding,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface LineCommentDocNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _TokenTreePatternParenNs extends NodeNs<
	_TokenTreePatternParen,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _TokenTreePatternBracketNs extends NodeNs<
	_TokenTreePatternBracket,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _TokenTreePatternBraceNs extends NodeNs<
	_TokenTreePatternBrace,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _TokenTreeParenNs extends NodeNs<
	_TokenTreeParen,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _TokenTreeBracketNs extends NodeNs<
	_TokenTreeBracket,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _TokenTreeBraceNs extends NodeNs<
	_TokenTreeBrace,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _DelimTokenTreeParenNs extends NodeNs<
	_DelimTokenTreeParen,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _DelimTokenTreeBracketNs extends NodeNs<
	_DelimTokenTreeBracket,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _DelimTokenTreeBraceNs extends NodeNs<
	_DelimTokenTreeBrace,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export namespace ScopedTypeIdentifierInExpressionPosition {
	export type Config =
		ConfigFor<'scoped_type_identifier_in_expression_position'>;
	export type Fluent =
		FluentFor<'scoped_type_identifier_in_expression_position'>;
