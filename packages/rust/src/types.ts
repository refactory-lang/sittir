...
export function kindIdFromName(kindName: string): TSKindId {
  switch (kindName) {
    ...
    case "_enum_variant_list_optional1_repeat1":
      return TSKindId._EnumVariantListOptional1Repeat1;
    case "_field_declaration_list_optional1_repeat1":
      return TSKindId._FieldDeclarationListOptional1Repeat1;
    case "_ordered_field_declaration_list_optional1_repeat1":
      return TSKindId._OrderedFieldDeclarationListOptional1Repeat1;
    case "_where_clause_optional1_repeat1":
      return TSKindId._WhereClauseOptional1Repeat1;
    case "_use_list_optional1_repeat1":
      return TSKindId._UseListOptional1Repeat1;
    case "_parameters_optional1_repeat1":
      return TSKindId._ParametersOptional1Repeat1;
    case "_use_bounds_optional1_repeat1":
      return TSKindId._UseBoundsOptional1Repeat1;
    case "_arguments_optional1_repeat1":
      return TSKindId._ArgumentsOptional1Repeat1;
    case "_field_initializer_list_optional1_repeat1":
      return TSKindId._FieldInitializerListOptional1Repeat1;
    case "_closure_parameters_optional1_repeat1":
      return TSKindId._ClosureParametersOptional1Repeat1;
    case "_tuple_pattern_optional1_repeat1":
      return TSKindId._TuplePatternOptional1Repeat1;
    case "_slice_pattern_optional1_repeat1":
      return TSKindId._SlicePatternOptional1Repeat1;
    case "_struct_pattern_optional1_repeat1":
      return TSKindId._StructPatternOptional1Repeat1;
...
export interface RangePatternLeftWithRight {
  ...
  readonly __inputHints__?: {
    readonly content: KindEnum<
      "..." | "..=" | "..",
      TSKindId.DotDotDot | TSKindId.DotDotEq | TSKindId.DotDot
    >;
  };
  content(): number;
...
export interface FieldInitializerList {
  ...
  readonly _initializers?: readonly (
...
export type UnaryExpressionOperator = Terminal<
  TSKindId.Dash | TSKindId.Star | TSKindId.Bang,
  "-" | "*" | "!"
>;
...
export interface ForExpressionOptional1Tree extends AnyTreeNode {
  readonly type: "_for_expression_optional1";
}
export interface FunctionItemOptional1Tree extends AnyTreeNode {
  readonly type: "_function_item_optional1";
}
export interface FunctionSignatureItemOptional1Tree extends AnyTreeNode {
  readonly type: "_function_signature_item_optional1";
}
export interface FunctionTypeFnFormTree extends AnyTreeNode {
  readonly type: "_function_type_fn_form";
}
export interface FunctionTypeOptional1Tree extends AnyTreeNode {
  readonly type: "_function_type_optional1";
}
...
export interface LetDeclarationOptional3Tree extends AnyTreeNode {
  readonly type: "_let_declaration_optional3";
}
export interface LineCommentDocTree extends AnyTreeNode {
  readonly type: "_line_comment_doc";
}
export interface LoopExpressionOptional1Tree extends AnyTreeNode {
  readonly type: "_loop_expression_optional1";
}
...
export interface StaticItemOptional1Tree extends AnyTreeNode {
  readonly type: "_static_item_optional1";
}
...
export interface ArrayExpressionSemiNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface ArrayTypeOptional1Ns extends NodeNs<
  ArrayTypeOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface AttributedTypeParameterNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface BlockOptional1Ns extends NodeNs<
  BlockOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface ClosureExpressionOptional1Ns extends NodeNs<
  ...
  NamespaceMap
> {}
export interface ConstItemOptional1Ns extends NodeNs<
  ConstItemOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface FieldPatternNamedNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface ForExpressionOptional1Ns extends NodeNs<
  ForExpressionOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface FunctionItemOptional1Ns extends NodeNs<
  ...
  NamespaceMap
> {}
export interface FunctionSignatureItemOptional1Ns extends NodeNs<
  FunctionSignatureItemOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface FunctionTypeFnFormNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface FunctionTypeOptional1Ns extends NodeNs<
  FunctionTypeOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface ImplItemBodyNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface ImplItemGroup1Ns extends NodeNs<
  ImplItemGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface LetDeclarationOptional2Ns extends NodeNs<
  ...
  NamespaceMap
> {}
export interface LetDeclarationOptional3Ns extends NodeNs<
  LetDeclarationOptional3,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface LineCommentDocNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface LoopExpressionOptional1Ns extends NodeNs<
  LoopExpressionOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface ReferenceExpressionRawMutNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface StaticItemOptional1Ns extends NodeNs<
  StaticItemOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface UseWildcardClauseNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface UseWildcardGroup1Ns extends NodeNs<
  UseWildcardGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
