...
export interface BracketedType {
  ...
  readonly children: readonly (QualifiedType | Type)[];
}
...
export type AbstractTypeFromInput = FromInputOf<AbstractType, LeafScalarMap>;
export type ArgumentsFromInput = FromInputOf<Arguments, LeafScalarMap>;
export type ArrayExpressionFromInput = FromInputOf<ArrayExpression, LeafScalarMap>;
...
export type AssociatedTypeFromInput = FromInputOf<AssociatedType, LeafScalarMap>;
export type AsyncBlockFromInput = FromInputOf<AsyncBlock, LeafScalarMap>;
export type AttributeFromInput = FromInputOf<Attribute, LeafScalarMap>;
export type AttributeItemFromInput = FromInputOf<AttributeItem, LeafScalarMap>;
export type AwaitExpressionFromInput = FromInputOf<AwaitExpression, LeafScalarMap>;
export type BaseFieldInitializerFromInput = FromInputOf<BaseFieldInitializer, LeafScalarMap>;
export type BinaryExpressionFromInput = FromInputOf<BinaryExpression, LeafScalarMap>;
export type BlockFromInput = FromInputOf<Block, LeafScalarMap>;
export type BlockCommentFromInput = FromInputOf<BlockComment, LeafScalarMap>;
export type BoundedTypeFromInput = FromInputOf<BoundedType, LeafScalarMap>;
export type BracketedTypeFromInput = FromInputOf<BracketedType, LeafScalarMap>;
export type BreakExpressionFromInput = FromInputOf<BreakExpression, LeafScalarMap>;
export type CallExpressionFromInput = FromInputOf<CallExpression, LeafScalarMap>;
export type CapturedPatternFromInput = FromInputOf<CapturedPattern, LeafScalarMap>;
export type ClosureExpressionFromInput = FromInputOf<ClosureExpression, LeafScalarMap>;
export type ClosureParametersFromInput = FromInputOf<ClosureParameters, LeafScalarMap>;
export type CompoundAssignmentExprFromInput = FromInputOf<CompoundAssignmentExpr, LeafScalarMap>;
export type ConstBlockFromInput = FromInputOf<ConstBlock, LeafScalarMap>;
export type ConstItemFromInput = FromInputOf<ConstItem, LeafScalarMap>;
export type ConstParameterFromInput = FromInputOf<ConstParameter, LeafScalarMap>;
export type ContinueExpressionFromInput = FromInputOf<ContinueExpression, LeafScalarMap>;
export type DeclarationListFromInput = FromInputOf<DeclarationList, LeafScalarMap>;
export type DynamicTypeFromInput = FromInputOf<DynamicType, LeafScalarMap>;
export type ElseClauseFromInput = FromInputOf<ElseClause, LeafScalarMap>;
export type EnumItemFromInput = FromInputOf<EnumItem, LeafScalarMap>;
export type EnumVariantFromInput = FromInputOf<EnumVariant, LeafScalarMap>;
export type EnumVariantListFromInput = FromInputOf<EnumVariantList, LeafScalarMap>;
export type ExpressionStatementFromInput = FromInputOf<ExpressionStatement, LeafScalarMap>;
export type ExternCrateDeclarationFromInput = FromInputOf<ExternCrateDeclaration, LeafScalarMap>;
export type ExternModifierFromInput = FromInputOf<ExternModifier, LeafScalarMap>;
export type FieldDeclarationFromInput = FromInputOf<FieldDeclaration, LeafScalarMap>;
export type FieldDeclarationListFromInput = FromInputOf<FieldDeclarationList, LeafScalarMap>;
export type FieldExpressionFromInput = FromInputOf<FieldExpression, LeafScalarMap>;
export type FieldInitializerFromInput = FromInputOf<FieldInitializer, LeafScalarMap>;
export type FieldInitializerListFromInput = FromInputOf<FieldInitializerList, LeafScalarMap>;
export type FieldPatternFromInput = FromInputOf<FieldPattern, LeafScalarMap>;
export type ForExpressionFromInput = FromInputOf<ForExpression, LeafScalarMap>;
export type ForLifetimesFromInput = FromInputOf<ForLifetimes, LeafScalarMap>;
export type ForeignModItemFromInput = FromInputOf<ForeignModItem, LeafScalarMap>;
export type FunctionItemFromInput = FromInputOf<FunctionItem, LeafScalarMap>;
export type FunctionModifiersFromInput = FromInputOf<FunctionModifiers, LeafScalarMap>;
export type FunctionSignatureItemFromInput = FromInputOf<FunctionSignatureItem, LeafScalarMap>;
export type FunctionTypeFromInput = FromInputOf<FunctionType, LeafScalarMap>;
export type GenBlockFromInput = FromInputOf<GenBlock, LeafScalarMap>;
export type GenericFunctionFromInput = FromInputOf<GenericFunction, LeafScalarMap>;
export type GenericPatternFromInput = FromInputOf<GenericPattern, LeafScalarMap>;
export type GenericTypeFromInput = FromInputOf<GenericType, LeafScalarMap>;
export type GenericTypeWithTurbofishFromInput = FromInputOf<GenericTypeWithTurbofish, LeafScalarMap>;
export type HigherRankedTraitBoundFromInput = FromInputOf<HigherRankedTraitBound, LeafScalarMap>;
export type IfExpressionFromInput = FromInputOf<IfExpression, LeafScalarMap>;
export type ImplItemFromInput = FromInputOf<ImplItem, LeafScalarMap>;
export type IndexExpressionFromInput = FromInputOf<IndexExpression, LeafScalarMap>;
export type InnerAttributeItemFromInput = FromInputOf<InnerAttributeItem, LeafScalarMap>;
export type LabelFromInput = FromInputOf<Label, LeafScalarMap>;
export type LetChainFromInput = FromInputOf<LetChain, LeafScalarMap>;
export type LetConditionFromInput = FromInputOf<LetCondition, LeafScalarMap>;
export type LetDeclarationFromInput = FromInputOf<LetDeclaration, LeafScalarMap>;
export type LifetimeFromInput = FromInputOf<Lifetime, LeafScalarMap>;
export type LifetimeParameterFromInput = FromInputOf<LifetimeParameter, LeafScalarMap>;
export type LineCommentFromInput = FromInputOf<LineComment, LeafScalarMap>;
export type LoopExpressionFromInput = FromInputOf<LoopExpression, LeafScalarMap>;
export type MacroDefinitionFromInput = FromInputOf<MacroDefinition, LeafScalarMap>;
export type MacroInvocationFromInput = FromInputOf<MacroInvocation, LeafScalarMap>;
export type MacroRuleFromInput = FromInputOf<MacroRule, LeafScalarMap>;
export type MatchArmFromInput = FromInputOf<MatchArm, LeafScalarMap>;
export type MatchBlockFromInput = FromInputOf<MatchBlock, LeafScalarMap>;
export type MatchExpressionFromInput = FromInputOf<MatchExpression, LeafScalarMap>;
export type MatchPatternFromInput = FromInputOf<MatchPattern, LeafScalarMap>;
export type ModItemFromInput = FromInputOf<ModItem, LeafScalarMap>;
export type MutPatternFromInput = FromInputOf<MutPattern, LeafScalarMap>;
export type NegativeLiteralFromInput = FromInputOf<NegativeLiteral, LeafScalarMap>;
export type OrPatternFromInput = FromInputOf<OrPattern, LeafScalarMap>;
export type OrderedFieldDeclarationListFromInput = FromInputOf<OrderedFieldDeclarationList, LeafScalarMap>;
export type ParameterFromInput = FromInputOf<Parameter, LeafScalarMap>;
export type ParametersFromInput = FromInputOf<Parameters, LeafScalarMap>;
export type ParenthesizedExpressionFromInput = FromInputOf<ParenthesizedExpression, LeafScalarMap>;
export type PointerTypeFromInput = FromInputOf<PointerType, LeafScalarMap>;
export type QualifiedTypeFromInput = FromInputOf<QualifiedType, LeafScalarMap>;
export type RangeExpressionFromInput = FromInputOf<RangeExpression, LeafScalarMap>;
export type RangePatternFromInput = FromInputOf<RangePattern, LeafScalarMap>;
export type RawStringLiteralFromInput = FromInputOf<RawStringLiteral, LeafScalarMap>;
export type RefPatternFromInput = FromInputOf<RefPattern, LeafScalarMap>;
export type ReferenceExpressionFromInput = FromInputOf<ReferenceExpression, LeafScalarMap>;
export type ReferencePatternFromInput = FromInputOf<ReferencePattern, LeafScalarMap>;
export type ReferenceTypeFromInput = FromInputOf<ReferenceType, LeafScalarMap>;
export type RemovedTraitBoundFromInput = FromInputOf<RemovedTraitBound, LeafScalarMap>;
export type ReturnExpressionFromInput = FromInputOf<ReturnExpression, LeafScalarMap>;
export type ScopedIdentifierFromInput = FromInputOf<ScopedIdentifier, LeafScalarMap>;
export type ScopedTypeIdentifierFromInput = FromInputOf<ScopedTypeIdentifier, LeafScalarMap>;
export type ScopedUseListFromInput = FromInputOf<ScopedUseList, LeafScalarMap>;
export type SelfParameterFromInput = FromInputOf<SelfParameter, LeafScalarMap>;
export type ShorthandFieldInitializerFromInput = FromInputOf<ShorthandFieldInitializer, LeafScalarMap>;
export type SlicePatternFromInput = FromInputOf<SlicePattern, LeafScalarMap>;
export type SourceFileFromInput = FromInputOf<SourceFile, LeafScalarMap>;
export type StaticItemFromInput = FromInputOf<StaticItem, LeafScalarMap>;
export type StringLiteralFromInput = FromInputOf<StringLiteral, LeafScalarMap>;
export type StructExpressionFromInput = FromInputOf<StructExpression, LeafScalarMap>;
export type StructItemFromInput = FromInputOf<StructItem, LeafScalarMap>;
export type StructPatternFromInput = FromInputOf<StructPattern, LeafScalarMap>;
export type TokenBindingPatternFromInput = FromInputOf<TokenBindingPattern, LeafScalarMap>;
export type TokenRepetitionFromInput = FromInputOf<TokenRepetition, LeafScalarMap>;
export type TokenRepetitionPatternFromInput = FromInputOf<TokenRepetitionPattern, LeafScalarMap>;
export type TokenTreeFromInput = FromInputOf<TokenTree, LeafScalarMap>;
export type TokenTreePatternFromInput = FromInputOf<TokenTreePattern, LeafScalarMap>;
export type TraitBoundsFromInput = FromInputOf<TraitBounds, LeafScalarMap>;
export type TraitItemFromInput = FromInputOf<TraitItem, LeafScalarMap>;
export type TryBlockFromInput = FromInputOf<TryBlock, LeafScalarMap>;
export type TryExpressionFromInput = FromInputOf<TryExpression, LeafScalarMap>;
export type TupleExpressionFromInput = FromInputOf<TupleExpression, LeafScalarMap>;
export type TuplePatternFromInput = FromInputOf<TuplePattern, LeafScalarMap>;
export type TupleStructPatternFromInput = FromInputOf<TupleStructPattern, LeafScalarMap>;
...
export type TypeBindingFromInput = FromInputOf<TypeBinding, LeafScalarMap>;
export type TypeCastExpressionFromInput = FromInputOf<TypeCastExpression, LeafScalarMap>;
export type TypeItemFromInput = FromInputOf<TypeItem, LeafScalarMap>;
...
export type UnionItemFromInput = FromInputOf<UnionItem, LeafScalarMap>;
export type UnsafeBlockFromInput = FromInputOf<UnsafeBlock, LeafScalarMap>;
export type UseAsClauseFromInput = FromInputOf<UseAsClause, LeafScalarMap>;
export type UseBoundsFromInput = FromInputOf<UseBounds, LeafScalarMap>;
export type UseDeclarationFromInput = FromInputOf<UseDeclaration, LeafScalarMap>;
export type UseListFromInput = FromInputOf<UseList, LeafScalarMap>;
export type UseWildcardFromInput = FromInputOf<UseWildcard, LeafScalarMap>;
export type VariadicParameterFromInput = FromInputOf<VariadicParameter, LeafScalarMap>;
export type VisibilityModifierFromInput = FromInputOf<VisibilityModifier, LeafScalarMap>;
export type WhereClauseFromInput = FromInputOf<WhereClause, LeafScalarMap>;
export type WherePredicateFromInput = FromInputOf<WherePredicate, LeafScalarMap>;
export type WhileExpressionFromInput = FromInputOf<WhileExpression, LeafScalarMap>;
