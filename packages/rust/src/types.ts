...
export interface LineDocCommentMarkerTree extends TreeNode<'_line_doc_comment_marker'> {}

export interface BlockDocCommentMarkerTree extends TreeNode<'_block_doc_comment_marker'> {}
