...
export const integerLiteral = bundle(F.buildIntegerLiteral, C.coerceToIntegerLiteral);
...
export const charLiteral = bundle(F.buildCharLiteral, C.coerceToCharLiteral);
