...
const _KIND_ID_STORED: ReadonlySet<number> = new Set([
	...
	118, 119, 121, 124, 125, 126, 129, 130, 132, 133, 134, 136, 137, 138, 139, 140, 141, 143, 152, 153, 165, 231, 241,
	268, 308, 322, 323, 325, 326, 327, 328, 329, 352, 353, 354, 356, 358, 370, 373, 378, 400, 404
]);
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	expression_statement: new Set([
		1, 120, 122, 132, 135, 151, 232, 246, 250, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 265, 266, 267,
		268, 269, 274, 279, 284, 285, 286, 287, 288, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 318, 319, 320,
		353, 361, 362, 374, 375, 376, 377
	]),
	token_tree_pattern: new Set([385, 386, 387]),
	token_tree: new Set([388, 389, 390, 391, 392, 393]),
	attribute_item: new Set([179]),
	inner_attribute_item: new Set([179]),
	enum_variant_list: new Set([331, 406]),
	field_declaration_list: new Set([332, 405]),
	ordered_field_declaration_list: new Set([333, 410]),
	where_clause: new Set([199, 334]),
	removed_trait_bound: new Set([
		1, 135, 204, 205, 227, 229, 230, 231, 233, 235, 239, 240, 241, 242, 243, 246, 252, 347
	]),
	type_parameters: new Set([335, 408]),
	use_list: new Set([1, 132, 133, 134, 135, 213, 214, 215, 216, 250, 336]),
	use_wildcard: new Set([1, 132, 133, 134, 135, 250]),
	parameters: new Set([337, 407]),
	extern_modifier: new Set([318]),
	visibility_modifier: new Set([1, 132, 133, 134, 135, 250, 346, 366, 367]),
	bracketed_type: new Set([
		1, 135, 204, 205, 225, 227, 229, 230, 231, 233, 235, 239, 240, 241, 242, 243, 246, 252, 347
	]),
	lifetime: new Set([1]),
	for_lifetimes: new Set([1, 226, 338]),
	tuple_type: new Set([1, 135, 204, 205, 227, 229, 230, 231, 233, 235, 239, 240, 241, 242, 243, 246, 252, 347]),
	use_bounds: new Set([1, 226, 339]),
	type_arguments: new Set([340, 411]),
	dynamic_type: new Set([1, 135, 204, 205, 227, 229, 230, 231, 233, 235, 239, 240, 241, 242, 243, 246, 252, 347]),
	delim_token_tree: new Set([391, 392, 393]),
	range_expression: new Set([
		1, 120, 122, 132, 135, 151, 232, 246, 250, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 265, 266, 267,
		268, 269, 274, 279, 284, 285, 286, 287, 288, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 318, 319, 320,
		353, 361, 362, 374, 375, 376
	]),
	...
	arguments: new Set([341, 409]),
	array_expression: new Set([361, 362]),
	...
	field_initializer_list: new Set([
		...
		318, 319, 320, 342, 353, 361, 362, 374, 375, 376
	]),
	...
	tuple_pattern: new Set([
		1, 120, 122, 151, 246, 250, 287, 288, 300, 302, 303, 304, 305, 306, 308, 309, 310, 311, 312, 313, 314, 317, 318,
		319, 320, 343, 344, 352, 371, 372, 398, 401
	]),
	...
	line_comment: new Set([146, 155, 380, 381, 382]),
	block_comment: new Set([154, 383, 384]),
	_macro_rules: new Set([168]),
	_enum_variant_list_elements: new Set([406]),
	_field_declaration_list_elements: new Set([405]),
	_ordered_field_declaration_list_elements: new Set([410]),
	_where_predicates: new Set([199]),
	_type_parameters_elements: new Set([408]),
	_use_clauses: new Set([1, 132, 133, 134, 135, 213, 214, 215, 216, 250, 336]),
	_parameters_elements: new Set([407]),
	_lifetimes: new Set([1, 226]),
	_use_bounds_elements: new Set([1, 226]),
	_type_arguments_elements: new Set([411]),
	_arguments_elements: new Set([409]),
	_field_initializer_list_elements: new Set([
		1, 120, 122, 132, 135, 151, 232, 246, 250, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 265, 266, 267,
		268, 269, 271, 272, 273, 274, 279, 284, 285, 286, 287, 288, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300,
		318, 319, 320, 353, 361, 362, 374, 375, 376
	]),
	...
	_struct_pattern_elements: new Set([307, 308]),
	_visibility_modifier_group: new Set([1, 132, 133, 134, 135, 250, 367]),
	...
	_visibility_modifier_pub: new Set([1, 132, 133, 134, 135, 250, 346, 367]),
	_visibility_modifier_in_path: new Set([1, 132, 133, 134, 135, 250]),
	...
	_macro_definition_paren: new Set([168, 330]),
	_macro_definition_bracket: new Set([168, 330]),
	_macro_definition_brace: new Set([168, 330])
};
