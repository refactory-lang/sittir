...
const _KIND_ID_STORED: ReadonlySet<number> = new Set([
	...
	118, 119, 121, 124, 125, 126, 129, 130, 132, 133, 134, 136, 137, 138, 139, 140, 141, 143, 152, 153, 162, 228, 238,
	265, 305, 319, 320, 322, 323, 324, 325, 326, 349, 350, 351, 353, 355, 367, 370, 375, 397, 401
]);
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	expression_statement: new Set([
		1, 120, 122, 132, 135, 151, 229, 243, 247, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 262, 263, 264,
		265, 266, 271, 276, 281, 282, 283, 284, 285, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 315, 316, 317,
		350, 358, 359, 371, 372, 373, 374
	]),
	token_tree_pattern: new Set([382, 383, 384]),
	token_tree: new Set([385, 386, 387, 388, 389, 390]),
	attribute_item: new Set([176]),
	inner_attribute_item: new Set([176]),
	enum_variant_list: new Set([328, 403]),
	field_declaration_list: new Set([329, 402]),
	ordered_field_declaration_list: new Set([330, 407]),
	where_clause: new Set([196, 331]),
	removed_trait_bound: new Set([
		1, 135, 201, 202, 224, 226, 227, 228, 230, 232, 236, 237, 238, 239, 240, 243, 249, 344
	]),
	type_parameters: new Set([332, 405]),
	use_list: new Set([1, 132, 133, 134, 135, 210, 211, 212, 213, 247, 333]),
	use_wildcard: new Set([1, 132, 133, 134, 135, 247]),
	parameters: new Set([334, 404]),
	extern_modifier: new Set([315]),
	visibility_modifier: new Set([1, 132, 133, 134, 135, 247, 343, 363, 364]),
	bracketed_type: new Set([
		1, 135, 201, 202, 222, 224, 226, 227, 228, 230, 232, 236, 237, 238, 239, 240, 243, 249, 344
	]),
	lifetime: new Set([1]),
	for_lifetimes: new Set([1, 223, 335]),
	tuple_type: new Set([1, 135, 201, 202, 224, 226, 227, 228, 230, 232, 236, 237, 238, 239, 240, 243, 249, 344]),
	use_bounds: new Set([1, 223, 336]),
	type_arguments: new Set([337, 408]),
	dynamic_type: new Set([1, 135, 201, 202, 224, 226, 227, 228, 230, 232, 236, 237, 238, 239, 240, 243, 249, 344]),
	delim_token_tree: new Set([388, 389, 390]),
	...
	field_initializer_list: new Set([
		1, 120, 122, 132, 135, 151, 229, 243, 247, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 262, 263, 264,
		265, 266, 268, 269, 270, 271, 276, 281, 282, 283, 284, 285, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297,
		315, 316, 317, 339, 350, 358, 359, 371, 372, 373
	]),
	...
	else_clause: new Set([271, 297]),
	match_block: new Set([409]),
	const_block: new Set([297]),
	label: new Set([1]),
	continue_expression: new Set([1, 287]),
	await_expression: new Set([
		1, 120, 122, 132, 135, 151, 229, 243, 247, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 262, 263, 264,
		265, 266, 271, 276, 281, 282, 283, 284, 285, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 315, 316, 317,
		350, 358, 359, 371, 372, 373
	]),
	unsafe_block: new Set([297]),
	try_block: new Set([297]),
	tuple_pattern: new Set([
		1, 120, 122, 151, 243, 247, 284, 285, 297, 299, 300, 301, 302, 303, 305, 306, 307, 308, 309, 310, 311, 314, 315,
		316, 317, 340, 341, 349, 368, 369, 395, 398
	]),
	...
	line_comment: new Set([146, 155, 377, 378, 379]),
	block_comment: new Set([154, 380, 381]),
	_macro_rules: new Set([165]),
	_enum_variant_list_elements: new Set([403]),
	_field_declaration_list_elements: new Set([402]),
	_ordered_field_declaration_list_elements: new Set([407]),
	_where_predicates: new Set([196]),
	_type_parameters_elements: new Set([405]),
	_use_clauses: new Set([1, 132, 133, 134, 135, 210, 211, 212, 213, 247, 333]),
	_parameters_elements: new Set([404]),
	_lifetimes: new Set([1, 223]),
	_use_bounds_elements: new Set([1, 223]),
	_type_arguments_elements: new Set([408]),
	_arguments_elements: new Set([406]),
	_field_initializer_list_elements: new Set([
		1, 120, 122, 132, 135, 151, 229, 243, 247, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 262, 263, 264,
		265, 266, 268, 269, 270, 271, 276, 281, 282, 283, 284, 285, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297,
		315, 316, 317, 350, 358, 359, 371, 372, 373
	]),
	...
	_struct_pattern_elements: new Set([304, 305]),
	_visibility_modifier_group: new Set([1, 132, 133, 134, 135, 247, 364]),
	...
	_impl_item_body: new Set([179]),
	_impl_item_positive_clause: new Set([1, 230, 249]),
	_impl_item_negative_clause: new Set([1, 230, 249]),
	_closure_expression_expr: new Set([
		1, 120, 122, 132, 135, 151, 229, 243, 247, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 262, 263, 264,
		265, 266, 271, 276, 281, 282, 283, 284, 285, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 315, 316, 317,
		350, 358, 359, 371, 372, 373
	]),
	_visibility_modifier_pub: new Set([1, 132, 133, 134, 135, 247, 343, 364]),
	_visibility_modifier_in_path: new Set([1, 132, 133, 134, 135, 247]),
	_function_type_trait_form: new Set([1, 249]),
	_function_type_fn_form: new Set([194]),
	...
	_macro_definition_paren: new Set([165, 327]),
	_macro_definition_bracket: new Set([165, 327]),
	_macro_definition_brace: new Set([165, 327])
};
...
const _K62: readonly string[] = ['_range_pattern_with_left', '_range_pattern_prefix'];
...
const _K72: readonly string[] = ['scoped_type_identifier', 'generic_type'];
...
const _K74: readonly string[] = ['string_literal', 'raw_string_literal', 'delim_token_tree'];
...
export function resolveRangePattern_content(value: T.RangePattern.LooseConfig['content']): T.RangePattern['_content'] {
	return _resolveOne<T.RangePatternWithLeft | T.RangePatternPrefix>(value, _K2, _K62);
}
...
export function resolveImplItemPositiveClause_trait(
	...
	return _resolveOne<T.Identifier | T.ScopedTypeIdentifier | T.GenericType>(value, _K34, _K72);
}
...
export function resolveDelimTokenTreeParen_delimTokens(
	...
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveMany<T._NonSpecialToken | '$' | T.DelimTokenTree>(value, _K73, _K74)),
