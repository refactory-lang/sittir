...
export const integerLiteral: Hoisted<typeof O.integerLiteral> = hoist(O.integerLiteral);
...
export const charLiteral: Hoisted<typeof O.charLiteral> = hoist(O.charLiteral);
...
export const modItem: Hoisted<typeof O.modItem> = hoistRoutes(O.modItem);
export const foreignModItem: Hoisted<typeof O.foreignModItem> = hoistRoutes(O.foreignModItem);
...
export const matchArm: Hoisted<typeof O.matchArm> = hoistRoutes(O.matchArm);
export const closureExpression: Hoisted<typeof O.closureExpression> = hoistRoutes(O.closureExpression);
export const fieldPattern: Hoisted<typeof O.fieldPattern> = hoistRoutes(O.fieldPattern);
