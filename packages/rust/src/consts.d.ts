...
export declare const TREE_SITTER_KIND_ID_BY_KIND: {
    ...
    readonly _kw_move_marker: 351;
    readonly _kw_static_marker: 352;
    readonly _kw_pub: 353;
    readonly _kw_in: 354;
    readonly _kw_turbofish: 355;
    readonly _kw_unsafe_marker: 356;
    readonly _kw_negative: 357;
    readonly _pointer_type_const: 358;
    readonly _pointer_type_mut: 359;
    readonly _kw_operator: 360;
    readonly _reference_expression_raw_const: 361;
    readonly _reference_expression_raw_mut: 362;
    readonly _expression_statement_with_semi: 365;
    readonly _expression_statement_block_ending: 366;
    readonly _foreign_mod_item_semi: 367;
    readonly _foreign_mod_item_body: 368;
    readonly _match_arm_block_ending: 370;
    readonly _line_comment_regular_dslash: 371;
    readonly _token_tree_pattern_paren: 373;
    readonly _token_tree_pattern_bracket: 374;
    readonly _token_tree_pattern_brace: 375;
    readonly _token_tree_paren: 376;
    readonly _token_tree_bracket: 377;
    readonly _token_tree_brace: 378;
    readonly _delim_token_tree_paren: 379;
    readonly _delim_token_tree_bracket: 380;
    readonly _delim_token_tree_brace: 381;
    readonly _field_identifier: 414;
    readonly _type_identifier: 417;
};
export declare const TREE_SITTER_KIND_BY_KIND_ID: {
    ...
    readonly [351]: "_kw_move_marker";
    readonly [352]: "_kw_static_marker";
    readonly [353]: "_kw_pub";
    readonly [354]: "_kw_in";
    readonly [355]: "_kw_turbofish";
    readonly [356]: "_kw_unsafe_marker";
    readonly [357]: "_kw_negative";
    readonly [358]: "_pointer_type_const";
    readonly [359]: "_pointer_type_mut";
    readonly [360]: "_kw_operator";
    readonly [361]: "_reference_expression_raw_const";
    readonly [362]: "_reference_expression_raw_mut";
    readonly [365]: "_expression_statement_with_semi";
    readonly [366]: "_expression_statement_block_ending";
    readonly [367]: "_foreign_mod_item_semi";
    readonly [368]: "_foreign_mod_item_body";
    readonly [370]: "_match_arm_block_ending";
    readonly [371]: "_line_comment_regular_dslash";
    readonly [373]: "_token_tree_pattern_paren";
    readonly [374]: "_token_tree_pattern_bracket";
    readonly [375]: "_token_tree_pattern_brace";
    readonly [376]: "_token_tree_paren";
    readonly [377]: "_token_tree_bracket";
    readonly [378]: "_token_tree_brace";
    readonly [379]: "_delim_token_tree_paren";
    readonly [380]: "_delim_token_tree_bracket";
    readonly [381]: "_delim_token_tree_brace";
    readonly [414]: "_field_identifier";
    readonly [417]: "_type_identifier";
};
export declare const TREE_SITTER_KIND_ID_JSON: readonly [{
    ...
    readonly name: "_kw_move_marker";
    readonly id: 351;
    readonly enumName: "KwMoveMarker";
    readonly cName: "sym__kw_move_marker";
}, {
    readonly name: "_kw_static_marker";
    readonly id: 352;
    readonly enumName: "KwStaticMarker";
    readonly cName: "sym__kw_static_marker";
}, {
    readonly name: "_kw_pub";
    readonly id: 353;
    readonly enumName: "KwPub";
    readonly cName: "sym__kw_pub";
}, {
    readonly name: "_kw_in";
    readonly id: 354;
    readonly enumName: "KwIn";
    readonly cName: "sym__kw_in";
}, {
    readonly name: "_kw_turbofish";
    readonly id: 355;
    readonly enumName: "KwTurbofish";
    readonly cName: "sym__kw_turbofish";
}, {
    readonly name: "_kw_unsafe_marker";
    readonly id: 356;
    readonly enumName: "KwUnsafeMarker";
    readonly cName: "sym__kw_unsafe_marker";
}, {
    readonly name: "_kw_negative";
    readonly id: 357;
    readonly enumName: "KwNegative";
    readonly cName: "sym__kw_negative";
}, {
    ...
    readonly name: "_kw_operator";
    readonly id: 360;
    readonly enumName: "KwOperator";
    readonly cName: "sym__kw_operator";
}, {
...
export declare const TREE_SITTER_FIELD_ID_BY_NAME: {
    ...
    readonly raw_string_literal_end: TSFieldId.FieldRawStringLiteralEnd;
    readonly raw_string_literal_start: TSFieldId.FieldRawStringLiteralStart;
    ...
    readonly trailing_where_clause: TSFieldId.FieldTrailingWhereClause;
...
export declare const TREE_SITTER_FIELD_NAME_BY_ID: {
    ...
    readonly 18: "end";
    readonly 19: "extern_modifier";
    readonly 20: "field";
    readonly 21: "for_lifetimes";
    readonly 22: "function";
    readonly 23: "function_modifiers";
    readonly 24: "identifier";
    readonly 25: "in";
    readonly 26: "index";
    readonly 28: "label";
    readonly 29: "left";
    readonly 30: "length";
    readonly 31: "lifetime";
    readonly 32: "list";
    readonly 33: "macro";
    readonly 34: "modifier";
    readonly 35: "move_marker";
    readonly 36: "mutable_specifier";
    readonly 37: "name";
    readonly 38: "negative";
    readonly 39: "object";
    readonly 40: "operand";
    readonly 41: "operator";
    readonly 43: "parameters";
    readonly 44: "path";
    readonly 45: "pattern";
    readonly 46: "pub";
    readonly 47: "raw_string_literal_end";
    readonly 48: "raw_string_literal_start";
    readonly 49: "reference";
    readonly 50: "return_type";
    readonly 51: "right";
    readonly 52: "self";
    readonly 53: "shebang";
    readonly 54: "start";
    readonly 55: "statements";
    readonly 56: "static_marker";
    readonly 57: "string_content";
    readonly 58: "string_literal";
    readonly 59: "token_tree";
    readonly 60: "trailing_expression";
    readonly 61: "trailing_where_clause";
    readonly 62: "trait";
...
export declare const TREE_SITTER_FIELD_ID_JSON: readonly [{
    ...
    readonly name: "raw_string_literal_end";
    readonly id: 47;
    readonly enumName: "FieldRawStringLiteralEnd";
    readonly cName: "field_raw_string_literal_end";
}, {
    readonly name: "raw_string_literal_start";
    readonly id: 48;
    readonly enumName: "FieldRawStringLiteralStart";
    readonly cName: "field_raw_string_literal_start";
}, {
    ...
    readonly name: "trailing_where_clause";
    readonly id: 61;
    readonly enumName: "FieldTrailingWhereClause";
    readonly cName: "field_trailing_where_clause";
}, {
    readonly name: "trait";
    readonly id: 62;
...
export declare const __VISIBILITY_MODIFIER_IN_PATH_INS: readonly ['in'];
...
export declare const __VISIBILITY_MODIFIER_PUB_PUBS: readonly ['pub'];
...
export declare const _BINARY_EXPRESSION_OPERATORS: readonly ['&&'];
...
export declare const _CLOSURE_EXPRESSION_ASYNC_MARKERS: readonly ['async'];
...
export declare const _CLOSURE_EXPRESSION_STATIC_MARKERS: readonly ['static'];
...
export declare const _CRATES: readonly ['crate'];
export type CrateValue = (typeof _CRATES)[number];
/** Valid values for `_generic_type_with_turbofish_turbofish` nodes. */
export declare const _GENERIC_TYPE_WITH_TURBOFISH_TURBOFISHS: readonly ['::'];
...
export declare const _REF_MARKERS: readonly ['ref'];
export type RefMarkerValue = (typeof _REF_MARKERS)[number];
/** Valid values for `_self` nodes. */
export declare const _SELFS: readonly ['self'];
...
export declare const _UNSAFE_MARKERS: readonly ['unsafe'];
