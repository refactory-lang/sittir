...
export function functionTypeFnForm(config?: T.FunctionTypeFnForm.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.FunctionTypeFnForm['$children']>(_config, [] as unknown as T.FunctionTypeFnForm['$children']);
  return withMethods({
...
export function _macroDefinitionBrace(config?: T._MacroDefinitionBrace.Config) {
  const _config = config ?? {};
  const children = _configChildren<T._MacroDefinitionBrace['$children']>(_config, [] as unknown as T._MacroDefinitionBrace['$children']);
  return withMethods({
...
export function _macroDefinitionBracket(config?: T._MacroDefinitionBracket.Config) {
  const _config = config ?? {};
  const children = _configChildren<T._MacroDefinitionBracket['$children']>(_config, [] as unknown as T._MacroDefinitionBracket['$children']);
  return withMethods({
...
export function _macroDefinitionParen(config?: T._MacroDefinitionParen.Config) {
  const _config = config ?? {};
  const children = _configChildren<T._MacroDefinitionParen['$children']>(_config, [] as unknown as T._MacroDefinitionParen['$children']);
  return withMethods({
...
export function _visibilityModifierPub(config?: T.VisibilityModifierPub.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.VisibilityModifierPub['$children']>(_config, [] as unknown as T.VisibilityModifierPub['$children']);
...
export function blockComment(config?: T.BlockComment.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.BlockComment['$children']>(_config, [] as unknown as T.BlockComment['$children']);
...
export function breakExpression(config?: T.BreakExpression.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.BreakExpression['$children']>(_config, [] as unknown as T.BreakExpression['$children']);
  const _label = _config.label;
  return withMethods({
...
export function delimTokenTreeUFormParen(config?: Omit<ConfigOf<T.DelimTokenTreeUFormParen>, '$variant'>) {
  const inner = _delimTokenTreeParen(..._configChildren<Parameters<typeof _delimTokenTreeParen>>(config, [] as unknown as Parameters<typeof _delimTokenTreeParen>));
  const children = [inner] as const;
  return withMethods({
...
export function macroDefinitionParen(config?: T.MacroDefinitionParen.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.MacroDefinitionParen['$children']>(_config, [] as unknown as T.MacroDefinitionParen['$children']);
  return withMethods({
    $type: TSKindId._MacroDefinitionParen as const,
    $source: 2 as const,
    $named: true as const,
...
export function macroDefinitionBracket(config?: T.MacroDefinitionBracket.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.MacroDefinitionBracket['$children']>(_config, [] as unknown as T.MacroDefinitionBracket['$children']);
  return withMethods({
    $type: TSKindId._MacroDefinitionBracket as const,
    $source: 2 as const,
    $named: true as const,
...
export function macroDefinitionBrace(config?: T.MacroDefinitionBrace.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.MacroDefinitionBrace['$children']>(_config, [] as unknown as T.MacroDefinitionBrace['$children']);
  return withMethods({
    $type: TSKindId._MacroDefinitionBrace as const,
    $source: 2 as const,
    $named: true as const,
...
export function macroDefinitionUFormParen(config: Omit<ConfigOf<T.MacroDefinitionUFormParen>, '$variant'>) {
  const inner = _macroDefinitionParen(..._configChildren<Parameters<typeof _macroDefinitionParen>>(config, [] as unknown as Parameters<typeof _macroDefinitionParen>));
  const children = [inner] as const;
  const _name = config.name;
  return withMethods({
...
export function matchBlock(config?: T.MatchBlock.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.MatchBlock['$children']>(_config, [] as unknown as T.MatchBlock['$children']);
  return withMethods({
...
export function pointerTypeUFormMut(config: Omit<ConfigOf<T.PointerTypeUFormMut>, '$variant'>) {
  ...
  const inner = _pointerTypeMut(_innerChildren[0] as Parameters<typeof _pointerTypeMut>[0]);
  const children = [inner] as const;
  const _type = config.type;
  return withMethods({
    $type: TSKindId.PointerType as const,
...
export function returnExpression(config?: T.ReturnExpression.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.ReturnExpression['$children']>(_config, [] as unknown as T.ReturnExpression['$children']);
  return withMethods({
...
export function selfParameter(config?: T.SelfParameter.Config) {
  const _config = config ?? {};
  const _reference = coerceBooleanKeywordStorage(_config.reference);
  const _lifetime = _config.lifetime;
  const _mutable_specifier = coerceBooleanKeywordStorage(_config.mutableSpecifier);
  ...
  return withMethods({
    ...
    self() { return _self; },
    $with: {
      reference: (value?: NonNullable<Parameters<typeof selfParameter>[0]>['reference']) => selfParameter({ ..._config, reference: value }),
...
export function tokenTreeUFormParen(config?: Omit<ConfigOf<T.TokenTreeUFormParen>, '$variant'>) {
  const inner = _tokenTreeParen(..._configChildren<Parameters<typeof _tokenTreeParen>>(config, [] as unknown as Parameters<typeof _tokenTreeParen>));
  const children = [inner] as const;
  return withMethods({
...
export function tokenTreePatternUFormParen(config?: Omit<ConfigOf<T.TokenTreePatternUFormParen>, '$variant'>) {
  const inner = _tokenTreePatternParen(..._configChildren<Parameters<typeof _tokenTreePatternParen>>(config, [] as unknown as Parameters<typeof _tokenTreePatternParen>));
  const children = [inner] as const;
  return withMethods({
...
export function visibilityModifierUFormCrate(config?: Omit<ConfigOf<T.VisibilityModifierUFormCrate>, '$variant'>) {
  const _innerChildren = _configChildren<readonly [Parameters<typeof _visibilityModifierCrate>[0]] | []>(config, []);
  const inner = _visibilityModifierCrate(_innerChildren[0] as Parameters<typeof _visibilityModifierCrate>[0]);
  const children = [inner] as const;
  return withMethods({
...
export function yieldExpression(config?: T.YieldExpression.Config) {
  const _config = config ?? {};
  const children = _configChildren<T.YieldExpression['$children']>(_config, [] as unknown as T.YieldExpression['$children']);
  return withMethods({
