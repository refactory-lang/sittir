  ...
  return withMethods(
    {
      ...
      attributedArguments() {
        return _attributed_argument;
      },
      $with: {
        attributes: (...values: T.AttributeItem[]) =>
          _arrayExpressionList({ ...config, attributes: values }),
        attributedArguments: (...values: T.AttributedArgument[]) =>
          _arrayExpressionList({ ...config, attributedArgument: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        attributes: (...values: T.AttributeItem[]) =>
          _arrayExpressionSemi({ ...config, attributes: values }),
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItems: (...values: T.AttributeItem[]) =>
          attributedArgument({ ...config, attributeItem: values }),
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItems: (...values: T.AttributeItem[]) =>
          attributedEnumVariant({ ...config, attributeItem: values }),
        enumVariant: (value: T.EnumVariant) =>
          attributedEnumVariant({ ...config, enumVariant: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItems: (...values: T.AttributeItem[]) =>
          attributedFieldDeclaration({ ...config, attributeItem: values }),
        fieldDeclaration: (value: T.FieldDeclaration) =>
          attributedFieldDeclaration({ ...config, fieldDeclaration: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItems: (...values: T.AttributeItem[]) =>
          _attributedOrderedField({ ...config, attributeItem: values }),
        visibilityModifier: (value?: T.VisibilityModifier) =>
          _attributedOrderedField({ ...config, visibilityModifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItem: (value?: T.AttributeItem) =>
          attributedParameter({ ...config, attributeItem: value }),
        content: (value: T.Parameter | T.SelfParameter | T.VariadicParameter | "_" | T._Type) =>
          attributedParameter({ ...config, content: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItems: (...values: T.AttributeItem[]) =>
          attributedTypeParameter({ ...config, attributeItem: values }),
        content: (
          value: T.Metavariable | T.TypeParameter | T.LifetimeParameter | T.ConstParameter,
        ) => attributedTypeParameter({ ...config, content: value }),
      },
    },
    methodsEngine,
  );
...
export function fieldIdentifier(text: string) {
  ...
  if (
    ...
    !_leafRe_fieldIdentifier.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        trait: (value: T.Identifier | T.ScopedTypeIdentifier) =>
          functionTypeTraitForm({ ...config, trait: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        trait: (value: T.Identifier | T.ScopedTypeIdentifier | T.GenericType) =>
          _implItemNegativeClause({ ...config, trait: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        trait: (value: T.Identifier | T.ScopedTypeIdentifier | T.GenericType) =>
          _implItemPositiveClause({ ...config, trait: value }),
      },
    },
    methodsEngine,
  );
...
export function lineCommentContent(text: string) {
  ...
  if (
    typeof process !== "undefined" &&
    process.env.SITTIR_DEBUG &&
    !_leafRe_lineCommentContent.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        outer: (value?: NonNullable<Parameters<typeof _lineCommentDoc>[0]>["outer"]) =>
          _lineCommentDoc({ ...config, outer: value }),
        inner: (value?: NonNullable<Parameters<typeof _lineCommentDoc>[0]>["inner"]) =>
          _lineCommentDoc({ ...config, inner: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        operator: (value: NonNullable<Parameters<typeof _rangeExpressionBinary>[0]>["operator"]) =>
          _rangeExpressionBinary({ ...config, operator: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        content: (
          value: NonNullable<Parameters<typeof _rangePatternLeftWithRight>[0]>["content"],
        ) => _rangePatternLeftWithRight({ ...config, content: value }),
        right: (value: T.LiteralPattern | T.Path) =>
          _rangePatternLeftWithRight({ ...config, right: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        content: (value: NonNullable<Parameters<typeof _rangePatternPrefix>[0]>["content"]) =>
          _rangePatternPrefix({ ...config, content: value }),
        right: (value: T.LiteralPattern | T.Path) =>
          _rangePatternPrefix({ ...config, right: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        body: (value: T.OrderedFieldDeclarationList) =>
          _structItemTuple({ ...config, body: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        content: (value: T._Type | T.TypeBinding | T.Lifetime | T.Literal | T.Block) =>
          typeArgument({ ...config, content: value }),
...
export function typeIdentifier(text: string) {
  ...
  if (
    typeof process !== "undefined" &&
    process.env.SITTIR_DEBUG &&
    !_leafRe_typeIdentifier.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifierGroup1: (value?: T.VisibilityModifierGroup1) =>
          _visibilityModifierPub({ ...config, visibilityModifierGroup1: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        typeParameters: (value?: T.TypeParameters) =>
          abstractType({ ...config, typeParameters: value }),
        trait: (
          value:
            | T.Identifier
            ...
            | T.TupleType
            | T.BoundedType,
        ) => abstractType({ ...config, trait: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeParameters: (value?: T.TypeParameters) =>
          associatedType({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        moveMarker: (value?: NonNullable<Parameters<typeof asyncBlock>[0]>["moveMarker"]) =>
          asyncBlock({ ...config, moveMarker: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        expression: (value: T.BaseFieldInitializer.Config["expression"]) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        trailingExpression: (value?: T.Expression) =>
          block({ ...config, trailingExpression: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        outer: (value?: NonNullable<Parameters<typeof blockComment>[0]>["outer"]) =>
          blockComment({ ...config, outer: value }),
        inner: (value?: NonNullable<Parameters<typeof blockComment>[0]>["inner"]) =>
          blockComment({ ...config, inner: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        left: (value: T.Lifetime | T._Type | T.UseBounds) =>
          boundedType({ ...config, left: value }),
        right: (value: T.Lifetime | T._Type | T.UseBounds) =>
          boundedType({ ...config, right: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        function: (value: T.ExpressionExceptRange) =>
          callExpression({ ...config, function: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        staticMarker: (
          value?: NonNullable<Parameters<typeof closureExpression>[0]>["staticMarker"],
        ) => closureExpression({ ...config, staticMarker: value }),
        asyncMarker: (
          value?: NonNullable<Parameters<typeof closureExpression>[0]>["asyncMarker"],
        ) => closureExpression({ ...config, asyncMarker: value }),
        moveMarker: (value?: NonNullable<Parameters<typeof closureExpression>[0]>["moveMarker"]) =>
          closureExpression({ ...config, moveMarker: value }),
        parameters: (value: T.ClosureParameters) =>
          closureExpression({ ...config, parameters: value }),
        content: (value: T.ClosureExpressionBlock | T.ClosureExpressionExpr) =>
          closureExpression({ ...config, content: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        parameters: (...values: (T.Pattern | T.Parameter)[]) =>
          closureParameters({ ...config, parameters: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        operator: (value: NonNullable<Parameters<typeof compoundAssignmentExpr>[0]>["operator"]) =>
          compoundAssignmentExpr({ ...config, operator: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          constItem({ ...config, visibilityModifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        value: (value?: T.Block | T.Identifier | T.Literal | T.NegativeLiteral) =>
          constParameter({ ...config, value: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          enumItem({ ...config, visibilityModifier: value }),
        name: (value: T.Identifier) => enumItem({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          enumItem({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      attributedEnumVariants() {
        return _attributed_enum_variant;
      },
  ...
  return withMethods(
    {
      ...
      $with: {
        $child: (v: T.ExpressionStatementWithSemi | T.ExpressionEndingWithBlock) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          externCrateDeclaration({ ...config, visibilityModifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          fieldDeclaration({ ...config, visibilityModifier: value }),
  ...
  return withMethods(
    {
      ...
      attributedFieldDeclarations() {
        return _attributed_field_declaration;
      },
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        field: (value: T.Identifier | T.IntegerLiteral) =>
          fieldExpression({ ...config, field: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        attributeItems: (...values: T.AttributeItem[]) =>
          fieldInitializer({ ...config, attributeItem: values }),
        field: (value: T.Identifier | T.IntegerLiteral) =>
          fieldInitializer({ ...config, field: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        initializers: (
          ...values: (T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer)[]
        ) => fieldInitializerList({ ...config, initializers: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          foreignModItem({ ...config, visibilityModifier: value }),
        externModifier: (value: T.ExternModifier) =>
          foreignModItem({ ...config, externModifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          functionItem({ ...config, visibilityModifier: value }),
        functionModifiers: (value?: T.FunctionModifiers) =>
          functionItem({ ...config, functionModifiers: value }),
        name: (value: T.Identifier | T.Metavariable) => functionItem({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          functionItem({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        ) => functionModifiers({ ...config, modifier: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          functionSignatureItem({ ...config, visibilityModifier: value }),
        functionModifiers: (value?: T.FunctionModifiers) =>
          functionSignatureItem({ ...config, functionModifiers: value }),
        name: (value: T.Identifier | T.Metavariable) =>
          functionSignatureItem({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          functionSignatureItem({ ...config, typeParameters: value }),
        parameters: (value: T.Parameters) =>
          functionSignatureItem({ ...config, parameters: value }),
        returnType: (value?: T._Type) => functionSignatureItem({ ...config, returnType: value }),
        whereClause: (value?: T.WhereClause) =>
          functionSignatureItem({ ...config, whereClause: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        functionTypeFnForm: (value?: T.FunctionTypeFnForm) =>
          functionType({ ...config, functionTypeFnForm: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        moveMarker: (value?: NonNullable<Parameters<typeof genBlock>[0]>["moveMarker"]) =>
          genBlock({ ...config, moveMarker: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        function: (value: T.Identifier | T.ScopedIdentifier | T.FieldExpression) =>
          genericFunction({ ...config, function: value }),
        typeArguments: (value: T.TypeArguments) =>
          genericFunction({ ...config, typeArguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        content: (value: T.Identifier | T.ScopedIdentifier) =>
          genericPattern({ ...config, content: value }),
        typeArguments: (value: T.TypeArguments) =>
          genericPattern({ ...config, typeArguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        type: (value: T.Identifier | T.ScopedTypeIdentifier) =>
          genericType({ ...config, type: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        type: (value: T.Identifier | T.ScopedIdentifier) =>
          genericTypeWithTurbofish({ ...config, type: value }),
        typeArguments: (value: T.TypeArguments) =>
          genericTypeWithTurbofish({ ...config, typeArguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        typeParameters: (value: T.TypeParameters) =>
          higherRankedTraitBound({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        unsafeMarker: (value?: NonNullable<Parameters<typeof implItem>[0]>["unsafeMarker"]) =>
          implItem({ ...config, unsafeMarker: value }),
        typeParameters: (value?: T.TypeParameters) =>
          implItem({ ...config, typeParameters: value }),
        traitClause: (value?: T.ImplItemPositiveClause | T.ImplItemNegativeClause) =>
          implItem({ ...config, traitClause: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        attributes: (...values: (T.AttributeItem | T.InnerAttributeItem)[]) =>
          lastMatchArm({ ...config, attributes: values }),
  ...
  return withMethods(
    {
      ...
      $with: {
        mutableSpecifier: (
          value?: NonNullable<Parameters<typeof letDeclaration>[0]>["mutableSpecifier"],
        ) => letDeclaration({ ...config, mutableSpecifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        $child: (v: T.LineCommentRegularDslash | T.LineCommentDoc | T.LineCommentContent) =>
          lineComment(v),
      },
    },
    methodsEngine,
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        ) => macroDefinition({ ...config, content: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        macro: (value: T.ScopedIdentifier | T.Identifier) =>
          macroInvocation({ ...config, macro: value }),
...
export function metavariable(text: string) {
  ...
  if (
    typeof process !== "undefined" &&
    process.env.SITTIR_DEBUG &&
    !_leafRe_metavariable.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          modItem({ ...config, visibilityModifier: value }),
...
export function orderedFieldDeclarationList(
  config: Partial<T.OrderedFieldDeclarationList.Config> = {},
) {
  const _attributes = config.attributes;
  return withMethods(
    {
      ...
      $with: {
        attributes: (...values: T.AttributedOrderedField[]) =>
          orderedFieldDeclarationList({ ...config, attributes: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        mutableSpecifier: (
          value?: NonNullable<Parameters<typeof parameter>[0]>["mutableSpecifier"],
        ) => parameter({ ...config, mutableSpecifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        expression: (value: T.ParenthesizedExpression.Config["expression"]) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        content: (value: "const" | T.MutableSpecifier) =>
          pointerType({ ...config, content: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        content: (value?: T.RangePatternLeftWithRight | "..") =>
          rangePattern({ ...config, content: value }),
        rangePatternPrefix: (value?: T.RangePatternPrefix) =>
          rangePattern({ ...config, rangePatternPrefix: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        stringContent: (value: T.RawStringLiteral.Config["stringContent"]) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        ) => referenceExpression({ ...config, content: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        mutableSpecifier: (
          value?: NonNullable<Parameters<typeof referencePattern>[0]>["mutableSpecifier"],
        ) => referencePattern({ ...config, mutableSpecifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        mutableSpecifier: (
          value?: NonNullable<Parameters<typeof referenceType>[0]>["mutableSpecifier"],
        ) => referenceType({ ...config, mutableSpecifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        path: (value?: T.Path | T.BracketedType | T.GenericTypeWithTurbofish) =>
          scopedIdentifier({ ...config, path: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        path: (value?: T.Path | T.GenericTypeWithTurbofish | T.BracketedType | T.GenericType) =>
          scopedTypeIdentifier({ ...config, path: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        path: (value?: T.Path | T.GenericTypeWithTurbofish) =>
          scopedTypeIdentifierInExpressionPosition({ ...config, path: value }),
        name: (value: T.Identifier) =>
          scopedTypeIdentifierInExpressionPosition({ ...config, name: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        reference: (value?: NonNullable<Parameters<typeof selfParameter>[0]>["reference"]) =>
          selfParameter({ ...config, reference: value }),
        lifetime: (value?: T.Lifetime) => selfParameter({ ...config, lifetime: value }),
        mutableSpecifier: (
          value?: NonNullable<Parameters<typeof selfParameter>[0]>["mutableSpecifier"],
        ) => selfParameter({ ...config, mutableSpecifier: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        attributes: (...values: T.AttributeItem[]) =>
          shorthandFieldInitializer({ ...config, attributes: values }),
        identifier: (value: T.Identifier) =>
          shorthandFieldInitializer({ ...config, identifier: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          staticItem({ ...config, visibilityModifier: value }),
        mutableSpecifier: (value?: "ref" | T.MutableSpecifier) =>
          staticItem({ ...config, mutableSpecifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        ) => structExpression({ ...config, name: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          structItem({ ...config, visibilityModifier: value }),
        name: (value: T.Identifier) => structItem({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          structItem({ ...config, typeParameters: value }),
        content: (value: T.StructItemBrace | T.StructItemTuple | ";") =>
          structItem({ ...config, content: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        type: (value: T.Identifier | T.ScopedTypeIdentifier) =>
          structPattern({ ...config, type: value }),
        fields: (...values: (T.FieldPattern | T.RemainingFieldPattern)[]) =>
          structPattern({ ...config, fields: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        type: (value: NonNullable<Parameters<typeof tokenBindingPattern>[0]>["type"]) =>
          tokenBindingPattern({ ...config, type: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        separator: (value?: NonNullable<Parameters<typeof tokenRepetition>[0]>["separator"]) =>
          tokenRepetition({ ...config, separator: value }),
        operator: (value: NonNullable<Parameters<typeof tokenRepetition>[0]>["operator"]) =>
          tokenRepetition({ ...config, operator: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        tokenPatterns: (...values: T.TokenPattern[]) =>
          tokenRepetitionPattern({ ...config, tokenPattern: values }),
        separator: (
          value?: NonNullable<Parameters<typeof tokenRepetitionPattern>[0]>["separator"],
        ) => tokenRepetitionPattern({ ...config, separator: value }),
        operator: (value: NonNullable<Parameters<typeof tokenRepetitionPattern>[0]>["operator"]) =>
          tokenRepetitionPattern({ ...config, operator: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        $child: (
          v: T.TokenTreePatternParen | T.TokenTreePatternBracket | T.TokenTreePatternBrace,
        ) => tokenTreePattern(v),
      },
    },
    methodsEngine,
  ...
  return withMethods(
    {
      ...
      $with: {
        bounds: (...values: NonEmptyArray<T._Type | T.Lifetime | T.HigherRankedTraitBound>) =>
          traitBounds({ ...config, bounds: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          traitItem({ ...config, visibilityModifier: value }),
        unsafeMarker: (value?: NonNullable<Parameters<typeof traitItem>[0]>["unsafeMarker"]) =>
          traitItem({ ...config, unsafeMarker: value }),
        name: (value: T.Identifier) => traitItem({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          traitItem({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        attributes: (...values: T.AttributeItem[]) =>
          tupleExpression({ ...config, attributes: values }),
  ...
  return withMethods(
    {
      ...
      $with: {
        elements: (...values: (T.Pattern | T.ClosureExpression)[]) =>
          tuplePattern({ ...config, elements: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        type: (value: T.Identifier | T.ScopedIdentifier | T.GenericTypeWithTurbofish) =>
          tupleStructPattern({ ...config, type: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeArguments: (value?: T.TypeArguments) =>
          typeBinding({ ...config, typeArguments: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          unionItem({ ...config, visibilityModifier: value }),
        name: (value: T.Identifier) => unionItem({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          unionItem({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        bounds: (...values: (T.Lifetime | T.Identifier)[]) =>
          useBounds({ ...config, bounds: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        visibilityModifier: (value?: T.VisibilityModifier) =>
          useDeclaration({ ...config, visibilityModifier: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        mutableSpecifier: (
          value?: NonNullable<Parameters<typeof variadicParameter>[0]>["mutableSpecifier"],
        ) => variadicParameter({ ...config, mutableSpecifier: value }),
      ...
      $with: {
        left: (
          value:
            ...
            | T.PrimitiveType,
        ) => wherePredicate({ ...config, left: value }),
...
export type FluentKindMap = {
  ...
  _attributed_field_declaration: FluentNode<
    "_attributed_field_declaration",
  ...
  _attributed_type_parameter: FluentNode<
    "_attributed_type_parameter",
  ...
  _visibility_modifier_group1: FluentNode<
    "_visibility_modifier_group1",
    T._VisibilityModifierGroup1.Config
  >;
  ...
  visibility_modifier_group1: FluentNode<
    "visibility_modifier_group1",
    T.VisibilityModifierGroup1.Config
  >;
