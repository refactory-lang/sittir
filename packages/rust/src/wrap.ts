...
export function wrap_ArgumentsGroup1(data: T._ArgumentsGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_argument]), true, "attributed_argument", { tree, nodeType: data.$type, slotName: "attributed_argument", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    attributed_argument() { return drillInAll<T.AttributedArgument>(this._attributed_argument as readonly T.AttributedArgument[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrapArrayExpressionList(data: T.ArrayExpressionList, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _arguments_group1: normalizeSingularWrapSlot(data._arguments_group1, "arguments_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "arguments_group1", span: (data as _NodeData).$span }),

    attributes() { return drillInAll<T.AttributeItem>(this._attributes as readonly T.AttributeItem[] | undefined, tree); },
    argumentsGroup1() { return drillIn<T.ArgumentsGroup1 | undefined>(this._arguments_group1, tree); },
    $with: {
      attributes: (...v: NonNullable<T.ArrayExpressionList['_attributes']>[number][]) => wrapArrayExpressionList({ ...data, _attributes: v }, tree),
      argumentsGroup1: (v: NonNullable<T.ArrayExpressionList['_arguments_group1']>) => wrapArrayExpressionList({ ...data, _arguments_group1: v }, tree),
    },
  }, methodsEngine);
  return _node;
}
...
export function wrap_EnumVariantListGroup1(data: T._EnumVariantListGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_enum_variant]), true, "attributed_enum_variant", { tree, nodeType: data.$type, slotName: "attributed_enum_variant", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    attributed_enum_variant() { return drillInAll<T.AttributedEnumVariant>(this._attributed_enum_variant as readonly T.AttributedEnumVariant[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrap_FieldDeclarationListGroup1(data: T._FieldDeclarationListGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_field_declaration]), true, "attributed_field_declaration", { tree, nodeType: data.$type, slotName: "attributed_field_declaration", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    attributed_field_declaration() { return drillInAll<T.AttributedFieldDeclaration>(this._attributed_field_declaration as readonly T.AttributedFieldDeclaration[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}

export function wrap_FieldInitializerListGroup1(data: T._FieldInitializerListGroup1 & { readonly "_shorthand_field_initializer"?: T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer; readonly "_field_initializer"?: T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer; readonly "_base_field_initializer"?: T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._shorthand_field_initializer, data._field_initializer, data._base_field_initializer, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    content() { return drillInAll<T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer>(this._content as readonly (T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer)[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrap_OrderedFieldDeclarationListGroup1(data: T._OrderedFieldDeclarationListGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_ordered_field]), true, "attributed_ordered_field", { tree, nodeType: data.$type, slotName: "attributed_ordered_field", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    attributed_ordered_field() { return drillInAll<T.AttributedOrderedField>(this._attributed_ordered_field as readonly T.AttributedOrderedField[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}

export function wrap_ParametersGroup1(data: T._ParametersGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_parameter]), true, "attributed_parameter", { tree, nodeType: data.$type, slotName: "attributed_parameter", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    attributed_parameter() { return drillInAll<T.AttributedParameter>(this._attributed_parameter as readonly T.AttributedParameter[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrapRangeExpressionBinary(data: T.RangeExpressionBinary, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _operator: projectKindEnumStorage(normalizeSingularWrapSlot((data._operator ?? readTerminalFromOther(data, [TSKindId.DotDot, TSKindId.DotDotDot, TSKindId.DotDotEq])), "operator", true, data.$type, { tree, nodeType: data.$type, slotName: "operator", span: (data as _NodeData).$span })),
...
export function wrapRangeExpressionPostfix(data: T.RangeExpressionPostfix, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _start: normalizeSingularWrapSlot(data._start, "start", true, data.$type, { tree, nodeType: data.$type, slotName: "start", span: (data as _NodeData).$span }),
    _operator: projectKindEnumStorage(normalizeSingularWrapSlot((data._operator ?? readTerminalFromOther(data, [TSKindId.DotDot])), "operator", true, data.$type, { tree, nodeType: data.$type, slotName: "operator", span: (data as _NodeData).$span })),
...
export function wrapRangePatternLeftWithRight(data: T.RangePatternLeftWithRight, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: projectKindEnumStorage(normalizeSingularWrapSlot(((data._dot_dot_dot ?? data._dot_dot_eq ?? data._dot_dot ?? data._content) ?? readTerminalFromOther(data, [TSKindId.DotDotDot, TSKindId.DotDotEq, TSKindId.DotDot])), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span })),
    _right: normalizeSingularWrapSlot(data._right, "right", true, data.$type, { tree, nodeType: data.$type, slotName: "right", span: (data as _NodeData).$span }),
...
export function wrapRangePatternPrefix(data: T.RangePatternPrefix, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: projectKindEnumStorage(normalizeSingularWrapSlot(((data._dot_dot_eq ?? data._dot_dot ?? data._content) ?? readTerminalFromOther(data, [TSKindId.DotDotEq, TSKindId.DotDot])), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span })),
    _right: normalizeSingularWrapSlot(data._right, "right", true, data.$type, { tree, nodeType: data.$type, slotName: "right", span: (data as _NodeData).$span }),
...
export function wrap_SlicePatternGroup1(data: T._SlicePatternGroup1 & { readonly "_string_literal"?: T.Pattern; readonly "_raw_string_literal"?: T.Pattern; readonly "_char_literal"?: T.Pattern; readonly "_boolean_literal"?: T.Pattern; readonly "_integer_literal"?: T.Pattern; readonly "_float_literal"?: T.Pattern; readonly "_negative_literal"?: T.Pattern; readonly "_identifier"?: T.Pattern; readonly "_scoped_identifier"?: T.Pattern; readonly "_generic_pattern"?: T.Pattern; readonly "_tuple_pattern"?: T.Pattern; readonly "_tuple_struct_pattern"?: T.Pattern; readonly "_struct_pattern"?: T.Pattern; readonly "_reserved_identifier"?: T.Pattern; readonly "_ref_pattern"?: T.Pattern; readonly "_slice_pattern"?: T.Pattern; readonly "_captured_pattern"?: T.Pattern; readonly "_reference_pattern"?: T.Pattern; readonly "_remaining_field_pattern"?: T.Pattern; readonly "_mut_pattern"?: T.Pattern; readonly "_range_pattern"?: T.Pattern; readonly "_or_pattern"?: T.Pattern; readonly "_const_block"?: T.Pattern; readonly "_macro_invocation"?: T.Pattern; readonly "_wildcard_pattern"?: T.Pattern; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._string_literal, data._raw_string_literal, data._char_literal, data._boolean_literal, data._integer_literal, data._float_literal, data._negative_literal, data._identifier, data._scoped_identifier, data._generic_pattern, data._tuple_pattern, data._tuple_struct_pattern, data._struct_pattern, data._reserved_identifier, data._ref_pattern, data._slice_pattern, data._captured_pattern, data._reference_pattern, data._remaining_field_pattern, data._mut_pattern, data._range_pattern, data._or_pattern, data._const_block, data._macro_invocation, data._wildcard_pattern, data._pattern]), true, "pattern", { tree, nodeType: data.$type, slotName: "pattern", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
...
export function wrap_StructPatternGroup1(data: T._StructPatternGroup1 & { readonly "_field_pattern"?: T.FieldPattern | T.RemainingFieldPattern; readonly "_remaining_field_pattern"?: T.FieldPattern | T.RemainingFieldPattern; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._field_pattern, data._remaining_field_pattern, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    content() { return drillInAll<T.FieldPattern | T.RemainingFieldPattern>(this._content as readonly (T.FieldPattern | T.RemainingFieldPattern)[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrap_TuplePatternGroup1(data: T._TuplePatternGroup1 & { readonly "_string_literal"?: T.Pattern | T.ClosureExpression; readonly "_raw_string_literal"?: T.Pattern | T.ClosureExpression; readonly "_char_literal"?: T.Pattern | T.ClosureExpression; readonly "_boolean_literal"?: T.Pattern | T.ClosureExpression; readonly "_integer_literal"?: T.Pattern | T.ClosureExpression; readonly "_float_literal"?: T.Pattern | T.ClosureExpression; readonly "_negative_literal"?: T.Pattern | T.ClosureExpression; readonly "_identifier"?: T.Pattern | T.ClosureExpression; readonly "_scoped_identifier"?: T.Pattern | T.ClosureExpression; readonly "_generic_pattern"?: T.Pattern | T.ClosureExpression; readonly "_tuple_pattern"?: T.Pattern | T.ClosureExpression; readonly "_tuple_struct_pattern"?: T.Pattern | T.ClosureExpression; readonly "_struct_pattern"?: T.Pattern | T.ClosureExpression; readonly "_reserved_identifier"?: T.Pattern | T.ClosureExpression; readonly "_ref_pattern"?: T.Pattern | T.ClosureExpression; readonly "_slice_pattern"?: T.Pattern | T.ClosureExpression; readonly "_captured_pattern"?: T.Pattern | T.ClosureExpression; readonly "_reference_pattern"?: T.Pattern | T.ClosureExpression; readonly "_remaining_field_pattern"?: T.Pattern | T.ClosureExpression; readonly "_mut_pattern"?: T.Pattern | T.ClosureExpression; readonly "_range_pattern"?: T.Pattern | T.ClosureExpression; readonly "_or_pattern"?: T.Pattern | T.ClosureExpression; readonly "_const_block"?: T.Pattern | T.ClosureExpression; readonly "_macro_invocation"?: T.Pattern | T.ClosureExpression; readonly "_wildcard_pattern"?: T.Pattern | T.ClosureExpression; readonly "_closure_expression"?: T.Pattern | T.ClosureExpression; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._string_literal, data._raw_string_literal, data._char_literal, data._boolean_literal, data._integer_literal, data._float_literal, data._negative_literal, data._identifier, data._scoped_identifier, data._generic_pattern, data._tuple_pattern, data._tuple_struct_pattern, data._struct_pattern, data._reserved_identifier, data._ref_pattern, data._slice_pattern, data._captured_pattern, data._reference_pattern, data._remaining_field_pattern, data._mut_pattern, data._range_pattern, data._or_pattern, data._const_block, data._macro_invocation, data._wildcard_pattern, data._closure_expression, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    content() { return drillInAll<T.Pattern | T.ClosureExpression>(this._content as readonly (T.Pattern | T.ClosureExpression)[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrap_UseBoundsGroup1(data: T._UseBoundsGroup1 & { readonly "_lifetime"?: T.Lifetime | T.TypeIdentifier; readonly "_type_identifier"?: T.Lifetime | T.TypeIdentifier; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._lifetime, data._type_identifier, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    content() { return drillInAll<T.Lifetime | T.TypeIdentifier>(this._content as readonly (T.Lifetime | T.TypeIdentifier)[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrap_UseListGroup1(data: T._UseListGroup1 & { readonly "_self"?: T.UseClause; readonly "_identifier"?: T.UseClause; readonly "_metavariable"?: T.UseClause; readonly "_super"?: T.UseClause; readonly "_crate"?: T.UseClause; readonly "_scoped_identifier"?: T.UseClause; readonly "_reserved_identifier"?: T.UseClause; readonly "_use_as_clause"?: T.UseClause; readonly "_use_list"?: T.UseClause; readonly "_scoped_use_list"?: T.UseClause; readonly "_use_wildcard"?: T.UseClause; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._self, data._identifier, data._metavariable, data._super, data._crate, data._scoped_identifier, data._reserved_identifier, data._use_as_clause, data._use_list, data._scoped_use_list, data._use_wildcard, data._use_clause]), true, "use_clause", { tree, nodeType: data.$type, slotName: "use_clause", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    use_clause() { return drillInAll<T.UseClause>(this._use_clause as readonly T.UseClause[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrapVisibilityModifierInPath(data: T.VisibilityModifierInPath, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _in: projectKindEnumStorage(normalizeSingularWrapSlot((data._in ?? readTerminalFromOther(data, [TSKindId.In])), "in", true, data.$type, { tree, nodeType: data.$type, slotName: "in", span: (data as _NodeData).$span })),
...
export function wrapVisibilityModifierPub(data: T.VisibilityModifierPub, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _pub: projectKindEnumStorage(normalizeSingularWrapSlot((data._pub ?? readTerminalFromOther(data, [TSKindId.Pub])), "pub", true, data.$type, { tree, nodeType: data.$type, slotName: "pub", span: (data as _NodeData).$span })),
...
export function wrap_WhereClauseGroup1(data: T._WhereClauseGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._where_predicate]), true, "where_predicate", { tree, nodeType: data.$type, slotName: "where_predicate", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    ...
    where_predicate() { return drillInAll<T.WherePredicate>(this._where_predicate as readonly T.WherePredicate[] | undefined, tree); },
    $with: {},
  }, methodsEngine);
}
...
export function wrapBinaryExpression(data: T.BinaryExpression, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _left: normalizeSingularWrapSlot(data._left, "left", true, data.$type, { tree, nodeType: data.$type, slotName: "left", span: (data as _NodeData).$span }),
    _operator: projectKindEnumStorage(normalizeSingularWrapSlot((data._operator ?? readTerminalFromOther(data, [TSKindId.AmpAmp, TSKindId.PipePipe, TSKindId.Amp2, TSKindId.Pipe2, TSKindId.Caret, TSKindId.EqEq, TSKindId.BangEq, TSKindId.Lt, TSKindId.LtEq, TSKindId.Gt, TSKindId.GtEq, TSKindId.LtLt, TSKindId.GtGt, TSKindId.Plus, TSKindId.Dash, TSKindId.Star, TSKindId.Slash, TSKindId.Percent])), "operator", true, data.$type, { tree, nodeType: data.$type, slotName: "operator", span: (data as _NodeData).$span })),
    _right: normalizeSingularWrapSlot(data._right, "right", true, data.$type, { tree, nodeType: data.$type, slotName: "right", span: (data as _NodeData).$span }),
...
export function wrapCompoundAssignmentExpr(data: T.CompoundAssignmentExpr, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _left: normalizeSingularWrapSlot(data._left, "left", true, data.$type, { tree, nodeType: data.$type, slotName: "left", span: (data as _NodeData).$span }),
    _operator: projectKindEnumStorage(normalizeSingularWrapSlot((data._operator ?? readTerminalFromOther(data, [TSKindId.PlusEq, TSKindId.DashEq, TSKindId.StarEq, TSKindId.SlashEq, TSKindId.PercentEq, TSKindId.AmpEq, TSKindId.PipeEq, TSKindId.CaretEq, TSKindId.LtLtEq, TSKindId.GtGtEq])), "operator", true, data.$type, { tree, nodeType: data.$type, slotName: "operator", span: (data as _NodeData).$span })),
    _right: normalizeSingularWrapSlot(data._right, "right", true, data.$type, { tree, nodeType: data.$type, slotName: "right", span: (data as _NodeData).$span }),
...
export function wrapEnumVariantList(data: T.EnumVariantList, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _enum_variant_list_group1: normalizeSingularWrapSlot(data._enum_variant_list_group1, "enum_variant_list_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "enum_variant_list_group1", span: (data as _NodeData).$span }),

    enumVariantListGroup1() { return drillIn<T.EnumVariantListGroup1 | undefined>(this._enum_variant_list_group1, tree); },
...
export function wrapExpressionStatement(data: T.ExpressionStatement, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: normalizeSingularWrapSlot((data._expression_statement_with_semi ?? data._unsafe_block ?? data._async_block ?? data._gen_block ?? data._try_block ?? data._block ?? data._if_expression ?? data._match_expression ?? data._while_expression ?? data._loop_expression ?? data._for_expression ?? data._const_block ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    content() { return drillAs<T.ExpressionStatementWithSemi | T.ExpressionEndingWithBlock>(this._content, tree, "expression_statement_with_semi", "_expression_statement_with_semi"); },
...
export function wrapExternCrateDeclaration(data: T.ExternCrateDeclaration, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _visibility_modifier: normalizeSingularWrapSlot(data._visibility_modifier, "visibility_modifier", false, data.$type, { tree, nodeType: data.$type, slotName: "visibility_modifier", span: (data as _NodeData).$span }),
    _crate: projectKindEnumStorage(normalizeSingularWrapSlot((data._crate ?? readTerminalFromOther(data, [TSKindId.Crate])), "crate", true, data.$type, { tree, nodeType: data.$type, slotName: "crate", span: (data as _NodeData).$span })),
    _name: normalizeSingularWrapSlot(data._name, "name", true, data.$type, { tree, nodeType: data.$type, slotName: "name", span: (data as _NodeData).$span }),
...
export function wrapFieldDeclarationList(data: T.FieldDeclarationList, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _field_declaration_list_group1: normalizeSingularWrapSlot(data._field_declaration_list_group1, "field_declaration_list_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "field_declaration_list_group1", span: (data as _NodeData).$span }),

    fieldDeclarationListGroup1() { return drillIn<T.FieldDeclarationListGroup1 | undefined>(this._field_declaration_list_group1, tree); },
...
export function wrapFieldInitializerList(data: T.FieldInitializerList, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _initializers: normalizeSingularWrapSlot(data._initializers, "initializers", false, data.$type, { tree, nodeType: data.$type, slotName: "initializers", span: (data as _NodeData).$span }),

    initializers() { return drillIn<T.FieldInitializerListGroup1 | undefined>(this._initializers, tree); },
    $with: {
      initializers: (v: NonNullable<T.FieldInitializerList['_initializers']>) => wrapFieldInitializerList({ ...data, _initializers: v }, tree),
    },
  }, methodsEngine);
  return _node;
}
...
export function wrapFieldPattern(data: T.FieldPattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: normalizeSingularWrapSlot((data._shorthand_field_identifier ?? data._field_pattern_named ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    refMarker() { return this._ref_marker; },
    mutableSpecifier() { return this._mutable_specifier; },
    content() { return drillIn<T.Identifier | T.FieldPatternNamed>(this._content, tree); },
...
export function wrapForeignModItem(data: T.ForeignModItem, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: normalizeSingularWrapSlot((data._foreign_mod_item_semi ?? data._declaration_list ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    visibilityModifier() { return drillIn<T.VisibilityModifier | undefined>(this._visibility_modifier, tree); },
    externModifier() { return drillIn<T.ExternModifier>(this._extern_modifier, tree); },
    content() { return drillAs<";" | T.DeclarationList>(this._content, tree, "foreign_mod_item_semi", "_foreign_mod_item_semi"); },
    $with: {
...
export function wrapGenericTypeWithTurbofish(data: T.GenericTypeWithTurbofish, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _type: normalizeSingularWrapSlot(data._type, "type", true, data.$type, { tree, nodeType: data.$type, slotName: "type", span: (data as _NodeData).$span }),
    _turbofish: projectKindEnumStorage(normalizeSingularWrapSlot((data._turbofish ?? readTerminalFromOther(data, [TSKindId.ColonColon])), "turbofish", true, data.$type, { tree, nodeType: data.$type, slotName: "turbofish", span: (data as _NodeData).$span })),
    _type_arguments: normalizeSingularWrapSlot(data._type_arguments, "type_arguments", true, data.$type, { tree, nodeType: data.$type, slotName: "type_arguments", span: (data as _NodeData).$span }),
...
export function wrapMatchArm(data: T.MatchArm, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _attributes: normalizeRepeatedWrapSlot(data._attributes, false, "attributes", { tree, nodeType: data.$type, slotName: "attributes", span: (data as _NodeData).$span }),
    _pattern: normalizeSingularWrapSlot(data._pattern, "pattern", true, data.$type, { tree, nodeType: data.$type, slotName: "pattern", span: (data as _NodeData).$span }),
    _content: normalizeSingularWrapSlot((data._match_arm_with_comma ?? data._unsafe_block ?? data._async_block ?? data._gen_block ?? data._try_block ?? data._block ?? data._if_expression ?? data._match_expression ?? data._while_expression ?? data._loop_expression ?? data._for_expression ?? data._const_block ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    attributes() { return drillInAll<T.AttributeItem | T.InnerAttributeItem>(this._attributes as readonly (T.AttributeItem | T.InnerAttributeItem)[] | undefined, tree); },
    pattern() { return drillIn<T.MatchPattern>(this._pattern, tree); },
    content() { return drillAs<T.MatchArmWithComma | T.ExpressionEndingWithBlock>(this._content, tree, "match_arm_with_comma", "_match_arm_with_comma"); },
    $with: {
...
export function wrapModItem(data: T.ModItem, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _visibility_modifier: normalizeSingularWrapSlot(data._visibility_modifier, "visibility_modifier", false, data.$type, { tree, nodeType: data.$type, slotName: "visibility_modifier", span: (data as _NodeData).$span }),
    _name: normalizeSingularWrapSlot(data._name, "name", true, data.$type, { tree, nodeType: data.$type, slotName: "name", span: (data as _NodeData).$span }),
    _content: normalizeSingularWrapSlot((data._mod_item_external ?? data._declaration_list ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    visibilityModifier() { return drillIn<T.VisibilityModifier | undefined>(this._visibility_modifier, tree); },
    name() { return drillIn<T.Identifier>(this._name, tree); },
    content() { return drillAs<";" | T.DeclarationList>(this._content, tree, "mod_item_external", "_mod_item_external"); },
    $with: {
...
export function wrapOrderedFieldDeclarationList(data: T.OrderedFieldDeclarationList, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _attributes: normalizeSingularWrapSlot(data._attributes, "attributes", false, data.$type, { tree, nodeType: data.$type, slotName: "attributes", span: (data as _NodeData).$span }),

    attributes() { return drillIn<T.OrderedFieldDeclarationListGroup1 | undefined>(this._attributes, tree); },
    $with: {
      attributes: (v: NonNullable<T.OrderedFieldDeclarationList['_attributes']>) => wrapOrderedFieldDeclarationList({ ...data, _attributes: v }, tree),
    },
  }, methodsEngine);
  return _node;
}
...
export function wrapParameters(data: T.Parameters, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _parameters_group1: normalizeSingularWrapSlot(data._parameters_group1, "parameters_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "parameters_group1", span: (data as _NodeData).$span }),

    parametersGroup1() { return drillIn<T.ParametersGroup1 | undefined>(this._parameters_group1, tree); },
...
export function wrapPointerType(data: T.PointerType, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: normalizeSingularWrapSlot((data._pointer_type_const ?? data._mutable_specifier ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),
    _type: normalizeSingularWrapSlot(data._type, "type", true, data.$type, { tree, nodeType: data.$type, slotName: "type", span: (data as _NodeData).$span }),

    content() { return drillAs<"const" | T.MutableSpecifier>(this._content, tree, "pointer_type_const", "_pointer_type_const"); },
    type() { return drillIn<T._Type>(this._type, tree); },
    $with: {
...
export function wrapRangeExpression(data: T.RangeExpression, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: normalizeSingularWrapSlot((data._range_expression_binary ?? data._range_expression_postfix ?? data._range_expression_prefix ?? data._dot_dot ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    content() { return drillIn<T.RangeExpressionBinary | T.RangeExpressionPostfix | T.RangeExpressionPrefix | "..">(this._content, tree); },
...
export function wrapSelfParameter(data: T.SelfParameter, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _lifetime: normalizeSingularWrapSlot(data._lifetime, "lifetime", false, data.$type, { tree, nodeType: data.$type, slotName: "lifetime", span: (data as _NodeData).$span }),
    _mutable_specifier: coerceBooleanKeywordStorage(normalizeSingularWrapSlot(data._mutable_specifier, "mutable_specifier", false, data.$type, { tree, nodeType: data.$type, slotName: "mutable_specifier", span: (data as _NodeData).$span })),
    _self: projectKindEnumStorage(normalizeSingularWrapSlot((data._self ?? readTerminalFromOther(data, [TSKindId.Self])), "self", true, data.$type, { tree, nodeType: data.$type, slotName: "self", span: (data as _NodeData).$span })),
...
export function wrapSlicePattern(data: T.SlicePattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _slice_pattern_group1: normalizeSingularWrapSlot(data._slice_pattern_group1, "slice_pattern_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "slice_pattern_group1", span: (data as _NodeData).$span }),

    slicePatternGroup1() { return drillIn<T.SlicePatternGroup1 | undefined>(this._slice_pattern_group1, tree); },
...
export function wrapStructPattern(data: T.StructPattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _type: normalizeSingularWrapSlot(data._type, "type", true, data.$type, { tree, nodeType: data.$type, slotName: "type", span: (data as _NodeData).$span }),
    _fields: normalizeSingularWrapSlot(data._fields, "fields", false, data.$type, { tree, nodeType: data.$type, slotName: "fields", span: (data as _NodeData).$span }),

    type() { return drillAs<T.Identifier | T.ScopedTypeIdentifier>(this._type, tree, "type_identifier", "identifier"); },
    fields() { return drillIn<T.StructPatternGroup1 | undefined>(this._fields, tree); },
    $with: {
...
export function wrapTokenBindingPattern(data: T.TokenBindingPattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _name: normalizeSingularWrapSlot(data._name, "name", true, data.$type, { tree, nodeType: data.$type, slotName: "name", span: (data as _NodeData).$span }),
    _type: projectKindEnumStorage(normalizeSingularWrapSlot((data._type ?? readTerminalFromOther(data, [TSKindId.Block, TSKindId.Expr, TSKindId.Expr2021, TSKindId.Ident, TSKindId.Item, TSKindId.Lifetime, TSKindId.Literal, TSKindId.Meta, TSKindId.Pat, TSKindId.PatParam, TSKindId.Path, TSKindId.Stmt, TSKindId.Tt, TSKindId.Ty, TSKindId.Vis])), "type", true, data.$type, { tree, nodeType: data.$type, slotName: "type", span: (data as _NodeData).$span })),
...
export function wrapTokenRepetition(data: T.TokenRepetition, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _operator: projectKindEnumStorage(normalizeSingularWrapSlot((data._operator ?? readTerminalFromOther(data, [TSKindId.Plus, TSKindId.Star, TSKindId.Qmark])), "operator", true, data.$type, { tree, nodeType: data.$type, slotName: "operator", span: (data as _NodeData).$span })),
...
export function wrapTuplePattern(data: T.TuplePattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _elements: normalizeSingularWrapSlot(data._elements, "elements", false, data.$type, { tree, nodeType: data.$type, slotName: "elements", span: (data as _NodeData).$span }),

    elements() { return drillIn<T.TuplePatternGroup1 | undefined>(this._elements, tree); },
    $with: {
...
export function wrapTupleStructPattern(data: T.TupleStructPattern, tree: TreeHandle) {
  const _node = withMethods({
    ...
    $with: {
      ...
      slicePatternGroup1: (v: NonNullable<T.TupleStructPattern['_slice_pattern_group1']>) => wrapTupleStructPattern({ ...data, _slice_pattern_group1: v }, tree),
    },
  }, methodsEngine);
  return _node;
}
...
export function wrapUnaryExpression(data: T.UnaryExpression, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _operator: projectKindEnumStorage(normalizeSingularWrapSlot((data._operator ?? readTerminalFromOther(data, [TSKindId.Dash, TSKindId.Star, TSKindId.Bang])), "operator", true, data.$type, { tree, nodeType: data.$type, slotName: "operator", span: (data as _NodeData).$span })),
...
export function wrapUseBounds(data: T.UseBounds, tree: TreeHandle) {
  const _node = withMethods({
    ...
    bounds() { return drillIn<T.UseBoundsGroup1 | undefined>(this._bounds, tree); },
    $with: {
...
export function wrapUseList(data: T.UseList, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _use_list_group1: normalizeSingularWrapSlot(data._use_list_group1, "use_list_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "use_list_group1", span: (data as _NodeData).$span }),

    useListGroup1() { return drillIn<T.UseListGroup1 | undefined>(this._use_list_group1, tree); },
...
export function wrapVisibilityModifier(data: T.VisibilityModifier, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _content: normalizeSingularWrapSlot((data._crate ?? data._visibility_modifier_pub ?? data._content), "content", true, data.$type, { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span }),

    content() { return drillAs<T.Crate | T.VisibilityModifierPub>(this._content, tree, "visibility_modifier_pub", "_visibility_modifier_pub"); },
...
export function wrapWhereClause(data: T.WhereClause, tree: TreeHandle) {
  const _node = withMethods({
    ...
    _where_clause_group1: normalizeSingularWrapSlot(data._where_clause_group1, "where_clause_group1", false, data.$type, { tree, nodeType: data.$type, slotName: "where_clause_group1", span: (data as _NodeData).$span }),

    whereClauseGroup1() { return drillIn<T.WhereClauseGroup1 | undefined>(this._where_clause_group1, tree); },
...
export function wrapArgumentsGroup1(data: T.ArgumentsGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_argument]), true, "attributed_argument", { tree, nodeType: data.$type, slotName: "attributed_argument", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _attributed_argument: _content,
...
export function wrapEnumVariantListGroup1(data: T.EnumVariantListGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_enum_variant]), true, "attributed_enum_variant", { tree, nodeType: data.$type, slotName: "attributed_enum_variant", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _attributed_enum_variant: _content,
...
export function wrapFieldDeclarationListGroup1(data: T.FieldDeclarationListGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_field_declaration]), true, "attributed_field_declaration", { tree, nodeType: data.$type, slotName: "attributed_field_declaration", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _attributed_field_declaration: _content,
...
export function wrapFieldInitializerListGroup1(data: T.FieldInitializerListGroup1 & { readonly "_shorthand_field_initializer"?: T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer; readonly "_field_initializer"?: T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer; readonly "_base_field_initializer"?: T.ShorthandFieldInitializer | T.FieldInitializer | T.BaseFieldInitializer; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._shorthand_field_initializer, data._field_initializer, data._base_field_initializer, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _content: _content,
...
export function wrapOrderedFieldDeclarationListGroup1(data: T.OrderedFieldDeclarationListGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_ordered_field]), true, "attributed_ordered_field", { tree, nodeType: data.$type, slotName: "attributed_ordered_field", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _attributed_ordered_field: _content,
...
export function wrapParametersGroup1(data: T.ParametersGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._attributed_parameter]), true, "attributed_parameter", { tree, nodeType: data.$type, slotName: "attributed_parameter", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _attributed_parameter: _content,
...
export function wrapSlicePatternGroup1(data: T.SlicePatternGroup1 & { readonly "_string_literal"?: T.Pattern; readonly "_raw_string_literal"?: T.Pattern; readonly "_char_literal"?: T.Pattern; readonly "_boolean_literal"?: T.Pattern; readonly "_integer_literal"?: T.Pattern; readonly "_float_literal"?: T.Pattern; readonly "_negative_literal"?: T.Pattern; readonly "_identifier"?: T.Pattern; readonly "_scoped_identifier"?: T.Pattern; readonly "_generic_pattern"?: T.Pattern; readonly "_tuple_pattern"?: T.Pattern; readonly "_tuple_struct_pattern"?: T.Pattern; readonly "_struct_pattern"?: T.Pattern; readonly "_reserved_identifier"?: T.Pattern; readonly "_ref_pattern"?: T.Pattern; readonly "_slice_pattern"?: T.Pattern; readonly "_captured_pattern"?: T.Pattern; readonly "_reference_pattern"?: T.Pattern; readonly "_remaining_field_pattern"?: T.Pattern; readonly "_mut_pattern"?: T.Pattern; readonly "_range_pattern"?: T.Pattern; readonly "_or_pattern"?: T.Pattern; readonly "_const_block"?: T.Pattern; readonly "_macro_invocation"?: T.Pattern; readonly "_wildcard_pattern"?: T.Pattern; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._string_literal, data._raw_string_literal, data._char_literal, data._boolean_literal, data._integer_literal, data._float_literal, data._negative_literal, data._identifier, data._scoped_identifier, data._generic_pattern, data._tuple_pattern, data._tuple_struct_pattern, data._struct_pattern, data._reserved_identifier, data._ref_pattern, data._slice_pattern, data._captured_pattern, data._reference_pattern, data._remaining_field_pattern, data._mut_pattern, data._range_pattern, data._or_pattern, data._const_block, data._macro_invocation, data._wildcard_pattern, data._pattern]), true, "pattern", { tree, nodeType: data.$type, slotName: "pattern", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _pattern: _content,
...
export function wrapStructPatternGroup1(data: T.StructPatternGroup1 & { readonly "_field_pattern"?: T.FieldPattern | T.RemainingFieldPattern; readonly "_remaining_field_pattern"?: T.FieldPattern | T.RemainingFieldPattern; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._field_pattern, data._remaining_field_pattern, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _content: _content,
...
export function wrapTuplePatternGroup1(data: T.TuplePatternGroup1 & { readonly "_string_literal"?: T.Pattern | T.ClosureExpression; readonly "_raw_string_literal"?: T.Pattern | T.ClosureExpression; readonly "_char_literal"?: T.Pattern | T.ClosureExpression; readonly "_boolean_literal"?: T.Pattern | T.ClosureExpression; readonly "_integer_literal"?: T.Pattern | T.ClosureExpression; readonly "_float_literal"?: T.Pattern | T.ClosureExpression; readonly "_negative_literal"?: T.Pattern | T.ClosureExpression; readonly "_identifier"?: T.Pattern | T.ClosureExpression; readonly "_scoped_identifier"?: T.Pattern | T.ClosureExpression; readonly "_generic_pattern"?: T.Pattern | T.ClosureExpression; readonly "_tuple_pattern"?: T.Pattern | T.ClosureExpression; readonly "_tuple_struct_pattern"?: T.Pattern | T.ClosureExpression; readonly "_struct_pattern"?: T.Pattern | T.ClosureExpression; readonly "_reserved_identifier"?: T.Pattern | T.ClosureExpression; readonly "_ref_pattern"?: T.Pattern | T.ClosureExpression; readonly "_slice_pattern"?: T.Pattern | T.ClosureExpression; readonly "_captured_pattern"?: T.Pattern | T.ClosureExpression; readonly "_reference_pattern"?: T.Pattern | T.ClosureExpression; readonly "_remaining_field_pattern"?: T.Pattern | T.ClosureExpression; readonly "_mut_pattern"?: T.Pattern | T.ClosureExpression; readonly "_range_pattern"?: T.Pattern | T.ClosureExpression; readonly "_or_pattern"?: T.Pattern | T.ClosureExpression; readonly "_const_block"?: T.Pattern | T.ClosureExpression; readonly "_macro_invocation"?: T.Pattern | T.ClosureExpression; readonly "_wildcard_pattern"?: T.Pattern | T.ClosureExpression; readonly "_closure_expression"?: T.Pattern | T.ClosureExpression; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._string_literal, data._raw_string_literal, data._char_literal, data._boolean_literal, data._integer_literal, data._float_literal, data._negative_literal, data._identifier, data._scoped_identifier, data._generic_pattern, data._tuple_pattern, data._tuple_struct_pattern, data._struct_pattern, data._reserved_identifier, data._ref_pattern, data._slice_pattern, data._captured_pattern, data._reference_pattern, data._remaining_field_pattern, data._mut_pattern, data._range_pattern, data._or_pattern, data._const_block, data._macro_invocation, data._wildcard_pattern, data._closure_expression, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _content: _content,
...
export function wrapUseBoundsGroup1(data: T.UseBoundsGroup1 & { readonly "_lifetime"?: T.Lifetime | T.TypeIdentifier; readonly "_type_identifier"?: T.Lifetime | T.TypeIdentifier; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._lifetime, data._type_identifier, data._content]), true, "content", { tree, nodeType: data.$type, slotName: "content", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _content: _content,
...
export function wrapUseListGroup1(data: T.UseListGroup1 & { readonly "_self"?: T.UseClause; readonly "_identifier"?: T.UseClause; readonly "_metavariable"?: T.UseClause; readonly "_super"?: T.UseClause; readonly "_crate"?: T.UseClause; readonly "_scoped_identifier"?: T.UseClause; readonly "_reserved_identifier"?: T.UseClause; readonly "_use_as_clause"?: T.UseClause; readonly "_use_list"?: T.UseClause; readonly "_scoped_use_list"?: T.UseClause; readonly "_use_wildcard"?: T.UseClause; readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._self, data._identifier, data._metavariable, data._super, data._crate, data._scoped_identifier, data._reserved_identifier, data._use_as_clause, data._use_list, data._scoped_use_list, data._use_wildcard, data._use_clause]), true, "use_clause", { tree, nodeType: data.$type, slotName: "use_clause", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _use_clause: _content,
...
export function wrapWhereClauseGroup1(data: T.WhereClauseGroup1 & { readonly $other?: _NodeData['$other']; readonly $span?: { start: number; end: number }; }, tree: TreeHandle) {
  const _content = normalizeRepeatedWrapSlot(_concatInSourceOrder([data._where_predicate]), true, "where_predicate", { tree, nodeType: data.$type, slotName: "where_predicate", span: (data as _NodeData).$span });
  return withMethods({
    ...data,
    _where_predicate: _content,
...
const _wrapTable: Record<string, (data: _NodeData, tree: TreeHandle) => unknown> = {
  '_arguments_group1': (d, t) => wrap_ArgumentsGroup1(d as unknown as T._ArgumentsGroup1, t),
  ...
  '_enum_variant_list_group1': (d, t) => wrap_EnumVariantListGroup1(d as unknown as T._EnumVariantListGroup1, t),
  ...
  '_field_declaration_list_group1': (d, t) => wrap_FieldDeclarationListGroup1(d as unknown as T._FieldDeclarationListGroup1, t),
  '_field_identifier': (d) => ({ ...d, $type: TSKindId.FieldIdentifier as const }),
  '_field_initializer_list_group1': (d, t) => wrap_FieldInitializerListGroup1(d as unknown as T._FieldInitializerListGroup1, t),
  ...
  '_ordered_field_declaration_list_group1': (d, t) => wrap_OrderedFieldDeclarationListGroup1(d as unknown as T._OrderedFieldDeclarationListGroup1, t),
  '_parameters_group1': (d, t) => wrap_ParametersGroup1(d as unknown as T._ParametersGroup1, t),
  ...
  '_slice_pattern_group1': (d, t) => wrap_SlicePatternGroup1(d as unknown as T._SlicePatternGroup1, t),
  ...
  '_struct_pattern_group1': (d, t) => wrap_StructPatternGroup1(d as unknown as T._StructPatternGroup1, t),
  ...
  '_use_bounds_group1': (d, t) => wrap_UseBoundsGroup1(d as unknown as T._UseBoundsGroup1, t),
  '_use_clause': (d, t) => wrapUseClause(d as unknown as T.UseClause, t),
  '_use_list_group1': (d, t) => wrap_UseListGroup1(d as unknown as T._UseListGroup1, t),
  ...
  '_where_clause_group1': (d, t) => wrap_WhereClauseGroup1(d as unknown as T._WhereClauseGroup1, t),
  ...
  'arguments_group1': (d, t) => wrapArgumentsGroup1(d as unknown as T.ArgumentsGroup1, t),
  'visibility_modifier_group1': (d, t) => wrapVisibilityModifierGroup1(d as unknown as T.VisibilityModifierGroup1, t),
  'enum_variant_list_group1': (d, t) => wrapEnumVariantListGroup1(d as unknown as T.EnumVariantListGroup1, t),
  'field_declaration_list_group1': (d, t) => wrapFieldDeclarationListGroup1(d as unknown as T.FieldDeclarationListGroup1, t),
  'field_initializer_list_group1': (d, t) => wrapFieldInitializerListGroup1(d as unknown as T.FieldInitializerListGroup1, t),
  'ordered_field_declaration_list_group1': (d, t) => wrapOrderedFieldDeclarationListGroup1(d as unknown as T.OrderedFieldDeclarationListGroup1, t),
  'parameters_group1': (d, t) => wrapParametersGroup1(d as unknown as T.ParametersGroup1, t),
  'slice_pattern_group1': (d, t) => wrapSlicePatternGroup1(d as unknown as T.SlicePatternGroup1, t),
  'struct_pattern_group1': (d, t) => wrapStructPatternGroup1(d as unknown as T.StructPatternGroup1, t),
  'tuple_pattern_group1': (d, t) => wrapTuplePatternGroup1(d as unknown as T.TuplePatternGroup1, t),
  'use_bounds_group1': (d, t) => wrapUseBoundsGroup1(d as unknown as T.UseBoundsGroup1, t),
  'use_list_group1': (d, t) => wrapUseListGroup1(d as unknown as T.UseListGroup1, t),
  'where_clause_group1': (d, t) => wrapWhereClauseGroup1(d as unknown as T.WhereClauseGroup1, t),
