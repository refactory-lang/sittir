...
const _overrides = {
  ...
  "attribute_item": {"fields":{"attribute":{"types":[],"multiple":false,"required":true,"position":0}}},
  "inner_attribute_item": {"fields":{"attribute":{"types":[],"multiple":false,"required":true,"position":0}}},
  "mod_item": {"fields":{"visibility_modifier":{"types":[{"type":"visibility_modifier","named":true}],"multiple":false,"required":false,"position":0}}},
  "foreign_mod_item": {"fields":{"visibility_modifier":{"types":[{"type":"visibility_modifier","named":true}],"multiple":false,"required":false,"position":0},"extern_modifier":{"types":[],"multiple":false,"required":true,"position":1}}},
  ...
  "extern_crate_declaration": {"fields":{"visibility_modifier":{"types":[{"type":"visibility_modifier","named":true}],"multiple":false,"required":false,"position":0},"crate":{"types":[],"multiple":false,"required":true,"position":1}}},
  ...
  "lifetime": {"fields":{"identifier":{"types":[],"multiple":false,"required":true,"position":0}}},
  ...
  "shorthand_field_initializer": {"fields":{"attributes":{"types":[{"type":"attribute_item","named":true}],"multiple":true,"required":true,"position":0},"identifier":{"types":[],"multiple":false,"required":true,"position":1}}},
  ...
  "label": {"fields":{"identifier":{"types":[],"multiple":false,"required":true,"position":0}}},
  ...
  "unsafe_block": {"fields":{"unsafe":{"types":[{"type":"unsafe","named":false}],"multiple":false,"required":true,"position":0},"block":{"types":[],"multiple":false,"required":true,"position":1}}},
  "async_block": {"fields":{"async":{"types":[{"type":"async","named":false}],"multiple":false,"required":true,"position":0},"move":{"types":[{"type":"move","named":false}],"multiple":false,"required":false,"position":1},"block":{"types":[],"multiple":false,"required":true,"position":2}}},
  "gen_block": {"fields":{"gen":{"types":[{"type":"gen","named":false}],"multiple":false,"required":true,"position":0},"move":{"types":[{"type":"move","named":false}],"multiple":false,"required":false,"position":1},"block":{"types":[],"multiple":false,"required":true,"position":2}}},
  "try_block": {"fields":{"try":{"types":[{"type":"try","named":false}],"multiple":false,"required":true,"position":0},"block":{"types":[],"multiple":false,"required":true,"position":1}}},
  ...
  "mut_pattern": {"fields":{"mutable_specifier":{"types":[],"multiple":false,"required":true,"position":0},"pattern":{"types":[{"type":"_pattern","named":true}],"multiple":false,"required":true,"position":1}}},
  "ref_pattern": {"fields":{"ref":{"types":[{"type":"ref","named":false}],"multiple":false,"required":true,"position":0}}},
  "captured_pattern": {"fields":{"identifier":{"types":[],"multiple":false,"required":true,"position":0},"pattern":{"types":[{"type":"_pattern","named":true}],"multiple":false,"required":true,"position":1}}},
