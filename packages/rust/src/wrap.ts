...
export function wrapWherePredicate(data: _NodeData, tree: TreeHandle): WrappedNode<WherePredicate> {
	return {
		...data,
		get left() {
			return drillAs(data.$fields?.["left"], tree, "primitive_type", "_primitive_type");
		},
		get bounds() {
...
export function wrapMacroInvocation(
	...
	return {
		...
		get tokenTree() {
			return drillAs(data.$fields?.["token_tree"], tree, "token_tree", "delim_token_tree");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
...
export function wrapScopedIdentifier(
	...
	return {
		...data,
		get path() {
			return drillAs(data.$fields?.["path"], tree, "generic_type", "generic_type_with_turbofish");
		},
		get name() {
			return drillIn(data.$fields?.["name"], tree);
		},
...
export function wrapTupleStructPattern(
	...
	return {
		...data,
		get typeField() {
			return drillAs(data.$fields?.["type"], tree, "generic_type", "generic_type_with_turbofish");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
...
export function wrapRawStringLiteral(
	...
	return {
		...
		get stringContent() {
			return drillAs(data.$fields?.["string_content"], tree, "string_content", "_string_content");
		},
...
export function wrapBlockComment(data: _NodeData, tree: TreeHandle): WrappedNode<BlockComment> {
	return {
		...data,
		get doc() {
			return drillAs(data.$fields?.["doc"], tree, "doc_comment", "_doc_comment");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
