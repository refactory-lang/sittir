...
export function wrapSourceFile(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<SourceFile> {
	return {
		...data,
		get shebang() {
			return drillIn(data.$fields?.['shebang'], tree);
		},
		get statements() {
...
export function wrapExpressionStatementWithSemi(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ExpressionStatementWithSemi> {
	return {
		...data,
		get child() {
...
export function wrapExpressionStatementBlockEnding(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ExpressionStatementBlockEnding> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapMacroDefinitionParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MacroDefinitionParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapMacroDefinitionBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MacroDefinitionBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapMacroDefinitionBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MacroDefinitionBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapMacroRule(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MacroRule> {
	return {
		...data,
		get left() {
...
export function wrapTokenTreePatternParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TokenTreePatternParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapTokenTreePatternBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TokenTreePatternBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapTokenTreePatternBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TokenTreePatternBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapTokenBindingPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TokenBindingPattern> {
	return {
		...data,
		get name() {
			return drillIn(data.$fields?.['name'], tree);
...
export function wrapTokenRepetitionPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TokenRepetitionPattern> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapAttributeItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<AttributeItem> {
	return {
		...data,
		get attribute() {
			return drillIn(data.$fields?.['attribute'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapInnerAttributeItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<InnerAttributeItem> {
	return {
		...data,
		get attribute() {
			return drillIn(data.$fields?.['attribute'], tree);
...
export function wrapAttribute(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<Attribute> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapModItemInline(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ModItemInline> {
	return {
		...data,
		get body() {
...
export function wrapModItem(
	...
	return {
		...
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
		},
		get name() {
			return drillIn(data.$fields?.['name'], tree);
		},
...
export function wrapForeignModItemBody(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ForeignModItemBody> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrapForeignModItem(
	...
	return {
		...
		get externModifier() {
			return drillIn(data.$fields?.['extern_modifier'], tree);
		},
		get child() {
			return drillIn(data.$children?.[0], tree);
		}
...
export function wrapUnionItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<UnionItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
		...
		get whereClause() {
			return drillIn(data.$fields?.['where_clause'], tree);
		},
		get body() {
			return drillIn(data.$fields?.['body'], tree);
		},
...
export function wrapEnumItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<EnumItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapEnumVariant(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<EnumVariant> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapFieldDeclarationList(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldDeclarationList> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapFieldDeclaration(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldDeclaration> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapOrderedFieldDeclarationList(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<OrderedFieldDeclarationList> {
	return {
		...data,
		get typeField() {
...
export function wrapExternCrateDeclaration(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ExternCrateDeclaration> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
		...
		get crate() {
			return drillIn(data.$fields?.['crate'], tree);
		},
		get name() {
			return drillIn(data.$fields?.['name'], tree);
		},
...
export function wrapConstItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ConstItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapStaticItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<StaticItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
		},
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
		},
		get name() {
			return drillIn(data.$fields?.['name'], tree);
		},
...
export function wrapTypeItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TypeItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
		...
		get trailingWhereClause() {
			return drillIn(data.$fields?.['trailing_where_clause'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapFunctionItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FunctionItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
		...
		get functionModifiers() {
			return drillIn(data.$fields?.['function_modifiers'], tree);
		},
		get name() {
			return drillIn(data.$fields?.['name'], tree);
		},
...
export function wrapFunctionSignatureItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FunctionSignatureItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapFunctionModifiers(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FunctionModifiers> {
	return {
		...data,
		get modifier() {
			return drillInAll(data.$fields?.['modifier'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapWhereClause(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<WhereClause> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapWherePredicate(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<WherePredicate> {
	return {
		...data,
		get left() {
			return drillAs(
		...
		get bounds() {
			return drillIn(data.$fields?.['bounds'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapImplItemBody(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ImplItemBody> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrapImplItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ImplItem> {
	return {
		...data,
		get unsafeMarker() {
			return drillIn(data.$fields?.['unsafe_marker'], tree);
		},
		get typeParameters() {
			return drillIn(data.$fields?.['type_parameters'], tree);
		},
		get negative() {
			return drillIn(data.$fields?.['negative'], tree);
		},
		get trait() {
			return drillIn(data.$fields?.['trait'], tree);
		},
		get typeField() {
			return drillIn(data.$fields?.['type'], tree);
		},
...
export function wrapTraitItem(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TraitItem> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapAssociatedType(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<AssociatedType> {
	return {
		...data,
		get name() {
			return drillIn(data.$fields?.['name'], tree);
...
export function wrapTraitBounds(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TraitBounds> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapHigherRankedTraitBound(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<HigherRankedTraitBound> {
	return {
		...data,
		get typeParameters() {
			return drillIn(data.$fields?.['type_parameters'], tree);
...
export function wrapRemovedTraitBound(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<RemovedTraitBound> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapConstParameter(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ConstParameter> {
	return {
		...data,
		get name() {
			return drillIn(data.$fields?.['name'], tree);
...
export function wrapTypeParameter(
	...
	return {
		...
		get defaultType() {
			return drillIn(data.$fields?.['default_type'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapLifetimeParameter(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<LifetimeParameter> {
	return {
		...data,
		get name() {
			return drillIn(data.$fields?.['name'], tree);
...
export function wrapLetDeclaration(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<LetDeclaration> {
	return {
		...data,
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
...
export function wrapUseDeclaration(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<UseDeclaration> {
	return {
		...data,
		get visibilityModifier() {
			return drillIn(data.$fields?.['visibility_modifier'], tree);
...
export function wrapScopedUseList(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ScopedUseList> {
	return {
		...data,
		get path() {
			return drillIn(data.$fields?.['path'], tree);
		},
		get list() {
			return drillIn(data.$fields?.['list'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapUseAsClause(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<UseAsClause> {
	return {
		...data,
		get path() {
			return drillIn(data.$fields?.['path'], tree);
...
export function wrapUseWildcard(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<UseWildcard> {
	return {
		...data,
		get path() {
			return drillIn(data.$fields?.['path'], tree);
...
export function wrapSelfParameter(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<SelfParameter> {
	return {
		...data,
		get reference() {
			return drillIn(data.$fields?.['reference'], tree);
		},
		get lifetime() {
			return drillIn(data.$fields?.['lifetime'], tree);
		},
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
		},
		get self() {
			return drillIn(data.$fields?.['self'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapVariadicParameter(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<VariadicParameter> {
	return {
		...data,
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
...
export function wrapExternModifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ExternModifier> {
	return {
		...data,
		get stringLiteral() {
			return drillIn(data.$fields?.['string_literal'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapVisibilityModifierCrate(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<VisibilityModifierCrate> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapVisibilityModifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<VisibilityModifier> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapQualifiedType(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<QualifiedType> {
	return {
		...data,
		get typeField() {
			return drillIn(data.$fields?.['type'], tree);
...
export function wrapLifetime(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<Lifetime> {
	return {
		...data,
		get identifier() {
...
export function wrapArrayType(
	...
	return {
		...data,
		get element() {
			return drillIn(data.$fields?.['element'], tree);
		},
		get length() {
			return drillIn(data.$fields?.['length'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapForLifetimes(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ForLifetimes> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapFunctionType(
	...
	return {
		...data,
		get forLifetimes() {
			return drillIn(data.$fields?.['for_lifetimes'], tree);
		},
		get parameters() {
			return drillIn(data.$fields?.['parameters'], tree);
		},
...
export function wrapGenericFunction(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<GenericFunction> {
	return {
		...data,
		get function() {
			return drillIn(data.$fields?.['function'], tree);
		},
		get typeArguments() {
...
export function wrapGenericTypeWithTurbofish(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<GenericTypeWithTurbofish> {
	return {
		...data,
		get typeField() {
			return drillIn(data.$fields?.['type'], tree);
		...
		get turbofish() {
			return drillIn(data.$fields?.['turbofish'], tree);
		},
		get typeArguments() {
			return drillIn(data.$fields?.['type_arguments'], tree);
		},
...
export function wrapBoundedType(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<BoundedType> {
	return {
		...data,
		get left() {
			return drillIn(data.$fields?.['left'], tree);
...
export function wrapUseBounds(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<UseBounds> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapTypeBinding(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TypeBinding> {
	return {
		...data,
		get name() {
			return drillIn(data.$fields?.['name'], tree);
...
export function wrapReferenceType(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ReferenceType> {
	return {
		...data,
		get lifetime() {
			return drillIn(data.$fields?.['lifetime'], tree);
...
export function wrapPointerTypeMut(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<PointerTypeMut> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapAbstractType(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<AbstractType> {
	return {
		...data,
		get typeParameters() {
			return drillIn(data.$fields?.['type_parameters'], tree);
...
export function wrapDynamicType(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<DynamicType> {
	return {
		...data,
		get trait() {
			return drillIn(data.$fields?.['trait'], tree);
...
export function wrapMacroInvocation(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MacroInvocation> {
	return {
		...data,
		get macro() {
			return drillIn(data.$fields?.['macro'], tree);
		},
		get tokenTree() {
			return drillAs(
				data.$fields?.['token_tree'],
				tree,
				'token_tree',
				'delim_token_tree'
			);
...
export function wrapDelimTokenTreeParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<DelimTokenTreeParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapDelimTokenTreeBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<DelimTokenTreeBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapDelimTokenTreeBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<DelimTokenTreeBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapScopedIdentifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ScopedIdentifier> {
	return {
		...data,
		get path() {
			return drillAs(
...
export function wrapScopedTypeIdentifierInExpressionPosition(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ScopedTypeIdentifierInExpressionPosition> {
	return {
		...data,
		get path() {
			return drillAs(
...
export function wrapScopedTypeIdentifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ScopedTypeIdentifier> {
	return {
		...data,
		get path() {
			return drillAs(
...
export function wrapRangeExpressionBare(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<RangeExpressionBare> {
	return {
		...data,
		get operator() {
...
export function wrapUnaryExpression(
	...
	return {
		...
		get operand() {
			return drillIn(data.$fields?.['operand'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapTryExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TryExpression> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapReferenceExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ReferenceExpression> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapCompoundAssignmentExpr(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<CompoundAssignmentExpr> {
	return {
		...data,
		get left() {
			return drillIn(data.$fields?.['left'], tree);
...
export function wrapTypeCastExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TypeCastExpression> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapTupleExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TupleExpression> {
	return {
		...data,
		get attributes() {
			return drillInAll(data.$fields?.['attributes'], tree);
		},
		get elements() {
			return drillInAll(data.$fields?.['elements'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapStructExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<StructExpression> {
	return {
		...data,
		get name() {
			return drillAs(
...
export function wrapFieldInitializerList(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldInitializerList> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapShorthandFieldInitializer(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ShorthandFieldInitializer> {
	return {
		...data,
		get attributes() {
			return drillInAll(data.$fields?.['attributes'], tree);
...
export function wrapFieldInitializer(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldInitializer> {
	return {
		...data,
		get field() {
			return drillIn(data.$fields?.['field'], tree);
		},
		get value() {
			return drillIn(data.$fields?.['value'], tree);
		},
...
export function wrapBaseFieldInitializer(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<BaseFieldInitializer> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapIfExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<IfExpression> {
	return {
		...data,
		get condition() {
...
export function wrapLetCondition(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<LetCondition> {
	return {
		...data,
		get pattern() {
			return drillIn(data.$fields?.['pattern'], tree);
...
export function wrapMatchExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MatchExpression> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapMatchArmBlockEnding(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MatchArmBlockEnding> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapLastMatchArm(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<LastMatchArm> {
	return {
		...data,
		get pattern() {
			return drillIn(data.$fields?.['pattern'], tree);
...
export function wrapMatchPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MatchPattern> {
	return {
		...data,
		get condition() {
			return drillIn(data.$fields?.['condition'], tree);
...
export function wrapWhileExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<WhileExpression> {
	return {
		...data,
		get label() {
			return drillIn(data.$fields?.['label'], tree);
		},
		get condition() {
			return drillIn(data.$fields?.['condition'], tree);
		},
...
export function wrapLoopExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<LoopExpression> {
	return {
		...data,
		get label() {
			return drillIn(data.$fields?.['label'], tree);
...
export function wrapForExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ForExpression> {
	return {
		...data,
		get label() {
			return drillIn(data.$fields?.['label'], tree);
...
export function wrapConstBlock(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ConstBlock> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrapClosureExpressionExpr(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ClosureExpressionExpr> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrapClosureExpression(
	...
	return {
		...
		get moveMarker() {
			return drillIn(data.$fields?.['move_marker'], tree);
		},
		get parameters() {
			return drillIn(data.$fields?.['parameters'], tree);
		},
...
export function wrapClosureParameters(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ClosureParameters> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapContinueExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ContinueExpression> {
	return {
		...data,
		get label() {
			return drillIn(data.$fields?.['label'], tree);
...
export function wrapIndexExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<IndexExpression> {
	return {
		...data,
		get object() {
...
export function wrapFieldExpression(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldExpression> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapUnsafeBlock(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<UnsafeBlock> {
	return {
		...data,
		get block() {
			return drillIn(data.$fields?.['block'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapAsyncBlock(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<AsyncBlock> {
	return {
		...data,
		get moveMarker() {
			return drillIn(data.$fields?.['move_marker'], tree);
...
export function wrapGenBlock(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<GenBlock> {
	return {
		...data,
		get moveMarker() {
			return drillIn(data.$fields?.['move_marker'], tree);
...
export function wrapTryBlock(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TryBlock> {
	return {
		...data,
		get block() {
			return drillIn(data.$fields?.['block'], tree);
...
export function wrapTuplePattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TuplePattern> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrapTupleStructPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<TupleStructPattern> {
	return {
		...data,
		get typeField() {
			return drillAs(
...
export function wrapStructPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<StructPattern> {
	return {
		...data,
		get typeField() {
			return drillIn(data.$fields?.['type'], tree);
...
export function wrapFieldPatternShorthand(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldPatternShorthand> {
	return {
		...data,
		get name() {
			return drillAs(
...
export function wrapFieldPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldPattern> {
	return {
		...data,
		get refMarker() {
			return drillIn(data.$fields?.['ref_marker'], tree);
		},
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
		},
...
export function wrapMutPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<MutPattern> {
	return {
		...data,
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
...
export function wrapRefPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<RefPattern> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapCapturedPattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<CapturedPattern> {
	return {
		...data,
		get identifier() {
			return drillIn(data.$fields?.['identifier'], tree);
...
export function wrapReferencePattern(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ReferencePattern> {
	return {
		...data,
		get mutableSpecifier() {
			return drillIn(data.$fields?.['mutable_specifier'], tree);
...
export function wrapNegativeLiteral(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<NegativeLiteral> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrapRawStringLiteral(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<RawStringLiteral> {
	return {
		...data,
		get rawStringLiteralStart() {
			return drillIn(data.$fields?.['raw_string_literal_start'], tree);
		},
		get stringContent() {
			return drillAs(
				data.$fields?.['string_content'],
				tree,
				'string_content',
				'_string_content'
			);
		},
		get rawStringLiteralEnd() {
			return drillIn(data.$fields?.['raw_string_literal_end'], tree);
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		}
...
export function wrapReservedIdentifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ReservedIdentifier> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapFieldIdentifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FieldIdentifier> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapShorthandFieldIdentifier(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ShorthandFieldIdentifier> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_StringContent(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_StringContent> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_ClosureExpressionExpr(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_ClosureExpressionExpr> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrap_FieldPatternShorthand(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_FieldPatternShorthand> {
	return {
		...data,
		get name() {
			return drillAs(
...
export function wrapFunctionTypeTraitForm(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FunctionTypeTraitForm> {
	return {
		...data,
		get trait() {
			return drillIn(data.$fields?.['trait'], tree);
...
export function wrapFunctionTypeFnForm(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<FunctionTypeFnForm> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_ImplItemBody(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_ImplItemBody> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrap_MacroDefinitionParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_MacroDefinitionParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_MacroDefinitionBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_MacroDefinitionBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_MacroDefinitionBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_MacroDefinitionBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_ModItemInline(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_ModItemInline> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrap_RangeExpressionBare(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_RangeExpressionBare> {
	return {
		...data,
		get operator() {
			return drillIn(data.$fields?.['operator'], tree);
...
export function wrap_VisibilityModifierCrate(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_VisibilityModifierCrate> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_PointerTypeMut(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_PointerTypeMut> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrapReferenceExpressionRawMut(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<ReferenceExpressionRawMut> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_ExpressionStatementWithSemi(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_ExpressionStatementWithSemi> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_ExpressionStatementBlockEnding(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_ExpressionStatementBlockEnding> {
	return {
		...data,
		get child() {
			return drillIn(data.$children?.[0], tree);
...
export function wrap_ForeignModItemBody(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_ForeignModItemBody> {
	return {
		...data,
		get body() {
			return drillIn(data.$fields?.['body'], tree);
...
export function wrap_MatchArmBlockEnding(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_MatchArmBlockEnding> {
	return {
		...data,
		get value() {
			return drillIn(data.$fields?.['value'], tree);
...
export function wrap_TokenTreePatternParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_TokenTreePatternParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_TokenTreePatternBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_TokenTreePatternBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_TokenTreePatternBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_TokenTreePatternBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_TokenTreeParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_TokenTreeParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_TokenTreeBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_TokenTreeBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_TokenTreeBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_TokenTreeBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_DelimTokenTreeParen(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_DelimTokenTreeParen> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_DelimTokenTreeBracket(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_DelimTokenTreeBracket> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
export function wrap_DelimTokenTreeBrace(
	data: _NodeData,
	tree: TreeHandle
): WrappedNode<_DelimTokenTreeBrace> {
	return {
		...data,
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
...
> = {
	...
	expression_statement_with_semi: (d, t) =>
		wrapExpressionStatementWithSemi(d, t),
	expression_statement_block_ending: (d, t) =>
		wrapExpressionStatementBlockEnding(d, t),
	...
	ordered_field_declaration_list: (d, t) =>
		wrapOrderedFieldDeclarationList(d, t),
	...
	scoped_type_identifier_in_expression_position: (d, t) =>
		wrapScopedTypeIdentifierInExpressionPosition(d, t),
	...
	_expression_statement_with_semi: (d, t) =>
		wrap_ExpressionStatementWithSemi(d, t),
	_expression_statement_block_ending: (d, t) =>
		wrap_ExpressionStatementBlockEnding(d, t),
