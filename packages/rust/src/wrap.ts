...
const _overrides = {
  ...
  "macro_definition": {"fields":{"rules":{"types":[{"type":"macro_rule","named":true},{"type":"macro_rule","named":true},{"type":"macro_rule","named":true},{"type":"macro_rule","named":true},{"type":"macro_rule","named":true},{"type":"macro_rule","named":true}],"multiple":false,"required":true,"position":1}}},
  ...
  "ordered_field_declaration_list": {"fields":{"attributes":{"types":[{"type":"attribute_item","named":true},{"type":"visibility_modifier","named":true},{"type":"_type","named":true},{"type":"attribute_item","named":true},{"type":"visibility_modifier","named":true},{"type":"_type","named":true}],"multiple":false,"required":false,"position":0},"visibility_modifier":{"types":[],"multiple":false,"required":false,"position":1}}},
  ...
  "self_parameter": {"fields":{"lifetime":{"types":[],"multiple":false,"required":false,"position":0},"mutable_specifier":{"types":[{"type":"lifetime","named":true}],"multiple":false,"required":false,"position":1},"self":{"types":[{"type":"mutable_specifier","named":true}],"multiple":false,"required":false,"position":2}}},
  ...
  "macro_invocation": {"fields":{"token_tree":{"types":[{"type":"delim_token_tree","named":true}],"multiple":false,"required":true,"position":1}}},
  "unary_expression": {"fields":{"operand":{"types":[],"multiple":false,"required":true,"position":0}}},
  "try_expression": {"fields":{"value":{"types":[{"type":"_expression","named":true}],"multiple":false,"required":true,"position":0}}},
  "reference_expression": {"fields":{"mutable_specifier":{"types":[{"type":"mutable_specifier","named":true},{"type":"mutable_specifier","named":true}],"multiple":false,"required":true,"position":0}}},
  "array_expression": {"fields":{"attributes":{"types":[{"type":"attribute_item","named":true}],"multiple":true,"required":true,"position":0},"elements":{"types":[{"type":"_expression","named":true},{"type":"_expression","named":true},{"type":"attribute_item","named":true},{"type":"_expression","named":true},{"type":"attribute_item","named":true},{"type":"_expression","named":true}],"multiple":false,"required":true,"position":1}}},
...
const _supertypeExpansion = new Map<string, readonly string[]>(Object.entries({
  ...
  "_type": ["abstract_type","reference_type","metavariable","pointer_type","generic_type","scoped_type_identifier","tuple_type","unit_type","array_type","function_type","_type_identifier","macro_invocation","never_type","dynamic_type","bounded_type","removed_trait_bound"],
  ...
  "_pattern": ["_literal_pattern","identifier","scoped_identifier","generic_pattern","tuple_pattern","tuple_struct_pattern","struct_pattern","_reserved_identifier","ref_pattern","slice_pattern","captured_pattern","reference_pattern","remaining_field_pattern","mut_pattern","range_pattern","or_pattern","const_block","macro_invocation"],
