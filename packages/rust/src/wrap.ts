...
export function wrapBlockCommentArm(data: T.BlockCommentArm, tree: TreeHandle) {
	if (_isReadTextLeaf(data)) return withMethods({ ...data, $type: TSKindId.BlockCommentArm as const }, methodsEngine);
	const _node = withMethods(
		{
			...data,
