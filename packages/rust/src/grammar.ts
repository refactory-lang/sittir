...
export type RustGrammar = {
	...
	readonly associated_type: {
		...
		fields: {
			bounds: {
				multiple: false;
				required: false;
				types: [{ type: 'trait_bounds'; named: true }];
			};
			name: {
				multiple: false;
				required: true;
	...
	readonly attribute: {
		...
		fields: {
			arguments: {
				multiple: false;
				required: false;
				types: [{ type: 'token_tree'; named: true }];
			};
			value: {
				multiple: false;
				required: false;
	...
	readonly attribute_item: {
		...
		fields: {
			attribute: {
				multiple: false;
				required: true;
				types: [{ type: 'attribute'; named: true }];
			};
		};
	};
	...
	readonly block_comment: {
		...
		fields: {
			doc: {
				multiple: false;
				required: false;
				types: [{ type: 'doc_comment'; named: true }];
			};
			inner: {
				multiple: false;
				required: false;
	...
	readonly bracketed_type: {
		...
		children: {
			...
			types: [
				{ type: '_type'; named: true },
				{ type: 'qualified_type'; named: true }
			];
		};
	};
	...
	readonly captured_pattern: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: '_pattern'; named: true }];
		};
	};
	...
	readonly field_declaration: {
		...
		fields: {
			name: {
				multiple: false;
				required: true;
				types: [{ type: 'field_identifier'; named: true }];
			};
			type: {
				multiple: false;
				required: true;
	...
	readonly for_lifetimes: {
		...
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'lifetime'; named: true }];
		};
	};
	...
	readonly impl_item: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: 'impl_item_body'; named: true },
				{ type: 'impl_item_semi'; named: true }
			];
		};
	};
	...
	readonly inner_doc_comment_marker: {
	...
	readonly macro_definition_brace: {
		...
		children: {
			multiple: true;
			required: false;
			types: [{ type: 'macro_rule'; named: true }];
		};
	};
	...
	readonly match_arm: {
		...
		fields: {
			pattern: {
				multiple: false;
				required: true;
				types: [{ type: 'match_pattern'; named: true }];
			};
			value: {
				multiple: false;
				required: false;
	...
	readonly match_block: {
		...
		children: {
			multiple: true;
			required: false;
			types: [{ type: 'match_arm'; named: true }];
		};
	};
	readonly match_expression: {
		...
		fields: {
			body: {
				multiple: false;
				required: true;
				types: [{ type: 'match_block'; named: true }];
			};
			value: {
				multiple: false;
				required: true;
	...
	readonly mod_item: {
		...
		children: {
			...
			types: [
				...
				{ type: 'mod_item_inline'; named: true }
			];
		};
	};
	...
	readonly outer_doc_comment_marker: {
	...
	readonly range_pattern_left_bare: {
		type: 'range_pattern_left_bare';
		named: true;
		fields: {};
	};
	...
	readonly remaining_field_pattern: {
	...
	readonly scoped_use_list: {
		...
		fields: {
			list: {
				multiple: false;
				required: true;
				types: [{ type: 'use_list'; named: true }];
			};
			path: {
				multiple: false;
				required: false;
	...
	readonly token_binding_pattern: {
		...
		fields: {
			name: {
				multiple: false;
				required: true;
				types: [{ type: 'metavariable'; named: true }];
			};
			type: {
				multiple: false;
				required: true;
	...
	readonly shorthand_field_identifier: {
