// Auto-generated grammar type from tree-sitter-rust/src/node-types.json
// Structurally compatible with @codemod.com/jssg-types RustTypes

export type RustGrammar = {
	readonly _declaration_statement: {
		type: '_declaration_statement';
		named: true;
		subtypes: [
			{ type: 'associated_type'; named: true },
			{ type: 'attribute_item'; named: true },
			{ type: 'const_item'; named: true },
			{ type: 'empty_statement'; named: true },
			{ type: 'enum_item'; named: true },
			{ type: 'extern_crate_declaration'; named: true },
			{ type: 'foreign_mod_item'; named: true },
			{ type: 'function_item'; named: true },
			{ type: 'function_signature_item'; named: true },
			{ type: 'impl_item'; named: true },
			{ type: 'inner_attribute_item'; named: true },
			{ type: 'let_declaration'; named: true },
			{ type: 'macro_definition'; named: true },
			{ type: 'macro_invocation'; named: true },
			{ type: 'mod_item'; named: true },
			{ type: 'static_item'; named: true },
			{ type: 'struct_item'; named: true },
			{ type: 'trait_item'; named: true },
			{ type: 'type_item'; named: true },
			{ type: 'union_item'; named: true },
			{ type: 'use_declaration'; named: true }
		];
	};
	readonly _expression: {
		...
		subtypes: [
			...
			{ type: 'break_expression'; named: true },
			{ type: 'call_expression'; named: true },
			{ type: 'closure_expression'; named: true },
			{ type: 'compound_assignment_expr'; named: true },
			{ type: 'const_block'; named: true },
			{ type: 'continue_expression'; named: true },
			{ type: 'field_expression'; named: true },
			{ type: 'for_expression'; named: true },
			{ type: 'gen_block'; named: true },
			{ type: 'generic_function'; named: true },
			{ type: 'identifier'; named: true },
			{ type: 'if_expression'; named: true },
			{ type: 'index_expression'; named: true },
			{ type: 'loop_expression'; named: true },
			{ type: 'macro_invocation'; named: true },
			{ type: 'match_expression'; named: true },
			{ type: 'metavariable'; named: true },
			{ type: 'parenthesized_expression'; named: true },
			{ type: 'range_expression'; named: true },
			{ type: 'reference_expression'; named: true },
			{ type: 'return_expression'; named: true },
			{ type: 'scoped_identifier'; named: true },
			{ type: 'self'; named: true },
			{ type: 'struct_expression'; named: true },
			{ type: 'try_block'; named: true },
			{ type: 'try_expression'; named: true },
			{ type: 'tuple_expression'; named: true },
			{ type: 'type_cast_expression'; named: true },
			{ type: 'unary_expression'; named: true },
			{ type: 'unit_expression'; named: true },
			{ type: 'unsafe_block'; named: true },
			{ type: 'while_expression'; named: true },
	...
	readonly _literal: {
		...
		named: true;
		subtypes: [
			{ type: 'boolean_literal'; named: true },
			{ type: 'char_literal'; named: true },
			{ type: 'float_literal'; named: true },
			{ type: 'integer_literal'; named: true },
			{ type: 'raw_string_literal'; named: true },
			{ type: 'string_literal'; named: true }
		];
	};
	readonly _literal_pattern: {
		...
		subtypes: [
			...
			{ type: 'float_literal'; named: true },
			{ type: 'integer_literal'; named: true },
			{ type: 'negative_literal'; named: true },
			{ type: 'raw_string_literal'; named: true },
			{ type: 'string_literal'; named: true }
		];
	};
	readonly _pattern: {
		...
		subtypes: [
			...
			{ type: 'captured_pattern'; named: true },
			{ type: 'const_block'; named: true },
			{ type: 'generic_pattern'; named: true },
			{ type: 'identifier'; named: true },
			{ type: 'macro_invocation'; named: true },
			{ type: 'mut_pattern'; named: true },
			{ type: 'or_pattern'; named: true },
			{ type: 'range_pattern'; named: true },
			{ type: 'ref_pattern'; named: true },
			{ type: 'reference_pattern'; named: true },
			{ type: 'remaining_field_pattern'; named: true },
			{ type: 'scoped_identifier'; named: true },
			{ type: 'slice_pattern'; named: true },
			{ type: 'struct_pattern'; named: true },
			{ type: 'tuple_pattern'; named: true },
			{ type: 'tuple_struct_pattern'; named: true },
	...
	readonly _type: {
		...
		named: true;
		subtypes: [
			{ type: 'abstract_type'; named: true },
			{ type: 'array_type'; named: true },
			{ type: 'bounded_type'; named: true },
			{ type: 'dynamic_type'; named: true },
			{ type: 'function_type'; named: true },
			{ type: 'generic_type'; named: true },
			{ type: 'macro_invocation'; named: true },
			{ type: 'metavariable'; named: true },
			{ type: 'never_type'; named: true },
			{ type: 'pointer_type'; named: true },
			{ type: 'primitive_type'; named: true },
			{ type: 'reference_type'; named: true },
			{ type: 'removed_trait_bound'; named: true },
			{ type: 'scoped_type_identifier'; named: true },
			{ type: 'tuple_type'; named: true },
			{ type: 'type_identifier'; named: true },
			{ type: 'unit_type'; named: true }
		];
	};
	...
	readonly arguments: {
		...
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'arguments_elements'; named: true }] };
	};
	readonly arguments_elements: {
		type: 'arguments_elements';
		named: true;
	...
	readonly array_expression_arm1: {
		type: 'array_expression_arm1';
		named: true;
	...
	readonly array_expression_semi: {
		...
		named: true;
		fields: { attributes: { multiple: true; required: false; types: [{ type: 'attribute_item'; named: true }] } };
		children: { multiple: false; required: true; types: [{ type: 'array_expression_arm1'; named: true }] };
	};
	readonly array_type: {
		type: 'array_type';
		named: true;
		fields: {
			element: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
			length: { multiple: false; required: false; types: [{ type: '_expression'; named: true }] };
		};
	};
	...
	readonly associated_type: {
		...
		named: true;
		fields: {
			bounds: { multiple: false; required: false; types: [{ type: 'trait_bounds'; named: true }] };
			name: { multiple: false; required: true; types: [{ type: 'type_identifier'; named: true }] };
			type_parameters: { multiple: false; required: false; types: [{ type: 'type_parameters'; named: true }] };
			where_clause: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
		};
	};
	...
	readonly attribute: {
		...
		children: { multiple: false; required: false; types: [{ type: 'attribute_arm1'; named: true }] };
	};
	readonly attribute_arm1: {
		type: 'attribute_arm1';
		named: true;
		fields: {
	...
	readonly attributed_argument: {
		type: 'attributed_argument';
		named: true;
		fields: {};
		children: {
			multiple: true;
			required: true;
			types: [{ type: '_expression'; named: true }, { type: 'attribute_item'; named: true }];
		};
	};
	readonly attributed_enum_variant: {
		type: 'attributed_enum_variant';
		named: true;
		fields: {};
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'attribute_item'; named: true }, { type: 'enum_variant'; named: true }];
		};
	};
	readonly attributed_field_declaration: {
		type: 'attributed_field_declaration';
		named: true;
		fields: {};
		children: {
			multiple: true;
			required: true;
			types: [{ type: 'attribute_item'; named: true }, { type: 'field_declaration'; named: true }];
		};
	};
	readonly attributed_ordered_field: {
		type: 'attributed_ordered_field';
		named: true;
		fields: { type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] } };
		children: {
			multiple: true;
			required: false;
			types: [{ type: 'attribute_item'; named: true }, { type: 'visibility_modifier'; named: true }];
		};
	};
	readonly attributed_parameter: {
		...
		children: {
			...
			types: [
				...
				{ type: 'self_parameter'; named: true },
				{ type: 'variadic_parameter'; named: true }
			];
		};
	};
	readonly attributed_type_parameter: {
		type: 'attributed_type_parameter';
		named: true;
		fields: {};
		children: {
			multiple: true;
			...
			types: [
				{ type: 'attribute_item'; named: true },
				{ type: 'const_parameter'; named: true },
				{ type: 'lifetime_parameter'; named: true },
				{ type: 'metavariable'; named: true },
				{ type: 'type_parameter'; named: true }
			];
		};
	};
	...
	readonly block_comment: {
		...
		extra: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'block_comment_arm1'; named: true }] };
	};
	readonly block_comment_arm1: {
		type: 'block_comment_arm1';
		named: true;
		fields: {
	...
	readonly bounded_type: {
		...
		fields: {
			left: {
				multiple: false;
				required: true;
				types: [{ type: '_type'; named: true }, { type: 'lifetime'; named: true }, { type: 'use_bounds'; named: true }];
			};
			right: {
				multiple: false;
				required: true;
	...
	readonly break_expression: {
		...
		named: true;
		fields: { label: { multiple: false; required: false; types: [{ type: 'label'; named: true }] } };
	...
	readonly call_expression: {
		...
		named: true;
		fields: {
			arguments: { multiple: false; required: true; types: [{ type: 'arguments'; named: true }] };
			function: {
				multiple: false;
				required: true;
				types: [
	...
	readonly closure_expression: {
		...
		fields: {
			...
			move_marker: { multiple: false; required: false; types: [{ type: 'move'; named: false }] };
			parameters: { multiple: false; required: true; types: [{ type: 'closure_parameters'; named: true }] };
			static_marker: { multiple: false; required: false; types: [{ type: 'static'; named: false }] };
		};
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'closure_expression_block'; named: true }, { type: 'closure_expression_expr'; named: true }];
		};
	};
	readonly closure_expression_block: {
		type: 'closure_expression_block';
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'block'; named: true }] };
			return_type: { multiple: false; required: false; types: [{ type: '_type'; named: true }] };
		};
	};
	readonly closure_expression_expr: {
		...
		fields: {
			body: {
				multiple: false;
				required: true;
				types: [{ type: '_'; named: false }, { type: '_expression'; named: true }];
			};
		};
	};
	...
	readonly enum_item: {
		...
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'enum_variant_list'; named: true }] };
			name: { multiple: false; required: true; types: [{ type: 'type_identifier'; named: true }] };
			type_parameters: { multiple: false; required: false; types: [{ type: 'type_parameters'; named: true }] };
			visibility_modifier: { multiple: false; required: false; types: [{ type: 'visibility_modifier'; named: true }] };
			where_clause: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
	...
	readonly enum_variant: {
		...
		fields: {
			body: {
				...
				required: false;
				types: [
					{ type: 'field_declaration_list'; named: true },
					{ type: 'ordered_field_declaration_list'; named: true }
				];
			};
			name: { multiple: false; required: true; types: [{ type: 'identifier'; named: true }] };
			value: { multiple: false; required: false; types: [{ type: '_expression'; named: true }] };
	...
	readonly enum_variant_list: {
		...
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'enum_variant_list_elements'; named: true }] };
	};
	readonly enum_variant_list_elements: {
		type: 'enum_variant_list_elements';
		named: true;
	...
	readonly expression_statement: {
		...
		children: {
			...
			types: [
				...
				{ type: 'block'; named: true },
				{ type: 'const_block'; named: true },
				{ type: 'expression_statement_with_semi'; named: true },
				{ type: 'for_expression'; named: true },
				{ type: 'gen_block'; named: true },
				{ type: 'if_expression'; named: true },
				{ type: 'loop_expression'; named: true },
	...
	readonly extern_crate_declaration: {
		...
		fields: {
			...
			crate: { multiple: false; required: true; types: [{ type: 'crate'; named: true }] };
			name: { multiple: false; required: true; types: [{ type: 'identifier'; named: true }] };
			visibility_modifier: { multiple: false; required: false; types: [{ type: 'visibility_modifier'; named: true }] };
		};
	};
	...
	readonly field_declaration: {
		...
		named: true;
		fields: {
			name: { multiple: false; required: true; types: [{ type: 'field_identifier'; named: true }] };
			type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
			visibility_modifier: { multiple: false; required: false; types: [{ type: 'visibility_modifier'; named: true }] };
		};
	};
	readonly field_declaration_list: {
		...
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'field_declaration_list_elements'; named: true }] };
	};
	readonly field_declaration_list_elements: {
		type: 'field_declaration_list_elements';
		named: true;
		fields: {
	...
	readonly field_expression: {
		...
		fields: {
			field: {
				multiple: false;
				required: true;
				types: [{ type: 'field_identifier'; named: true }, { type: 'integer_literal'; named: true }];
			};
	...
	readonly field_initializer: {
		...
		children: { multiple: true; required: false; types: [{ type: 'attribute_item'; named: true }] };
	};
	readonly field_initializer_list: {
		...
		fields: {
			initializers: {
				multiple: false;
				required: false;
				types: [{ type: 'field_initializer_list_elements'; named: true }];
			};
		};
	};
	readonly field_initializer_list_elements: {
		type: 'field_initializer_list_elements';
		named: true;
		fields: {
			element: {
				multiple: true;
	...
	readonly field_pattern: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'field_pattern_named'; named: true }, { type: 'shorthand_field_identifier'; named: true }];
		};
	};
	readonly field_pattern_named: {
		type: 'field_pattern_named';
		named: true;
		fields: {
			name: { multiple: false; required: true; types: [{ type: 'field_identifier'; named: true }] };
			pattern: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] };
	...
	readonly foreign_mod_item: {
		...
		named: true;
		fields: {
			extern_modifier: { multiple: false; required: true; types: [{ type: 'extern_modifier'; named: true }] };
			visibility_modifier: { multiple: false; required: false; types: [{ type: 'visibility_modifier'; named: true }] };
		};
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'declaration_list'; named: true }, { type: 'foreign_mod_item_semi'; named: true }];
		};
	};
	readonly foreign_mod_item_semi: { type: 'foreign_mod_item_semi'; named: true; fields: {} };
	readonly fragment_specifier: { type: 'fragment_specifier'; named: true; fields: {} };
	readonly function_item: {
		type: 'function_item';
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'block'; named: true }] };
			function_modifiers: { multiple: false; required: false; types: [{ type: 'function_modifiers'; named: true }] };
			name: {
				multiple: false;
				required: true;
				types: [{ type: 'identifier'; named: true }, { type: 'metavariable'; named: true }];
			};
		...
		fields: {
			modifier: {
				...
				types: [
					...
					{ type: 'default'; named: false },
					{ type: 'extern_modifier'; named: true },
					{ type: 'unsafe'; named: false }
				];
			};
		};
	};
	...
	readonly function_type: {
		...
		named: true;
		fields: {
			for_lifetimes: { multiple: false; required: false; types: [{ type: 'for_lifetimes'; named: true }] };
			parameters: { multiple: false; required: true; types: [{ type: 'parameters'; named: true }] };
			return_type: { multiple: false; required: false; types: [{ type: '_type'; named: true }] };
		};
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'function_type_fn_form'; named: true }, { type: 'function_type_trait_form'; named: true }];
		};
	};
	readonly function_type_fn_form: {
		type: 'function_type_fn_form';
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'function_modifiers'; named: true }] };
	};
	readonly function_type_trait_form: {
		type: 'function_type_trait_form';
		named: true;
		fields: {
			trait: {
				multiple: false;
				required: true;
				types: [{ type: 'scoped_type_identifier'; named: true }, { type: 'type_identifier'; named: true }];
			};
		};
	};
	readonly gen_block: {
	...
	readonly generic_type_with_turbofish: {
		...
		fields: {
			...
			type: {
				multiple: false;
				required: true;
				types: [{ type: 'scoped_identifier'; named: true }, { type: 'type_identifier'; named: true }];
			};
			type_arguments: { multiple: false; required: true; types: [{ type: 'type_arguments'; named: true }] };
		};
	};
	readonly higher_ranked_trait_bound: {
		...
		fields: {
			type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
			type_parameters: { multiple: false; required: true; types: [{ type: 'type_parameters'; named: true }] };
		};
	};
		...
		fields: {
			...
			condition: {
				...
				types: [
					...
					{ type: 'let_chain'; named: true },
					{ type: 'let_condition'; named: true }
				];
			};
			consequence: { multiple: false; required: true; types: [{ type: 'block'; named: true }] };
		};
	};
	readonly impl_item: {
		type: 'impl_item';
		...
		fields: {
			trait_clause: {
				multiple: false;
				required: false;
				types: [{ type: 'impl_item_negative_clause'; named: true }, { type: 'impl_item_positive_clause'; named: true }];
			};
			type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
			type_parameters: { multiple: false; required: false; types: [{ type: 'type_parameters'; named: true }] };
			unsafe_marker: { multiple: false; required: false; types: [{ type: 'unsafe'; named: false }] };
			where_clause: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
		};
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'impl_item_body'; named: true }, { type: 'impl_item_semi'; named: true }];
		};
	};
	readonly impl_item_body: {
		type: 'impl_item_body';
		named: true;
		fields: {};
		children: { multiple: false; required: true; types: [{ type: 'declaration_list'; named: true }] };
	};
	readonly impl_item_negative_clause: {
		type: 'impl_item_negative_clause';
		named: true;
		fields: {
			trait: {
				multiple: false;
	...
	readonly impl_item_positive_clause: {
		type: 'impl_item_positive_clause';
		named: true;
		fields: {
			trait: {
				multiple: false;
	...
	readonly impl_item_semi: { type: 'impl_item_semi'; named: true; fields: {} };
	readonly index_expression: {
		type: 'index_expression';
		named: true;
		fields: {
			index: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
			object: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
		};
	};
	...
	readonly let_declaration: {
		...
		named: true;
		fields: {
			alternative: { multiple: false; required: false; types: [{ type: 'block'; named: true }] };
			mutable_specifier: { multiple: false; required: false; types: [{ type: 'mutable_specifier'; named: true }] };
			pattern: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] };
			type: { multiple: false; required: false; types: [{ type: '_type'; named: true }] };
			value: { multiple: false; required: false; types: [{ type: '_expression'; named: true }] };
		};
	};
	readonly lifetime: {
	...
	readonly macro_definition: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: 'macro_definition_brace'; named: true },
				{ type: 'macro_definition_bracket'; named: true },
				{ type: 'macro_definition_paren'; named: true }
			];
		};
	};
	...
	readonly match_arm: {
		...
		children: {
			...
			types: [
				...
				{ type: 'if_expression'; named: true },
				{ type: 'loop_expression'; named: true },
				{ type: 'match_arm_with_comma'; named: true },
				{ type: 'match_expression'; named: true },
				{ type: 'try_block'; named: true },
				{ type: 'unsafe_block'; named: true },
				{ type: 'while_expression'; named: true }
	...
	readonly match_expression: {
		...
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'match_block'; named: true }] };
			value: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
		};
	};
	...
	readonly mod_item: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'declaration_list'; named: true }, { type: 'mod_item_external'; named: true }];
		};
	};
	...
	readonly mut_pattern: {
		...
		named: true;
		fields: {
			mutable_specifier: { multiple: false; required: true; types: [{ type: 'mutable_specifier'; named: true }] };
			pattern: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] };
		};
	};
	readonly negative_literal: {
		...
		fields: {
			value: {
				multiple: false;
				required: true;
				types: [{ type: 'float_literal'; named: true }, { type: 'integer_literal'; named: true }];
			};
		};
	};
	...
	readonly or_pattern: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'or_pattern_binary'; named: true }, { type: 'or_pattern_prefix'; named: true }];
		};
	};
	readonly or_pattern_binary: {
		type: 'or_pattern_binary';
		named: true;
		fields: {
			left: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] };
			right: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] };
		};
	};
	readonly or_pattern_prefix: {
		type: 'or_pattern_prefix';
		named: true;
		fields: { right: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] } };
	};
	readonly ordered_field_declaration_list: {
		...
		fields: {
			attributes: {
				multiple: false;
				required: false;
				types: [{ type: 'ordered_field_declaration_list_elements'; named: true }];
			};
		};
	};
	readonly ordered_field_declaration_list_elements: {
		type: 'ordered_field_declaration_list_elements';
		named: true;
	...
	readonly pointer_type: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'mutable_specifier'; named: true }, { type: 'pointer_type_const'; named: true }];
		};
	};
	readonly pointer_type_const: { type: 'pointer_type_const'; named: true; fields: {} };
	readonly qualified_type: {
		type: 'qualified_type';
		named: true;
		fields: {
			alias: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
			type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
		};
	};
	readonly range_expression: {
	...
	readonly range_expression_binary: {
		...
		named: true;
		fields: {
			end: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
			operator: {
				multiple: false;
				required: true;
				types: [{ type: '..'; named: false }, { type: '...'; named: false }, { type: '..='; named: false }];
			};
			start: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
		};
	};
	readonly range_expression_postfix: {
		type: 'range_expression_postfix';
		named: true;
		fields: {
			operator: { multiple: false; required: true; types: [{ type: '..'; named: false }] };
			start: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
		};
	};
	readonly range_expression_prefix: {
		type: 'range_expression_prefix';
		named: true;
		fields: {
			end: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
			operator: { multiple: false; required: true; types: [{ type: '..'; named: false }] };
	...
	readonly ref_pattern: {
		type: 'ref_pattern';
		named: true;
		fields: { pattern: { multiple: false; required: true; types: [{ type: '_pattern'; named: true }] } };
	};
	readonly reference_expression: {
		...
		children: {
			...
			types: [
				{ type: 'mutable_specifier'; named: true },
				{ type: 'reference_expression_raw_const'; named: true },
				{ type: 'reference_expression_raw_mut'; named: true }
			];
		};
	};
	readonly reference_expression_raw_const: { type: 'reference_expression_raw_const'; named: true; fields: {} };
	readonly reference_expression_raw_mut: {
		type: 'reference_expression_raw_mut';
		named: true;
		fields: {};
	...
	readonly reference_type: {
		...
		named: true;
		fields: {
			lifetime: { multiple: false; required: false; types: [{ type: 'lifetime'; named: true }] };
			mutable_specifier: { multiple: false; required: false; types: [{ type: 'mutable_specifier'; named: true }] };
			type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
		};
	};
	readonly remaining_field_pattern: { type: 'remaining_field_pattern'; named: true; fields: {} };
	...
	readonly scoped_identifier: {
		...
		fields: {
			name: {
				multiple: false;
				required: true;
				types: [{ type: 'identifier'; named: true }, { type: 'super'; named: true }];
			};
			path: {
				multiple: false;
				required: false;
	...
	readonly scoped_use_list: {
		...
		named: true;
		fields: {
			list: { multiple: false; required: true; types: [{ type: 'use_list'; named: true }] };
			path: {
				multiple: false;
				required: false;
				types: [
	...
	readonly self_parameter: {
		...
		fields: {
			lifetime: { multiple: false; required: false; types: [{ type: 'lifetime'; named: true }] };
			mutable_specifier: { multiple: false; required: false; types: [{ type: 'mutable_specifier'; named: true }] };
			reference: { multiple: false; required: false; types: [{ type: '&'; named: false }] };
			self: { multiple: false; required: true; types: [{ type: 'self'; named: true }] };
		};
	};
	...
	readonly slice_pattern: {
		...
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'patterns'; named: true }] };
	};
	readonly source_file: {
		...
		root: true;
		fields: {
			shebang: { multiple: false; required: false; types: [{ type: 'shebang'; named: true }] };
			statements: {
				multiple: true;
				required: false;
				types: [{ type: '_declaration_statement'; named: true }, { type: 'expression_statement'; named: true }];
	...
	readonly struct_expression: {
		...
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'field_initializer_list'; named: true }] };
			name: {
				multiple: false;
				required: true;
				types: [
	...
	readonly struct_item_brace: {
		type: 'struct_item_brace';
		named: true;
		fields: { body: { multiple: false; required: true; types: [{ type: 'field_declaration_list'; named: true }] } };
		children: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
	};
	readonly struct_item_tuple: {
		type: 'struct_item_tuple';
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'ordered_field_declaration_list'; named: true }] };
		};
		children: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
	};
	readonly struct_item_unit: { type: 'struct_item_unit'; named: true; fields: {} };
	readonly struct_pattern: {
		type: 'struct_pattern';
		named: true;
		fields: {
			fields: { multiple: false; required: false; types: [{ type: 'struct_pattern_elements'; named: true }] };
			type: {
				multiple: false;
				required: true;
				types: [{ type: 'scoped_type_identifier'; named: true }, { type: 'type_identifier'; named: true }];
	...
	readonly token_binding_pattern: {
		...
		named: true;
		fields: {
			name: { multiple: false; required: true; types: [{ type: 'metavariable'; named: true }] };
	...
	readonly token_tree_pattern: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: 'token_tree_pattern_brace'; named: true },
				{ type: 'token_tree_pattern_bracket'; named: true },
				{ type: 'token_tree_pattern_paren'; named: true }
			];
		};
	};
	...
	readonly trait_item: {
		...
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'declaration_list'; named: true }] };
			bounds: { multiple: false; required: false; types: [{ type: 'trait_bounds'; named: true }] };
			name: { multiple: false; required: true; types: [{ type: 'type_identifier'; named: true }] };
			type_parameters: { multiple: false; required: false; types: [{ type: 'type_parameters'; named: true }] };
			unsafe_marker: { multiple: false; required: false; types: [{ type: 'unsafe'; named: false }] };
	...
	readonly tuple_pattern: {
		...
		named: true;
		fields: {
			elements: { multiple: false; required: false; types: [{ type: 'tuple_pattern_elements'; named: true }] };
		};
	};
	readonly tuple_pattern_elements: {
		type: 'tuple_pattern_elements';
		named: true;
		fields: {
			element: {
				multiple: true;
	...
	readonly type_argument: {
		...
		children: {
			...
			types: [
				...
				{ type: 'block'; named: true },
				{ type: 'lifetime'; named: true },
				{ type: 'trait_bounds'; named: true },
				{ type: 'type_binding'; named: true }
			];
		};
	};
	...
	readonly type_item: {
		...
		fields: {
			name: { multiple: false; required: true; types: [{ type: 'type_identifier'; named: true }] };
			trailing_where_clause: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
			type: { multiple: false; required: true; types: [{ type: '_type'; named: true }] };
			type_parameters: { multiple: false; required: false; types: [{ type: 'type_parameters'; named: true }] };
			visibility_modifier: { multiple: false; required: false; types: [{ type: 'visibility_modifier'; named: true }] };
			where_clause: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
	...
	readonly type_parameter: {
		...
		fields: {
			bounds: { multiple: false; required: false; types: [{ type: 'trait_bounds'; named: true }] };
			default_type: { multiple: false; required: false; types: [{ type: '_type'; named: true }] };
			name: { multiple: false; required: true; types: [{ type: 'type_identifier'; named: true }] };
		};
	};
	...
	readonly unary_expression: {
		...
		named: true;
		fields: {
			operand: { multiple: false; required: true; types: [{ type: '_expression'; named: true }] };
			operator: {
				multiple: false;
				required: true;
				types: [{ type: '!'; named: false }, { type: '*'; named: false }, { type: '-'; named: false }];
	...
	readonly union_item: {
		...
		named: true;
		fields: {
			body: { multiple: false; required: true; types: [{ type: 'field_declaration_list'; named: true }] };
			name: { multiple: false; required: true; types: [{ type: 'type_identifier'; named: true }] };
			type_parameters: { multiple: false; required: false; types: [{ type: 'type_parameters'; named: true }] };
			visibility_modifier: { multiple: false; required: false; types: [{ type: 'visibility_modifier'; named: true }] };
			where_clause: { multiple: false; required: false; types: [{ type: 'where_clause'; named: true }] };
	...
	readonly unit_expression: { type: 'unit_expression'; named: true; fields: {} };
	readonly unit_type: { type: 'unit_type'; named: true; fields: {} };
	...
	readonly use_bounds: {
		type: 'use_bounds';
		named: true;
		fields: { bounds: { multiple: false; required: false; types: [{ type: 'use_bounds_elements'; named: true }] } };
	};
	readonly use_bounds_elements: {
		type: 'use_bounds_elements';
		named: true;
		fields: {
			element: {
				multiple: true;
	...
	readonly use_list: {
		...
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'use_clauses'; named: true }] };
	};
	...
	readonly variadic_parameter: {
		...
		fields: {
			mutable_specifier: { multiple: false; required: false; types: [{ type: 'mutable_specifier'; named: true }] };
			pattern: { multiple: false; required: false; types: [{ type: '_pattern'; named: true }] };
		};
	};
	...
	readonly visibility_modifier_group1: {
		type: 'visibility_modifier_group1';
		named: true;
		fields: {};
		children: {
			multiple: false;
	...
	readonly visibility_modifier_pub: {
		...
		children: { multiple: false; required: false; types: [{ type: 'visibility_modifier_group1'; named: true }] };
	};
	readonly where_clause: {
		type: 'where_clause';
		named: true;
		fields: {};
		children: { multiple: false; required: false; types: [{ type: 'where_predicates'; named: true }] };
	};
	readonly where_predicate: {
		type: 'where_predicate';
		named: true;
		fields: {
			bounds: { multiple: false; required: true; types: [{ type: 'trait_bounds'; named: true }] };
			left: {
				multiple: false;
				required: true;
				types: [
	...
	readonly doc_comment: { type: 'doc_comment'; named: true };
	...
	readonly metavariable: { type: 'metavariable'; named: true };
	...
	readonly shebang: { type: 'shebang'; named: true };
	...
	readonly _anonymous_true: { type: 'true'; named: false };
	readonly _anonymous_try: { type: 'try'; named: false };
	readonly _anonymous_tt: { type: 'tt'; named: false };
