...
export interface Declaration<G extends GrammarContext> {
	...
	readonly constraint?: V.Clause.Bounds<G> | V.Clause.Constraint<G>; // rt only
	readonly content?:
		...
		| G['identifier']
		| V.Pattern.Splat<G>
		| V.Pattern.Splat.Dictionary<G>; // prt only   // unmapped: <python:assignment_eq> <python:assignment_type> <python:assignment_typed> <rust:impl_item_body> <rust:macro_definition_brace> <rust:macro_definition_bracket> <rust:macro_definition_paren> <rust:struct_item_brace> <rust:struct_item_tuple> <typescript:ambient_declaration_global> <typescript:ambient_declaration_module> <typescript:index_signature_colon> literal:ForeignModItemSemi literal:ImplItemSemi literal:ModItemExternal literal:StructItemUnit
	readonly declarators?: V.Unmapped<'typescript:variable_declarator'>[]; // t only   // unmapped: <typescript:variable_declarator>
	readonly declareMarker?: boolean; // t only
	...
	readonly default?:
		...
		| G['literal']
		| G['type']; // prt only
	readonly definition?: V.Declaration.Class<G> | V.Declaration.Function<G>; // p only
	...
	readonly name?:
		...
		| G['identifier']
		| G['literal']
		| G['pattern']; // prt only   // unmapped: <python:pattern> <typescript:__property_identifier> <typescript:pattern> literal:Self literal:This
...
export namespace Declaration {
	...
	export namespace Class {
		...
		export type Kinds<G extends GrammarContext> = V.Declaration.Class.Abstract<G> | V.Declaration.Class.StaticBlock<G>;
	}
	...
	export interface Decorated<G extends GrammarContext> extends V.Declaration<G> {
		// claimed by p
		readonly decorator: G['attribute'][];
		readonly definition: V.Declaration.Class<G> | V.Declaration.Function<G>;
	}
	...
	export interface EnumMember<G extends GrammarContext> extends V.Declaration<G> {
		...
		readonly name:
			...
			| G['identifier']
			| V.Literal.Number<G>
			| V.Literal.String<G>; // unmapped: <typescript:__property_identifier>
	...
	export interface Getter<G extends GrammarContext> extends V.Declaration<G> {} // claimed by t
	...
	export namespace Method {
		...
		export interface Dunder<G extends GrammarContext> extends V.Declaration.Method<G> {} // claimed by p
	...
	export interface Parameter<G extends GrammarContext> extends V.Declaration<G> {
		...
		readonly constMarker?: boolean; // t only
		readonly constraint?: V.Clause.Bounds<G> | V.Clause.Constraint<G>; // rt only
		readonly content?: G['identifier'] | V.Pattern.Splat<G> | V.Pattern.Splat.Dictionary<G>; // p only
		readonly decorator?: G['attribute'][]; // t only
		readonly default?:
			| V.Clause.Bounds.Removed<G>
			| V.Clause.Default<G>
		...
		readonly name?:
			...
			| G['identifier']
			| G['literal']
			| G['pattern']; // unmapped: <typescript:pattern> literal:Self literal:This
		readonly overrideModifier?: boolean; // t only
		readonly pattern?:
			| V.Expression.Block.Const<G>
			| V.Expression.Call.Macro<G>
	...
	export namespace Parameter {
		export interface Default<G extends GrammarContext> extends V.Declaration.Parameter<G> {
			// claimed by p
			readonly default: G['expression'] | G['identifier'] | G['literal'];
		...
		export interface Optional<G extends GrammarContext> extends V.Declaration.Parameter<G> {
			...
			readonly name: V.Unmapped<'typescript:pattern'>; // unmapped: <typescript:pattern> literal:This
			readonly overrideModifier?: boolean;
			readonly readonlyMarker?: boolean;
		...
		export interface Typed<G extends GrammarContext> extends V.Declaration.Parameter<G> {
			// claimed by p
			readonly content: G['identifier'] | V.Pattern.Splat<G> | V.Pattern.Splat.Dictionary<G>;
	...
	export interface Setter<G extends GrammarContext> extends V.Declaration<G> {} // claimed by t
	...
	export namespace TypeAlias {
		...
		export type Kinds<G extends GrammarContext> = V.Declaration.TypeAlias.Associated<G>;
	}
