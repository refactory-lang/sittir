...
export interface Modifier<G extends GrammarContext> {
	...
	readonly content?: V.Modifier.Visibility.Pub<G>; // r only   // unmapped: literal:Crate
...
export namespace Modifier {
	...
	export interface Visibility<G extends GrammarContext> extends V.Modifier<G> {
		// claimed by r
		readonly content?: V.Modifier.Visibility.Pub<G>; // unmapped: literal:Crate
	...
	export namespace Visibility {
		...
		export type Kinds<G extends GrammarContext> = V.Modifier.Visibility.Pub<G>;
	}
	export type Kinds<G extends GrammarContext> = V.Modifier.Extern<G> | V.Modifier.Visibility.Pub<G>;
}
