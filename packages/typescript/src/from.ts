...
const _K20: readonly string[] = ['object_pattern', 'array_pattern'];
...
const _K24: readonly string[] = ['_class_heritage_extends_clause', 'implements_clause'];
const _K25: readonly string[] = ['type_annotation', 'asserts_annotation', 'type_predicate_annotation'];
const _K26: readonly string[] = ['_arrow_function_parameter', '_arrow_function__call_signature'];
...
const _K28: readonly string[] = ['_call_expression_call', '_call_expression_template_call', '_call_expression_member'];
...
const _K34: readonly string[] = ['_update_expression_postfix', '_update_expression_prefix'];
const _K35: readonly string[] = ['_string_double', '_string_single'];
const _K36: readonly string[] = ['_template_chars', 'escape_sequence'];
const _K37: readonly string[] = ['template_substitution'];
...
function resolveVariableDeclaratorArm1_name(
	...
	return _resolveOne<T.Identifier | T.ObjectPattern | T.ArrayPattern>(value, _K3, _K20);
}
...
function resolveCallExpressionCall_function(
	...
	return _resolveOne<T.Expression | T.Import>(value, _K30, _K15);
}
...
function resolveCallExpressionMember_function(
	...
	return _resolveOne<T.PrimaryExpression>(value, _K8, _K29);
}
...
function resolveTypeQueryMemberExpression_property(
	...
	return _resolveOne<T.PrivatePropertyIdentifier | T.Identifier>(value, _K31, _K0);
}
...
export function coerceToArray(
	...
	if (input.length === 1 && isNodeData(input[0]) && input[0].$type === TSKindId.Array) {
		...
		const children = stored === undefined ? [] : Array.isArray(stored) ? stored : [stored];
		return F.buildArray(
			...(_resolveMany<T.Expression | T.SpreadElement>(children, _K8, _K21) as unknown as Parameters<
				typeof F.buildArray
			>)
		);
	}
	...
	return F.buildArray(
		...(_resolveMany<T.Expression | T.SpreadElement>(_elems, _K8, _K21) as unknown as Parameters<typeof F.buildArray>)
	);
}
...
export function coerceToArrayPattern(
	...
	if (input.length === 1 && isNodeData(input[0]) && input[0].$type === TSKindId.ArrayPattern) {
		...
		return F.buildArrayPattern(
			...(_resolveMany<T.Pattern | T.AssignmentPattern>(children, _K18, _K22) as unknown as Parameters<
	...
	return F.buildArrayPattern(
		...(_resolveMany<T.Pattern | T.AssignmentPattern>(_elems, _K18, _K22) as unknown as Parameters<
			typeof F.buildArrayPattern
		>)
	);
}
...
export function resolveNestedIdentifier_object(
	...
	return _resolveOne<T.Identifier | T.NestedIdentifier>(value, _K3, _K23);
}
...
export function resolveClassHeritage_content(
	...
	return _resolveOne<T.ClassHeritageExtendsClause | T.ImplementsClause>(value, _K0, _K24);
}
...
export function resolveFunctionExpression_returnType(
	...
	return _resolveOne<T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation>(value, _K0, _K25);
}
...
export function resolveArrowFunction_content(
	...
	return _resolveOne<T.ArrowFunctionParameter | T.ArrowFunctionUCallSignature>(value, _K0, _K26);
}

export function resolveArrowFunction_body(value: T.ArrowFunction.LooseConfig['body']): T.ArrowFunction['_body'] {
	return _resolveOne<T.Expression | T.StatementBlock>(value, _K8, _K27);
}
...
export function resolveCallExpression_content(
	...
	return _resolveOne<T.CallExpressionCall | T.CallExpressionTemplateCall | T.CallExpressionMember>(value, _K0, _K28);
}
...
export function resolveMemberExpression_object(
	...
	return _resolveOne<T.Expression | T.PrimaryExpression | T.Import>(value, _K30, _K15);
}
...
export function resolveAssignmentExpression_left(
	...
	return _resolveOne<T.ParenthesizedExpression | T._LhsExpression>(value, _K18, _K32);
}
...
export function resolveAugmentedAssignmentExpression_left(
	...
	return _resolveOne<
		...
		| T.NonNullExpression
	>(value, _super_statement_identifier, _K33);
}
...
export function resolveUpdateExpression_content(
	...
	return _resolveOne<T.UpdateExpressionPostfix | T.UpdateExpressionPrefix>(value, _K0, _K34);
}
...
export function resolveString_content(value: T.String.LooseConfig['content']): T.String['_content'] {
	return _resolveOne<T.StringDouble | T.StringSingle>(value, _K0, _K35);
}
...
export function coerceToArguments(
	...
	return F.buildArguments(
		...(_resolveMany<T.Expression | T.SpreadElement>(_elems, _K8, _K21) as unknown as Parameters<
			typeof F.buildArguments
		>)
	);
}
...
export function resolvePairPattern_value(value: T.PairPattern.LooseConfig['value']): T.PairPattern['_value'] {
	return _resolveOne<T.Pattern | T.AssignmentPattern>(value, _K18, _K22);
}
