...
> = {
	...
	_export_statement_default_from_arm_ns_from: [{ name: "source", required: true, multiple: false }],
	_export_statement_default_from_arm_star_from: [
		{ name: "source", required: true, multiple: false },
	],
	_export_statement_equals_export: [],
	_export_statement_namespace_export: [],
	_export_statement_type_export: [{ name: "source", required: false, multiple: false }],
	_for_header_lhs: [{ name: "left", required: true, multiple: false }],
	_import_clause_default_import: [],
	_import_clause_named_imports: [],
	_import_clause_namespace_import: [],
	_import_specifier_name: [{ name: "name", required: true, multiple: false }],
	_index_signature_mapped_type_clause: [],
	_interface_body: [],
	_jsx_string: [],
	_lhs_expression: [],
	...
	arrow_function_parameter: [{ name: "parameter", required: true, multiple: false }],
	as_expression: [
	...
	constraint: [{ name: "type", required: true, multiple: false }],
	construct_signature: [
	...
	export_statement_equals_export: [],
	export_statement_namespace_export: [],
	export_statement_type_export: [{ name: "source", required: false, multiple: false }],
	expression_statement: [{ name: "semicolon", required: true, multiple: false }],
	extends_clause: [
	...
	import_specifier: [{ name: "importKind", required: false, multiple: false }],
	import_specifier_name: [{ name: "name", required: true, multiple: false }],
	import_statement: [
	...
	return_statement: [{ name: "semicolon", required: true, multiple: false }],
	satisfies_expression: [
		{ name: "expression", required: true, multiple: false },
		{ name: "typeAnnotation", required: true, multiple: false },
	],
	...
	switch_default: [{ name: "body", required: true, multiple: true }],
	switch_statement: [
		{ name: "value", required: true, multiple: false },
		{ name: "body", required: true, multiple: false },
	],
	...
	throw_statement: [{ name: "semicolon", required: true, multiple: false }],
	try_statement: [
		{ name: "body", required: true, multiple: false },
