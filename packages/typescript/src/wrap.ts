...
export function wrapJsxOpeningElement(
	...
	return {
		...data,
		get name() {
			return drillAs(data.$fields?.["name"], tree, "member_expression", "nested_identifier");
		},
		get typeArguments() {
...
export function wrapNestedIdentifier(
	...
	return {
		...data,
		get object() {
			return drillAs(data.$fields?.["object"], tree, "member_expression", "nested_identifier");
		},
		get property() {
			return drillAs(
...
export function wrapArrowFunctionParameter(
	...
	return {
		...data,
		get parameter() {
			return drillAs(data.$fields?.["parameter"], tree, "identifier", "_reserved_identifier");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
...
export function wrapAugmentedAssignmentExpression(
	...
	return {
		...data,
		get left() {
			return drillAs(data.$fields?.["left"], tree, "identifier", "_reserved_identifier");
		},
		get operator() {
			return drillIn(data.$fields?.["operator"], tree);
		},
...
export function wrapInterfaceDeclaration(
	...
	return {
		...
		get body() {
			return drillAs(data.$fields?.["body"], tree, "interface_body", "_interface_body");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
...
export function wrapTypePredicate(data: _NodeData, tree: TreeHandle): WrappedNode<TypePredicate> {
	return {
		...data,
		get name() {
			return drillAs(data.$fields?.["name"], tree, "identifier", "predefined_type");
		},
		get typeField() {
			return drillIn(data.$fields?.["type"], tree);
		},
