...
const SUPERTYPE_MEMBERS: Record<string, ReadonlySet<string>> = {
	...
	import_specifier: new Set(['import_specifier_name', 'import_specifier_as']),
	statement: new Set([
		'export_statement',
		'export_statement_default',
		'export_statement_default_from',
	...
	variable_declarator: new Set(['variable_declarator_plain', 'variable_declarator_definite']),
	_for_header: new Set(['for_header_lhs', 'for_header_var_kind', 'for_header_let_const_kind']),
	...
	update_expression: new Set(['update_expression_postfix', 'update_expression_prefix']),
...
export function wrapExportStatement(
	...
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.ExportStatement | readonly T.ExportStatement[] },
		[
	...
	const kindKeyed = _firstKindKeyedWrapChild(node, [
		...
		'export_statement_equals_export',
		'export_statement_namespace_export'
	]) as T.ExportStatement | readonly T.ExportStatement[] | undefined;
	const filtered =
		kindKeyed ??
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ExportStatement>(node as unknown as T.ExportStatement, tree);
	}
...
export function wrapModuleExportName(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.ModuleExportName | readonly T.ModuleExportName[] },
		['_identifier', '_string']
	);
	const kindKeyed = _firstKindKeyedWrapChild(node, ['identifier', 'string']) as
		| T.ModuleExportName
		| readonly T.ModuleExportName[]
		| undefined;
	const filtered = kindKeyed ?? _filterWrapChildrenByKind(node.$other, ['identifier', 'string']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ModuleExportName>(node as unknown as T.ModuleExportName, tree);
	}
...
export function wrapDeclaration(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.Declaration | readonly T.Declaration[] },
		[
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.Declaration>(node as unknown as T.Declaration, tree);
	}
...
export function wrapImportSpecifier(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.ImportSpecifier | readonly T.ImportSpecifier[] },
		['_import_specifier_name', '_import_specifier_as']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ImportSpecifier>(node as unknown as T.ImportSpecifier, tree);
	}
...
export function wrapStatement(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.Statement | readonly T.Statement[] },
		[
			'_export_statement',
			'_import_statement',
			'_debugger_statement',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.Statement>(node as unknown as T.Statement, tree);
	}
...
export function wrapVariableDeclarator(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.VariableDeclarator | readonly T.VariableDeclarator[] },
		['_variable_declarator_plain', '_variable_declarator_definite']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.VariableDeclarator>(node as unknown as T.VariableDeclarator, tree);
	}
...
export function wrapForInStatement(
	data: T.ForInStatement & {
		readonly _for_header_lhs?: T.ForHeader;
		readonly _for_header_var_kind?: T.ForHeader;
		readonly _for_header_let_const_kind?: T.ForHeader;
	},
	tree: TreeHandle
) {
	...
	const _node = withMethods(
		{
			...
			_for_header: normalizeSingularWrapSlot(
				data._for_header ?? data._for_header_lhs ?? data._for_header_var_kind ?? data._for_header_let_const_kind,
				'for_header',
				true,
				data.$type,
				{ tree, nodeType: data.$type, slotName: 'for_header', span: (data as _NodeData).$span }
			),
			_body: projectMixedEnumStorage(
				normalizeSingularWrapSlot(data._body, 'body', true, data.$type, {
					tree,
...
export function wrapForHeader(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.ForHeader | readonly T.ForHeader[] },
		['_for_header_lhs', '_for_header_var_kind', '_for_header_let_const_kind']
	);
	const kindKeyed = _firstKindKeyedWrapChild(node, [
		'for_header_lhs',
		'for_header_var_kind',
		'for_header_let_const_kind'
	]) as T.ForHeader | readonly T.ForHeader[] | undefined;
	const filtered =
		kindKeyed ??
		_filterWrapChildrenByKind(node.$other, ['for_header_lhs', 'for_header_var_kind', 'for_header_let_const_kind']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ForHeader>(node as unknown as T.ForHeader, tree);
	}
...
export function wrapParenthesizedExpression(
	data: T.ParenthesizedExpression & {
		...
		readonly _parenthesized_expression_sequence?:
			| T.ParenthesizedExpressionTyped
			| T.ParenthesizedExpressionSequence
			| T.Identifier
			| T.DecoratorMemberExpression
	...
	const _node = withMethods(
		{
			...
			_content: normalizeSingularWrapSlot(
				data._content ??
					...
					data._parenthesized_expression_sequence ??
					data._identifier ??
...
export function wrapExpression(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.Expression | readonly T.Expression[] },
		[
			'_as_expression',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.Expression>(node as unknown as T.Expression, tree);
	}
...
export function wrapPrimaryExpression(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.PrimaryExpression | readonly T.PrimaryExpression[] },
		[
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.PrimaryExpression>(node as unknown as T.PrimaryExpression, tree);
	}
...
export function wrapFormalParameter(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.FormalParameter | readonly T.FormalParameter[] },
		['_required_parameter', '_optional_parameter']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.FormalParameter>(node as unknown as T.FormalParameter, tree);
	}
...
export function wrap_LhsExpression(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T._LhsExpression | readonly T._LhsExpression[] },
		[
			'_member_expression',
			'_subscript_expression',
			'_undefined',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T._LhsExpression>(node as unknown as T._LhsExpression, tree);
	}
...
export function wrapAugmentedAssignmentLhs(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.AugmentedAssignmentLhs | readonly T.AugmentedAssignmentLhs[] },
		[
			'_member_expression',
			'_subscript_expression',
			'__reserved_identifier',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.AugmentedAssignmentLhs>(node as unknown as T.AugmentedAssignmentLhs, tree);
	}
...
export function wrapDestructuringPattern(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.DestructuringPattern | readonly T.DestructuringPattern[] },
		['_object_pattern', '_array_pattern']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.DestructuringPattern>(node as unknown as T.DestructuringPattern, tree);
	}
...
export function wrapUpdateExpression(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.UpdateExpression | readonly T.UpdateExpression[] },
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.UpdateExpression>(node as unknown as T.UpdateExpression, tree);
	}
...
export function wrapPattern(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.Pattern | readonly T.Pattern[] },
		['__lhs_expression', '_lhs_expression', '_rest_pattern']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.Pattern>(node as unknown as T.Pattern, tree);
	}
...
export function wrapPropertyName(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.PropertyName | readonly T.PropertyName[] },
		[
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.PropertyName>(node as unknown as T.PropertyName, tree);
	}
...
export function wrapStatementIdentifier(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.StatementIdentifier | readonly T.StatementIdentifier[] },
		['_identifier', '__reserved_identifier', '_reserved_identifier']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.StatementIdentifier>(node as unknown as T.StatementIdentifier, tree);
	}
...
export function wrapShorthandPropertyIdentifier(
	...
	const filtered =
		kindKeyed ?? _filterWrapChildrenByKind(node.$other, ['identifier', '_reserved_identifier', 'reserved_identifier']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ShorthandPropertyIdentifier>(node as unknown as T.ShorthandPropertyIdentifier, tree);
	}
...
export function wrapShorthandPropertyIdentifierPattern(
	...
	const filtered =
		kindKeyed ?? _filterWrapChildrenByKind(node.$other, ['identifier', '_reserved_identifier', 'reserved_identifier']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ShorthandPropertyIdentifierPattern>(
			node as unknown as T.ShorthandPropertyIdentifierPattern,
			tree
		);
	}
...
export function wrap_PropertyIdentifier(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T._PropertyIdentifier | readonly T._PropertyIdentifier[] },
		['_identifier', '__reserved_identifier', '_reserved_identifier']
	);
	const kindKeyed = _firstKindKeyedWrapChild(node, ['identifier', '_reserved_identifier', 'reserved_identifier']) as
	...
	const filtered =
		kindKeyed ?? _filterWrapChildrenByKind(node.$other, ['identifier', '_reserved_identifier', 'reserved_identifier']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T._PropertyIdentifier>(node as unknown as T._PropertyIdentifier, tree);
	}
...
export function wrapImportIdentifier(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.ImportIdentifier | readonly T.ImportIdentifier[] },
		['_identifier', '_type_keyword']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ImportIdentifier>(node as unknown as T.ImportIdentifier, tree);
	}
...
export function wrapType(data: T.Type & { readonly $other?: T.Type | readonly T.Type[] }, tree: TreeHandle) {
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(data as unknown as _NodeData & { readonly $other?: T.Type | readonly T.Type[] }, [
		'_primary_type',
		'_function_type',
		'_readonly_type',
		'_constructor_type',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.Type>(node as unknown as T.Type, tree);
	}
...
export function wrapTupleTypeMember(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.TupleTypeMember | readonly T.TupleTypeMember[] },
		['_tuple_parameter', '_optional_tuple_parameter', '_optional_type', '_rest_type', '_type']
	);
	const kindKeyed = _firstKindKeyedWrapChild(node, [
		'tuple_parameter',
		'optional_tuple_parameter',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.TupleTypeMember>(node as unknown as T.TupleTypeMember, tree);
	}
...
export function wrapPrimaryType(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.PrimaryType | readonly T.PrimaryType[] },
		[
			'_parenthesized_type',
			'_predefined_type',
			'_identifier',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.PrimaryType>(node as unknown as T.PrimaryType, tree);
	}
...
export function wrapIndexSignature(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.IndexSignature | readonly T.IndexSignature[] },
		['_index_signature_colon', '_index_signature_mapped_type_clause']
	);
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.IndexSignature>(node as unknown as T.IndexSignature, tree);
	}
...
export function wrapObjectTypeContent(
	data: T.ObjectTypeContent & {
		readonly _export_statement_default_from?:
			| T.ExportStatement
			| T.PropertySignature
			| T.CallSignature
			...
			| T.IndexSignature
			| T.MethodSignature;
		readonly _export_statement_default_declaration?:
			| T.ExportStatement
			| T.PropertySignature
			| T.CallSignature
			| T.ConstructSignature
		...
		readonly _construct_signature?:
			...
			| T.IndexSignature
			| T.MethodSignature;
		readonly _index_signature_colon?:
			| T.ExportStatement
			| T.PropertySignature
			| T.CallSignature
			| T.ConstructSignature
			| T.IndexSignature
			| T.MethodSignature;
		readonly _index_signature_mapped_type_clause?:
			| T.ExportStatement
			| T.PropertySignature
			| T.CallSignature
			| T.ConstructSignature
	...
	const _content = normalizeRepeatedWrapSlot(
		data._content !== undefined
			? _toArr(data._content)
			: _interleaveBySlotOrder(data as _NodeData, [
					['export_statement_default_from', data._export_statement_default_from],
					['export_statement_default_declaration', data._export_statement_default_declaration],
					['export_statement_type_export', data._export_statement_type_export],
					['export_statement_equals_export', data._export_statement_equals_export],
					['export_statement_namespace_export', data._export_statement_namespace_export],
					...
					['index_signature_colon', data._index_signature_colon],
					['index_signature_mapped_type_clause', data._index_signature_mapped_type_clause],
...
export function wrapExportStatementDefault(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.ExportStatementDefault | readonly T.ExportStatementDefault[] },
		['_export_statement_default_from', '_export_statement_default_declaration']
	);
	const kindKeyed = _firstKindKeyedWrapChild(node, [
		'export_statement_default_from',
		'export_statement_default_declaration'
	]) as T.ExportStatementDefault | readonly T.ExportStatementDefault[] | undefined;
	const filtered =
		kindKeyed ??
		_filterWrapChildrenByKind(node.$other, ['export_statement_default_from', 'export_statement_default_declaration']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.ExportStatementDefault>(node as unknown as T.ExportStatementDefault, tree);
	}
	...
	const _node = withMethods(
		{
			...
			_content: normalizeSingularWrapSlot(
				data._content ??
					...
					data._index_signature_colon ??
					data._index_signature_mapped_type_clause ??
...
export function wrapParenthesizedExpressionTyped(
	data: T.ParenthesizedExpressionTyped & {
		...
		readonly _meta_property_new_target?: T.Expression;
		readonly _meta_property_import_meta?: T.Expression;
		...
		readonly _update_expression_postfix?: T.Expression;
		readonly _update_expression_prefix?: T.Expression;
			...
			_expression: projectMixedEnumStorage(
				normalizeSingularWrapSlot(
					data._expression ??
						...
						data._update_expression_postfix ??
						data._update_expression_prefix ??
...
export function wrapExportStatementDefaultFrom(
	data: T.ExportStatementDefaultFrom & {
		readonly _export_statement_default_from_star_from?:
			| T.ExportStatementDefaultFromStarFrom
			| T.ExportStatementDefaultFromNsFrom
			| T.ExportStatementDefaultFromClauseFrom
			| T.ExportClause;
		readonly _export_statement_default_from_ns_from?:
			| T.ExportStatementDefaultFromStarFrom
			| T.ExportStatementDefaultFromNsFrom
			| T.ExportStatementDefaultFromClauseFrom
			| T.ExportClause;
		readonly _export_statement_default_from_clause_from?:
			| T.ExportStatementDefaultFromStarFrom
			| T.ExportStatementDefaultFromNsFrom
			| T.ExportStatementDefaultFromClauseFrom
			| T.ExportClause;
	...
	const _node = withMethods(
		{
			...
			_content: normalizeSingularWrapSlot(
				data._content ??
					data._export_statement_default_from_star_from ??
					data._export_statement_default_from_ns_from ??
					data._export_statement_default_from_clause_from ??
					data._export_clause,
				'content',
				true,
				data.$type,
...
export function wrapExportStatementDefaultDeclaration(
	data: T.ExportStatementDefaultDeclaration & {
		readonly _declaration?: T.ExportStatementDefaultDeclarationDefaultKw | T.Declaration;
		readonly _export_statement_default_declaration_default_kw?:
			| T.ExportStatementDefaultDeclarationDefaultKw
			| T.Declaration;
	},
	tree: TreeHandle
) {
	...
	const _node = withMethods(
		{
			..._omitWrapKeys(data, ['_declaration', '_export_statement_default_declaration_default_kw']),
			...
			_content: normalizeSingularWrapSlot(
				data._content ?? data._declaration ?? data._export_statement_default_declaration_default_kw,
				'content',
				true,
				data.$type,
				{ tree, nodeType: data.$type, slotName: 'content', span: (data as _NodeData).$span }
...
export function wrapExportStatementDefaultDeclarationDefaultKw(
	data: T.ExportStatementDefaultDeclarationDefaultKw & {
		readonly _declaration?: T.ExportStatementDefaultDeclarationDefaultKwValue | T.Declaration;
		readonly _export_statement_default_declaration_default_kw_value?:
	...
	const _node = withMethods(
		{
			..._omitWrapKeys(data, ['_declaration', '_export_statement_default_declaration_default_kw_value']),
			$type: TSKindId.ExportStatementDefaultDeclarationDefaultKw as const,
			_content: normalizeSingularWrapSlot(
				data._content ?? data._declaration ?? data._export_statement_default_declaration_default_kw_value,
				'content',
				true,
				data.$type,
				{ tree, nodeType: data.$type, slotName: 'content', span: (data as _NodeData).$span }
...
export function wrapLhsExpression(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.LhsExpression | readonly T.LhsExpression[] },
		[
			'_member_expression',
			'_subscript_expression',
			'_undefined',
	...
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.LhsExpression>(node as unknown as T.LhsExpression, tree);
	}
...
export function wrapPropertyIdentifier(
	...
	if (typeof data === 'number') return data;
	const node = _keepModelledSlots(
		data as unknown as _NodeData & { readonly $other?: T.PropertyIdentifier | readonly T.PropertyIdentifier[] },
		['_identifier', '__reserved_identifier', '_reserved_identifier']
	);
	const kindKeyed = _firstKindKeyedWrapChild(node, ['identifier', '_reserved_identifier', 'reserved_identifier']) as
	...
	const filtered =
		kindKeyed ?? _filterWrapChildrenByKind(node.$other, ['identifier', '_reserved_identifier', 'reserved_identifier']);
	if (filtered === undefined && (typeof node.$text === 'string' || node.$nodeHandle != null)) {
		return drillInSelf<T.PropertyIdentifier>(node as unknown as T.PropertyIdentifier, tree);
	}
...
const _wrapTable: Record<number, (data: _NodeData, tree: TreeHandle) => unknown> = {
	...
	[TSKindId.ParenthesizedExpressionSequence]: (d, t) =>
		wrapParenthesizedExpressionSequence(d as unknown as T.ParenthesizedExpressionSequence, t),
	...
	[TSKindId.ExportStatementDefaultFromStarFrom]: (d, t) =>
		wrapExportStatementDefaultFromStarFrom(d as unknown as T.ExportStatementDefaultFromStarFrom, t),
	[TSKindId.ExportStatementDefaultFromNsFrom]: (d, t) =>
		wrapExportStatementDefaultFromNsFrom(d as unknown as T.ExportStatementDefaultFromNsFrom, t),
	[TSKindId.ExportStatementDefaultFromClauseFrom]: (d, t) =>
		wrapExportStatementDefaultFromClauseFrom(d as unknown as T.ExportStatementDefaultFromClauseFrom, t),
	[TSKindId.ExportStatementDefaultDeclarationDefaultKw]: (d, t) =>
		wrapExportStatementDefaultDeclarationDefaultKw(d as unknown as T.ExportStatementDefaultDeclarationDefaultKw, t),
	[TSKindId.ExportStatementDefaultDeclarationDefaultKwValue]: (d, t) =>
		wrapExportStatementDefaultDeclarationDefaultKwValue(
			d as unknown as T.ExportStatementDefaultDeclarationDefaultKwValue,
			t
		),
...
interface _WrapReturnByKindId {
	...
	[TSKindId.ImportSpecifierName]: ReturnType<typeof wrapImportSpecifierName>;
	...
	[TSKindId.ParenthesizedExpressionSequence]: ReturnType<typeof wrapParenthesizedExpressionSequence>;
	...
	[TSKindId.ExportStatementDefaultFromStarFrom]: ReturnType<typeof wrapExportStatementDefaultFromStarFrom>;
	[TSKindId.ExportStatementDefaultFromNsFrom]: ReturnType<typeof wrapExportStatementDefaultFromNsFrom>;
	[TSKindId.ExportStatementDefaultFromClauseFrom]: ReturnType<typeof wrapExportStatementDefaultFromClauseFrom>;
	[TSKindId.ExportStatementDefaultDeclarationDefaultKw]: ReturnType<
		typeof wrapExportStatementDefaultDeclarationDefaultKw
	>;
	[TSKindId.ExportStatementDefaultDeclarationDefaultKwValue]: ReturnType<
		typeof wrapExportStatementDefaultDeclarationDefaultKwValue
	>;
	...
	[TSKindId.MetaPropertyNewTarget]: _NodeData & { readonly $type: TSKindId.MetaPropertyNewTarget };
	[TSKindId.MetaPropertyImportMeta]: _NodeData & { readonly $type: TSKindId.MetaPropertyImportMeta };
