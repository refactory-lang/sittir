...
const WRAP_WARNING_MODE =
  typeof process !== "undefined" && process.env?.SITTIR_WRAP_WARNING_MODE === "1";
...
function normalizeRepeatedWrapSlot<T>(
  ...
  if (nonEmpty && items.length === 0)
    return handleWrapViolation(
      `repeated slot ${JSON.stringify(slotName)} requires at least one value`,
      items,
      context,
    );
  return items;
...
function projectKindEnumStorage<T>(value: T): T {
  ...
  if (Array.isArray(value))
    return value.map((entry) => projectKindEnumStorage(entry)) as unknown as T;
...
function readTerminalFromOther(
  data: _NodeData,
  allowedKindIds: readonly number[],
): _NodeData | number | undefined {
...
function _matchesAllowedWrapKind(kind: string, allowedKinds: readonly string[]): boolean {
  ...
  for (const allowed of allowedKinds) {
    const members =
      SUPERTYPE_MEMBERS[allowed] ??
      SUPERTYPE_MEMBERS[allowed.startsWith("_") ? allowed.slice(1) : allowed];
  ...
  const _node = withMethods(
    {
      ...
      _type_arguments: normalizeSingularWrapSlot(
        data._type_arguments,
        "type_arguments",
        false,
        data.$type,
  ...
  const _node = withMethods(
    {
      ...
      _type_parameters: normalizeSingularWrapSlot(
        data._type_parameters,
        "type_parameters",
        false,
        data.$type,
        {
      ...
      returnType() {
        return drillIn<
          T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation | undefined
        >(this._return_type, tree);
      },
      $with: {
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        type: (v: NonNullable<T._CatchClauseGroup1["_type"]>) =>
          wrap_CatchClauseGroup1({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        content: (v: NonNullable<T.ClassBodyMember["_content"]>) =>
          wrapClassBodyMember({ ...data, _content: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      _method_definition: normalizeSingularWrapSlot(
        data._method_definition,
        "method_definition",
        true,
        data.$type,
        {
  ...
  const _node = withMethods(
    {
      ...
      _method_signature: normalizeSingularWrapSlot(
        data._method_signature,
        "method_signature",
        true,
        data.$type,
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapClassBodyMethodSig({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _extends_clause: normalizeSingularWrapSlot(
        data._extends_clause,
        "extends_clause",
        true,
        data.$type,
        { tree, nodeType: data.$type, slotName: "extends_clause", span: (data as _NodeData).$span },
      ),
      _implements_clause: normalizeSingularWrapSlot(
        data._implements_clause,
        "implements_clause",
        false,
        data.$type,
        {
  ...
  const _node = withMethods(
    {
      ...
      _content: normalizeSingularWrapSlot(
        data._export_statement_default_from_arm ??
          data._export_statement_default_decl_arm ??
          data._content,
        "content",
        true,
        data.$type,
      ...
      content() {
        return drillIn<T.ExportStatementDefaultFromArm | T.ExportStatementDefaultDeclArm>(
          this._content,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapExportStatementDefault({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        exportStatementDefaultDeclArmDefaultKw: (
          v: NonNullable<
            T.ExportStatementDefaultDeclArm["_export_statement_default_decl_arm_default_kw"]
          >,
        ) =>
          wrapExportStatementDefaultDeclArm(
            { ...data, _export_statement_default_decl_arm_default_kw: v },
            tree,
          ),
      },
    },
  ...
  const _node = withMethods(
    {
      ...
      _export_clause: normalizeSingularWrapSlot(
        data._export_clause,
        "export_clause",
        true,
        data.$type,
        { tree, nodeType: data.$type, slotName: "export_clause", span: (data as _NodeData).$span },
      ),
      ...
      $with: {
        exportClause: (
          v: NonNullable<T.ExportStatementDefaultFromArmClauseFrom["_export_clause"]>,
...
export function wrapExportStatementDefaultFromArmNsFrom(
  data: T.ExportStatementDefaultFromArmNsFrom,
  tree: TreeHandle,
) {
  const _node = withMethods(
    {
      ...
      _namespace_export: normalizeSingularWrapSlot(
        data._namespace_export,
        "namespace_export",
        true,
        data.$type,
        {
      ...
      $with: {
        namespaceExport: (
          v: NonNullable<T.ExportStatementDefaultFromArmNsFrom["_namespace_export"]>,
  ...
  const _node = withMethods(
    {
      ...
      _content: normalizeSingularWrapSlot(
        data._for_header_lhs ??
          data._for_header_var_kind ??
          data._for_header_let_const_kind ??
          data._content,
        "content",
        true,
        data.$type,
      ...
      content() {
        return drillIn<T.ForHeaderLhs | T.ForHeaderVarKind | T.ForHeaderLetConstKind>(
          this._content,
          tree,
        );
      },
      ...
      $with: {
        content: (v: NonNullable<T.ForHeader["_content"]>) =>
          wrapForHeader({ ...data, _content: v }, tree),
        operator: (v: NonNullable<T.ForHeader["_operator"]>) =>
          wrapForHeader({ ...data, _operator: v }, tree),
        right: (v: NonNullable<T.ForHeader["_right"]>) =>
          wrapForHeader({ ...data, _right: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        left: (v: NonNullable<T.ForHeaderLhs["_left"]>) =>
          wrapForHeaderLhs({ ...data, _left: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _kind: projectKindEnumStorage(
        normalizeSingularWrapSlot(
          data._kind ?? readTerminalFromOther(data, [TSKindId.Var]),
          "kind",
          true,
          data.$type,
          { tree, nodeType: data.$type, slotName: "kind", span: (data as _NodeData).$span },
      ...
      $with: {
        kind: (v: NonNullable<T.ForHeaderVarKind["_kind"]>) =>
          wrapForHeaderVarKind({ ...data, _kind: v }, tree),
        left: (v: NonNullable<T.ForHeaderVarKind["_left"]>) =>
          wrapForHeaderVarKind({ ...data, _left: v }, tree),
        value: (v: NonNullable<T.ForHeaderVarKind["_value"]>) =>
          wrapForHeaderVarKind({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        source: (v: NonNullable<T.FromClause["_source"]>) =>
          wrapFromClause({ ...data, _source: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        importClauseGroup1: (
          v: NonNullable<T.ImportClauseDefaultImport["_import_clause_group1"]>,
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrap_ImportClauseGroup1({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
...
export function wrapImportIdentifier(data: T.ImportIdentifier, tree: TreeHandle) {
  return drillIn<T.ImportIdentifier>(
    normalizeSingularWrapSlot(
      _filterWrapChildrenByKind(data.$other, ["identifier"]),
      "children",
      true,
      data.$type,
      { tree, nodeType: data.$type, slotName: "children", span: (data as _NodeData).$span },
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.ImportSpecifierAs["_name"]>) =>
          wrapImportSpecifierAs({ ...data, _name: v }, tree),
        alias: (v: NonNullable<T.ImportSpecifierAs["_alias"]>) =>
          wrapImportSpecifierAs({ ...data, _alias: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.IndexSignatureColon["_name"]>) =>
          wrapIndexSignatureColon({ ...data, _name: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        value: (v: NonNullable<T.Initializer["_value"]>) =>
          wrapInitializer({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        operator: (v: NonNullable<T._Number["_operator"]>) =>
          wrap_Number({ ...data, _operator: v }, tree),
        argument: (v: NonNullable<T._Number["_argument"]>) =>
          wrap_Number({ ...data, _argument: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        pattern: (v: NonNullable<T.ParameterName["_pattern"]>) =>
          wrapParameterName({ ...data, _pattern: v }, tree),
      },
    },
    methodsEngine,
  );
...
export function wrapPublicFieldDefinitionAbstractFirst(
  data: T.PublicFieldDefinitionAbstractFirst,
  tree: TreeHandle,
) {
  const _node = withMethods(
    {
      ...
      $with: {
        abstractMarker: (
          v: NonNullable<T.PublicFieldDefinitionAbstractFirst["_abstract_marker"]>,
        ) => wrapPublicFieldDefinitionAbstractFirst({ ...data, _abstract_marker: v }, tree),
        readonlyMarker: (
          v: NonNullable<T.PublicFieldDefinitionAbstractFirst["_readonly_marker"]>,
...
export function wrapPublicFieldDefinitionAccessFirst(
  data: T.PublicFieldDefinitionAccessFirst,
  tree: TreeHandle,
) {
  const _node = withMethods(
    {
      ...
      $with: {
        accessibilityModifier: (
          v: NonNullable<T.PublicFieldDefinitionAccessFirst["_accessibility_modifier"]>,
...
export function wrapPublicFieldDefinitionDeclareFirst(
  data: T.PublicFieldDefinitionDeclareFirst,
  tree: TreeHandle,
) {
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapPublicFieldDefinitionDeclareFirst({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
...
export function wrapPublicFieldDefinitionReadonlyFirst(
  data: T.PublicFieldDefinitionReadonlyFirst,
  tree: TreeHandle,
) {
  const _node = withMethods(
    {
      ...
      $with: {
        readonlyMarker: (
          v: NonNullable<T.PublicFieldDefinitionReadonlyFirst["_readonly_marker"]>,
        ) => wrapPublicFieldDefinitionReadonlyFirst({ ...data, _readonly_marker: v }, tree),
        abstractMarker: (
          v: NonNullable<T.PublicFieldDefinitionReadonlyFirst["_abstract_marker"]>,
...
export function wrapPublicFieldDefinitionStaticMods(
  data: T.PublicFieldDefinitionStaticMods,
  tree: TreeHandle,
) {
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        overrideModifier: (
          v: NonNullable<T.PublicFieldDefinitionStaticMods["_override_modifier"]>,
  ...
  const _node = withMethods(
    {
      ...
      function() {
        return drillIn<
          T.Import | T.Identifier | T.TypeQueryMemberExpression | T.TypeQuerySubscriptExpression
        >(this._function, tree);
      },
      arguments() {
        return drillIn<T.Arguments>(this._arguments, tree);
  ...
  const _node = withMethods(
    {
      ...
      _class_heritage: normalizeSingularWrapSlot(
        data._class_heritage,
        "class_heritage",
        false,
        data.$type,
        { tree, nodeType: data.$type, slotName: "class_heritage", span: (data as _NodeData).$span },
      ),
      _body: normalizeSingularWrapSlot(data._body, "body", true, data.$type, {
        tree,
        nodeType: data.$type,
  ...
  const _node = withMethods(
    {
      ...
      _accessor_kind: projectKindEnumStorage(
        normalizeSingularWrapSlot(
          data._accessor_kind ??
            readTerminalFromOther(data, [TSKindId.Get, TSKindId.Set, TSKindId.Star2]),
          "accessor_kind",
          false,
          data.$type,
          {
      ...
      $with: {
        accessibilityModifier: (
          v: NonNullable<T.AbstractMethodSignature["_accessibility_modifier"]>,
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.AddingTypeAnnotation["_type"]>) =>
          wrapAddingTypeAnnotation({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      content() {
        return drillIn<T.Declaration | T.AmbientDeclarationGlobal | T.AmbientDeclarationModule>(
          this._content,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapAmbientDeclaration({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        elements: (...v: NonNullable<T.Array["_elements"]>[number][]) =>
          wrapArray({ ...data, _elements: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _primary_type: normalizeSingularWrapSlot(
        data._primary_type,
        "primary_type",
        true,
        data.$type,
        { tree, nodeType: data.$type, slotName: "primary_type", span: (data as _NodeData).$span },
      ),
  ...
  const _node = withMethods(
    {
      ...
      _arrow_function_parameter: normalizeSingularWrapSlot(
        ...
        data.$type,
        {
          tree,
          nodeType: data.$type,
          slotName: "arrow_function_parameter",
          span: (data as _NodeData).$span,
        },
      ),
      _type_parameters: normalizeSingularWrapSlot(
      ...
      $with: {
        ...
        body: (v: NonNullable<T.ArrowFunction["_body"]>) =>
          wrapArrowFunction({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _type_annotation: normalizeSingularWrapSlot(
        data._type_annotation,
        "type_annotation",
        true,
        data.$type,
        {
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        left: (v: NonNullable<T.AssignmentPattern["_left"]>) =>
          wrapAssignmentPattern({ ...data, _left: v }, tree),
        right: (v: NonNullable<T.AssignmentPattern["_right"]>) =>
          wrapAssignmentPattern({ ...data, _right: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        left: (v: NonNullable<T.BinaryExpression["_left"]>) =>
          wrapBinaryExpression({ ...data, _left: v }, tree),
        ...
        right: (v: NonNullable<T.BinaryExpression["_right"]>) =>
          wrapBinaryExpression({ ...data, _right: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      label() {
        return drillAs<T.Identifier | undefined>(
          this._label,
          tree,
      ...
      $with: {
        label: (v: NonNullable<T.BreakStatement["_label"]>) =>
          wrapBreakStatement({ ...data, _label: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapCallExpression({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        body: (v: NonNullable<T.CatchClause["_body"]>) =>
          wrapCatchClause({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        decorators: (...v: NonNullable<T.Class["_decorator"]>[number][]) =>
          wrapClass({ ...data, _decorator: v }, tree),
        ...
        classHeritage: (v: NonNullable<T.Class["_class_heritage"]>) =>
          wrapClass({ ...data, _class_heritage: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapClassBody({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.ClassDeclaration["_name"]>) =>
          wrapClassDeclaration({ ...data, _name: v }, tree),
        ...
        body: (v: NonNullable<T.ClassDeclaration["_body"]>) =>
          wrapClassDeclaration({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapClassHeritage({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        body: (v: NonNullable<T.ClassStaticBlock["_body"]>) =>
          wrapClassStaticBlock({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        left: (v: NonNullable<T.ConditionalType["_left"]>) =>
          wrapConditionalType({ ...data, _left: v }, tree),
        right: (v: NonNullable<T.ConditionalType["_right"]>) =>
          wrapConditionalType({ ...data, _right: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        content: (v: NonNullable<T.Constraint["_content"]>) =>
          wrapConstraint({ ...data, _content: v }, tree),
        type: (v: NonNullable<T.Constraint["_type"]>) =>
          wrapConstraint({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        type: (v: NonNullable<T.ConstructSignature["_type"]>) =>
          wrapConstructSignature({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        type: (v: NonNullable<T.ConstructorType["_type"]>) =>
          wrapConstructorType({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        label: (v: NonNullable<T.ContinueStatement["_label"]>) =>
          wrapContinueStatement({ ...data, _label: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapDecorator({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      content() {
        return drillIn<T.Identifier | T.DecoratorMemberExpression | T.DecoratorCallExpression>(
          this._content,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapDecoratorParenthesizedExpression({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.DefaultType["_type"]>) =>
          wrapDefaultType({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        body: (v: NonNullable<T.DoStatement["_body"]>) =>
          wrapDoStatement({ ...data, _body: v }, tree),
        condition: (v: NonNullable<T.DoStatement["_condition"]>) =>
          wrapDoStatement({ ...data, _condition: v }, tree),
        semicolon: (v: NonNullable<T.DoStatement["_semicolon"]>) =>
          wrapDoStatement({ ...data, _semicolon: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        statement: (v: NonNullable<T.ElseClause["_statement"]>) =>
          wrapElseClause({ ...data, _statement: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.EnumAssignment["_name"]>) =>
          wrapEnumAssignment({ ...data, _name: v }, tree),
        value: (v: NonNullable<T.EnumAssignment["_value"]>) =>
          wrapEnumAssignment({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _enum_assignment: normalizeRepeatedWrapSlot(
        ...
        "enum_assignment",
        {
          tree,
          nodeType: data.$type,
          slotName: "enum_assignment",
          span: (data as _NodeData).$span,
        },
      ),

      names() {
        return drillInAll<T.PropertyName>(
          this._name as readonly T.PropertyName[] | undefined,
          tree,
        );
      },
      enumAssignments() {
        return drillInAll<T.EnumAssignment>(
          this._enum_assignment as readonly T.EnumAssignment[] | undefined,
          tree,
        );
      },
      $with: {
        names: (...v: NonNullable<T.EnumBody["_name"]>[number][]) =>
          wrapEnumBody({ ...data, _name: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.EnumDeclaration["_name"]>) =>
          wrapEnumDeclaration({ ...data, _name: v }, tree),
        body: (v: NonNullable<T.EnumDeclaration["_body"]>) =>
          wrapEnumDeclaration({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapExportClause({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.ExportSpecifier["_name"]>) =>
          wrapExportSpecifier({ ...data, _name: v }, tree),
        alias: (v: NonNullable<T.ExportSpecifier["_alias"]>) =>
          wrapExportSpecifier({ ...data, _alias: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapExportStatement({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      typeArguments() {
        return drillInAll<T.TypeArguments>(
          this._type_arguments as readonly T.TypeArguments[] | undefined,
          tree,
        );
      },
      $with: {
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        body: (v: NonNullable<T.FinallyClause["_body"]>) =>
          wrapFinallyClause({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        content: (v: NonNullable<T.ForInStatement["_content"]>) =>
          wrapForInStatement({ ...data, _content: v }, tree),
        ...
        right: (v: NonNullable<T.ForInStatement["_right"]>) =>
          wrapForInStatement({ ...data, _right: v }, tree),
        body: (v: NonNullable<T.ForInStatement["_body"]>) =>
          wrapForInStatement({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      initializer() {
        return drillIn<T.LexicalDeclaration | T.VariableDeclaration | T.Expressions | ";">(
          this._initializer,
          tree,
        );
      },
      ...
      $with: {
        ...
        condition: (v: NonNullable<T.ForStatement["_condition"]>) =>
          wrapForStatement({ ...data, _condition: v }, tree),
        increment: (v: NonNullable<T.ForStatement["_increment"]>) =>
          wrapForStatement({ ...data, _increment: v }, tree),
        body: (v: NonNullable<T.ForStatement["_body"]>) =>
          wrapForStatement({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      formalParameters() {
        return drillInAll<T.FormalParameter>(
          this._formal_parameter as readonly T.FormalParameter[] | undefined,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) => wrapFormalParameters({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.FunctionDeclaration["_name"]>) =>
          wrapFunctionDeclaration({ ...data, _name: v }, tree),
        ...
        body: (v: NonNullable<T.FunctionDeclaration["_body"]>) =>
          wrapFunctionDeclaration({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.FunctionExpression["_name"]>) =>
          wrapFunctionExpression({ ...data, _name: v }, tree),
        ...
        body: (v: NonNullable<T.FunctionExpression["_body"]>) =>
          wrapFunctionExpression({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.FunctionSignature["_name"]>) =>
          wrapFunctionSignature({ ...data, _name: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.GeneratorFunction["_name"]>) =>
          wrapGeneratorFunction({ ...data, _name: v }, tree),
        ...
        body: (v: NonNullable<T.GeneratorFunction["_body"]>) =>
          wrapGeneratorFunction({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      name() {
        return drillAs<T.Identifier | T.NestedTypeIdentifier>(
          this._name,
          tree,
          "type_identifier",
          "identifier",
      ...
      $with: {
        name: (v: NonNullable<T.GenericType["_name"]>) =>
          wrapGenericType({ ...data, _name: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        condition: (v: NonNullable<T.IfStatement["_condition"]>) =>
          wrapIfStatement({ ...data, _condition: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapImplementsClause({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.ImportAlias["_name"]>) =>
          wrapImportAlias({ ...data, _name: v }, tree),
        value: (v: NonNullable<T.ImportAlias["_value"]>) =>
          wrapImportAlias({ ...data, _value: v }, tree),
        semicolon: (v: NonNullable<T.ImportAlias["_semicolon"]>) =>
          wrapImportAlias({ ...data, _semicolon: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        object: (v: NonNullable<T.ImportAttribute["_object"]>) =>
          wrapImportAttribute({ ...data, _object: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _content: normalizeSingularWrapSlot(
        data._namespace_import ??
          data._named_imports ??
          data._import_clause_default_import ??
          data._content,
        "content",
        true,
        data.$type,
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapImportClause({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        content: (v: NonNullable<T.ImportSpecifier["_content"]>) =>
          wrapImportSpecifier({ ...data, _content: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _import_attribute: normalizeSingularWrapSlot(
        data._import_attribute,
        "import_attribute",
        false,
        data.$type,
        {
  ...
  const _node = withMethods(
    {
      ...
      type() {
        return drillIn<
          | T.TypeAnnotation
          | T.OmittingTypeAnnotation
          | T.AddingTypeAnnotation
          | T.OptingTypeAnnotation
        >(this._type, tree);
      },
      $with: {
        sign: (v: NonNullable<T.IndexSignature["_sign"]>) =>
          wrapIndexSignature({ ...data, _sign: v }, tree),
        content: (v: NonNullable<T.IndexSignature["_content"]>) =>
          wrapIndexSignature({ ...data, _content: v }, tree),
        type: (v: NonNullable<T.IndexSignature["_type"]>) =>
          wrapIndexSignature({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _type_identifier: normalizeSingularWrapSlot(
        data._type_identifier,
        "type_identifier",
        true,
        data.$type,
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        body: (v: NonNullable<T.InterfaceDeclaration["_body"]>) =>
          wrapInterfaceDeclaration({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.InternalModule["_name"]>) =>
          wrapInternalModule({ ...data, _name: v }, tree),
        body: (v: NonNullable<T.InternalModule["_body"]>) =>
          wrapInternalModule({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        left: (v: NonNullable<T.IntersectionType["_left"]>) =>
          wrapIntersectionType({ ...data, _left: v }, tree),
        right: (v: NonNullable<T.IntersectionType["_right"]>) =>
          wrapIntersectionType({ ...data, _right: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      label() {
        return drillAs<T.StatementIdentifier>(
          this._label,
          tree,
          "statement_identifier",
      ...
      $with: {
        label: (v: NonNullable<T.LabeledStatement["_label"]>) =>
          wrapLabeledStatement({ ...data, _label: v }, tree),
        body: (v: NonNullable<T.LabeledStatement["_body"]>) =>
          wrapLabeledStatement({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      declarators() {
        return drillInAll<T.VariableDeclarator>(
      ...
      $with: {
        kind: (v: NonNullable<T.LexicalDeclaration["_kind"]>) =>
          wrapLexicalDeclaration({ ...data, _kind: v }, tree),
        declarators: (
          ...v: NonEmptyArray<NonNullable<T.LexicalDeclaration["_declarators"]>[number]>
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapLiteralType({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        indexType: (v: NonNullable<T.LookupType["_index_type"]>) =>
          wrapLookupType({ ...data, _index_type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.MappedTypeClause["_name"]>) =>
          wrapMappedTypeClause({ ...data, _name: v }, tree),
        type: (v: NonNullable<T.MappedTypeClause["_type"]>) =>
          wrapMappedTypeClause({ ...data, _type: v }, tree),
        alias: (v: NonNullable<T.MappedTypeClause["_alias"]>) =>
          wrapMappedTypeClause({ ...data, _alias: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        object: (v: NonNullable<T.MemberExpression["_object"]>) =>
          wrapMemberExpression({ ...data, _object: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.MethodDefinition["_name"]>) =>
          wrapMethodDefinition({ ...data, _name: v }, tree),
        ...
        body: (v: NonNullable<T.MethodDefinition["_body"]>) =>
          wrapMethodDefinition({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.MethodSignature["_name"]>) =>
          wrapMethodSignature({ ...data, _name: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapNamedImports({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapNamespaceExport({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      object() {
        return drillAs<T.Identifier | T.NestedIdentifier>(
          this._object,
          tree,
          "member_expression",
          "nested_identifier",
      ...
      $with: {
        object: (v: NonNullable<T.NestedIdentifier["_object"]>) =>
          wrapNestedIdentifier({ ...data, _object: v }, tree),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.NestedTypeIdentifier["_name"]>) =>
          wrapNestedTypeIdentifier({ ...data, _name: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        constructor: (v: NonNullable<T.NewExpression["_constructor"]>) =>
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        opening: (v: NonNullable<T.ObjectType["_opening"]>) =>
          wrapObjectType({ ...data, _opening: v }, tree),
        members: (v: NonNullable<T.ObjectType["_members"]>) =>
          wrapObjectType({ ...data, _members: v }, tree),
        closing: (v: NonNullable<T.ObjectType["_closing"]>) =>
          wrapObjectType({ ...data, _closing: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapObjectTypeContent({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapObjectTypeContentComma({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapObjectTypeContentSemi({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.OptingTypeAnnotation["_type"]>) =>
          wrapOptingTypeAnnotation({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        type: (v: NonNullable<T.OptionalParameter["_type"]>) =>
          wrapOptionalParameter({ ...data, _type: v }, tree),
        value: (v: NonNullable<T.OptionalParameter["_value"]>) =>
          wrapOptionalParameter({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.OptionalType["_type"]>) =>
          wrapOptionalType({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        value: (v: NonNullable<T.PairPattern["_value"]>) =>
          wrapPairPattern({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapParenthesizedExpression({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.ParenthesizedType["_type"]>) =>
          wrapParenthesizedType({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _hash_bang_line: normalizeSingularWrapSlot(
        data._hash_bang_line,
        "hash_bang_line",
        false,
        data.$type,
        { tree, nodeType: data.$type, slotName: "hash_bang_line", span: (data as _NodeData).$span },
      ),
      ...
      statements() {
        return drillInAll<T.Statement>(
          this._statements as readonly T.Statement[] | undefined,
          tree,
        );
      },
      $with: {
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.PropertySignature["_name"]>) =>
          wrapPropertySignature({ ...data, _name: v }, tree),
        ...
        type: (v: NonNullable<T.PropertySignature["_type"]>) =>
          wrapPropertySignature({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _content: normalizeSingularWrapSlot(
        data._public_field_definition_declare_first ??
          data._public_field_definition_access_first ??
          data._content,
        "content",
        false,
        data.$type,
      ...
      _public_field_definition_static_mods: normalizeSingularWrapSlot(
        ...
        data.$type,
        {
          tree,
          nodeType: data.$type,
          slotName: "public_field_definition_static_mods",
          span: (data as _NodeData).$span,
        },
      ),
      ...
      content() {
        return drillIn<
          T.PublicFieldDefinitionDeclareFirst | T.PublicFieldDefinitionAccessFirst | undefined
        >(this._content, tree);
      },
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.ReadonlyType["_type"]>) =>
          wrapReadonlyType({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        type: (v: NonNullable<T.RequiredParameter["_type"]>) =>
          wrapRequiredParameter({ ...data, _type: v }, tree),
        value: (v: NonNullable<T.RequiredParameter["_value"]>) =>
          wrapRequiredParameter({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapRestPattern({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      expressions() {
        return drillInAll<T.Expression>(
          this._expression as readonly T.Expression[] | undefined,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapSequenceExpression({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      contents() {
        return drillAsAll<
          T.UnescapedDoubleStringFragment | T.EscapeSequence | T.UnescapedSingleStringFragment
        >(this._contents, tree, "string_fragment", "unescaped_single_string_fragment");
      },
      closing() {
        return this._closing;
      },
      $with: {
        opening: (v: NonNullable<T.String["_opening"]>) =>
          wrapString({ ...data, _opening: v }, tree),
        contents: (...v: NonNullable<T.String["_contents"]>[number][]) =>
          wrapString({ ...data, _contents: v }, tree),
        closing: (v: NonNullable<T.String["_closing"]>) =>
          wrapString({ ...data, _closing: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        cases: (...v: NonNullable<T.SwitchBody["_cases"]>[number][]) =>
          wrapSwitchBody({ ...data, _cases: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        value: (v: NonNullable<T.SwitchCase["_value"]>) =>
          wrapSwitchCase({ ...data, _value: v }, tree),
        bodies: (...v: NonNullable<T.SwitchCase["_body"]>[number][]) =>
          wrapSwitchCase({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        value: (v: NonNullable<T.SwitchStatement["_value"]>) =>
          wrapSwitchStatement({ ...data, _value: v }, tree),
        body: (v: NonNullable<T.SwitchStatement["_body"]>) =>
          wrapSwitchStatement({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      contents() {
        return drillAsAll<T.TemplateChars | T.TemplateType>(
          this._content,
          tree,
          "string_fragment",
          "_template_chars",
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapTemplateLiteralType({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapTemplateString({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapTemplateSubstitution({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapTemplateType({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        body: (v: NonNullable<T.TryStatement["_body"]>) =>
          wrapTryStatement({ ...data, _body: v }, tree),
        handler: (v: NonNullable<T.TryStatement["_handler"]>) =>
          wrapTryStatement({ ...data, _handler: v }, tree),
        finalizer: (v: NonNullable<T.TryStatement["_finalizer"]>) =>
          wrapTryStatement({ ...data, _finalizer: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.TupleParameter["_name"]>) =>
          wrapTupleParameter({ ...data, _name: v }, tree),
        type: (v: NonNullable<T.TupleParameter["_type"]>) =>
          wrapTupleParameter({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      tupleTypeMembers() {
        return drillInAll<T.TupleTypeMember>(
          this._tuple_type_member as readonly T.TupleTypeMember[] | undefined,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) => wrapTupleType({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        type: (v: NonNullable<T.TypeAnnotation["_type"]>) =>
          wrapTypeAnnotation({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapTypeArguments({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        name: (v: NonNullable<T.TypeParameter["_name"]>) =>
          wrapTypeParameter({ ...data, _name: v }, tree),
        ...
        value: (v: NonNullable<T.TypeParameter["_value"]>) =>
          wrapTypeParameter({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      typeParameters() {
        return drillInAll<T.TypeParameter>(
          this._type_parameter as readonly T.TypeParameter[] | undefined,
          tree,
        );
      },
      $with: {
        $children: (...vs: readonly [never]) => wrapTypeParameters({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      name() {
        return drillAs<T.Identifier | T.This | T.PredefinedType>(
          this._name,
          tree,
          "identifier",
          "predefined_type",
      ...
      $with: {
        name: (v: NonNullable<T.TypePredicate["_name"]>) =>
          wrapTypePredicate({ ...data, _name: v }, tree),
        type: (v: NonNullable<T.TypePredicate["_type"]>) =>
          wrapTypePredicate({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      _type_predicate: normalizeSingularWrapSlot(
        data._type_predicate,
        "type_predicate",
        true,
        data.$type,
        { tree, nodeType: data.$type, slotName: "type_predicate", span: (data as _NodeData).$span },
      ),
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapTypeQuery({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        right: (v: NonNullable<T.UnionType["_right"]>) =>
          wrapUnionType({ ...data, _right: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) => wrapUpdateExpression({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        declarators: (
          ...v: NonEmptyArray<NonNullable<T.VariableDeclaration["_declarators"]>[number]>
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        name: (v: NonNullable<T.VariableDeclarator["_name"]>) =>
          wrapVariableDeclarator({ ...data, _name: v }, tree),
        type: (v: NonNullable<T.VariableDeclarator["_type"]>) =>
          wrapVariableDeclarator({ ...data, _type: v }, tree),
        value: (v: NonNullable<T.VariableDeclarator["_value"]>) =>
          wrapVariableDeclarator({ ...data, _value: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        body: (v: NonNullable<T.WhileStatement["_body"]>) =>
          wrapWhileStatement({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        object: (v: NonNullable<T.WithStatement["_object"]>) =>
          wrapWithStatement({ ...data, _object: v }, tree),
        body: (v: NonNullable<T.WithStatement["_body"]>) =>
          wrapWithStatement({ ...data, _body: v }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        $children: (...vs: readonly [never]) =>
          wrapImportClauseGroup1({ ...data, $other: vs }, tree),
      },
    },
    methodsEngine,
  );
  ...
  const _node = withMethods(
    {
      ...
      $with: {
        ...
        type: (v: NonNullable<T.CatchClauseGroup1["_type"]>) =>
          wrapCatchClauseGroup1({ ...data, _type: v }, tree),
      },
    },
    methodsEngine,
  );
...
const _wrapTable: Record<string, (data: _NodeData, tree: TreeHandle) => unknown> = {
  _ambient_declaration_global: (d, t) =>
    wrapAmbientDeclarationGlobal(d as unknown as T.AmbientDeclarationGlobal, t),
  _ambient_declaration_module: (d, t) =>
    wrapAmbientDeclarationModule(d as unknown as T.AmbientDeclarationModule, t),
  _arrow_function_parameter: (d, t) =>
    wrapArrowFunctionParameter(d as unknown as T.ArrowFunctionParameter, t),
  _call_expression_call: (d, t) => wrapCallExpressionCall(d as unknown as T.CallExpressionCall, t),
  _call_expression_member: (d, t) =>
    wrapCallExpressionMember(d as unknown as T.CallExpressionMember, t),
  ...
  _destructuring_pattern: (d, t) =>
    wrapDestructuringPattern(d as unknown as T.DestructuringPattern, t),
  _export_statement_default: (d, t) =>
    wrapExportStatementDefault(d as unknown as T.ExportStatementDefault, t),
  ...
  _export_statement_default_decl_arm_default_kw: (d, t) =>
    wrapExportStatementDefaultDeclArmDefaultKw(
      d as unknown as T.ExportStatementDefaultDeclArmDefaultKw,
      t,
    ),
  _export_statement_default_decl_arm_default_kw_value: (d, t) =>
    wrapExportStatementDefaultDeclArmDefaultKwValue(
      d as unknown as T.ExportStatementDefaultDeclArmDefaultKwValue,
      t,
    ),
  ...
  _export_statement_default_from_arm_clause_from: (d, t) =>
    wrapExportStatementDefaultFromArmClauseFrom(
      d as unknown as T.ExportStatementDefaultFromArmClauseFrom,
      t,
    ),
  _export_statement_default_from_arm_ns_from: (d, t) =>
    wrapExportStatementDefaultFromArmNsFrom(
      d as unknown as T.ExportStatementDefaultFromArmNsFrom,
      t,
    ),
  _export_statement_default_from_arm_star_from: (d, t) =>
    wrapExportStatementDefaultFromArmStarFrom(
      d as unknown as T.ExportStatementDefaultFromArmStarFrom,
      t,
    ),
  ...
  _extends_clause_single: (d, t) =>
    wrapExtendsClauseSingle(d as unknown as T.ExtendsClauseSingle, t),
  _for_header: (d, t) => wrapForHeader(d as unknown as T.ForHeader, t),
  _for_header_let_const_kind: (d, t) =>
    wrapForHeaderLetConstKind(d as unknown as T.ForHeaderLetConstKind, t),
  ...
  _import_clause_group1: (d, t) =>
    wrap_ImportClauseGroup1(d as unknown as T._ImportClauseGroup1, t),
  ...
  _index_signature_colon: (d, t) =>
    wrapIndexSignatureColon(d as unknown as T.IndexSignatureColon, t),
  ...
  _statement_identifier: (d, t) =>
    wrapStatementIdentifier(d as unknown as T.StatementIdentifier, t),
  ...
  _type_query_call_expression: (d, t) =>
  ...
  _type_query_call_expression_in_type_annotation: (d, t) =>
    wrapTypeQueryCallExpressionInTypeAnnotation(
      d as unknown as T.TypeQueryCallExpressionInTypeAnnotation,
      t,
    ),
  ...
  _type_query_member_expression_in_type_annotation: (d, t) =>
    wrapTypeQueryMemberExpressionInTypeAnnotation(
      d as unknown as T.TypeQueryMemberExpressionInTypeAnnotation,
      t,
    ),
  _type_query_subscript_expression: (d, t) =>
    wrapTypeQuerySubscriptExpression(d as unknown as T.TypeQuerySubscriptExpression, t),
  _update_expression_postfix: (d, t) =>
    wrapUpdateExpressionPostfix(d as unknown as T.UpdateExpressionPostfix, t),
  _update_expression_prefix: (d, t) =>
    wrapUpdateExpressionPrefix(d as unknown as T.UpdateExpressionPrefix, t),
  abstract_class_declaration: (d, t) =>
    wrapAbstractClassDeclaration(d as unknown as T.AbstractClassDeclaration, t),
  abstract_method_signature: (d, t) =>
  ...
  adding_type_annotation: (d, t) =>
    wrapAddingTypeAnnotation(d as unknown as T.AddingTypeAnnotation, t),
  ...
  assignment_expression: (d, t) =>
    wrapAssignmentExpression(d as unknown as T.AssignmentExpression, t),
  ...
  computed_property_name: (d, t) =>
    wrapComputedPropertyName(d as unknown as T.ComputedPropertyName, t),
  ...
  import_require_clause: (d, t) =>
    wrapImportRequireClause(d as unknown as T.ImportRequireClause, t),
  ...
  instantiation_expression: (d, t) =>
    wrapInstantiationExpression(d as unknown as T.InstantiationExpression, t),
  interface_declaration: (d, t) =>
    wrapInterfaceDeclaration(d as unknown as T.InterfaceDeclaration, t),
  ...
  nested_type_identifier: (d, t) =>
    wrapNestedTypeIdentifier(d as unknown as T.NestedTypeIdentifier, t),
  ...
  object_type_content_comma: (d, t) =>
    wrapObjectTypeContentComma(d as unknown as T.ObjectTypeContentComma, t),
  object_type_content_semi: (d, t) =>
    wrapObjectTypeContentSemi(d as unknown as T.ObjectTypeContentSemi, t),
  omitting_type_annotation: (d, t) =>
    wrapOmittingTypeAnnotation(d as unknown as T.OmittingTypeAnnotation, t),
  opting_type_annotation: (d, t) =>
    wrapOptingTypeAnnotation(d as unknown as T.OptingTypeAnnotation, t),
  optional_parameter: (d, t) => wrapOptionalParameter(d as unknown as T.OptionalParameter, t),
  optional_tuple_parameter: (d, t) =>
    wrapOptionalTupleParameter(d as unknown as T.OptionalTupleParameter, t),
  ...
  public_field_definition: (d, t) =>
    wrapPublicFieldDefinition(d as unknown as T.PublicFieldDefinition, t),
  ...
  template_literal_type: (d, t) =>
    wrapTemplateLiteralType(d as unknown as T.TemplateLiteralType, t),
  template_string: (d, t) => wrapTemplateString(d as unknown as T.TemplateString, t),
  template_substitution: (d, t) =>
    wrapTemplateSubstitution(d as unknown as T.TemplateSubstitution, t),
  ...
  type_alias_declaration: (d, t) =>
    wrapTypeAliasDeclaration(d as unknown as T.TypeAliasDeclaration, t),
  ...
  unescaped_double_string_fragment: (d) => ({
    ...d,
    $type: TSKindId.UnescapedDoubleStringFragment as const,
  }),
  unescaped_single_string_fragment: (d) => ({
    ...d,
