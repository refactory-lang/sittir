...
const _overrides = {
  ...
  "variable_declaration": {"fields":{"declarators":{"types":[{"type":"variable_declarator","named":true},{"type":"variable_declarator","named":true}],"multiple":false,"required":true,"position":0},"semicolon":{"types":[{"type":"_semicolon","named":true}],"multiple":false,"required":true,"position":1}}},
  "lexical_declaration": {"fields":{"declarators":{"types":[{"type":"variable_declarator","named":true},{"type":"variable_declarator","named":true}],"multiple":false,"required":true,"position":1},"semicolon":{"types":[{"type":"_semicolon","named":true}],"multiple":false,"required":true,"position":2}}},
  ...
  "yield_expression": {"fields":{"expression":{"types":[{"type":"expression","named":true},{"type":"expression","named":true}],"multiple":false,"required":true,"position":0}}},
  "class": {"fields":{"class_heritage":{"types":[{"type":"decorator","named":true}],"multiple":true,"required":true,"position":0}}},
  "class_declaration": {"fields":{"class_heritage":{"types":[{"type":"decorator","named":true}],"multiple":true,"required":true,"position":0},"automatic_semicolon":{"types":[{"type":"class_heritage","named":true}],"multiple":false,"required":false,"position":3}}},
  ...
  "public_field_definition": {"fields":{"accessibility_modifier":{"types":[{"type":"decorator","named":true}],"multiple":true,"required":true,"position":0},"override_modifier":{"types":[{"type":"accessibility_modifier","named":true},{"type":"accessibility_modifier","named":true}],"multiple":false,"required":false,"position":1},"initializer":{"types":[{"type":"override_modifier","named":true}],"multiple":false,"required":true,"position":2}}},
  ...
  "abstract_class_declaration": {"fields":{"class_heritage":{"types":[{"type":"decorator","named":true}],"multiple":true,"required":true,"position":0}}},
  ...
  "enum_body": {"fields":{"opening":{"types":[{"type":"_property_name","named":true},{"type":"_property_name","named":true},{"type":"enum_assignment","named":true},{"type":"enum_assignment","named":true},{"type":"_property_name","named":true},{"type":"enum_assignment","named":true}],"multiple":false,"required":false,"position":0}}},
  "required_parameter": {"fields":{"parameter_name":{"types":[{"type":"_parameter_name","named":true}],"multiple":false,"required":true,"position":0},"initializer":{"types":[{"type":"_initializer","named":true}],"multiple":false,"required":false,"position":2}}},
  "optional_parameter": {"fields":{"parameter_name":{"types":[{"type":"_parameter_name","named":true}],"multiple":false,"required":true,"position":0},"initializer":{"types":[{"type":"_initializer","named":true}],"multiple":false,"required":false,"position":2}}},
  "asserts_annotation": {"fields":{"asserts":{"types":[{"type":"asserts","named":true}],"multiple":false,"required":true,"position":0}}},
  ...
  "type_predicate_annotation": {"fields":{"type_predicate":{"types":[{"type":"type_predicate","named":true}],"multiple":false,"required":true,"position":0}}},
