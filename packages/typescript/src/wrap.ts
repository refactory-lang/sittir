...
export function wrapBreakStatement(data: _NodeData, tree: TreeHandle): WrappedNode<BreakStatement> {
	return {
		...data,
		get label() {
			return drillAs(data.$fields?.["label"], tree, "statement_identifier", "identifier");
		},
		get semicolon() {
			return drillIn(data.$fields?.["semicolon"], tree);
		},
...
export function wrapNestedIdentifier(
	...
	return {
		...
		get property() {
			return drillAs(data.$fields?.["property"], tree, "property_identifier", "identifier");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
...
export function wrapAmbientDeclaration(
	...
	return {
		...data,
		get declaration() {
			return drillAs(data.$fields?.["declaration"], tree, "property_identifier", "identifier");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
...
export function wrapInterfaceDeclaration(
	...
	return {
		...
		get body() {
			return drillAs(data.$fields?.["body"], tree, "interface_body", "object_type");
		},
		get children() {
			return (data.$children ?? []).map((c) => drillIn(c, tree));
		},
