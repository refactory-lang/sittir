...
const _leafRegistry: { readonly [kind: string]: _LeafEntry } = {
	hash_bang_line: {
		pattern: new RegExp(TOKEN_INTERIORS['hash_bang_line'].regex, 'su'),
		factory: (text: string) =>
			F.buildHashBangLine(lexedConfig(text, TOKEN_INTERIORS['hash_bang_line'], 'hash_bang_line')['content'] as never)
	},
	...
	private_property_identifier: {
		pattern: new RegExp(TOKEN_INTERIORS['private_property_identifier'].regex, 'su'),
		factory: (text: string) =>
			F.buildPrivatePropertyIdentifier(
				lexedConfig(text, TOKEN_INTERIORS['private_property_identifier'], 'private_property_identifier')[
					'content'
				] as never
			)
	},
	...
	comment_line: {
		pattern: new RegExp(TOKEN_INTERIORS['comment_line'].regex, 'su'),
		factory: (text: string) =>
			F.buildCommentLine(lexedConfig(text, TOKEN_INTERIORS['comment_line'], 'comment_line')['content'] as never)
	},
	comment_block: {
		pattern: new RegExp(TOKEN_INTERIORS['comment_block'].regex, 'su'),
		factory: (text: string) =>
			F.buildCommentBlock(lexedConfig(text, TOKEN_INTERIORS['comment_block'], 'comment_block')['content'] as never)
	},
...
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	...
	yield_expression: new Set([
		1, 98, 100, 101, 102, 103, 104, 105, 219, 222, 223, 227, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247, 249, 253,
	...
	rest_pattern: new Set([
		1, 98, 100, 101, 102, 103, 104, 105, 219, 222, 223, 224, 227, 228, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247,
	...
	enum_body: new Set([
		1, 98, 99, 100, 101, 102, 103, 104, 105, 219, 222, 223, 227, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247, 249,
	...
	omitting_type_annotation: new Set([
		1, 98, 100, 102, 103, 104, 105, 258, 298, 314, 315, 319, 320, 321, 322, 324, 327, 328, 329, 330, 333, 334, 335, 336,
...
const _K70: readonly string[] = ['unescaped_double_string_fragment'];
const _K71: readonly string[] = ['escape_sequence'];
const _K72: readonly string[] = ['unescaped_single_string_fragment'];
...
export function resolveBinaryExpressionIn_left(
	...
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T.Expression | T.PrivatePropertyIdentifier>(value, _K7, _K66)),
		[]
	);
}
...
export function resolveCallExpressionTemplateCall_function(
	...
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T.PrimaryExpression | T.NewExpression>(value, _K7, _K69)),
		[]
	);
}
...
export function coerceToStringDouble(
	...
	return F.buildStringDouble(
		...(_resolveMany<T.UnescapedDoubleStringFragment | T.EscapeSequence>(_elems, _K70, _K71) as unknown as Parameters<
...
export function coerceToStringSingle(
	...
	return F.buildStringSingle(
		...(_resolveMany<T.UnescapedSingleStringFragment | T.EscapeSequence>(_elems, _K72, _K71) as unknown as Parameters<
...
export function resolveExportStatementDefaultDeclaration_content(
	...
	return _resolveOne<T.ExportStatementDefaultDeclarationDefaultKw | T.Declaration>(value, _K2, _K74);
}
...
export function resolveExportStatementDefaultDeclarationDefaultKw_content(
	...
	return _resolveOne<T.ExportStatementDefaultDeclarationDefaultKwValue | T.Declaration>(value, _K2, _K75);
}
