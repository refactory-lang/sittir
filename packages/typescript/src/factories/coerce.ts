...
const _KIND_ID_STORED: ReadonlySet<number> = new Set([
	...
	63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 92, 94, 100,
	101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123,
	124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140, 141, 142, 143, 144, 145, 146,
	147, 148, 149, 150, 151, 152, 155, 157, 159, 160, 161, 162, 163, 168, 170, 171, 172, 173, 174, 175, 183, 212, 240,
...
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	...
	export_clause: new Set([1, 180, 258, 371, 403, 404]),
	...
	yield_expression: new Set([
		1, 7, 44, 98, 100, 101, 102, 103, 104, 105, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120,
		121, 122, 123, 124, 125, 126, 219, 222, 223, 227, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247, 249, 253, 254,
		255, 257, 258, 259, 261, 265, 266, 279, 284, 285, 286, 287, 295, 398, 399, 400, 401, 402, 403, 404, 405, 406, 419,
		420, 451
	]),
	...
	rest_pattern: new Set([
		1, 7, 44, 98, 100, 101, 102, 103, 104, 105, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120,
		121, 122, 123, 124, 125, 126, 219, 222, 223, 224, 227, 228, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247, 249,
		253, 254, 255, 257, 258, 259, 261, 265, 266, 279, 284, 285, 286, 287, 295, 398, 399, 400, 401, 402, 403, 404, 405,
		406, 419, 420, 451
	]),
	...
	enum_body: new Set([
		1, 7, 44, 98, 99, 100, 101, 102, 103, 104, 105, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119,
		120, 121, 122, 123, 124, 125, 126, 219, 222, 223, 227, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247, 249, 253,
		254, 255, 257, 258, 259, 261, 265, 266, 276, 279, 284, 285, 286, 287, 295, 303, 374, 398, 399, 400, 401, 402, 403,
		404, 405, 406, 419, 420, 451
	]),
	omitting_type_annotation: new Set([
		1, 87, 98, 100, 102, 103, 104, 105, 118, 119, 120, 121, 122, 124, 144, 145, 146, 258, 298, 314, 315, 319, 320, 321,
		322, 324, 327, 328, 329, 330, 333, 334, 335, 336, 337, 338, 339, 341, 342, 343, 344, 345, 346, 348, 357, 358, 359,
		360, 361, 362, 377, 403, 404
	]),
	...
	asserts: new Set([1, 100, 331]),
	asserts_annotation: new Set([1, 100, 316, 331]),
	...
	type_query: new Set([1, 100, 333, 334, 335, 336]),
	index_type_query: new Set([
		1, 87, 98, 100, 102, 103, 104, 105, 118, 119, 120, 121, 122, 124, 144, 145, 146, 258, 298, 314, 315, 319, 320, 321,
		322, 324, 327, 328, 329, 330, 333, 334, 335, 336, 337, 338, 339, 341, 342, 343, 344, 345, 346, 348, 357, 358, 359,
		360, 361, 362, 377, 403, 404
	]),
	literal_type: new Set([98, 102, 103, 104, 105, 258, 342, 403, 404]),
	...
	type_arguments: new Set([
		1, 87, 98, 100, 102, 103, 104, 105, 118, 119, 120, 121, 122, 124, 144, 145, 146, 258, 298, 314, 315, 319, 320, 321,
		322, 324, 327, 328, 329, 330, 333, 334, 335, 336, 337, 338, 339, 341, 342, 343, 344, 345, 346, 348, 357, 358, 359,
		360, 361, 362, 375, 377, 403, 404
	]),
	type_parameters: new Set([1, 352, 376]),
	...
	export_specifiers: new Set([1, 180, 258, 403, 404]),
	import_specifiers: new Set([396, 397]),
	formal_parameters_elements: new Set([307, 308]),
	enum_body_elements: new Set([
		1, 7, 44, 98, 99, 100, 101, 102, 103, 104, 105, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119,
		120, 121, 122, 123, 124, 125, 126, 219, 222, 223, 227, 230, 233, 235, 237, 241, 242, 243, 244, 245, 247, 249, 253,
		254, 255, 257, 258, 259, 261, 265, 266, 276, 279, 284, 285, 286, 287, 295, 303, 398, 399, 400, 401, 402, 403, 404,
		405, 406, 419, 420, 451
	]),
	types: new Set([
		1, 87, 98, 100, 102, 103, 104, 105, 118, 119, 120, 121, 122, 124, 144, 145, 146, 258, 298, 314, 315, 319, 320, 321,
	...
	type_parameters_elements: new Set([1, 352]),
	...
	arrow_function_parameter: new Set([
		1, 7, 44, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125, 126, 451
	]),
...
const _ENUMS_OF_MEMBER: Record<number, readonly string[] | undefined> = {
	...
	111: ['_reserved_identifier'],
	112: ['_reserved_identifier', 'accessibility_modifier'],
	113: ['_reserved_identifier', 'accessibility_modifier'],
	114: ['_reserved_identifier', 'accessibility_modifier'],
	115: ['_reserved_identifier'],
	116: ['_reserved_identifier', '_reserved_identifier'],
	117: ['_reserved_identifier'],
	118: ['_reserved_identifier', 'predefined_type'],
	119: ['_reserved_identifier', 'predefined_type'],
	120: ['_reserved_identifier', 'predefined_type'],
	121: ['_reserved_identifier', 'predefined_type', 'predefined_type'],
	122: ['_reserved_identifier', 'predefined_type'],
	123: ['_reserved_identifier', '_reserved_identifier'],
	124: ['_reserved_identifier', 'predefined_type'],
	125: ['_reserved_identifier'],
	126: ['_reserved_identifier', '_kind'],
	129: ['_kind'],
	143: ['__for_header_operator'],
	144: ['predefined_type'],
	145: ['predefined_type'],
	146: ['predefined_type'],
	151: ['__for_header_operator'],
	159: ['_operator'],
	160: ['_operator']
};
...
const _K37: readonly string[] = ['identifier', '_reserved_identifier', 'number'];
const _K38: readonly string[] = ['private_property_identifier', 'string', 'computed_property_name'];
...
const _K57: readonly string[] = ['predefined_type', 'number'];
const _K58: readonly string[] = ['import', 'identifier'];
const _K59: readonly string[] = ['_type_query_member_expression', '_type_query_subscript_expression'];
...
const _K65: readonly string[] = ['private_property_identifier', 'string', 'computed_property_name', 'enum_assignment'];
...
const _K67: readonly string[] = ['namespace_import', 'named_imports'];
...
export function resolveIndexTypeQuery_type(value: T.IndexTypeQuery.LooseConfig['type']): T.IndexTypeQuery['_type'] {
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T.PrimaryType>(value, _K40, _K61)),
		[]
	);
}
...
export function resolveLiteralType_content(value: T.LiteralType.LooseConfig['content']): T.LiteralType['_content'] {
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () =>
			_resolveOne<T._Number | T.Number | T.String | 'true' | 'false' | 'null' | 'undefined'>(value, _K62, _K63)
		),
		[
...
export function resolveFunctionType_returnType(
	...
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T.Type | T.Asserts | T.TypePredicate>(value, _K40, _K64)),
		[]
	);
}
...
export function resolveImportClauseGroup_content(
	...
	return _resolveOne<T.NamespaceImport | T.NamedImports>(value, _K2, _K67);
}
...
export function resolveBinaryExpressionIn_left(
	...
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T.Expression | T.PrivatePropertyIdentifier>(value, _K7, _K69)),
		[]
	);
}
...
export function resolveCallExpressionTemplateCall_function(
	...
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T.PrimaryExpression | T.NewExpression>(value, _K7, _K72)),
		[]
	);
}
...
export function resolveForHeaderLhs_left(value: T.ForHeaderLhs.LooseConfig['left']): T.ForHeaderLhs['_left'] {
	return coerceMixedEnumStorage(
		_resolveKindEnum(value, () => _resolveOne<T._LhsExpression | T.ParenthesizedExpression>(value, _K16, _K79)),
		[]
	);
}
