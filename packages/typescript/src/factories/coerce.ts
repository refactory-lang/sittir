...
const _KIND_ID_STORED: ReadonlySet<number> = new Set([
	...
	148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 165, 178, 207, 235, 301, 338, 358, 359, 360, 361,
	362, 363, 364, 365, 411, 412
]);
const _BARE_ACCEPTS: Record<string, ReadonlySet<number> | undefined> = {
	export_statement: new Set([380, 381, 382, 383, 402, 403]),
	namespace_export: new Set([1, 253, 395, 396]),
	export_clause: new Set([175, 366]),
	import_clause: new Set([1, 182, 183, 184, 367, 401]),
	namespace_import: new Set([1]),
	named_imports: new Set([184, 367]),
	variable_declarator: new Set([409, 410]),
	else_clause: new Set([
		160, 172, 179, 187, 188, 189, 191, 193, 194, 195, 196, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 226,
		229, 231, 277, 287, 288, 289, 290, 292, 294, 296, 299, 377, 378, 380, 381, 382, 383, 402, 403
	]),
	debugger_statement: new Set([160]),
	finally_clause: new Set([191]),
	parenthesized_expression: new Set([1, 252, 260, 261, 391]),
	yield_expression: new Set([
		1, 98, 100, 101, 102, 103, 104, 105, 214, 217, 218, 222, 225, 228, 230, 232, 236, 237, 238, 239, 240, 242, 244, 248,
		249, 250, 251, 252, 253, 254, 256, 257, 260, 261, 274, 279, 280, 281, 282, 290, 391, 392, 393, 394, 395, 396, 397,
		398, 411, 412, 443
	]),
	class_heritage: new Set([286, 400]),
	call_expression: new Set([392, 393, 394]),
	...
	update_expression: new Set([397, 398]),
	string: new Set([395, 396]),
	template_substitution: new Set([
		1, 98, 100, 101, 102, 103, 104, 105, 214, 217, 218, 222, 225, 228, 230, 232, 236, 237, 238, 239, 240, 242, 244, 248,
		249, 250, 251, 252, 253, 254, 256, 257, 260, 261, 274, 279, 280, 281, 282, 290, 391, 392, 393, 394, 395, 396, 397,
		398, 411, 412, 443
	]),
	meta_property: new Set([411, 412]),
	decorator: new Set([1, 260, 261, 278]),
	formal_parameters: new Set([302, 303, 368]),
	rest_pattern: new Set([
		1, 98, 100, 101, 102, 103, 104, 105, 214, 217, 218, 219, 222, 223, 225, 228, 230, 232, 236, 237, 238, 239, 240, 242,
		244, 248, 249, 250, 251, 252, 253, 254, 256, 257, 260, 261, 274, 279, 280, 281, 282, 290, 391, 392, 393, 394, 395,
		396, 397, 398, 411, 412, 443
	]),
	...
	decorator_parenthesized_expression: new Set([1, 260, 261]),
	ambient_declaration: new Set([188, 189, 191, 226, 229, 231, 277, 287, 288, 289, 290, 292, 294, 296, 299, 377, 378]),
	enum_body: new Set([
		1, 98, 99, 100, 101, 102, 103, 104, 105, 214, 217, 218, 222, 225, 228, 230, 232, 236, 237, 238, 239, 240, 242, 244,
		248, 249, 250, 251, 252, 253, 254, 256, 257, 260, 261, 271, 274, 279, 280, 281, 282, 290, 298, 369, 391, 392, 393,
		394, 395, 396, 397, 398, 411, 412, 443
	]),
	omitting_type_annotation: new Set([
		1, 98, 100, 102, 103, 104, 105, 253, 293, 309, 310, 314, 315, 316, 317, 319, 322, 323, 324, 325, 328, 329, 330, 331,
		332, 333, 334, 336, 337, 338, 339, 340, 341, 343, 352, 353, 354, 355, 356, 357, 372, 395, 396
	]),
	...
	asserts: new Set([1, 100, 326]),
	asserts_annotation: new Set([1, 100, 311, 326]),
	...
	type_predicate_annotation: new Set([326]),
	type_query: new Set([1, 100, 328, 329, 330, 331]),
	index_type_query: new Set([
		1, 98, 100, 102, 103, 104, 105, 253, 293, 309, 310, 314, 315, 316, 317, 319, 322, 323, 324, 325, 328, 329, 330, 331,
		332, 333, 334, 336, 337, 338, 339, 340, 341, 343, 352, 353, 354, 355, 356, 357, 372, 395, 396
	]),
	literal_type: new Set([98, 102, 103, 104, 105, 253, 337, 395, 396]),
	...
	type_arguments: new Set([
		1, 98, 100, 102, 103, 104, 105, 253, 293, 309, 310, 314, 315, 316, 317, 319, 322, 323, 324, 325, 328, 329, 330, 331,
		332, 333, 334, 336, 337, 338, 339, 340, 341, 343, 352, 353, 354, 355, 356, 357, 370, 372, 395, 396
	]),
	type_parameters: new Set([347, 371]),
	...
	_export_specifiers: new Set([175]),
	_import_specifiers: new Set([184]),
	_formal_parameters_elements: new Set([302, 303]),
	_enum_body_elements: new Set([
		1, 98, 99, 100, 101, 102, 103, 104, 105, 214, 217, 218, 222, 225, 228, 230, 232, 236, 237, 238, 239, 240, 242, 244,
		248, 249, 250, 251, 252, 253, 254, 256, 257, 260, 261, 271, 274, 279, 280, 281, 282, 290, 298, 391, 392, 393, 394,
		395, 396, 397, 398, 411, 412, 443
	]),
	_types: new Set([
		1, 98, 100, 102, 103, 104, 105, 253, 293, 309, 310, 314, 315, 316, 317, 319, 322, 323, 324, 325, 328, 329, 330, 331,
		332, 333, 334, 336, 337, 338, 339, 340, 341, 343, 352, 353, 354, 355, 356, 357, 372, 395, 396
	]),
	_type_parameters_elements: new Set([347]),
	_tuple_type_members: new Set([
		1, 98, 100, 102, 103, 104, 105, 253, 293, 309, 310, 314, 315, 316, 317, 319, 322, 323, 324, 325, 328, 329, 330, 331,
		332, 333, 334, 336, 337, 338, 339, 340, 341, 343, 352, 353, 354, 355, 356, 357, 372, 395, 396
	]),
	_import_clause_group: new Set([1, 182, 183, 184, 367]),
	_ambient_declaration_global: new Set([191]),
	object_type_content: new Set([172, 275, 344, 345, 350, 351, 380, 381, 382, 383, 402, 403]),
	_export_statement_default: new Set([402, 403]),
	_arrow_function_parameter: new Set([1, 443]),
	_export_statement_default_star_from: new Set([253, 395, 396]),
	_export_statement_default_default_kw: new Set([
		188, 189, 191, 226, 229, 231, 277, 287, 288, 289, 290, 292, 294, 296, 299, 377, 378, 408
	]),
