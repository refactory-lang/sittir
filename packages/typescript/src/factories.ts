  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        semicolon: (value?: T.Semicolon) =>
          _ambientDeclarationModule({ ...config, semicolon: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        function: (value: T.Expression | T.Import) =>
          _callExpressionCall({ ...config, function: value }),
        typeArguments: (value?: T.TypeArguments) =>
          _callExpressionCall({ ...config, typeArguments: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        function: (value: T.PrimaryExpression) =>
          _callExpressionMember({ ...config, function: value }),
        typeArguments: (value?: T.TypeArguments) =>
          _callExpressionMember({ ...config, typeArguments: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        arguments: (value: T.TemplateString) =>
          _callExpressionTemplateCall({ ...config, arguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        typeParameters: (value?: T.TypeParameters) =>
          _callSignature({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        terminator: (value?: T.Semicolon | ",") =>
          _classBodyMember({ ...config, terminator: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          _classBodyMethod({ ...config, decorator: values }),
        methodDefinition: (value: T.MethodDefinition) =>
          _classBodyMethod({ ...config, methodDefinition: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        extendsClause: (value: T.ExtendsClause) =>
          classHeritageExtendsClause({ ...config, extendsClause: value }),
...
export function exportStatementDefault(
...
export function _exportStatementDefaultDeclArm(
  config: Partial<T.ExportStatementDefaultDeclArm.Config> = {},
) {
  const _decorator = config.decorator;
  const _declaration = config.declaration;
  const _export_statement_default_decl_arm_default_kw =
    config.exportStatementDefaultDeclArmDefaultKw;
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          _exportStatementDefaultDeclArm({ ...config, decorator: values }),
        declaration: (value?: T.Declaration) =>
          _exportStatementDefaultDeclArm({ ...config, declaration: value }),
        exportStatementDefaultDeclArmDefaultKw: (
          value?: T.ExportStatementDefaultDeclArmDefaultKw,
        ) =>
          _exportStatementDefaultDeclArm({
            ...config,
            exportStatementDefaultDeclArmDefaultKw: value,
          }),
      },
    },
    methodsEngine,
...
export function _exportStatementDefaultDeclArmDefaultKw(
  ...
  const _declaration = config.declaration;
  const _export_statement_default_decl_arm_default_kw_value =
    config.exportStatementDefaultDeclArmDefaultKwValue;
  return withMethods(
    {
      ...
      exportStatementDefaultDeclArmDefaultKwValue() {
        return _export_statement_default_decl_arm_default_kw_value;
      },
      $with: {
        declaration: (value?: T.Declaration) =>
          _exportStatementDefaultDeclArmDefaultKw({ ...config, declaration: value }),
        exportStatementDefaultDeclArmDefaultKwValue: (
          value?: T.ExportStatementDefaultDeclArmDefaultKwValue,
        ) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        value: (value: T.Expression) =>
          _exportStatementDefaultDeclArmDefaultKwValue({ ...config, value: value }),
        semicolon: (value?: T.Semicolon) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        semicolon: (value?: T.Semicolon) =>
          exportStatementDefaultFromArm({ ...config, semicolon: value }),
      },
    },
    methodsEngine,
  );
...
export function exportStatementDefaultFromArmClauseFrom(
  config: T.ExportStatementDefaultFromArmClauseFrom.Config,
) {
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        source: (value: T.String) =>
          exportStatementDefaultFromArmClauseFrom({ ...config, source: value }),
      },
    },
    methodsEngine,
  );
...
export function exportStatementDefaultFromArmNsFrom(
  config: T.ExportStatementDefaultFromArmNsFrom.Config,
) {
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        source: (value: T.String) =>
          exportStatementDefaultFromArmNsFrom({ ...config, source: value }),
      },
    },
    methodsEngine,
  );
...
export function exportStatementDefaultFromArmStarFrom(
  config: T.ExportStatementDefaultFromArmStarFrom.Config,
) {
  const _source = config.source;
  return withMethods(
    {
      ...
      $with: {
        source: (value: T.String) =>
          exportStatementDefaultFromArmStarFrom({ ...config, source: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        expression: (value: T.Expression) =>
          exportStatementEqualsExport({ ...config, expression: value }),
        semicolon: (value?: T.Semicolon) =>
          exportStatementEqualsExport({ ...config, semicolon: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        identifier: (value: T.Identifier) =>
          exportStatementNamespaceExport({ ...config, identifier: value }),
        semicolon: (value?: T.Semicolon) =>
          exportStatementNamespaceExport({ ...config, semicolon: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        exportClause: (value: T.ExportClause) =>
          exportStatementTypeExport({ ...config, exportClause: value }),
        source: (value?: T.String) => exportStatementTypeExport({ ...config, source: value }),
        semicolon: (value?: T.Semicolon) =>
          exportStatementTypeExport({ ...config, semicolon: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeArguments: (value?: T.TypeArguments) =>
          _extendsClauseSingle({ ...config, typeArguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        left: (value: T.Identifier | T.DestructuringPattern) =>
          _forHeaderLetConstKind({ ...config, left: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        left: (value: T.Identifier | T.DestructuringPattern) =>
          _forHeaderVarKind({ ...config, left: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.ModuleExportName | T.Identifier) =>
          _importSpecifierAs({ ...config, name: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.Identifier | T.ReservedIdentifier) =>
          _indexSignatureColon({ ...config, name: value }),
  ...
  return withMethods(
    {
      ...
      overrideModifier() {
        return _override_modifier;
      },
      readonlyMarker() {
        return _readonly_marker;
      },
      pattern() {
        return _pattern;
      },
      $with: {
        ...
        accessibilityModifier: (
          value?: NonNullable<Parameters<typeof _parameterName>[0]>["accessibilityModifier"],
        ) => _parameterName({ ...config, accessibilityModifier: value }),
        overrideModifier: (
          value?: NonNullable<Parameters<typeof _parameterName>[0]>["overrideModifier"],
        ) => _parameterName({ ...config, overrideModifier: value }),
        readonlyMarker: (
          value?: NonNullable<Parameters<typeof _parameterName>[0]>["readonlyMarker"],
  ...
  return withMethods(
    {
      ...
      $with: {
        expression: (value: T.Expression) =>
          _parenthesizedExpressionTyped({ ...config, expression: value }),
        type: (value?: T.TypeAnnotation) =>
          _parenthesizedExpressionTyped({ ...config, type: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        readonlyMarker: (
          value?: NonNullable<
            Parameters<typeof _publicFieldDefinitionAbstractFirst>[0]
          >["readonlyMarker"],
...
export function _publicFieldDefinitionAccessFirst(
  config: T.PublicFieldDefinitionAccessFirst.Config,
) {
  const _accessibility_modifier = coerceKindEnumStorage(config.accessibilityModifier, [
    ["public", TSKindId.Public] as const,
    ["private", TSKindId.Private] as const,
  ...
  return withMethods(
    {
      ...
      declareMarker() {
        return _declare_marker;
      },
      $with: {
        accessibilityModifier: (
          value: NonNullable<
            Parameters<typeof _publicFieldDefinitionAccessFirst>[0]
          >["accessibilityModifier"],
  ...
  return withMethods(
    {
      ...
      $with: {
        abstractMarker: (
          value?: NonNullable<
            Parameters<typeof _publicFieldDefinitionReadonlyFirst>[0]
          >["abstractMarker"],
...
export function _publicFieldDefinitionStaticMods(
  config: Partial<T.PublicFieldDefinitionStaticMods.Config> = {},
) {
  ...
  return withMethods(
    {
      ...
      $with: {
        overrideModifier: (
          value?: NonNullable<
            Parameters<typeof _publicFieldDefinitionStaticMods>[0]
          >["overrideModifier"],
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        arguments: (value: T.Arguments) =>
          _typeQueryCallExpression({ ...config, arguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        arguments: (value: T.Arguments) =>
          _typeQueryCallExpressionInTypeAnnotation({ ...config, arguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        content: (
          value: NonNullable<Parameters<typeof _typeQueryMemberExpression>[0]>["content"],
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        operator: (
          value: NonNullable<Parameters<typeof _updateExpressionPostfix>[0]>["operator"],
  ...
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          abstractClassDeclaration({ ...config, decorator: values }),
        name: (value: T.Identifier) => abstractClassDeclaration({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          abstractClassDeclaration({ ...config, typeParameters: value }),
        classHeritage: (value?: T.ClassHeritage) =>
          abstractClassDeclaration({ ...config, classHeritage: value }),
  ...
  return withMethods(
    {
      ...
      accessorKind() {
        return _accessor_kind;
      },
      name() {
        return _name;
      },
      optionalMarker() {
        return _optional_marker;
      },
      typeParameters() {
        return _type_parameters;
      },
      ...
      $with: {
        accessibilityModifier: (
          value?: NonNullable<
            Parameters<typeof abstractMethodSignature>[0]
          >["accessibilityModifier"],
        ) => abstractMethodSignature({ ...config, accessibilityModifier: value }),
        overrideModifier: (
          value?: NonNullable<Parameters<typeof abstractMethodSignature>[0]>["overrideModifier"],
        ) => abstractMethodSignature({ ...config, overrideModifier: value }),
        accessorKind: (
          value?: NonNullable<Parameters<typeof abstractMethodSignature>[0]>["accessorKind"],
        ) => abstractMethodSignature({ ...config, accessorKind: value }),
        name: (value: T.PropertyName) => abstractMethodSignature({ ...config, name: value }),
        optionalMarker: (
          value?: NonNullable<Parameters<typeof abstractMethodSignature>[0]>["optionalMarker"],
        ) => abstractMethodSignature({ ...config, optionalMarker: value }),
        typeParameters: (value?: T.TypeParameters) =>
          abstractMethodSignature({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          abstractMethodSignature({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        arguments: (...values: (T.Expression | T.SpreadElement)[]) =>
          arguments_({ ...config, arguments: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        elements: (...values: (T.Expression | T.SpreadElement)[]) =>
          array({ ...config, elements: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        elements: (...values: (T.Pattern | T.AssignmentPattern)[]) =>
          arrayPattern({ ...config, elements: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeParameters: (value?: T.TypeParameters) =>
          arrowFunction({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeAnnotation: (value: "const" | T.Type) =>
          asExpression({ ...config, typeAnnotation: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        usingMarker: (
          value?: NonNullable<Parameters<typeof assignmentExpression>[0]>["usingMarker"],
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        operator: (
          value: NonNullable<Parameters<typeof augmentedAssignmentExpression>[0]>["operator"],
  ...
  return withMethods(
    {
      ...
      $with: {
        left: (value: T.Expression | T.PrivatePropertyIdentifier) =>
          binaryExpression({ ...config, left: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        typeParameters: (value?: T.TypeParameters) =>
          callSignature({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      _body,
      catchClauseGroup1() {
        return _catch_clause_group1;
      },
      body() {
        return _body;
      },
      $with: {
        catchClauseGroup1: (value?: T.CatchClauseGroup1) =>
          catchClause({ ...config, catchClauseGroup1: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          classDeclaration({ ...config, decorator: values }),
        name: (value: T.Identifier) => classDeclaration({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          classDeclaration({ ...config, typeParameters: value }),
        classHeritage: (value?: T.ClassHeritage) =>
          classDeclaration({ ...config, classHeritage: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        expression: (value: T.ComputedPropertyName.Config["expression"]) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        abstractMarker: (
          value?: NonNullable<Parameters<typeof constructSignature>[0]>["abstractMarker"],
        ) => constructSignature({ ...config, abstractMarker: value }),
        typeParameters: (value?: T.TypeParameters) =>
          constructSignature({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          constructSignature({ ...config, parameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        abstractMarker: (
          value?: NonNullable<Parameters<typeof constructorType>[0]>["abstractMarker"],
        ) => constructorType({ ...config, abstractMarker: value }),
        typeParameters: (value?: T.TypeParameters) =>
          constructorType({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          constructorType({ ...config, parameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeArguments: (value?: T.TypeArguments) =>
          decoratorCallExpression({ ...config, typeArguments: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        property: (value: T.Identifier) =>
          decoratorMemberExpression({ ...config, property: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        condition: (value: T.ParenthesizedExpression) =>
          doStatement({ ...config, condition: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        enumAssignments: (...values: T.EnumAssignment[]) =>
          enumBody({ ...config, enumAssignment: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        expressions: (value: T.Expressions) =>
          expressionStatement({ ...config, expressions: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        values: (...values: NonEmptyArray<T.Expression>) =>
          extendsClause({ ...config, value: values }),
        typeArguments: (...values: T.TypeArguments[]) =>
          extendsClause({ ...config, typeArguments: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        condition: (value: T.Expressions | T.EmptyStatement) =>
          forStatement({ ...config, condition: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        asyncMarker: (
          value?: NonNullable<Parameters<typeof functionDeclaration>[0]>["asyncMarker"],
        ) => functionDeclaration({ ...config, asyncMarker: value }),
        name: (value: T.Identifier) => functionDeclaration({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          functionDeclaration({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          functionDeclaration({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        asyncMarker: (
          value?: NonNullable<Parameters<typeof functionExpression>[0]>["asyncMarker"],
        ) => functionExpression({ ...config, asyncMarker: value }),
        name: (value?: T.Identifier) => functionExpression({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          functionExpression({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          functionExpression({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        asyncMarker: (
          value?: NonNullable<Parameters<typeof functionSignature>[0]>["asyncMarker"],
        ) => functionSignature({ ...config, asyncMarker: value }),
        name: (value: T.Identifier) => functionSignature({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          functionSignature({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          functionSignature({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        typeParameters: (value?: T.TypeParameters) =>
          functionType({ ...config, typeParameters: value }),
        ...
        returnType: (value: T.Type | T.Asserts | T.TypePredicate) =>
          functionType({ ...config, returnType: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        asyncMarker: (
          value?: NonNullable<Parameters<typeof generatorFunction>[0]>["asyncMarker"],
        ) => generatorFunction({ ...config, asyncMarker: value }),
        name: (value?: T.Identifier) => generatorFunction({ ...config, name: value }),
        typeParameters: (value?: T.TypeParameters) =>
          generatorFunction({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          generatorFunction({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        asyncMarker: (
          value?: NonNullable<Parameters<typeof generatorFunctionDeclaration>[0]>["asyncMarker"],
        ...
        parameters: (value: T.FormalParameters) =>
          generatorFunctionDeclaration({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.Identifier | T.NestedTypeIdentifier) =>
          genericType({ ...config, name: value }),
...
export function hashBangLine(text: string) {
  ...
  if (
    ...
    !_leafRe_hashBangLine.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        condition: (value: T.ParenthesizedExpression) =>
          ifStatement({ ...config, condition: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        value: (value: T.Identifier | T.NestedIdentifier) =>
          importAlias({ ...config, value: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        $child: (v: T.NamespaceImport | T.NamedImports | T.ImportClauseDefaultImport) =>
          importClause(v),
      },
    },
    methodsEngine,
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        content: (value: T.ImportIdentifier | T.ImportSpecifierAs) =>
          importSpecifier({ ...config, content: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      _semicolon,
      importClause() {
        return _import_clause;
      },
      fromClause() {
        return _from_clause;
      },
      importAttribute() {
        return _import_attribute;
      },
      semicolon() {
        return _semicolon;
      },
      $with: {
        importClause: (
          value?: NonNullable<Parameters<typeof importStatement>[0]>["importClause"],
        ...
        importAttribute: (value?: T.ImportAttribute) =>
          importStatement({ ...config, importAttribute: value }),
...
export function indexSignature(config: T.IndexSignature.Config) {
  const _sign = coerceKindEnumStorage(config.sign, [
    ["-", TSKindId.Dash] as const,
    ["+", TSKindId.Plus] as const,
  ]);
  const _content = config.content;
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        content: (value: T.IndexSignatureColon | T.MappedTypeClause) =>
          indexSignature({ ...config, content: value }),
        type: (
          value:
            | T.TypeAnnotation
  ...
  return withMethods(
    {
      ...
      $with: {
        expression: (value: T.Expression) =>
          instantiationExpression({ ...config, expression: value }),
        typeArguments: (value: T.TypeArguments) =>
          instantiationExpression({ ...config, typeArguments: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeParameters: (value?: T.TypeParameters) =>
          interfaceDeclaration({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.String | T.Identifier | T.NestedIdentifier) =>
          internalModule({ ...config, name: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        optionalChain: (
          value?: NonNullable<Parameters<typeof memberExpression>[0]>["optionalChain"],
  ...
  return withMethods(
    {
      ...
      $with: {
        accessibilityModifier: (
          value?: NonNullable<Parameters<typeof methodDefinition>[0]>["accessibilityModifier"],
        ) => methodDefinition({ ...config, accessibilityModifier: value }),
        staticMarker: (
          value?: NonNullable<Parameters<typeof methodDefinition>[0]>["staticMarker"],
        ) => methodDefinition({ ...config, staticMarker: value }),
        overrideModifier: (
          value?: NonNullable<Parameters<typeof methodDefinition>[0]>["overrideModifier"],
        ) => methodDefinition({ ...config, overrideModifier: value }),
        readonlyMarker: (
          value?: NonNullable<Parameters<typeof methodDefinition>[0]>["readonlyMarker"],
        ...
        accessorKind: (
          value?: NonNullable<Parameters<typeof methodDefinition>[0]>["accessorKind"],
        ) => methodDefinition({ ...config, accessorKind: value }),
        name: (value: T.PropertyName) => methodDefinition({ ...config, name: value }),
        optionalMarker: (
          value?: NonNullable<Parameters<typeof methodDefinition>[0]>["optionalMarker"],
        ) => methodDefinition({ ...config, optionalMarker: value }),
        typeParameters: (value?: T.TypeParameters) =>
          methodDefinition({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          methodDefinition({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        accessibilityModifier: (
          value?: NonNullable<Parameters<typeof methodSignature>[0]>["accessibilityModifier"],
        ) => methodSignature({ ...config, accessibilityModifier: value }),
        staticMarker: (
          value?: NonNullable<Parameters<typeof methodSignature>[0]>["staticMarker"],
        ) => methodSignature({ ...config, staticMarker: value }),
        overrideModifier: (
          value?: NonNullable<Parameters<typeof methodSignature>[0]>["overrideModifier"],
        ) => methodSignature({ ...config, overrideModifier: value }),
        readonlyMarker: (
          value?: NonNullable<Parameters<typeof methodSignature>[0]>["readonlyMarker"],
        ...
        accessorKind: (
          value?: NonNullable<Parameters<typeof methodSignature>[0]>["accessorKind"],
        ) => methodSignature({ ...config, accessorKind: value }),
        name: (value: T.PropertyName) => methodSignature({ ...config, name: value }),
        optionalMarker: (
          value?: NonNullable<Parameters<typeof methodSignature>[0]>["optionalMarker"],
        ) => methodSignature({ ...config, optionalMarker: value }),
        typeParameters: (value?: T.TypeParameters) =>
          methodSignature({ ...config, typeParameters: value }),
        parameters: (value: T.FormalParameters) =>
          methodSignature({ ...config, parameters: value }),
        returnType: (value?: T.TypeAnnotation | T.AssertsAnnotation | T.TypePredicateAnnotation) =>
  ...
  return withMethods(
    {
      ...
      $with: {
        object: (value: T.Identifier | T.NestedIdentifier) =>
          nestedIdentifier({ ...config, object: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        module: (value: T.Identifier | T.NestedIdentifier) =>
          nestedTypeIdentifier({ ...config, module: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        constructor: (value: T.PrimaryExpression) =>
          newExpression({ ...config, constructor: value }),
        typeArguments: (value?: T.TypeArguments) =>
          newExpression({ ...config, typeArguments: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        $child: (v: T.ObjectTypeContentComma | T.ObjectTypeContentSemi) => objectTypeContent(v),
      },
    },
    methodsEngine,
  );
...
export function objectTypeContentComma(
  ...children: (
    | T.ExportStatement
    | T.PropertySignature
    | T.CallSignature
...
export function objectTypeContentSemi(
  ...children: (
    | T.ExportStatement
    | T.PropertySignature
    | T.CallSignature
  ...
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          optionalParameter({ ...config, decorator: values }),
        accessibilityModifier: (
        ...
        overrideModifier: (
          value?: NonNullable<Parameters<typeof optionalParameter>[0]>["overrideModifier"],
        ) => optionalParameter({ ...config, overrideModifier: value }),
        readonlyMarker: (
          value?: NonNullable<Parameters<typeof optionalParameter>[0]>["readonlyMarker"],
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        staticMarker: (
          value?: NonNullable<Parameters<typeof propertySignature>[0]>["staticMarker"],
        ) => propertySignature({ ...config, staticMarker: value }),
        overrideModifier: (
          value?: NonNullable<Parameters<typeof propertySignature>[0]>["overrideModifier"],
        ) => propertySignature({ ...config, overrideModifier: value }),
        readonlyMarker: (
          value?: NonNullable<Parameters<typeof propertySignature>[0]>["readonlyMarker"],
        ) => propertySignature({ ...config, readonlyMarker: value }),
        name: (value: T.PropertyName) => propertySignature({ ...config, name: value }),
        optionalMarker: (
          value?: NonNullable<Parameters<typeof propertySignature>[0]>["optionalMarker"],
  ...
  return withMethods(
    {
      ...
      publicFieldDefinitionAbstractFirst() {
        return _public_field_definition_abstract_first;
      },
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          publicFieldDefinition({ ...config, decorator: values }),
        content: (
          value?: T.PublicFieldDefinitionDeclareFirst | T.PublicFieldDefinitionAccessFirst,
        ...
        accessorMarker: (
          value?: NonNullable<Parameters<typeof publicFieldDefinition>[0]>["accessorMarker"],
        ) => publicFieldDefinition({ ...config, accessorMarker: value }),
        name: (value: T.PropertyName) => publicFieldDefinition({ ...config, name: value }),
        optionalityMarker: (
          value?: NonNullable<Parameters<typeof publicFieldDefinition>[0]>["optionalityMarker"],
  ...
  return withMethods(
    {
      ...
      $with: {
        decorators: (...values: T.Decorator[]) =>
          requiredParameter({ ...config, decorator: values }),
        accessibilityModifier: (
        ...
        overrideModifier: (
          value?: NonNullable<Parameters<typeof requiredParameter>[0]>["overrideModifier"],
        ) => requiredParameter({ ...config, overrideModifier: value }),
        readonlyMarker: (
          value?: NonNullable<Parameters<typeof requiredParameter>[0]>["readonlyMarker"],
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeAnnotation: (value: T.Type) =>
          satisfiesExpression({ ...config, typeAnnotation: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        opening: (value: NonNullable<Parameters<typeof string>[0]>["opening"]) =>
          string({ ...config, opening: value }),
        contents: (
          ...values: (
        ...
        closing: (value: NonNullable<Parameters<typeof string>[0]>["closing"]) =>
          string({ ...config, closing: value }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        object: (value: T.Expression | T.PrimaryExpression) =>
          subscriptExpression({ ...config, object: value }),
        optionalChain: (
          value?: NonNullable<Parameters<typeof subscriptExpression>[0]>["optionalChain"],
  ...
  return withMethods(
    {
      ...
      $with: {
        cases: (...values: (T.SwitchCase | T.SwitchDefault)[]) =>
          switchBody({ ...config, cases: values }),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        $children: (...vs: (T.TemplateChars | T.TemplateType)[]) => templateLiteralType(...vs),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        ...
        typeParameters: (value?: T.TypeParameters) =>
          typeAliasDeclaration({ ...config, typeParameters: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        typeArguments: (value: T.TypeArguments) =>
          typeAssertion({ ...config, typeArguments: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.Identifier | T.This | T.PredefinedType) =>
          typePredicate({ ...config, name: value }),
...
export function unescapedDoubleStringFragment(text: string) {
  ...
  if (
    typeof process !== "undefined" &&
    process.env.SITTIR_DEBUG &&
    !_leafRe_unescapedDoubleStringFragment.test(text)
  )
...
export function unescapedSingleStringFragment(text: string) {
  ...
  if (
    typeof process !== "undefined" &&
    process.env.SITTIR_DEBUG &&
    !_leafRe_unescapedSingleStringFragment.test(text)
  )
  ...
  return withMethods(
    {
      ...
      $with: {
        $child: (v: T.UpdateExpressionPostfix | T.UpdateExpressionPrefix) => updateExpression(v),
      },
    },
    methodsEngine,
  );
  ...
  return withMethods(
    {
      ...
      $with: {
        name: (value: T.Identifier | T.DestructuringPattern) =>
          variableDeclarator({ ...config, name: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        condition: (value: T.ParenthesizedExpression) =>
          whileStatement({ ...config, condition: value }),
  ...
  return withMethods(
    {
      ...
      $with: {
        parameter: (value: T.Identifier | T.DestructuringPattern) =>
          catchClauseGroup1({ ...config, parameter: value }),
...
export type FluentKindMap = {
  ...
  >;
  _export_statement_default: FluentNode<
    "_export_statement_default",
    T.ExportStatementDefault.Config
  >;
  ...
  object_type_content_comma: FluentNode<
    "object_type_content_comma",
    T.ObjectTypeContentComma.Config
  >;
