...
export function augmented_assignment(left: Builder<Identifier | MemberExpression | NonNullExpression | ParenthesizedExpression | SubscriptExpression>): AugmentedAssignmentBuilder {
