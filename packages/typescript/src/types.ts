...
export type ExportStatement =
	| ExportStatementUFormDefault
	| ExportStatementUFormTypeExport
	| ExportStatementUFormEqualsExport
	| ExportStatementUFormNamespaceExport;
...
export interface ImportClauseDefaultImport {
	...
	readonly $children: readonly [
		ImportIdentifier | NamespaceImport | NamedImports
	];
}
...
export type ImportClause =
	| ImportClauseUFormNamespaceImport
	| ImportClauseUFormNamedImports
	| ImportClauseUFormDefaultImport;
...
export interface ForInStatement {
	...
	readonly $children: readonly [
		ForHeaderLhs | ForHeaderVarKind | ForHeaderLetConstKind
	];
}
...
export type ParenthesizedExpression =
	| ParenthesizedExpressionUFormTyped
	| ParenthesizedExpressionUFormSequence;
...
export interface JsxExpression {
	...
	readonly $children: readonly [
		Expression | SequenceExpression | SpreadElement
	];
}
...
export type ClassHeritage =
	| ClassHeritageUFormExtendsClause
	| ClassHeritageUFormImplementsClause;
...
export type ArrowFunction =
	...
	| ArrowFunctionUFormUCallSignature;
...
export type CallExpression =
	| CallExpressionUFormCall
	| CallExpressionUFormTemplateCall
	| CallExpressionUFormMember;
...
export type UpdateExpression =
	| UpdateExpressionUFormPostfix
	| UpdateExpressionUFormPrefix;
...
export interface DecoratorParenthesizedExpression {
	...
	readonly $children: readonly [
		Identifier | DecoratorMemberExpression | DecoratorCallExpression
	];
}
...
export interface ExtendsTypeClause {
	...
	readonly $fields: {
		readonly type: NonEmptyArray<
			TypeIdentifier | NestedTypeIdentifier | GenericType
		>;
	};
}
...
export interface LiteralType {
	...
	readonly $children: readonly [
		_Number | Number | String | True | False | Null | Undefined
	];
}
...
export interface ClassBodyMethodSig {
	...
	readonly $children: readonly [
		MethodSignature | FunctionSignatureAutomaticSemicolon
	];
}
...
export type HtmlCharacterReference = Terminal<
...
export type PrivatePropertyIdentifier = Terminal<
...
export type FunctionSignatureAutomaticSemicolon = Terminal<
...
export interface StatementIdentifierTree extends AnyTreeNode {
	readonly type: '_statement_identifier';
}
export interface PropertyIdentifierTree extends AnyTreeNode {
	readonly type: '_property_identifier';
}
export interface StringFragmentTree extends AnyTreeNode {
	readonly type: '_string_fragment';
}
...
export interface InterfaceBodyTree extends AnyTreeNode {
	readonly type: '_interface_body';
}
...
export type JsxAttributeName = Identifier | JsxNamespaceName;
...
export type ShorthandPropertyIdentifierTree =
	| IdentifierTree
...
export type ShorthandPropertyIdentifierPatternTree =
	| IdentifierTree
	| ReservedIdentifierTree;
...
export type ExportStatementDefaultTree =
	| ExportStatementDefaultFromArmTree
	| ExportStatementDefaultDeclArmTree;
...
export interface ImportStatementNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface ImportClauseNamespaceImportNs extends NodeNs<
	ImportClauseNamespaceImport,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface ImportClauseNamedImportsNs extends NodeNs<
	ImportClauseNamedImports,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ClassHeritageExtendsClauseNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface ClassHeritageImplementsClauseNs extends NodeNs<
	ClassHeritageImplementsClause,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface PropertyIdentifierNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface StringFragmentNs extends NodeNs<
	StringFragment,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface InterfaceBodyNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface ThisTypeNs extends NodeNs<
	ThisType,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ExportStatementDefaultDeclArmDefaultKwNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _ArrowFunctionParameterNs extends NodeNs<
	_ArrowFunctionParameter,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ArrowFunctionUCallSignatureNs extends NodeNs<
	_ArrowFunctionUCallSignature,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ClassHeritageExtendsClauseNs extends NodeNs<
	_ClassHeritageExtendsClause,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ClassHeritageImplementsClauseNs extends NodeNs<
	_ClassHeritageImplementsClause,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ImportClauseNamespaceImportNs extends NodeNs<
	_ImportClauseNamespaceImport,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ImportClauseNamedImportsNs extends NodeNs<
	_ImportClauseNamedImports,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ImportClauseDefaultImportNs extends NodeNs<
	_ImportClauseDefaultImport,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ImportSpecifierNameNs extends NodeNs<
	_ImportSpecifierName,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface IndexSignatureColonNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _IndexSignatureMappedTypeClauseNs extends NodeNs<
	_IndexSignatureMappedTypeClause,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface PublicFieldDefinitionReadonlyFirstNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface PublicFieldDefinitionAccessorOptNs extends NodeNs<
	PublicFieldDefinitionAccessorOpt,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface ParenthesizedExpressionTypedNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _ParenthesizedExpressionSequenceNs extends NodeNs<
	_ParenthesizedExpressionSequence,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ExportStatementTypeExportNs extends NodeNs<
	_ExportStatementTypeExport,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ExportStatementEqualsExportNs extends NodeNs<
	_ExportStatementEqualsExport,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _ExportStatementNamespaceExportNs extends NodeNs<
	_ExportStatementNamespaceExport,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export interface CallExpressionMemberNs extends NodeNs<
	...
	NamespaceMap
> {}
export interface _StringDoubleNs extends NodeNs<
	_StringDouble,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
> {}
export interface _StringSingleNs extends NodeNs<
	_StringSingle,
	LeafScalarMap,
	LeafStringMap,
	NamespaceMap
...
export namespace TypeQueryMemberExpressionInTypeAnnotation {
	export type Config =
		ConfigFor<'_type_query_member_expression_in_type_annotation'>;
	export type Fluent =
		FluentFor<'_type_query_member_expression_in_type_annotation'>;
	export type Loose =
		LooseFor<'_type_query_member_expression_in_type_annotation'>;
	export type Tree =
		TreeFor<'_type_query_member_expression_in_type_annotation'>;
...
export namespace TypeQueryCallExpressionInTypeAnnotation {
	export type Config =
		ConfigFor<'_type_query_call_expression_in_type_annotation'>;
	export type Fluent =
		FluentFor<'_type_query_call_expression_in_type_annotation'>;
	export type Loose =
		LooseFor<'_type_query_call_expression_in_type_annotation'>;
...
export namespace ExportStatementDefaultDeclArmDefaultKw {
	export type Config =
		ConfigFor<'_export_statement_default_decl_arm_default_kw'>;
	export type Fluent =
		FluentFor<'_export_statement_default_decl_arm_default_kw'>;
...
export namespace ExportStatementDefaultFromArmStarFrom {
	export type Config =
		ConfigFor<'_export_statement_default_from_arm_star_from'>;
	export type Fluent =
		FluentFor<'_export_statement_default_from_arm_star_from'>;
...
export namespace ExportStatementDefaultFromArmClauseFrom {
	export type Config =
		ConfigFor<'_export_statement_default_from_arm_clause_from'>;
	export type Fluent =
		FluentFor<'_export_statement_default_from_arm_clause_from'>;
	export type Loose =
		LooseFor<'_export_statement_default_from_arm_clause_from'>;
...
export namespace ExportStatementDefaultDeclArmDefaultKwValue {
	export type Config =
		ConfigFor<'_export_statement_default_decl_arm_default_kw_value'>;
	export type Fluent =
		FluentFor<'_export_statement_default_decl_arm_default_kw_value'>;
	export type Loose =
		LooseFor<'_export_statement_default_decl_arm_default_kw_value'>;
	export type Tree =
		TreeFor<'_export_statement_default_decl_arm_default_kw_value'>;
