...
export function kindIdFromName(kindName: string): TSKindId {
  switch (kindName) {
    ...
    case "object_type_content_comma":
      return TSKindId.ObjectTypeContentComma;
    case "object_type_content_semi":
      return TSKindId.ObjectTypeContentSemi;
    ...
    case "_export_clause_optional1_repeat1":
      return TSKindId._ExportClauseOptional1Repeat1;
    case "_named_imports_optional1_repeat1":
      return TSKindId._NamedImportsOptional1Repeat1;
    case "_formal_parameters_optional1_repeat1":
      return TSKindId._FormalParametersOptional1Repeat1;
    case "_enum_body_optional1_repeat1":
      return TSKindId._EnumBodyOptional1Repeat1;
    case "_tuple_type_optional1_repeat1":
      return TSKindId._TupleTypeOptional1Repeat1;
    case "object_type_content_comma_repeat1":
      return TSKindId.ObjectTypeContentCommaRepeat1;
    case "object_type_content_semi_repeat1":
      return TSKindId.ObjectTypeContentSemiRepeat1;
...
export interface AbstractMethodSignature {
  ...
  readonly __inputHints__?: {
    ...
    >;
    readonly override_modifier?: BooleanKeyword<"override">;
    readonly accessor_kind?: KindEnum<
      "get" | "set" | "*",
      TSKindId.Get | TSKindId.Set | TSKindId.Star2
    >;
...
export type _AccessibilityModifier = Terminal<
  ...
  "public" | "private" | "protected"
>;
export type AccessorKind = Terminal<
  TSKindId.Get | TSKindId.Set | TSKindId.Star2,
  "get" | "set" | "*"
>;
export type AugmentedAssignmentExpressionOperator = Terminal<
  ...
  | "??="
>;
export type ExportSpecifierExportKind = Terminal<
  TSKindId.Type | TSKindId.Typeof,
  "type" | "typeof"
>;
...
export type PublicFieldDefinitionOptionalityMarker = Terminal<
  TSKindId.Qmark | TSKindId.Bang,
  "?" | "!"
>;
...
export type UnescapedDoubleJsxStringFragment = Terminal<
  "unescaped_double_jsx_string_fragment",
  string
>;
export type UnescapedDoubleStringFragment = Terminal<
  TSKindId.UnescapedDoubleStringFragment,
  string
>;
export type UnescapedSingleJsxStringFragment = Terminal<
  "unescaped_single_jsx_string_fragment",
  string
>;
export type UnescapedSingleStringFragment = Terminal<
...
export interface EnumBodyOptional1Tree extends AnyTreeNode {
  readonly type: "_enum_body_optional1";
}
...
export interface ObjectTypeOptional1Tree extends AnyTreeNode {
  readonly type: "_object_type_optional1";
}
...
export interface _CallSignatureNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface _CatchClauseGroup1Ns extends NodeNs<
  _CatchClauseGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface ClassHeritageExtendsClauseNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface EnumBodyOptional1Ns extends NodeNs<
  EnumBodyOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface IndexSignatureOptional1Ns extends NodeNs<
  ...
  NamespaceMap
> {}
export interface InferTypeOptional1Ns extends NodeNs<
  InferTypeOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface JsxStartOpeningElementNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface JsxStringNs extends NodeNs<
  JsxString,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface ObjectTypeOptional1Ns extends NodeNs<
  ObjectTypeOptional1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface IntersectionTypeNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface JsxAttributeNs extends NodeNs<
  JsxAttribute,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface JsxClosingElementNs extends NodeNs<
  JsxClosingElement,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface JsxElementNs extends NodeNs<
  JsxElement,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface JsxExpressionNs extends NodeNs<
  JsxExpression,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface JsxNamespaceNameNs extends NodeNs<
  JsxNamespaceName,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface JsxOpeningElementNs extends NodeNs<
  JsxOpeningElement,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface ObjectTypeContentNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface ObjectTypeContentCommaNs extends NodeNs<
  ObjectTypeContentComma,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface ObjectTypeContentSemiNs extends NodeNs<
  ObjectTypeContentSemi,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
...
export interface YieldExpressionNs extends NodeNs<
  ...
  NamespaceMap
> {}
export interface ImportClauseGroup1Ns extends NodeNs<
  ImportClauseGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
> {}
export interface CatchClauseGroup1Ns extends NodeNs<
  CatchClauseGroup1,
  LeafScalarMap,
  LeafStringMap,
  NamespaceMap
