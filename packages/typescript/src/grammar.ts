...
export type TypescriptGrammar = {
	...
	readonly export_statement_default_decl_arm: {
		...
		children: {
			...
			required: false;
			types: [
				{ type: 'export_statement_default_decl_arm_default_kw'; named: true }
			];
		};
	};
	...
	readonly export_statement_default_from_arm_clause_from: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'export_clause'; named: true }];
		};
	};
	...
	readonly import_clause_named_imports: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: 'named_imports'; named: true }];
		};
	};
	...
	readonly infer_type: {
		...
		fields: {
			constraint: {
				multiple: false;
				required: false;
				types: [{ type: 'extends'; named: false }];
			};
			type: {
				multiple: false;
				required: false;
	...
	readonly lexical_declaration: {
		...
		fields: {
			declarators: {
				...
				types: [
					{ type: ','; named: false },
					{ type: 'variable_declarator'; named: true }
				];
			};
			kind: {
				multiple: false;
	...
	readonly string: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: 'string_double'; named: true },
				{ type: 'string_single'; named: true }
			];
		};
	};
