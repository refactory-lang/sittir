...
export type TypescriptGrammar = {
	...
	readonly abstract_method_signature: {
		...
		fields: {
			...
			override_modifier: {
				multiple: false;
				required: false;
				types: [{ type: "override_modifier"; named: true }];
			};
			parameters: {
				multiple: false;
				required: true;
	...
	readonly arrow_function_parameter: {
		...
		named: true;
		fields: {
			parameter: { multiple: false; required: true; types: [{ type: "identifier"; named: true }] };
		};
	};
	...
	readonly call_expression_template_call: {
		...
		fields: {
			arguments: {
				multiple: false;
				required: true;
				types: [{ type: "template_string"; named: true }];
			};
			function: {
				multiple: false;
				required: true;
	...
	readonly class_body_method: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: "method_definition"; named: true }];
		};
	};
	readonly class_body_method_sig: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: "method_signature"; named: true }];
		};
	};
	...
	readonly class_heritage: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: "class_heritage_extends_clause"; named: true },
				{ type: "class_heritage_implements_clause"; named: true },
			];
		};
	};
	...
	readonly class_heritage_implements_clause: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: "implements_clause"; named: true }];
		};
	};
	...
	readonly constructor_type: {
		...
		fields: {
			abstract_marker: {
				multiple: false;
				required: false;
				types: [{ type: "abstract"; named: false }];
			};
			parameters: {
				multiple: false;
				required: true;
	...
	readonly else_clause: {
		...
		named: true;
		fields: {
			statement: { multiple: false; required: true; types: [{ type: "statement"; named: true }] };
		};
	};
		...
		fields: {
			...
			opening: {
				...
				types: [
					{ type: ","; named: false },
					{ type: "computed_property_name"; named: true },
					{ type: "enum_assignment"; named: true },
					{ type: "number"; named: true },
					{ type: "private_property_identifier"; named: true },
					{ type: "property_identifier"; named: true },
					{ type: "string"; named: true },
	...
	readonly export_statement_default_from_arm_ns_from: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: "namespace_export"; named: true }];
		};
	};
	...
	readonly import_attribute: {
		...
		fields: {
			object: {
				...
				required: true;
				types: [
					{ type: "assert"; named: false },
					{ type: "object"; named: true },
					{ type: "with"; named: false },
				];
			};
		};
	};
	readonly import_clause: {
		...
		children: {
			...
			types: [
				...
				{ type: "import_clause_named_imports"; named: true },
				{ type: "import_clause_namespace_import"; named: true },
			];
		};
	};
	...
	readonly import_clause_named_imports: {
		...
		named: true;
		fields: {};
		children: { multiple: false; required: true; types: [{ type: "named_imports"; named: true }] };
	};
	readonly import_clause_namespace_import: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: "namespace_import"; named: true }];
		};
	};
	...
	readonly import_specifier: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: "import_specifier_as"; named: true },
				{ type: "import_specifier_name"; named: true },
			];
		};
	};
	...
	readonly import_statement: {
		...
		fields: {
			...
			import_attribute: {
				multiple: false;
				required: false;
				types: [{ type: "import_attribute"; named: true }];
			};
			import_clause: {
				multiple: false;
				required: false;
	...
	readonly infer_type: {
		...
		named: true;
		fields: {
			constraint: { multiple: false; required: false; types: [{ type: "extends"; named: false }] };
	...
	readonly method_definition: {
		...
		fields: {
			...
			override_modifier: {
				multiple: true;
				required: false;
				types: [{ type: "override_modifier"; named: true }, { type: "static"; named: false }];
			};
			parameters: {
				multiple: false;
				required: true;
			...
			readonly_marker: {
				multiple: false;
				required: false;
				types: [{ type: "readonly"; named: false }];
			};
			return_type: {
				multiple: false;
				required: false;
	...
	readonly parenthesized_expression_sequence: {
		...
		children: {
			multiple: false;
			required: true;
			types: [{ type: "sequence_expression"; named: true }];
		};
	};
	...
	readonly program: {
		...
		fields: {
			hash_bang_line: {
				multiple: false;
				required: false;
				types: [{ type: "hash_bang_line"; named: true }];
			};
	...
	readonly update_expression: {
		...
		children: {
			...
			required: true;
			types: [
				{ type: "update_expression_postfix"; named: true },
				{ type: "update_expression_prefix"; named: true },
			];
		};
	};
