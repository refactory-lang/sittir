...
class LabeledStatementBuilder extends Builder<LabeledStatement> {
  ...
  override get nodeKind(): 'labeled_statement' { return 'labeled_statement'; }
...
export namespace labeled_statement {
  export function from(options: Omit<LabeledStatementOptions, 'nodeKind'>): LabeledStatementBuilder {
