...
class MethodSignatureBuilder extends Builder<MethodSignature> {
  ...
  override get nodeKind(): 'method_signature' { return 'method_signature'; }
...
export namespace method_signature {
  export function from(options: Omit<MethodSignatureOptions, 'nodeKind'>): MethodSignatureBuilder {
    ...
    const b = new MethodSignatureBuilder(_ctor);
