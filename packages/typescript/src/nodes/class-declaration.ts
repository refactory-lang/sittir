...
class ClassDeclarationBuilder extends Builder<ClassDeclaration> {
  ...
  override get nodeKind(): 'class_declaration' { return 'class_declaration'; }
...
export namespace class_declaration {
  export function from(options: Omit<ClassDeclarationOptions, 'nodeKind'>): ClassDeclarationBuilder {
