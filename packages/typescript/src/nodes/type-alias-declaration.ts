...
export type { TypeAliasDeclarationBuilder };

export function type_alias_declaration(name: Builder<TypeIdentifier>): TypeAliasDeclarationBuilder {
  return new TypeAliasDeclarationBuilder(name);
}
