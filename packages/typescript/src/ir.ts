...
export const statement = {
  export: _attach(F.exportStatement, { from: FR.exportStatementFrom, "default": _attach(F.exportStatementUFormDefault, { from: FR.exportStatementUFormDefaultFrom }), "typeExport": _attach(F.exportStatementUFormTypeExport, { from: FR.exportStatementUFormTypeExportFrom }), "equalsExport": _attach(F.exportStatementUFormEqualsExport, { from: FR.exportStatementUFormEqualsExportFrom }), "namespaceExport": _attach(F.exportStatementUFormNamespaceExport, { from: FR.exportStatementUFormNamespaceExportFrom }) }),
...
export const ir = {
  ...
  arrowFunction: _attach(F.arrowFunction, { from: FR.arrowFunctionFrom, "parameter": _attach(F.arrowFunctionUFormParameter, { from: FR.arrowFunctionUFormParameterFrom }), "callSignature": _attach(F.arrowFunctionUFormUCallSignature, { from: FR.arrowFunctionUFormUCallSignatureFrom }) }),
  ...
  callExpression: _attach(F.callExpression, { from: FR.callExpressionFrom, "call": _attach(F.callExpressionUFormCall, { from: FR.callExpressionUFormCallFrom }), "templateCall": _attach(F.callExpressionUFormTemplateCall, { from: FR.callExpressionUFormTemplateCallFrom }), "member": _attach(F.callExpressionUFormMember, { from: FR.callExpressionUFormMemberFrom }) }),
  ...
  classHeritage: _attach(F.classHeritage, { from: FR.classHeritageFrom, "extendsClause": _attach(F.classHeritageUFormExtendsClause, { from: FR.classHeritageUFormExtendsClauseFrom }), "implementsClause": _attach(F.classHeritageUFormImplementsClause, { from: FR.classHeritageUFormImplementsClauseFrom }) }),
  ...
  exportStatement: _attach(F.exportStatement, { from: FR.exportStatementFrom, "default": _attach(F.exportStatementUFormDefault, { from: FR.exportStatementUFormDefaultFrom }), "typeExport": _attach(F.exportStatementUFormTypeExport, { from: FR.exportStatementUFormTypeExportFrom }), "equalsExport": _attach(F.exportStatementUFormEqualsExport, { from: FR.exportStatementUFormEqualsExportFrom }), "namespaceExport": _attach(F.exportStatementUFormNamespaceExport, { from: FR.exportStatementUFormNamespaceExportFrom }) }),
  ...
  importClause: _attach(F.importClause, { from: FR.importClauseFrom, "namespaceImport": _attach(F.importClauseUFormNamespaceImport, { from: FR.importClauseUFormNamespaceImportFrom }), "namedImports": _attach(F.importClauseUFormNamedImports, { from: FR.importClauseUFormNamedImportsFrom }), "defaultImport": _attach(F.importClauseUFormDefaultImport, { from: FR.importClauseUFormDefaultImportFrom }) }),
  ...
  indexSignature: _attach(F.indexSignature, { from: FR.indexSignatureFrom, "colon": _attach(F.indexSignatureUFormColon, { from: FR.indexSignatureUFormColonFrom }), "mappedTypeClause": _attach(F.indexSignatureUFormMappedTypeClause, { from: FR.indexSignatureUFormMappedTypeClauseFrom }) }),
  ...
  parenthesizedExpression: _attach(F.parenthesizedExpression, { from: FR.parenthesizedExpressionFrom, "typed": _attach(F.parenthesizedExpressionUFormTyped, { from: FR.parenthesizedExpressionUFormTypedFrom }), "sequence": _attach(F.parenthesizedExpressionUFormSequence, { from: FR.parenthesizedExpressionUFormSequenceFrom }) }),
  ...
  updateExpression: _attach(F.updateExpression, { from: FR.updateExpressionFrom, "postfix": _attach(F.updateExpressionUFormPostfix, { from: FR.updateExpressionUFormPostfixFrom }), "prefix": _attach(F.updateExpressionUFormPrefix, { from: FR.updateExpressionUFormPrefixFrom }) }),
