...
export const _BRANCH_FIELDS: Record<string, string[]> = {
  ...
  'abstract_method_signature': ["name","parameters","returnType","typeParameters"],
  ...
  'method_definition': ["body","name","parameters","returnType","typeParameters"],
  'method_signature': ["name","parameters","returnType","typeParameters"],
  'module': ["body","name"],
