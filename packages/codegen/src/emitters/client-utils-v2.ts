...
export interface EmitClientUtilsFromNodeMapConfig {
    nodeMap: NodeMap
}

export function emitClientUtilsFromNodeMap(_config: EmitClientUtilsFromNodeMapConfig): string {
    const lines: string[] = []
    ...
    lines.push("import type { KindMap, ConfigMap, LooseMap } from './types.js';")
    lines.push('')
