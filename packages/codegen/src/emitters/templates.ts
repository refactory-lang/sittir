...
import type { LoopDrivenEmitter } from './emitter.ts';
...
export class TemplateEmitter implements LoopDrivenEmitter<EmitTemplatesConfig, EmittedTemplates> {
	#config: EmitTemplatesConfig | null = null;
	#wordMatcher: RegExp | null = null;
	...
	init(config: EmitTemplatesConfig): void {
		this.#config = config;
	...
	#emitNode(node: AssembledNode): void {
		...
		const wordMatcher = this.#wordMatcher;
...
export const templateEmitter = new TemplateEmitter();
