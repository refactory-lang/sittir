...
export function emitTypesFromNodeMap(config: EmitTypesFromNodeMapConfig): string {
    ...
    lines.push("import type { NodeData as BaseNodeData, NodeConfig as BaseNodeConfig, TreeNode as BaseTreeNode, ConfigOf, FromInputOf, NodeKind, AnyTreeNodeOf as AnyTreeNode } from '@sittir/types';")
    lines.push('')
