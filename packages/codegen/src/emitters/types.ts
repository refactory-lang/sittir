...
export function emitTypes(config: EmitTypesConfig): string {
    ...
    lines.push("import type { NodeData as BaseNodeData, NodeConfig as BaseNodeConfig, TreeNode as BaseTreeNode, ConfigOf, FromInputOf, NodeKind, NodeNs, AnyTreeNodeOf as AnyTreeNode, Terminal, NonEmptyArray } from '@sittir/types';")
    lines.push('')
