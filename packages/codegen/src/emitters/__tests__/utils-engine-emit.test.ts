...
describe('utils engine facade emission', () => {
	...
	it('imports ArgsOf, ElementsOf, FlavorPair, Hoisted, OmitEach, and OptionsArg from @sittir/types rather than redeclaring them', () => {
		...
		expect(contents).toContain('export type { ArgsOf, ElementsOf, FlavorPair, Hoisted, OmitEach, OptionsArg };');
