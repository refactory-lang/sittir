...
export async function loadWebTreeSitter(): Promise<{
	...
	const Parser =
		mod.Parser ?? (mod.default && "Parser" in mod.default ? mod.default.Parser : undefined);
	const Language =
		mod.Language ?? (mod.default && "Language" in mod.default ? mod.default.Language : undefined);
	if (!Parser || !Language) {
