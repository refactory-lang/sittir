 ...
 */
export declare const KindUseFlag: {
    readonly None: 0;
...
export declare function computePolymorphFormKinds(nodes: Map<string, AssembledNode>): Set<string>;
