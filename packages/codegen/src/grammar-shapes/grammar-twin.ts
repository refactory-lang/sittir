 ...
 * baked into `Sym` or `$` — grammars are mutually recursive
...
//   - Node is `Sym<Name>` and Depth > 0 → `S['rules'][Name]` (one expansion),
//     decrementing Depth.
//   - Depth exhausted, or Node not a symbol, or Name not in rules → Node
